...
- [xmrig/xmrig](https://github.com/xmrig/xmrig) ★9398 [`argon2`] [`cpuminer`] [`cryptocurrency`] [`cryptonight`] [`miner`] [`monero`] [`randomx`] [`xmr`] [`xmrig`]  
...
- [sabrogden/Ditto](https://github.com/sabrogden/Ditto) ★4906 [`clipboard`] [`clipboard-manager`]  
...
- [viest/php-ext-xlswriter](https://github.com/viest/php-ext-xlswriter) ★2360 [`dll`] [`excel`] [`excel-export`] [`excelwriter`] [`extension`] [`laravel`] [`libxlsxwriter`] [`pecl`] [`phalcon`] [`php`] [`swoole`] [`xlswriter`] [`xlsx`] [`xlsx-files`] [`xlsx-writer`] [`xlsxreader`] [`xlsxwriter`]  
