...
- [nocodb/nocodb](https://github.com/nocodb/nocodb) ★55646 [`airtable`] [`airtable-alternative`] [`automatic-api`] [`hacktoberfest`] [`low-code`] [`no-code`] [`no-code-database`] [`no-code-platform`] [`postgresql`] [`rest-api`] [`restful-api`] [`spreadsheet`] [`sqlite`] [`swagger`]  
...
- [lyswhut/lx-music-desktop](https://github.com/lyswhut/lx-music-desktop) ★45038 [`electron`] [`javascript`] [`music-player`] [`vue`]  
...
- [mendableai/firecrawl](https://github.com/mendableai/firecrawl) ★42594 [`ai`] [`ai-scraping`] [`crawler`] [`data`] [`html-to-markdown`] [`llm`] [`markdown`] [`rag`] [`scraper`] [`scraping`] [`web-crawler`] [`webscraping`]  
...
- [DIYgod/RSSHub](https://github.com/DIYgod/RSSHub) ★37667 [`bilibili`] [`douban`] [`dribbble`] [`instagram`] [`lofter`] [`pixiv`] [`rss`] [`rsshub`] [`spotify`] [`telegram`] [`tiktok`] [`twitter`] [`v2ex`] [`wechat`] [`weibo`] [`ximalaya`] [`youtube`] [`zhihu`]  
...
- [markedjs/marked](https://github.com/markedjs/marked) ★35067 [`commonmark`] [`compiler`] [`gfm`] [`hacktoberfest`] [`markdown`] [`parser`]  
...
- [niklasvh/html2canvas](https://github.com/niklasvh/html2canvas) ★31361 [`dom`] [`javascript`] [`screenshot`]  
...
- [RSSNext/Folo](https://github.com/RSSNext/Folo) ★27949 [`ai`] [`blockchain`] [`reader`] [`rss`] [`rss-reader`]  
...
- [oldj/SwitchHosts](https://github.com/oldj/SwitchHosts) ★25328 [`electron`] [`hosts`] [`hostseditor`] [`hostsfile`] [`switch-hosts`] [`switchhosts`]  
...
- [fingerprintjs/fingerprintjs](https://github.com/fingerprintjs/fingerprintjs) ★25000 [`audio-fingerprinting`] [`browser`] [`browser-fingerprint`] [`browser-fingerprinting`] [`detection`] [`fingerprint`] [`fingerprinting`] [`fingerprintjs`] [`fraud`] [`fraud-detection`] [`identification`] [`javascript`] [`visitor-identifier`]  
...
- [blakeblackshear/frigate](https://github.com/blakeblackshear/frigate) ★23745 [`ai`] [`camera`] [`google-coral`] [`home-assistant`] [`home-automation`] [`homeautomation`] [`mqtt`] [`nvr`] [`object-detection`] [`realtime`] [`rtsp`] [`tensorflow`]  
...
- [GoogleChromeLabs/squoosh](https://github.com/GoogleChromeLabs/squoosh) ★23241  
...
- [wechaty/wechaty](https://github.com/wechaty/wechaty) ★21710 [`bot`] [`chatbot`] [`conversational-ai`] [`framework`] [`qq`] [`robotics`] [`wechat`] [`wechaty`] [`whatsapp`]  
...
- [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ★20197  
...
- [wulkano/Kap](https://github.com/wulkano/Kap) ★18693 [`aperture`] [`app`] [`capture`] [`communication`] [`electron`] [`javascript`] [`kap`] [`mac`] [`macos`] [`nextjs`] [`open-source`] [`oss`] [`productivity`] [`record`] [`screen-capture`] [`screen-recorder`]  
  Kap是一个用于构建和管理基于Vulkan的应用程序的工具。它提供了一套
- [louislam/dockge](https://github.com/louislam/dockge) ★18553 [`docker`] [`docker-compose`] [`docker-deployment`] [`docker-stack`] [`docker-stack-deploy`] [`docker-ui`] [`responsive`] [`self-hosted`] [`selfhosted`] [`single-page-app`] [`socket-io`] [`webapp`] [`websocket`]  
...
- [baidu/amis](https://github.com/baidu/amis) ★18377 [`admin`] [`frontend`] [`frontend-framework`] [`json`] [`low-code`] [`low-code-development-platform`] [`lowcode`] [`no-code`]  
...
- [maotoumao/MusicFree](https://github.com/maotoumao/MusicFree) ★17723 [`free`] [`music-player`] [`musicfree`] [`plugin`] [`react`] [`react-native`] [`typescript`]  
...
- [apitable/apitable](https://github.com/apitable/apitable) ★14651 [`admin-dashboard`] [`airtable`] [`airtable-alternative`] [`api`] [`automatic-api`] [`embed`] [`hacktoberfest`] [`internal-tool`] [`javascript`] [`low-code`] [`nestjs`] [`nextjs`] [`no-code`] [`nocodb`] [`notion`] [`react`] [`spreadsheet`] [`spring`] [`typescript`]  
...
- [electron-userland/electron-builder](https://github.com/electron-userland/electron-builder) ★14170 [`appx`] [`auto-update`] [`builder`] [`contributions-welcome`] [`deb`] [`distribution-electron`] [`dmg`] [`electron`] [`electron-builder`] [`electron-updater`] [`help-wanted`] [`linux`] [`macos`] [`msi`] [`muon`] [`nsis`] [`pkg`] [`rpm`] [`snap`] [`squirrel`]  
...
- [taye/interact.js](https://github.com/taye/interact.js) ★12634 [`drag-and-drop`] [`drop`] [`inertia`] [`javascript`] [`javascript-drag`] [`mobile`] [`modern-browsers`] [`multi-touch`] [`snap`] [`touch`] [`typescript`] [`vanilla`]  
...
- [ourongxing/newsnow](https://github.com/ourongxing/newsnow) ★11842 [`elegant`] [`news`]  
...
- [idootop/mi-gpt](https://github.com/idootop/mi-gpt) ★11301  
...
- [bitwarden/clients](https://github.com/bitwarden/clients) ★10437 [`angular`] [`bitwarden`] [`browser-extension`] [`chrome`] [`cli`] [`desktop`] [`electron`] [`firefox`] [`javascript`] [`nodejs`] [`safari`] [`typescript`] [`webextension`]  
...
- [dream-num/univer](https://github.com/dream-num/univer) ★9312 [`appscript`] [`collaboration`] [`data-table`] [`doc`] [`document`] [`excel`] [`grid`] [`live-share`] [`office`] [`powerpoint`] [`ppt`] [`productivity`] [`sdk`] [`sheet`] [`slide`] [`spreadsheet`] [`word`] [`xlsx`]  
...
- [ayangweb/BongoCat](https://github.com/ayangweb/BongoCat) ★8374 [`bongo-cat`] [`bongocat`] [`cross-platform`] [`desktop-app`] [`desktop-pet`] [`linux`] [`macos`] [`pet`] [`pet-project`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [x-extends/vxe-table](https://github.com/x-extends/vxe-table) ★8196 [`cell`] [`checkbox`] [`editable`] [`form`] [`grid`] [`input`] [`modal`] [`pager`] [`radio`] [`select`] [`switch`] [`table`] [`toolbar`] [`vue`] [`vue-table`] [`vxe-grid`] [`vxe-table`] [`vxe-ui`]  
...
- [HerbertHe/iptv-sources](https://github.com/HerbertHe/iptv-sources) ★7968 [`diyp`] [`docker`] [`iptv`] [`iptv-channels`] [`iptv-m3u`] [`kodi`] [`m3u`] [`tvbox`]  
...
- [alibaba/x-render](https://github.com/alibaba/x-render) ★7384 [`ant`] [`ant-design`] [`chart`] [`form`] [`formrender`] [`javascript`] [`json-schema`] [`list`] [`react`] [`table`] [`typescript`] [`webpack`] [`widget`]  
...
- [AIsouler/GKD_subscription](https://github.com/AIsouler/GKD_subscription) ★6793 [`gkd`] [`gkd-subscription`] [`typescript`]  
...
- [dushixiang/next-terminal](https://github.com/dushixiang/next-terminal) ★5098 [`antd`] [`antd-design`] [`docker`] [`go`] [`golang`] [`guacamole`] [`rdp`] [`react`] [`ssh`] [`vnc`]  
...
- [EcoPasteHub/EcoPaste](https://github.com/EcoPasteHub/EcoPaste) ★4687 [`application`] [`clipboard`] [`clipboard-manager`] [`cross-platform`] [`desktop-app`] [`desktop-application`] [`linux`] [`macos`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [Qsnh/meedu](https://github.com/Qsnh/meedu) ★3711  
  这是一个
- [browser-use/workflow-use](https://github.com/browser-use/workflow-use) ★3480  
...
- [surmon-china/vue-codemirror](https://github.com/surmon-china/vue-codemirror) ★3405 [`code-editor`] [`code-editor-component`] [`codemirror`] [`codemirror-component`] [`codemirror-editor`] [`codemirror-themes`] [`vue`] [`vue-code-editor`] [`vue-codemirror`] [`vue-component`] [`vue-plugin`] [`vue3`] [`vuejs`] [`web-editor`]  
...
- [VisActor/VTable](https://github.com/VisActor/VTable) ★2868 [`canvas-table`] [`data-analysis`] [`data-visualization`] [`database`] [`datagrid`] [`grid`] [`javascript-table`] [`javescript`] [`list-table`] [`list-tree`] [`online-excel`] [`pivot-chart`] [`pivot-grid`] [`pivot-tables`] [`react-table`] [`sparklines`] [`spreadsheet`] [`tree-table`] [`visualization`] [`vue-table`]  
...
- [cloudtogo/pageplug](https://github.com/cloudtogo/pageplug) ★1791 [`appsmith`] [`echarts`] [`formily`] [`internal-tool`] [`lowcode`] [`mini-program-lowcode`] [`miniprogram`] [`retool`] [`wechat`] [`wechat-mini-program`] [`weixin`]  
...
- [pt-plugins/PT-depiler](https://github.com/pt-plugins/PT-depiler) ★652 [`private-tracker`]  
...
- [Kchengz/epic-designer](https://github.com/Kchengz/epic-designer) ★510  
...
- [Cloxl/CursorPool_Client](https://github.com/Cloxl/CursorPool_Client) ★506  
