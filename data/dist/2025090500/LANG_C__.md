...
- [moonlight-stream/moonlight-qt](https://github.com/moonlight-stream/moonlight-qt) ★14294 [`gamestream`] [`linux-app`] [`macos-app`] [`moonlight`] [`nvidia`] [`qt`] [`sdl2`] [`steam-link`] [`windows-app`]  
...
- [BlackINT3/OpenArk](https://github.com/BlackINT3/OpenArk) ★11796 [`anti-malware`] [`ark`] [`windows-hacking`]  
...
- [BlueMatthew/WechatExporter](https://github.com/BlueMatthew/WechatExporter) ★7017 [`backup`] [`chat`] [`dump`] [`export`] [`friend`] [`history`] [`itunes`] [`libmp3lame`] [`libplist`] [`silk`] [`wechat`]  
...
- [TigerVNC/tigervnc](https://github.com/TigerVNC/tigervnc) ★6420  
...
- [rime/weasel](https://github.com/rime/weasel) ★5775  
...
- [Tatsu-syo/noMeiryoUI](https://github.com/Tatsu-syo/noMeiryoUI) ★5691  
...
- [xfangfang/wiliwili](https://github.com/xfangfang/wiliwili) ★4453 [`bilibili`] [`mpv`] [`nanovg`] [`nintendo-switch`] [`nintendo-switch-homebrew`] [`opencc`] [`opengl`] [`ps4`] [`psv`] [`xbox`]  
...
- [kiwibrowser/src.next](https://github.com/kiwibrowser/src.next) ★3166  
...
- [qiin2333/Sunshine-Foundation](https://github.com/qiin2333/Sunshine-Foundation) ★2845 [`cloudgaming`] [`game-streaming`] [`moonlight`] [`remote-desktop`] [`stream`] [`sunshine`]  
