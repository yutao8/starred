...
- [theonedev/onedev](https://github.com/theonedev/onedev) ★14089 [`ci-cd`] [`devops`] [`git`] [`kanban`] [`packages`] [`self-hosted`]  
...
- [Fuzion24/JustTrustMe](https://github.com/Fuzion24/JustTrustMe) ★5077  
...
- [javahuang/SurveyKing](https://github.com/javahuang/SurveyKing) ★3602 [`java`] [`react-survey`] [`springboot`] [`survey`] [`surveyjs`] [`surveymonkey`]  
...
- [niumoo/bing-wallpaper](https://github.com/niumoo/bing-wallpaper) ★2749 [`bing`] [`bing-image`] [`bing-wallpaper`] [`wallpaper`]  
