...
- [zerotier/ZeroTierOne](https://github.com/zerotier/ZeroTierOne) ★15915 [`decentralization`] [`networking`] [`peer-to-peer`] [`sd-wan`] [`sdn`] [`virtual-network`] [`vpn`]  
...
- [rime/weasel](https://github.com/rime/weasel) ★5863  
...
- [qiin2333/Sunshine-Foundation](https://github.com/qiin2333/Sunshine-Foundation) ★2978 [`cloudgaming`] [`game-streaming`] [`moonlight`] [`remote-desktop`] [`stream`] [`sunshine`]  
