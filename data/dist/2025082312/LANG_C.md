...
- [Genymobile/scrcpy](https://github.com/Genymobile/scrcpy) ★126962 [`android`] [`c`] [`ffmpeg`] [`libav`] [`mirroring`] [`recording`] [`screen`] [`sdl2`]  
...
- [ventoy/Ventoy](https://github.com/ventoy/Ventoy) ★70057 [`auto-install`] [`bootable-usb`] [`bsd`] [`chromeos`] [`iso-files`] [`legacy`] [`linux`] [`multiboot`] [`persistence`] [`secure-boot`] [`uefi`] [`unattended`] [`unix`] [`usb`] [`windows`]  
...
- [jqlang/jq](https://github.com/jqlang/jq) ★32442 [`jq`]  
...
- [coolsnowwolf/lede](https://github.com/coolsnowwolf/lede) ★30926 [`lede`] [`lua`] [`openwrt-feed`] [`openwrt-package`] [`openwrt-zh-cn`]  
...
- [kingToolbox/WindTerm](https://github.com/kingToolbox/WindTerm) ★27714 [`bash`] [`client`] [`cmd`] [`linux`] [`mac`] [`powershell`] [`serial`] [`sftp`] [`shell`] [`ssh`] [`telnet`] [`terminal`] [`tmux`] [`windows`] [`wsl`] [`x11`] [`xmodem`] [`xterm`] [`ymodem`] [`zmodem`]  
...
- [ggreer/the_silver_searcher](https://github.com/ggreer/the_silver_searcher) ★26806 [`ag`] [`c`] [`command-line-tool`] [`pcre`] [`search-in-text`] [`silver-searcher`]  
...
- [jarun/nnn](https://github.com/jarun/nnn) ★20471 [`android`] [`batch-rename`] [`c`] [`cli`] [`command-line`] [`developer-tools`] [`disk-usage`] [`file-manager`] [`file-preview`] [`file-search`] [`filesystem`] [`launcher`] [`multi-platform`] [`ncurses`] [`productivity`] [`raspberry-pi`] [`terminal`] [`tui`] [`vim`] [`wsl`]  
...
- [vanhauser-thc/thc-hydra](https://github.com/vanhauser-thc/thc-hydra) ★10750 [`brute-force`] [`brute-force-attacks`] [`brute-force-passwords`] [`bruteforce`] [`bruteforce-attacks`] [`bruteforcer`] [`bruteforcing`] [`hydra`] [`network-security`] [`password-cracker`] [`password-cracking`] [`penetration-testing`] [`pentest`] [`pentest-tool`] [`pentesting`] [`thc`]  
...
- [pymumu/smartdns](https://github.com/pymumu/smartdns) ★9459 [`c`] [`dns`] [`dns-over-https`] [`dns-over-tls`] [`dns-server`] [`dns64`] [`doh`] [`doh3`] [`doq`] [`dot`] [`nftables`] [`nftables-sets`] [`openwrt`] [`openwrt-package`] [`smartdns`] [`stubby`]  
...
- [esnet/iperf](https://github.com/esnet/iperf) ★7801  
...
- [winfsp/winfsp](https://github.com/winfsp/winfsp) ★7770 [`driver`] [`filesystem`] [`fuse`] [`gplv3`] [`kernel`] [`windows`] [`windows-kernel`]  
...
- [ntop/n2n](https://github.com/ntop/n2n) ★6675 [`peer-to-peer`] [`vpn`]  
...
- [tinyproxy/tinyproxy](https://github.com/tinyproxy/tinyproxy) ★5368  
...
- [sabrogden/Ditto](https://github.com/sabrogden/Ditto) ★4996 [`clipboard`] [`clipboard-manager`]  
...
- [philippe44/AirConnect](https://github.com/philippe44/AirConnect) ★3875 [`airplay`] [`bridge`] [`chromecast`] [`dlna`] [`dlna-player`] [`dlna-upnp`] [`sonos`] [`upnp`]  
