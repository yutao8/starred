...
- [EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books) ★365022 [`books`] [`education`] [`hacktoberfest`] [`list`] [`resource`]  
...
- [public-apis/public-apis](https://github.com/public-apis/public-apis) ★361183 [`api`] [`apis`] [`dataset`] [`development`] [`free`] [`list`] [`lists`] [`open-source`] [`public`] [`public-api`] [`public-apis`] [`resources`] [`software`]  
...
- [ytdl-org/youtube-dl](https://github.com/ytdl-org/youtube-dl) ★136849  
...
- [nvbn/thefuck](https://github.com/nvbn/thefuck) ★93460 [`python`] [`shell`]  
...
- [home-assistant/core](https://github.com/home-assistant/core) ★80725 [`asyncio`] [`hacktoberfest`] [`home-automation`] [`internet-of-things`] [`iot`] [`mqtt`] [`python`] [`raspberry-pi`]  
...
- [fighting41love/funNLP](https://github.com/fighting41love/funNLP) ★75431  
...
- [sherlock-project/sherlock](https://github.com/sherlock-project/sherlock) ★67983 [`cli`] [`cti`] [`cybersecurity`] [`forensics`] [`hacktoberfest`] [`information-gathering`] [`infosec`] [`linux`] [`osint`] [`pentesting`] [`python`] [`python3`] [`reconnaissance`] [`redteam`] [`sherlock`] [`tools`]  
...
- [xtekky/gpt4free](https://github.com/xtekky/gpt4free) ★64939 [`chatbot`] [`chatbots`] [`chatgpt`] [`chatgpt-4`] [`chatgpt-api`] [`chatgpt-free`] [`chatgpt4`] [`deepseek`] [`deepseek-api`] [`deepseek-r1`] [`gpt`] [`gpt-4`] [`gpt-4o`] [`gpt4`] [`gpt4-api`] [`language-model`] [`openai`] [`openai-api`] [`openai-chatgpt`] [`reverse-engineering`]  
  该项目提供一个基于GPT-4的免费API访问途径。用户无需付费即可调用GPT-4模型进行文本生成、翻译等任务。该项目使用Python和OpenAI API进行开发，核心功能包括API接口封装和请求管理，并提供简易的调用示例。
- [scrapy/scrapy](https://github.com/scrapy/scrapy) ★57936 [`crawler`] [`crawling`] [`framework`] [`hacktoberfest`] [`python`] [`scraping`] [`web-scraping`] [`web-scraping-python`]  
...
- [soimort/you-get](https://github.com/soimort/you-get) ★56308  
...
- [Z4nzu/hackingtool](https://github.com/Z4nzu/hackingtool) ★53250 [`allinonehackingtool`] [`besthackingtool`] [`ctf-tools`] [`ddos-attack-tool`] [`hacker`] [`hacking`] [`linux`] [`password-attack`] [`steganography`] [`web-attack`] [`wireless-attack`] [`xss-attacks`] [`xss-detection`]  
...
- [harry0703/MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo) ★39117 [`ai`] [`automation`] [`chatgpt`] [`moviepy`] [`python`] [`shortvideo`] [`tiktok`]  
...
- [zhayujie/chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat) ★38511 [`ai`] [`ai-agent`] [`chatgpt`] [`claude-4`] [`deepseek`] [`dingtalk`] [`feishu-bot`] [`gemini`] [`gpt-4`] [`kimi`] [`linkai`] [`llm`] [`mcp`] [`multi-agent`] [`openai`] [`python3`] [`qwen`] [`rag`] [`wechat`] [`wechat-bot`]  
...
- [2noise/ChatTTS](https://github.com/2noise/ChatTTS) ★37499 [`agent`] [`chat`] [`chatgpt`] [`chattts`] [`chinese`] [`chinese-language`] [`english`] [`english-language`] [`gpt`] [`llm`] [`llm-agent`] [`natural-language-inference`] [`python`] [`text-to-speech`] [`torch`] [`torchaudio`] [`tts`]  
...
- [hiroi-sora/Umi-OCR](https://github.com/hiroi-sora/Umi-OCR) ★36064 [`ocr`] [`ocr-python`] [`paddleocr`] [`qml`] [`qt`] [`screenshot`] [`umi-ocr`]  
...
- [NanmiCoder/MediaCrawler](https://github.com/NanmiCoder/MediaCrawler) ★35727  
...
- [yeongpin/cursor-free-vip](https://github.com/yeongpin/cursor-free-vip) ★34337 [`automation`] [`cursor`] [`cursor-ai`] [`cursor-ide`] [`cursorai`] [`cursors`] [`free`] [`freetrial`] [`pro`]  
...
- [certbot/certbot](https://github.com/certbot/certbot) ★32394 [`acme`] [`acme-client`] [`certbot`] [`certificate`] [`letsencrypt`] [`python`]  
...
- [python-telegram-bot/python-telegram-bot](https://github.com/python-telegram-bot/python-telegram-bot) ★27979 [`bot`] [`chatbot`] [`framework`] [`python`] [`telegram`]  
...
- [521xueweihan/GitHub520](https://github.com/521xueweihan/GitHub520) ★26527 [`dns`] [`github`] [`hosts`]  
...
- [littlecodersh/ItChat](https://github.com/littlecodersh/ItChat) ★26332 [`api`] [`itchat`] [`robot`] [`wechat`]  
...
- [dgtlmoon/changedetection.io](https://github.com/dgtlmoon/changedetection.io) ★26132 [`back-in-stock`] [`change-alert`] [`change-detection`] [`change-monitoring`] [`monitoring`] [`notifications`] [`restock-monitor`] [`rss`] [`self-hosted`] [`url-monitor`] [`web-scraping`] [`website-change-detection`] [`website-change-detector`] [`website-change-monitor`] [`website-change-notification`] [`website-change-tracker`] [`website-defacement-monitoring`] [`website-monitor`] [`website-monitoring`] [`website-watcher`]  
...
- [jhao104/proxy_pool](https://github.com/jhao104/proxy_pool) ★22719 [`crawler`] [`http`] [`proxy`] [`redis`] [`spider`]  
...
- [Delgan/loguru](https://github.com/Delgan/loguru) ★22443 [`log`] [`logger`] [`logging`] [`python`]  
...
- [XiaoMi/ha_xiaomi_home](https://github.com/XiaoMi/ha_xiaomi_home) ★20492 [`home-assistant`] [`home-assistant-integration`] [`miot`] [`miot-devices`] [`smart-home`] [`xiaomi`] [`xiaomi-smart-home`]  
...
- [LiLittleCat/awesome-free-chatgpt](https://github.com/LiLittleCat/awesome-free-chatgpt) ★20308 [`awesome`] [`awesome-list`] [`chat`] [`chatgpt`] [`free`] [`freechatgpt`]  
  这是一个收集免费 ChatGPT 替代方案的资源库。涵盖各种类型的免费或开源聊天机器人，包括代码生成、文本摘要、翻译等功能。该资源库主要使用 Markdown 格式组织，方便用户快速筛选和了解不同工具的特点。
- [bee-san/Ciphey](https://github.com/bee-san/Ciphey) ★19803 [`artificial-intelligence`] [`cipher`] [`cpp`] [`cryptography`] [`ctf`] [`ctf-tools`] [`cyberchef-magic`] [`decryption`] [`deep-neural-network`] [`encodings`] [`encryptions`] [`hacking`] [`hacktoberfest`] [`hashes`] [`natural-language-processing`] [`pentesting`] [`python`]  
...
- [Zeyi-Lin/HivisionIDPhotos](https://github.com/Zeyi-Lin/HivisionIDPhotos) ★18918 [`cnn`] [`demo`] [`docker`] [`face-recognition`] [`fastapi`] [`gradio`] [`idphoto`] [`machine-learning`] [`matting`] [`mtcnn`] [`tools`] [`unet`]  
...
- [InstaPy/InstaPy](https://github.com/InstaPy/InstaPy) ★17441 [`automation`] [`bot`] [`clarifai`] [`instagram`] [`python`] [`script`] [`selenium`]  
...
- [Guovin/iptv-api](https://github.com/Guovin/iptv-api) ★17187 [`amd64`] [`api`] [`arm64`] [`armv7`] [`auto`] [`diy`] [`docker`] [`epg`] [`ipdb`] [`iptv`] [`ipv4`] [`ipv6`] [`m3u`] [`m3u8`] [`rtmp`] [`tv`] [`tvbox`] [`workflow`]  
...
- [fastapi/sqlmodel](https://github.com/fastapi/sqlmodel) ★16560 [`fastapi`] [`json`] [`json-schema`] [`pydantic`] [`python`] [`sql`] [`sqlalchemy`]  
...
- [lss233/kirara-ai](https://github.com/lss233/kirara-ai) ★16268 [`bard`] [`bot`] [`chatglm-6b`] [`chatgpt`] [`deepseek`] [`discord`] [`ernie`] [`go-cqhttp`] [`grok`] [`mirai`] [`new-bing`] [`ollama`] [`openai`] [`poe`] [`qq`] [`qqbot`] [`sydney`] [`telegram`] [`wechat`] [`xinghuo`]  
...
- [Kr1s77/awesome-python-login-model](https://github.com/Kr1s77/awesome-python-login-model) ★16170 [`163mail-login`] [`bilibili-login`] [`douban-spider`] [`facebook-login`] [`github-login`] [`guoke-spider`] [`jingdong`] [`lagou-spider`] [`python`] [`selenium`] [`sina-spider`] [`spiders`] [`taobao-spider`] [`tuchong`] [`twitter-bot`] [`weixinbot`] [`zhihu-spider`]  
...
- [xming521/WeClone](https://github.com/xming521/WeClone) ★15309 [`chat-history`] [`digital-avatar`] [`llm`] [`qwen`] [`telegram`]  
...
- [Evil0ctal/Douyin_TikTok_Download_API](https://github.com/Evil0ctal/Douyin_TikTok_Download_API) ★13860 [`api`] [`async`] [`crawler`] [`douyin`] [`douyin-api`] [`douyin-scraper`] [`douyin-tiktok-api`] [`douyin-tiktok-download`] [`fastapi`] [`no-watermark`] [`online-parsing`] [`python`] [`pywebio`] [`scraper`] [`spider`] [`tiktok`] [`tiktok-api`] [`tiktok-scraper`] [`tiktok-signature`] [`web-scraping`]  
...
- [langbot-app/LangBot](https://github.com/langbot-app/LangBot) ★12997 [`agent`] [`ai`] [`chatgpt`] [`deepseek`] [`dify`] [`dingtalk`] [`discord`] [`feishu`] [`kimi`] [`langbot`] [`lark`] [`llm`] [`n8n`] [`ollama`] [`openai`] [`plugins`] [`qq`] [`rag`] [`telegram`] [`wechat`]  
...
- [sml2h3/ddddocr](https://github.com/sml2h3/ddddocr) ★12494 [`captcha`] [`ddddocr`] [`ocr`]  
...
- [zai-org/CogVideo](https://github.com/zai-org/CogVideo) ★11833 [`cogvideox`] [`image-to-video`] [`llm`] [`sora`] [`text-to-video`] [`video-generation`]  
...
- [dwyl/english-words](https://github.com/dwyl/english-words) ★11491  
...
- [JoeanAmier/TikTokDownloader](https://github.com/JoeanAmier/TikTokDownloader) ★11230 [`abogus`] [`api`] [`csv`] [`docker`] [`douyin`] [`downloader`] [`ffmpeg`] [`httpx`] [`linux`] [`macos`] [`mstoken`] [`pyinstaller`] [`python`] [`rich`] [`server`] [`sqlite`] [`tiktok`] [`ttwid`] [`windows`] [`xlsx`]  
...
- [hunshcn/gh-proxy](https://github.com/hunshcn/gh-proxy) ★8238  
...
- [shidahuilang/shuyuan](https://github.com/shidahuilang/shuyuan) ★8177 [`aiyueshuxiang`] [`ipa`] [`iptv`] [`reader`] [`shuyuan`] [`trollstore`] [`tts`] [`xiangsegige`] [`yuanyuedu`] [`yuedu`]  
...
- [kangvcar/InfoSpider](https://github.com/kangvcar/InfoSpider) ★8068 [`automation`] [`chrome`] [`crawl`] [`csdn`] [`hotmail`] [`outlook`] [`python3`] [`selenium`] [`spider`] [`tkinter`] [`wxpython`]  
...
- [jackhawks/rectg](https://github.com/jackhawks/rectg) ★7960 [`rectg`] [`telegram`] [`telegram-bot`] [`telegram-channel`] [`telegram-group`]  
...
- [PantsuDango/Dango-Translator](https://github.com/PantsuDango/Dango-Translator) ★7755  
...
- [vastsa/FileCodeBox](https://github.com/vastsa/FileCodeBox) ★7014 [`anonymous`] [`fastapi`] [`filecodebox`] [`python`] [`tool`] [`vue`]  
...
- [zhiyiYo/PyQt-Fluent-Widgets](https://github.com/zhiyiYo/PyQt-Fluent-Widgets) ★6996 [`custom`] [`fluent`] [`fluent-design`] [`fluentui`] [`gui`] [`modern`] [`pyqt5`] [`pyqt6`] [`pyside2`] [`pyside6`] [`python`] [`qt`] [`qt5`] [`qt6`] [`software`] [`ui`] [`widgets`] [`win11`] [`winui`] [`winui3`]  
...
- [nonebot/nonebot2](https://github.com/nonebot/nonebot2) ★6941 [`bot`] [`chatbot`] [`cqhttp`] [`dingtalk-robot`] [`fastapi`] [`lark-bot`] [`mirai-bot`] [`nonebot`] [`nonebot2`] [`onebot`] [`python`] [`qq`] [`qq-guild`] [`telegram-bot`]  
...
- [guofei9987/blind_watermark](https://github.com/guofei9987/blind_watermark) ★6598 [`blind-watermark`] [`image-processing`] [`watermark`] [`watermark-image`]  
...
- [davidteather/TikTok-Api](https://github.com/davidteather/TikTok-Api) ★5682 [`api`] [`download-tiktoks`] [`hacktoberfest`] [`python`] [`tik`] [`tiktok`] [`tiktok-api`] [`tiktok-automation`] [`tiktok-compilations`] [`tiktok-downloader`] [`tiktok-python`] [`tiktok-scraper`] [`tiktok-signature`] [`tiktok-trending-page`] [`tiktokapi`] [`tok`] [`trending`]  
...
- [rootphantomer/Blasting_dictionary](https://github.com/rootphantomer/Blasting_dictionary) ★5144  
...
- [qd-today/qd](https://github.com/qd-today/qd) ★5062 [`checkin`] [`docker`] [`har`] [`qd`] [`qiandao`]  
...
- [vbskycn/iptv](https://github.com/vbskycn/iptv) ★4304  
...
- [shaxiu/XianyuAutoAgent](https://github.com/shaxiu/XianyuAutoAgent) ★3521 [`agent`] [`chatbot`] [`llm`]  
...
- [ScottSloan/Bili23-Downloader](https://github.com/ScottSloan/Bili23-Downloader) ★2323 [`bili23`] [`bilibili`] [`bilibili-downloader`] [`crawler`] [`linux`] [`macos`] [`python`] [`videodownloader`] [`windows`] [`wxpython`]  
...
- [Neutree/COMTool](https://github.com/Neutree/COMTool) ★2190 [`assistant`] [`debug`] [`network`] [`plugin`] [`protocol`] [`python`] [`serial`] [`tcp`] [`terminal`] [`tool`] [`udp`]  
...
- [Cp0204/quark-auto-save](https://github.com/Cp0204/quark-auto-save) ★1762  
...
- [mofeng-git/One-KVM](https://github.com/mofeng-git/One-KVM) ★1655  
...
- [y9nhjy/Proxifier-Keygen](https://github.com/y9nhjy/Proxifier-Keygen) ★1105  
...
- [uk0/telethon_get_media](https://github.com/uk0/telethon_get_media) ★203 [`telegram`] [`telegram-api`] [`telegram-bot`]  
