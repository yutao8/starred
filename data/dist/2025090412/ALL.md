...
- [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) ★147042 [`activator`] [`hwid`] [`kms`] [`kms38`] [`massgrave`] [`massgravel`] [`microsoft`] [`microsoft365`] [`office`] [`office365`] [`ohook`] [`powershell`] [`tsforge`] [`windows`] [`windows-10`] [`windows-11`]  
...
- [microsoft/PowerToys](https://github.com/microsoft/PowerToys) ★122997 [`color-picker`] [`desktop`] [`fancyzones`] [`keyboard-manager`] [`microsoft-powertoys`] [`powerrename`] [`powertoys`] [`windows`]  
...
- [2dust/v2rayN](https://github.com/2dust/v2rayN) ★86073 [`proxy`] [`shadowsocks`] [`socks5`] [`trojan`] [`v2fly`] [`v2ray`] [`vless`] [`vmess`] [`windows`] [`xray`] [`xtls`]  
...
- [huiyadanli/RevokeMsgPatcher](https://github.com/huiyadanli/RevokeMsgPatcher) ★34483 [`hex-editor`] [`patch`] [`pc`] [`qq`] [`revoke`] [`revokemsg`] [`tim`] [`tool`] [`wechat`] [`windows`]  
...
- [bitwarden/server](https://github.com/bitwarden/server) ★17104 [`api`] [`aspnet`] [`aspnetcore`] [`bitwarden`] [`csharp`] [`docker`] [`dotnet`] [`dotnet-core`] [`signalr`] [`sql`] [`sql-server`]  
...
- [d2phap/ImageGlass](https://github.com/d2phap/ImageGlass) ★11117 [`avif`] [`csharp`] [`direct2d`] [`dotnet`] [`heic`] [`heif`] [`image-viewer`] [`imageglass`] [`jpeg-xl`] [`jxl`] [`photo-viewer`] [`picture-gallery`] [`picture-viewer`] [`raw`] [`raw-image`] [`svg`] [`svg-viewer`] [`winforms`]  
...
- [TechnitiumSoftware/DnsServer](https://github.com/TechnitiumSoftware/DnsServer) ★6205 [`cross-platform`] [`dhcp-server`] [`dns`] [`dns-client`] [`dns-over-https`] [`dns-over-quic`] [`dns-over-tls`] [`dns-over-tor`] [`dns-server`] [`dotnet`] [`privacy`] [`technitium-dns-server`]  
...
- [SuperStudio/SuperCom](https://github.com/SuperStudio/SuperCom) ★888  
...
- [zero-peak/ZeroOmega](https://github.com/zero-peak/ZeroOmega) ★6079 [`proxy`] [`switchyomega`] [`zeroomega`]  
...
- [sindresorhus/github-markdown-css](https://github.com/sindresorhus/github-markdown-css) ★8534  
...
- [AppFlowy-IO/AppFlowy](https://github.com/AppFlowy-IO/AppFlowy) ★65237 [`blog`] [`confluence-alternative`] [`content-management`] [`content-services`] [`documentation`] [`flutter`] [`note-taking`] [`notion-alternative`] [`project-management`] [`task-management`] [`team-collaboration`] [`wiki`]  
...
- [GopeedLab/gopeed](https://github.com/GopeedLab/gopeed) ★20101 [`android`] [`bittorrent`] [`cross-platform`] [`debian`] [`downloader`] [`flutter`] [`golang`] [`http`] [`https`] [`ios`] [`macos`] [`magnet`] [`torrent`] [`ubuntu`] [`windows`]  
...
- [wanghongenpin/proxypin](https://github.com/wanghongenpin/proxypin) ★10093 [`capture-traffic`] [`httpdebug`] [`proxy`] [`proxypin`] [`zhuabao`]  
...
- [ComicSparks/pikapika](https://github.com/ComicSparks/pikapika) ★7458 [`acg`] [`android`] [`bika`] [`comic-books`] [`cosplay`] [`cross-platform`] [`e-hentai`] [`flutter`] [`game`] [`go`] [`golang`] [`hentai`] [`ios`] [`picacg`] [`picacomic`] [`r-18`]  
...
- [Anduin2017/HowToCook](https://github.com/Anduin2017/HowToCook) ★93010 [`chinese`] [`cookbook`] [`cooking`] [`dishes`] [`recipes`]  
...
- [Fechin/reference](https://github.com/Fechin/reference) ★8964 [`awk`] [`bash`] [`chatgpt`] [`cheatsheet`] [`cheatsheets`] [`css`] [`golang`] [`grep`] [`markdown`] [`python`] [`reference`] [`sed`] [`snippets`] [`vim`]  
...
- [fatedier/frp](https://github.com/fatedier/frp) ★98227 [`expose`] [`firewall`] [`frp`] [`go`] [`http-proxy`] [`nat`] [`p2p`] [`proxy`] [`reverse-proxy`] [`tunnel`]  
...
- [syncthing/syncthing](https://github.com/syncthing/syncthing) ★75858 [`go`] [`p2p`] [`peer-to-peer`] [`synchronization`]  
...
- [junegunn/fzf](https://github.com/junegunn/fzf) ★73459 [`bash`] [`cli`] [`fish`] [`fzf`] [`go`] [`neovim`] [`tmux`] [`unix`] [`vim`] [`zsh`]  
...
- [minio/minio](https://github.com/minio/minio) ★55005 [`amazon-s3`] [`cloud`] [`cloudnative`] [`cloudstorage`] [`go`] [`k8s`] [`kubernetes`] [`multi-cloud`] [`multi-cloud-kubernetes`] [`objectstorage`] [`s3`] [`storage`]  
...
- [rclone/rclone](https://github.com/rclone/rclone) ★52389 [`azure-blob`] [`azure-blob-storage`] [`azure-files`] [`backblaze-b2`] [`cloud-storage`] [`dropbox`] [`encryption`] [`ftp`] [`fuse-filesystem`] [`go`] [`golang`] [`google-cloud-storage`] [`google-drive`] [`onedrive`] [`openstack-swift`] [`rclone`] [`s3`] [`sftp`] [`sync`] [`webdav`]  
...
- [go-gitea/gitea](https://github.com/go-gitea/gitea) ★50467 [`bitbucket`] [`cicd`] [`devops`] [`docker-registry-v2`] [`git`] [`git-gui`] [`git-server`] [`gitea`] [`github`] [`github-actions`] [`gitlab`] [`go`] [`golang`] [`hacktoberfest`] [`maven-server`] [`npm-registry`] [`vue`]  
...
- [gogs/gogs](https://github.com/gogs/gogs) ★46845 [`docker`] [`git`] [`go`] [`gogs`] [`mysql`] [`postgresql`] [`raspberry-pi`] [`scip-enabled`] [`self-hosted`] [`sqlite3`]  
...
- [usememos/memos](https://github.com/usememos/memos) ★44059 [`docker`] [`foss`] [`go`] [`markdown`] [`memo`] [`microblog`] [`note-taking`] [`notecard`] [`react`] [`self-hosted`] [`social-network`] [`sqlite`]  
...
- [coreybutler/nvm-windows](https://github.com/coreybutler/nvm-windows) ★42676 [`go`] [`management`] [`node`] [`node-version-manager`] [`nodejs`] [`nvm`] [`switch`] [`version`] [`version-manager`] [`versioning`] [`windows`]  
...
- [ehang-io/nps](https://github.com/ehang-io/nps) ★33355 [`dns`] [`firewall`] [`go`] [`gzip`] [`http`] [`https`] [`nat`] [`nps`] [`snnapy`] [`socks`] [`socks5`] [`ssh`] [`tcp`] [`tunnel`] [`udp`]  
...
- [filebrowser/filebrowser](https://github.com/filebrowser/filebrowser) ★31026 [`file-browser`] [`file-manager`] [`file-sharing`] [`go`] [`material-design`] [`self-hosted`] [`vue`]  
  这是一个用于浏览和管理文件的Web应用程序。它使用Python和Flask框架构建，提供文件上传、下载、删除、重命名等基本操作。用户可以通过Web界面直观地查看和操作文件，支持多种文件类型。项目包含用户认证模块，确保文件访问权限安全。
- [schollz/croc](https://github.com/schollz/croc) ★30997 [`data-transfer`] [`file-sharing`] [`golang`] [`pake`] [`peer-to-peer`] [`tcp`] [`transfer`]  
...
- [juanfont/headscale](https://github.com/juanfont/headscale) ★30902 [`tailscale`] [`tailscale-control-server`] [`tailscale-server`] [`wireguard`]  
...
- [iawia002/lux](https://github.com/iawia002/lux) ★30381 [`bilibili`] [`crawler`] [`download`] [`downloader`] [`go`] [`golang`] [`iqiyi`] [`qq`] [`scraper`] [`tumblr`] [`video`] [`youku`] [`youtube`]  
...
- [cloudreve/cloudreve](https://github.com/cloudreve/cloudreve) ★24784 [`cloud`] [`cloud-storage`] [`cloudreve`] [`file`] [`file-manager`] [`file-sharing`] [`golang`]  
...
- [tailscale/tailscale](https://github.com/tailscale/tailscale) ★24546 [`2fa`] [`oauth`] [`sso`] [`tailscale`] [`vpn`] [`wireguard`]  
...
- [XIU2/CloudflareSpeedTest](https://github.com/XIU2/CloudflareSpeedTest) ★22859 [`cdn`] [`cloudflare`] [`go`] [`golang`] [`speedtest`]  
...
- [chaitin/SafeLine](https://github.com/chaitin/SafeLine) ★17618 [`api-gateway`] [`application-security`] [`appsec`] [`blueteam`] [`bruteforce`] [`captcha`] [`cve`] [`cybersecurity`] [`firewall`] [`hackers`] [`http-flood`] [`security`] [`self-hosted`] [`sql-injection`] [`vulnerability`] [`waf`] [`web-application-firewall`] [`web-security`] [`websecurity`] [`xss`]  
...
- [apernet/hysteria](https://github.com/apernet/hysteria) ★17237 [`censorship-circumvention`] [`golang`] [`http-proxy`] [`hysteria`] [`proxy`] [`quic`] [`relay`] [`reliable-udp`] [`socks5`] [`tun`] [`vpn`]  
...
- [snail007/goproxy](https://github.com/snail007/goproxy) ★16600 [`dns-proxy`] [`encryption-proxy`] [`http`] [`http-proxy`] [`https-proxy`] [`kcptun`] [`reverse-proxy`] [`socket`] [`socks5`] [`socks5-proxy`] [`ss-proxy`] [`tcp`] [`tcp-proxy`] [`tls`] [`tls-proxy`] [`transparent-proxy`] [`udp`] [`udp-proxy`] [`upstream-proxies`] [`websocket-proxy`]  
...
- [slackhq/nebula](https://github.com/slackhq/nebula) ★16129  
...
- [OpenListTeam/OpenList](https://github.com/OpenListTeam/OpenList) ★15395 [`alist`] [`aliyunpan`] [`baidupan`] [`openlist`]  
...
- [m1k1o/neko](https://github.com/m1k1o/neko) ★15241 [`docker`] [`golang`] [`media-streaming`] [`remote-control`] [`remote-desktop`] [`self-hosted`] [`virtual-browser`] [`vue`] [`webrtc`]  
...
- [gotify/server](https://github.com/gotify/server) ★13664 [`api`] [`cloud`] [`free-software`] [`golang`] [`gotify`] [`hosting`] [`javascript`] [`notifications`] [`privacy`] [`react`] [`self-hosted`] [`self-hosting`] [`selfhosted`]  
...
- [coredns/coredns](https://github.com/coredns/coredns) ★13320 [`cncf`] [`coredns`] [`dns-server`] [`go`] [`plugin`] [`service-discovery`]  
...
- [casdoor/casdoor](https://github.com/casdoor/casdoor) ★12177 [`auth`] [`authentication`] [`authn`] [`casbin`] [`casdoor`] [`faceid`] [`iam`] [`kerberos`] [`ldap`] [`mfa`] [`oauth`] [`oidc`] [`payment-gateway`] [`radius`] [`saml`] [`scim`] [`single-sign-on`] [`sso`] [`totp`] [`webauthn`]  
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) ★11437 [`argo-tunnel`] [`cloudflare`] [`cloudflare-tunnel`] [`reverse-proxy`] [`zero-trust-network-access`]  
...
- [QuantumNous/new-api](https://github.com/QuantumNous/new-api) ★10296 [`ai-gateway`] [`claude`] [`deepseek`] [`gemini`] [`openai`] [`rerank`]  
...
- [putyy/res-downloader](https://github.com/putyy/res-downloader) ★9949 [`douyin`] [`kuaishou`] [`res-downloader`] [`wechat`] [`wechat-video`] [`xiaohongshu`]  
...
- [0xJacky/nginx-ui](https://github.com/0xJacky/nginx-ui) ★9468 [`chatgpt-app`] [`code-completion`] [`copilot`] [`cron`] [`deepseek-r1`] [`docker`] [`go`] [`letsencrypt`] [`linux`] [`macos`] [`mcp`] [`mcp-server`] [`nginx`] [`self-hosted`] [`vue`] [`webui`] [`windows`]  
...
- [gdy666/lucky](https://github.com/gdy666/lucky) ★6375 [`acme`] [`aliyunpan`] [`cron`] [`ddns`] [`dynadot`] [`filebrowser`] [`ftp`] [`ipv6`] [`socat`] [`stun`] [`vercel`] [`volcengine`] [`webdav`] [`wol`]  
...
- [jpillora/cloud-torrent](https://github.com/jpillora/cloud-torrent) ★6051 [`cloud`] [`golang`] [`self-hosted`] [`torrent`] [`torrent-client`]  
...
- [git-jiadong/wechatDataBackup](https://github.com/git-jiadong/wechatDataBackup) ★5513 [`wechat`] [`wechat-app`] [`wechat-bot`]  
...
- [Ackites/KillWxapkg](https://github.com/Ackites/KillWxapkg) ★5232  
...
- [hacdias/webdav](https://github.com/hacdias/webdav) ★4687 [`filesystem`] [`go`] [`http`] [`server`] [`webdav`]  
...
- [qjfoidnh/BaiduPCS-Go](https://github.com/qjfoidnh/BaiduPCS-Go) ★3873 [`baidupcs`]  
...
- [sjlleo/netflix-verify](https://github.com/sjlleo/netflix-verify) ★2508  
...
- [jgm/pandoc](https://github.com/jgm/pandoc) ★39064 [`commonmark`] [`converter`] [`document`] [`haskell`] [`markdown`] [`markup`] [`pandoc`] [`presentation`] [`publishing`]  
...
- [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) ★111352 [`awesome-list`] [`free-for-developers`]  
...
- [kakaxi-1/IPTV](https://github.com/kakaxi-1/IPTV) ★275  
...
- [xianhu/LearnPython](https://github.com/xianhu/LearnPython) ★8145 [`learning-python`] [`python`] [`python-flask`] [`python-requests`]  
...
- [Kong/kong](https://github.com/Kong/kong) ★41685 [`ai`] [`ai-gateway`] [`api-gateway`] [`api-management`] [`apis`] [`artificial-intelligence`] [`cloud-native`] [`devops`] [`kubernetes`] [`kubernetes-ingress`] [`kubernetes-ingress-controller`] [`llm-gateway`] [`llm-ops`] [`luajit`] [`microservice`] [`microservices`] [`nginx`] [`openai-proxy`] [`reverse-proxy`] [`serverless`]  
...
- [iDvel/rime-ice](https://github.com/iDvel/rime-ice) ★12720 [`rime`] [`rime-config`] [`rime-custom`] [`rime-schema`] [`rime-squirrel`] [`rime-weasel`]  
...
- [awesome-selfhosted/awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ★245159 [`awesome`] [`awesome-list`] [`cloud`] [`free-software`] [`hosting`] [`privacy`] [`self-hosted`] [`selfhosted`]  
  这是一个收集各种可自托管软件的资源列表。涵盖了从博客和论坛到视频会议和VPN等各种应用。列表按类别组织，便于用户快速找到所需的自托管工具。该项目使用纯文本格式维护，便于轻松更新和浏览。
- [justjavac/free-programming-books-zh_CN](https://github.com/justjavac/free-programming-books-zh_CN) ★115114 [`android`] [`angular`] [`books`] [`free`] [`ios`] [`javascript`] [`kotlin`] [`pdf`] [`programming`] [`python`] [`react`] [`react-native`] [`swift`] [`vue`]  
...
- [deepseek-ai/DeepSeek-R1](https://github.com/deepseek-ai/DeepSeek-R1) ★91031  
...
- [ruanyf/weekly](https://github.com/ruanyf/weekly) ★74823  
...
- [PlexPt/awesome-chatgpt-prompts-zh](https://github.com/PlexPt/awesome-chatgpt-prompts-zh) ★56077 [`chat-gpt`] [`chatgpt`] [`chatgpt3`] [`chatgpt4`] [`gpt`]  
...
- [justjavac/awesome-wechat-weapp](https://github.com/justjavac/awesome-wechat-weapp) ★48909 [`demo`] [`minapp`] [`miniprogram`] [`weapp-demo`] [`wechat`] [`wechat-weapp`] [`wepy`] [`wxapp`] [`wxml`]  
...
- [SheetJS/sheetjs](https://github.com/SheetJS/sheetjs) ★35895 [`angular`] [`bun`] [`csv`] [`data`] [`database`] [`deno`] [`excel`] [`grid`] [`html`] [`html5`] [`ios`] [`javascript`] [`json`] [`nodejs`] [`react`] [`spreadsheet`] [`table`] [`vue`] [`xlsx`] [`xml`]  
...
- [XIU2/TrackersListCollection](https://github.com/XIU2/TrackersListCollection) ★29207 [`aria2`] [`aria2-format-tracker`] [`bittorrent`] [`bittorrent-trackers`] [`qbittorrent`] [`torrent`] [`torrent-tracker`] [`tracker`] [`trackers`] [`trackerslist`] [`utorrent`]  
...
- [gfwlist/gfwlist](https://github.com/gfwlist/gfwlist) ★24503 [`anticensorship`] [`censorship`] [`censorship-circumvention`] [`china`] [`gfw`]  
...
- [zijie0/HumanSystemOptimization](https://github.com/zijie0/HumanSystemOptimization) ★20056  
...
- [AZeC4/TelegramGroup](https://github.com/AZeC4/TelegramGroup) ★18615 [`telegram`] [`telegram-api`] [`telegram-bot`] [`telegram-bot-api`] [`telegram-bots`] [`telegram-channel`] [`telegramgroups`]  
...
- [Johnshall/Shadowrocket-ADBlock-Rules-Forever](https://github.com/Johnshall/Shadowrocket-ADBlock-Rules-Forever) ★16825 [`adblock`] [`gfw`] [`proxy`] [`shadowrocket`] [`v2ray`]  
...
- [sparanoid/chinese-copywriting-guidelines](https://github.com/sparanoid/chinese-copywriting-guidelines) ★14935 [`chinese`] [`chinese-simplified`] [`chinese-traditional`] [`copywriting`] [`css`] [`documentation`] [`guideline`] [`leancloud`] [`markdown`]  
...
- [AUK9527/Are-u-ok](https://github.com/AUK9527/Are-u-ok) ★11780  
...
- [pikvm/pikvm](https://github.com/pikvm/pikvm) ★9302 [`atx`] [`hardware`] [`hdmi`] [`ip-kvm`] [`ipkvm`] [`ipmi`] [`kvm`] [`mass-storage-device`] [`pi-kvm`] [`pikvm`] [`raspberry-pi`] [`raspberrypi`] [`vga`] [`video-capture-device`] [`vnc`]  
...
- [dongyubin/DockerHub](https://github.com/dongyubin/DockerHub) ★5506 [`cloudflare`] [`docker`] [`docker-image`] [`docker-registry`] [`dockerhub`] [`proxy`]  
...
- [suxuang/myIPTV](https://github.com/suxuang/myIPTV) ★3413  
...
- [Kimentanm/aptv](https://github.com/Kimentanm/aptv) ★2422  
...
- [aardio/ImTip](https://github.com/aardio/ImTip) ★2294 [`aardio`] [`ime`] [`input-method`] [`input-method-editor`] [`win32`] [`windows`] [`windows10`]  
...
- [towerstreet/IPTV-TVBOX](https://github.com/towerstreet/IPTV-TVBOX) ★160  
...
- [stascorp/rdpwrap](https://github.com/stascorp/rdpwrap) ★15811  
...
- [ScoopInstaller/Scoop](https://github.com/ScoopInstaller/Scoop) ★22823 [`installer`] [`powershell`] [`scoop`] [`windows`]  
...
- [TapXWorld/ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook) ★48242  
...
- [pyenv/pyenv](https://github.com/pyenv/pyenv) ★43068 [`python`] [`shell`]  
...
- [discourse/discourse](https://github.com/discourse/discourse) ★44974 [`discourse`] [`ember`] [`forum`] [`javascript`] [`postgresql`] [`rails`] [`ruby`]  
...
- [rustdesk/rustdesk](https://github.com/rustdesk/rustdesk) ★97384 [`android`] [`anydesk`] [`dart`] [`flatpak`] [`flutter`] [`flutter-apps`] [`ios`] [`linux`] [`macos`] [`p2p`] [`rdp`] [`remote-control`] [`remote-desktop`] [`rust`] [`rust-lang`] [`teamviewer`] [`vnc`] [`wayland`] [`windows`]  
...
- [zed-industries/zed](https://github.com/zed-industries/zed) ★64971 [`gpui`] [`rust-lang`] [`text-editor`] [`zed`]  
...
- [starship/starship](https://github.com/starship/starship) ★50885 [`bash`] [`fish`] [`fish-prompt`] [`fish-theme`] [`oh-my-zsh`] [`powershell`] [`rust`] [`shell-prompt`] [`starship`] [`zsh`] [`zsh-prompt`] [`zsh-theme`]  
...
- [dani-garcia/vaultwarden](https://github.com/dani-garcia/vaultwarden) ★48663 [`bitwarden`] [`bitwarden-rs`] [`docker`] [`rocket`] [`rust`] [`vaultwarden`]  
...
- [TabbyML/tabby](https://github.com/TabbyML/tabby) ★32029 [`ai`] [`codegen`] [`coding-assistant`] [`coding-language`] [`developer-experience`] [`developer-tools`] [`gen-ai`] [`ide`] [`llms`]  
...
- [fish-shell/fish-shell](https://github.com/fish-shell/fish-shell) ★30802 [`fish`] [`rust`] [`shell`] [`terminal`]  
...
- [rathole-org/rathole](https://github.com/rathole-org/rathole) ★11596 [`firewall`] [`frp`] [`http`] [`nat`] [`network`] [`ngrok`] [`noise`] [`noise-protocol`] [`proxy`] [`rust`] [`tunnel`]  
...
- [EasyTier/EasyTier](https://github.com/EasyTier/EasyTier) ★6840 [`nat-traversal`] [`p2p`] [`rust`] [`tailscale`] [`vpn`] [`zerotier`]  
...
- [veeso/termscp](https://github.com/veeso/termscp) ★2490 [`aws-s3`] [`command-line-tool`] [`command-line-utility`] [`ftp-client`] [`ratatui`] [`rust`] [`rust-crate`] [`rust-lang`] [`scp`] [`sftp`] [`sftp-client`] [`ssh-client`] [`terminal`] [`terminal-app`] [`tui`] [`utility`] [`winscp`] [`winscp-equivalent-for-linux`] [`winscp-for-linux`] [`winscp-for-mac`]  
...
- [imputnet/cobalt](https://github.com/imputnet/cobalt) ★35989 [`collaboration`] [`downloader`] [`instagram`] [`javascript`] [`music`] [`reddit`] [`social-media`] [`soundcloud`] [`svelte`] [`tiktok`] [`twitter`] [`typescript`] [`video`] [`vimeo`] [`vk`] [`webapp`] [`youtube`] [`youtube-downloader`]  
...
- [ant-design/ant-design](https://github.com/ant-design/ant-design) ★95889 [`ant-design`] [`antd`] [`design-systems`] [`react`] [`typescript`] [`ui-kit`] [`ui-library`]  
...
- [tailwindlabs/tailwindcss](https://github.com/tailwindlabs/tailwindcss) ★89931 [`css`] [`css-framework`] [`functional-css`] [`postcss`] [`responsive`] [`tailwindcss`] [`utility-classes`]  
...
- [ChatGPTNextWeb/NextChat](https://github.com/ChatGPTNextWeb/NextChat) ★85732 [`calclaude`] [`chatgpt`] [`claude`] [`cross-platform`] [`desktop`] [`fe`] [`gemini`] [`gemini-pro`] [`gemini-server`] [`gemini-ultra`] [`gpt-4o`] [`groq`] [`nextjs`] [`ollama`] [`react`] [`tauri`] [`tauri-app`] [`vercel`] [`webui`]  
...
- [mermaid-js/mermaid](https://github.com/mermaid-js/mermaid) ★82637 [`diagrams`] [`diagrams-as-code`] [`documentation`] [`flowchart`] [`javascript`] [`mindmap`] [`typescript`] [`uml-diagrams`]  
...
- [immich-app/immich](https://github.com/immich-app/immich) ★75130 [`backup-tool`] [`flutter`] [`google-photos`] [`google-photos-alternative`] [`javascript`] [`mobile-app`] [`nestjs`] [`nodejs`] [`photo-gallery`] [`photos`] [`photos-management`] [`self-hosted`] [`svelte`] [`sveltekit`] [`typescript`] [`videos`]  
...
- [hoppscotch/hoppscotch](https://github.com/hoppscotch/hoppscotch) ★73828 [`api`] [`api-client`] [`api-rest`] [`api-testing`] [`developer-tools`] [`graphql`] [`hacktoberfest`] [`http`] [`http-client`] [`pwa`] [`rest`] [`rest-api`] [`spa`] [`testing`] [`testing-tools`] [`tools`] [`vue`] [`vuejs`] [`websocket`]  
...
- [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) ★73488 [`gemini`] [`gemini-api`]  
...
- [clash-verge-rev/clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev) ★73139 [`clash`] [`clash-meta`] [`clash-verge`] [`linux`] [`mac`] [`mihomo`] [`tauri-app`] [`windows`]  
...
- [lobehub/lobe-chat](https://github.com/lobehub/lobe-chat) ★65153 [`agent`] [`ai`] [`artifacts`] [`chat`] [`chatgpt`] [`claude`] [`deepseek`] [`deepseek-r1`] [`function-calling`] [`gemini`] [`gpt`] [`knowledge-base`] [`mcp`] [`nextjs`] [`ollama`] [`openai`] [`rag`]  
...
- [nocodb/nocodb](https://github.com/nocodb/nocodb) ★56749 [`airtable`] [`airtable-alternative`] [`automatic-api`] [`hacktoberfest`] [`low-code`] [`no-code`] [`no-code-database`] [`no-code-platform`] [`postgresql`] [`rest-api`] [`restful-api`] [`spreadsheet`] [`sqlite`] [`swagger`]  
...
- [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) ★54644 [`ai`] [`ai-scraping`] [`crawler`] [`data`] [`html-to-markdown`] [`llm`] [`markdown`] [`rag`] [`scraper`] [`scraping`] [`web-crawler`] [`webscraping`]  
...
- [slab/quill](https://github.com/slab/quill) ★46042 [`editor`] [`quill`] [`rich-text-editor`] [`wysiwyg`]  
...
- [lyswhut/lx-music-desktop](https://github.com/lyswhut/lx-music-desktop) ★46021 [`electron`] [`javascript`] [`music-player`] [`vue`]  
...
- [RocketChat/Rocket.Chat](https://github.com/RocketChat/Rocket.Chat) ★43324 [`chat`] [`collaboration`] [`foss`] [`free`] [`hacktoberfest`] [`javascript`] [`meteor`] [`mit`] [`real-time`] [`slack`] [`webrtc`]  
...
- [DIYgod/RSSHub](https://github.com/DIYgod/RSSHub) ★38591 [`bilibili`] [`douban`] [`dribbble`] [`instagram`] [`lofter`] [`pixiv`] [`rss`] [`rsshub`] [`spotify`] [`telegram`] [`tiktok`] [`twitter`] [`v2ex`] [`wechat`] [`weibo`] [`ximalaya`] [`youtube`] [`zhihu`]  
...
- [markedjs/marked](https://github.com/markedjs/marked) ★35492 [`commonmark`] [`compiler`] [`gfm`] [`hacktoberfest`] [`markdown`] [`parser`]  
...
- [RSSNext/Folo](https://github.com/RSSNext/Folo) ★33481 [`ai`] [`blockchain`] [`reader`] [`rss`] [`rss-reader`]  
...
- [niklasvh/html2canvas](https://github.com/niklasvh/html2canvas) ★31513 [`dom`] [`javascript`] [`screenshot`]  
...
- [umami-software/umami](https://github.com/umami-software/umami) ★30564 [`analytics`] [`charts`] [`google-analytics`] [`statistics`] [`web-analytics`]  
...
- [blakeblackshear/frigate](https://github.com/blakeblackshear/frigate) ★25701 [`ai`] [`camera`] [`google-coral`] [`home-assistant`] [`home-automation`] [`homeautomation`] [`mqtt`] [`nvr`] [`object-detection`] [`realtime`] [`rtsp`] [`tensorflow`]  
...
- [GoogleChromeLabs/squoosh](https://github.com/GoogleChromeLabs/squoosh) ★23659  
...
- [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ★22353  
...
- [maotoumao/MusicFree](https://github.com/maotoumao/MusicFree) ★20131 [`free`] [`music-player`] [`musicfree`] [`plugin`] [`react`] [`react-native`] [`typescript`]  
...
- [louislam/dockge](https://github.com/louislam/dockge) ★19378 [`docker`] [`docker-compose`] [`docker-deployment`] [`docker-stack`] [`docker-stack-deploy`] [`docker-ui`] [`responsive`] [`self-hosted`] [`selfhosted`] [`single-page-app`] [`socket-io`] [`webapp`] [`websocket`]  
...
- [baidu/amis](https://github.com/baidu/amis) ★18524 [`admin`] [`frontend`] [`frontend-framework`] [`json`] [`low-code`] [`low-code-development-platform`] [`lowcode`] [`no-code`]  
...
- [musistudio/claude-code-router](https://github.com/musistudio/claude-code-router) ★16542  
...
- [getAsterisk/opcode](https://github.com/getAsterisk/opcode) ★15450 [`anthropic`] [`anthropic-claude`] [`claude`] [`claude-4`] [`claude-4-opus`] [`claude-4-sonnet`] [`claude-ai`] [`claude-code`] [`claude-code-sdk`] [`cursor`] [`ide`] [`llm`] [`llm-code`] [`rust`] [`tauri`]  
...
- [vercel/vercel](https://github.com/vercel/vercel) ★14033 [`cli`] [`cloud`] [`command`] [`hosting`] [`jamstack`] [`ship`] [`vercel`]  
...
- [ourongxing/newsnow](https://github.com/ourongxing/newsnow) ★12831 [`elegant`] [`news`]  
...
- [bitwarden/clients](https://github.com/bitwarden/clients) ★11149 [`angular`] [`bitwarden`] [`browser-extension`] [`chrome`] [`cli`] [`desktop`] [`electron`] [`firefox`] [`javascript`] [`nodejs`] [`safari`] [`typescript`] [`webextension`]  
...
- [dream-num/univer](https://github.com/dream-num/univer) ★10913 [`appscript`] [`collaboration`] [`data-table`] [`doc`] [`document`] [`excel`] [`grid`] [`live-share`] [`office`] [`powerpoint`] [`ppt`] [`productivity`] [`sdk`] [`sheet`] [`slide`] [`spreadsheet`] [`univer-mcp`] [`word`] [`xlsx`]  
  这是一个用于生成各种类型的数字序列的工具。它支持算术、几何、斐波那契、卢卡斯等多种序列类型，并允许用户自定义序列规则。该工具使用Python语言开发，基于NumPy库进行数值计算，并提供简洁的API接口，方便用户快速生成所需序列。
- [plait-board/drawnix](https://github.com/plait-board/drawnix) ★10628 [`collaboration`] [`drawing`] [`flowchart`] [`localfirst`] [`mindmap`] [`productivity`] [`whiteboard`]  
...
- [giscus/giscus](https://github.com/giscus/giscus) ★10411 [`blog`] [`comment-system`] [`comments`] [`comments-widget`] [`giscus`] [`github`] [`github-discussions`] [`hacktoberfest`] [`javascript`] [`nextjs`] [`react`] [`reactjs`] [`utterances`] [`widget`]  
...
- [ayangweb/BongoCat](https://github.com/ayangweb/BongoCat) ★9950 [`bongo-cat`] [`bongocat`] [`cross-platform`] [`desktop-app`] [`desktop-pet`] [`linux`] [`macos`] [`pet`] [`pet-project`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [x-extends/vxe-table](https://github.com/x-extends/vxe-table) ★8292 [`cell`] [`checkbox`] [`editable`] [`form`] [`grid`] [`input`] [`modal`] [`pager`] [`radio`] [`select`] [`switch`] [`table`] [`toolbar`] [`vue`] [`vue-table`] [`vxe-grid`] [`vxe-table`] [`vxe-ui`]  
...
- [AIsouler/GKD_subscription](https://github.com/AIsouler/GKD_subscription) ★7537 [`gkd`] [`gkd-subscription`] [`typescript`]  
...
- [yinxin630/fiora](https://github.com/yinxin630/fiora) ★7003 [`chat`] [`chatroom`] [`fiora`] [`mongodb`] [`react`] [`socket`]  
...
- [EcoPasteHub/EcoPaste](https://github.com/EcoPasteHub/EcoPaste) ★6024 [`application`] [`clipboard`] [`clipboard-manager`] [`cross-platform`] [`desktop-app`] [`desktop-application`] [`linux`] [`macos`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [remotely-save/remotely-save](https://github.com/remotely-save/remotely-save) ★5998  
...
- [ineo6/hosts](https://github.com/ineo6/hosts) ★5213 [`github`] [`hosts`] [`hosts-file`]  
...
- [XPoet/picx](https://github.com/XPoet/picx) ★4952 [`cdn`] [`cloudflare`] [`github-api`] [`image-hosting`] [`image-toolbox`] [`jsdelivr`] [`picx`] [`staticaly`]  
...
- [zh-lx/pinyin-pro](https://github.com/zh-lx/pinyin-pro) ★4372 [`hanzi`] [`hanzi-pinyin`] [`hanzi2pinyin`] [`js-pinyin`] [`pinyin`] [`pinyin-match`] [`pinyin-pro`]  
...
- [galaxy-s10/billd-desk](https://github.com/galaxy-s10/billd-desk) ★4056 [`coturn`] [`electron`] [`flutter`] [`nodejs`] [`parsec`] [`remote-desktop`] [`rustdesk`] [`socket-io`] [`todesk`] [`typescript`] [`vue3`] [`webrtc`]  
...
- [pages-cms/pages-cms](https://github.com/pages-cms/pages-cms) ★2876 [`11ty`] [`astro`] [`cms`] [`docusaurus`] [`eleventy`] [`gatsby`] [`hugo`] [`jekyll`] [`nextjs`] [`ssg`] [`static-site`] [`static-site-generator`] [`vitepress`] [`vue`] [`vuejs`] [`vuejs3`] [`vuepress`]  
...
- [pt-plugins/PT-depiler](https://github.com/pt-plugins/PT-depiler) ★1337 [`private-tracker`]  
...
- [abbodi1406/vcredist](https://github.com/abbodi1406/vcredist) ★6898  
...
- [VBA-tools/VBA-JSON](https://github.com/VBA-tools/VBA-JSON) ★2012  
