...
- [nextcloud/server](https://github.com/nextcloud/server) ★30447 [`cloud`] [`collaboration`] [`decentralized`] [`design`] [`distributed`] [`enterprise`] [`federation`] [`file-sharing`] [`free-software`] [`hacktoberfest`] [`javascript`] [`nextcloud`] [`open-source`] [`opensource`] [`owncloud`] [`php`] [`self-hosting`] [`sharing`] [`usability`] [`ux`]  
...
- [easychen/howto-make-more-money](https://github.com/easychen/howto-make-more-money) ★17524  
...
- [koel/koel](https://github.com/koel/koel) ★16665 [`audio`] [`hacktoberfest`] [`laravel`] [`music`] [`music-player`] [`streaming`] [`vue`]  
...
- [getgrav/grav](https://github.com/getgrav/grav) ★15145 [`cms`] [`content`] [`content-management`] [`doctrine`] [`flat-file`] [`grav`] [`markdown`] [`php`] [`php7`] [`symfony`] [`twig`] [`website`] [`website-builder`] [`website-generation`] [`yaml`]  
...
- [Intervention/image](https://github.com/Intervention/image) ★14208 [`gd`] [`image`] [`imagick`] [`intervention`] [`php`]  
...
- [phpstan/phpstan](https://github.com/phpstan/phpstan) ★13539 [`php`] [`php7`] [`phpstan`] [`static-analysis`] [`static-analyzer`] [`static-code-analysis`] [`testing`]  
...
- [librespeed/speedtest](https://github.com/librespeed/speedtest) ★13441 [`hacktoberfest`] [`html5-speedtest`] [`internet-speed`] [`internet-speed-checker`] [`librespeed`] [`php`] [`speedtest`] [`web-worker`] [`xhr`]  
...
- [FreshRSS/FreshRSS](https://github.com/FreshRSS/FreshRSS) ★12183 [`feed`] [`freshrss`] [`news-aggregator`] [`php`] [`rss`] [`rss-aggregator`] [`rss-reader`] [`self-hosted`] [`websub`]  
...
- [YOURLS/YOURLS](https://github.com/YOURLS/YOURLS) ★11481 [`bitly`] [`hacktoberfest`] [`php`] [`short-url`] [`shorten-urls`] [`shortener`] [`url-shortener`] [`url-shortner`] [`yourls`]  
...
- [PHPOffice/PHPExcel](https://github.com/PHPOffice/PHPExcel) ★11418  
...
- [z-song/laravel-admin](https://github.com/z-song/laravel-admin) ★11176 [`laravel-admin`] [`model-form`] [`model-grid`] [`model-show`] [`model-tree`]  
  Laravel
- [assimon/dujiaoka](https://github.com/assimon/dujiaoka) ★10912 [`dujiaofaka`] [`dujiaoka`] [`faka`]  
...
- [vrana/adminer](https://github.com/vrana/adminer) ★6962 [`database`] [`mssql`] [`mysql`] [`php`] [`postgresql`] [`sqlite`]  
...
- [roundcube/roundcubemail](https://github.com/roundcube/roundcubemail) ★6457  
...
- [thephpleague/omnipay](https://github.com/thephpleague/omnipay) ★6022  
...
- [swoft-cloud/swoft](https://github.com/swoft-cloud/swoft) ★5568 [`annotation-framework`] [`annotations`] [`aop`] [`api`] [`coroutine`] [`framework`] [`http-server`] [`microservice`] [`mvc`] [`rpc`] [`spring-cloud`] [`springboot`] [`swoole`] [`tcp-server`] [`websocket-server`]  
...
- [kuaifan/dootask](https://github.com/kuaifan/dootask) ★5148 [`dootask`] [`project-management`] [`project-manager`] [`remote-work`] [`task-management-system`] [`task-manager`] [`team-chat`] [`to-do`] [`todo`]  
...
- [Hanson/vbot](https://github.com/Hanson/vbot) ★4298 [`php`] [`robot`] [`wechat`] [`weixin`]  
...
- [Bubka/2FAuth](https://github.com/Bubka/2FAuth) ★3298 [`2fa`] [`2factor`] [`hotp`] [`otp`] [`qrcode`] [`self-hosted`] [`totp`] [`two-factor`] [`two-factor-authentication`] [`webapp`]  
...
- [magicblack/maccms10](https://github.com/magicblack/maccms10) ★2579 [`maccms`] [`maccms10`]  
...
- [mochat-cloud/mochat](https://github.com/mochat-cloud/mochat) ★2431 [`mochat`] [`wecom`] [`weixin`] [`wework`]  
...
- [mineadmin/MineAdmin](https://github.com/mineadmin/MineAdmin) ★1028 [`admin`] [`element-plus`] [`hyperf`] [`php`] [`swoole`] [`swow`] [`vue`]  
...
- [aazooo/zjmf](https://github.com/aazooo/zjmf) ★492  
