...
- **编程语言种类：** 51
- **仓库总数：** 1766
- **最后更新时间：** 2025-09-15 06:00:14

[**→ 查看所有仓库**](dist/2025091506/ALL.md)

## 最近收藏（10 个）

- [dataease/dataease](https://github.com/dataease/dataease) ★21847 [`apache-doris`] [`business-intelligence`] [`data-analysis`] [`data-visualization`] [`echarts`] [`kettle`] [`superset`] [`tableau`]  
...
- [jaywcjlove/linux-command](https://github.com/jaywcjlove/linux-command) ★34375 [`bash`] [`chrome`] [`chrome-extension`] [`command-line`] [`gh-pages`] [`linux`] [`linux-command`] [`ls`] [`screen`] [`screenshot`] [`search`] [`ssh`] [`tools`] [`web-tools`]  
...
- [rocksdanister/lively](https://github.com/rocksdanister/lively) ★17150 [`csharp`] [`desktop`] [`desktop-wallpaper`] [`dynamic-desktop`] [`dynamic-wallpaper`] [`fluent-design`] [`live-wallpaper`] [`screensavers`] [`wallpaper`] [`wallpaper-app`] [`wallpaper-changer`] [`wallpaper-engine`] [`wallpaperengine`] [`wallpapers`] [`widgets`] [`windows-10`] [`windows-11`] [`windows-app`] [`winui`] [`winui3`]  
...
- [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) ★148349 [`activator`] [`hwid`] [`kms`] [`kms38`] [`massgrave`] [`massgravel`] [`microsoft`] [`microsoft365`] [`office`] [`office365`] [`ohook`] [`powershell`] [`tsforge`] [`windows`] [`windows-10`] [`windows-11`]  
...
- [FongMi/Release](https://github.com/FongMi/Release) ★4724  
...
- [Genymobile/scrcpy](https://github.com/Genymobile/scrcpy) ★128071 [`android`] [`c`] [`ffmpeg`] [`libav`] [`mirroring`] [`recording`] [`screen`] [`sdl2`]  
...
- [ventoy/Ventoy](https://github.com/ventoy/Ventoy) ★70647 [`auto-install`] [`bootable-usb`] [`bsd`] [`chromeos`] [`iso-files`] [`legacy`] [`linux`] [`multiboot`] [`persistence`] [`secure-boot`] [`uefi`] [`unattended`] [`unix`] [`usb`] [`windows`]  
...
- [jqlang/jq](https://github.com/jqlang/jq) ★32556 [`jq`]  
...
- [valinet/ExplorerPatcher](https://github.com/valinet/ExplorerPatcher) ★28790  
...
- [kingToolbox/WindTerm](https://github.com/kingToolbox/WindTerm) ★27996 [`bash`] [`client`] [`cmd`] [`linux`] [`mac`] [`powershell`] [`serial`] [`sftp`] [`shell`] [`ssh`] [`telnet`] [`terminal`] [`tmux`] [`windows`] [`wsl`] [`x11`] [`xmodem`] [`xterm`] [`ymodem`] [`zmodem`]  
...
- [jarun/nnn](https://github.com/jarun/nnn) ★20572 [`android`] [`batch-rename`] [`c`] [`cli`] [`command-line`] [`developer-tools`] [`disk-usage`] [`file-manager`] [`file-preview`] [`file-search`] [`filesystem`] [`launcher`] [`multi-platform`] [`ncurses`] [`productivity`] [`raspberry-pi`] [`terminal`] [`tui`] [`vim`] [`wsl`]  
...
[查看更多 C 仓库 →](dist/2025091506/LANG_C.md)

## C#

- [microsoft/PowerToys](https://github.com/microsoft/PowerToys) ★123558 [`color-picker`] [`desktop`] [`fancyzones`] [`keyboard-manager`] [`microsoft-powertoys`] [`powerrename`] [`powertoys`] [`windows`]  
...
- [2dust/v2rayN](https://github.com/2dust/v2rayN) ★86629 [`proxy`] [`shadowsocks`] [`socks5`] [`trojan`] [`v2fly`] [`v2ray`] [`vless`] [`vmess`] [`windows`] [`xray`] [`xtls`]  
...
- [huiyadanli/RevokeMsgPatcher](https://github.com/huiyadanli/RevokeMsgPatcher) ★34604 [`hex-editor`] [`patch`] [`pc`] [`qq`] [`revoke`] [`revokemsg`] [`tim`] [`tool`] [`wechat`] [`windows`]  
...
- [AvaloniaUI/Avalonia](https://github.com/AvaloniaUI/Avalonia) ★28667 [`android`] [`app-framework`] [`avalonia`] [`avaloniaui`] [`browser`] [`c-sharp`] [`cross-platform`] [`csharp`] [`desktop`] [`dotnet`] [`gui`] [`ios`] [`linux`] [`macos`] [`mobile`] [`mvvm`] [`wasm`] [`windows`] [`xamarin`] [`xaml`]  
...
[查看更多 C# 仓库 →](dist/2025091506/LANG_C_.md)

## C++

- [electron/electron](https://github.com/electron/electron) ★118297 [`c-plus-plus`] [`chrome`] [`css`] [`electron`] [`html`] [`javascript`] [`nodejs`] [`v8`] [`works-with-codespaces`]  
...
- [microsoft/terminal](https://github.com/microsoft/terminal) ★100252 [`cmd`] [`command-line`] [`console`] [`contributions-welcome`] [`good-first-issue`] [`hacktoberfest`] [`terminal`] [`windows`] [`windows-console`] [`windows-terminal`] [`wsl`]  
...
- [tesseract-ocr/tesseract](https://github.com/tesseract-ocr/tesseract) ★69608 [`hacktoberfest`] [`lstm`] [`machine-learning`] [`ocr`] [`ocr-engine`] [`tesseract`] [`tesseract-ocr`]  
...
- [aria2/aria2](https://github.com/aria2/aria2) ★38730 [`bittorrent`] [`cpp11`] [`download`] [`ftp`] [`http`] [`metalink`] [`rpc`] [`sftp`]  
...
- [LizardByte/Sunshine](https://github.com/LizardByte/Sunshine) ★28830 [`cpp`] [`docker`] [`flathub-pkg`] [`game-stream`] [`game-streaming`] [`game-streaming-server`] [`geforce-experience`] [`homebrew-pkg`] [`maintainer-wanted`] [`moonlight`] [`pacman-pkg`] [`python`] [`remote-desktop`] [`replicator-custom-issues`] [`replicator-release-notifications`] [`rtd`] [`winget-pkg`]  
...
- [cmderdev/cmder](https://github.com/cmderdev/cmder) ★26567 [`c-plus-plus`] [`cmder`] [`color-scheme`] [`command-line`] [`conemu`] [`mintty`] [`portable`] [`powershell`] [`shell`] [`ssh-agent`] [`windows`]  
...
- [c0re100/qBittorrent-Enhanced-Edition](https://github.com/c0re100/qBittorrent-Enhanced-Edition) ★23773 [`bittorrent`] [`bittorrent-client`]  
...
- [google/filament](https://github.com/google/filament) ★18832 [`3d-graphics`] [`android`] [`gltf`] [`gltf-viewer`] [`graphics`] [`metal`] [`opengl`] [`opengl-es`] [`pbr`] [`real-time`] [`vulkan`] [`wasm`] [`webgl`]  
...
[查看更多 C++ 仓库 →](dist/2025091506/LANG_C__.md)
...
- [zero-peak/ZeroOmega](https://github.com/zero-peak/ZeroOmega) ★6143 [`proxy`] [`switchyomega`] [`zeroomega`]  
...
- [houshanren/hangzhou_house_knowledge](https://github.com/houshanren/hangzhou_house_knowledge) ★27005 [`hangzhou`] [`knowledge`]  
...
[查看更多 CSS 仓库 →](dist/2025091506/LANG_CSS.md)
...
- [AppFlowy-IO/AppFlowy](https://github.com/AppFlowy-IO/AppFlowy) ★65436 [`blog`] [`confluence-alternative`] [`content-management`] [`content-services`] [`documentation`] [`flutter`] [`note-taking`] [`notion-alternative`] [`project-management`] [`task-management`] [`team-collaboration`] [`wiki`]  
...
- [GopeedLab/gopeed](https://github.com/GopeedLab/gopeed) ★20320 [`android`] [`bittorrent`] [`cross-platform`] [`debian`] [`downloader`] [`flutter`] [`golang`] [`http`] [`https`] [`ios`] [`macos`] [`magnet`] [`torrent`] [`ubuntu`] [`windows`]  
...
- [wanghongenpin/proxypin](https://github.com/wanghongenpin/proxypin) ★10231 [`capture-traffic`] [`httpdebug`] [`proxy`] [`proxypin`] [`zhuabao`]  
...
- [Anduin2017/HowToCook](https://github.com/Anduin2017/HowToCook) ★93239 [`chinese`] [`cookbook`] [`cooking`] [`dishes`] [`recipes`]  
...
- [Fechin/reference](https://github.com/Fechin/reference) ★9027 [`awk`] [`bash`] [`chatgpt`] [`cheatsheet`] [`cheatsheets`] [`css`] [`golang`] [`grep`] [`markdown`] [`python`] [`reference`] [`sed`] [`snippets`] [`vim`]  
...
- [fatedier/frp](https://github.com/fatedier/frp) ★98601 [`expose`] [`firewall`] [`frp`] [`go`] [`http-proxy`] [`nat`] [`p2p`] [`proxy`] [`reverse-proxy`] [`tunnel`]  
...
- [syncthing/syncthing](https://github.com/syncthing/syncthing) ★76166 [`go`] [`p2p`] [`peer-to-peer`] [`synchronization`]  
...
- [junegunn/fzf](https://github.com/junegunn/fzf) ★73735 [`bash`] [`cli`] [`fish`] [`fzf`] [`go`] [`neovim`] [`tmux`] [`unix`] [`vim`] [`zsh`]  
...
- [FiloSottile/mkcert](https://github.com/FiloSottile/mkcert) ★56552 [`certificates`] [`chrome`] [`firefox`] [`https`] [`ios`] [`linux`] [`local-development`] [`localhost`] [`macos`] [`root-ca`] [`tls`] [`windows`]  
...
- [minio/minio](https://github.com/minio/minio) ★55184 [`amazon-s3`] [`cloud`] [`cloudnative`] [`cloudstorage`] [`go`] [`k8s`] [`kubernetes`] [`multi-cloud`] [`multi-cloud-kubernetes`] [`objectstorage`] [`s3`] [`storage`]  
...
- [rclone/rclone](https://github.com/rclone/rclone) ★52542 [`azure-blob`] [`azure-blob-storage`] [`azure-files`] [`backblaze-b2`] [`cloud-storage`] [`dropbox`] [`encryption`] [`ftp`] [`fuse-filesystem`] [`go`] [`golang`] [`google-cloud-storage`] [`google-drive`] [`onedrive`] [`openstack-swift`] [`rclone`] [`s3`] [`sftp`] [`sync`] [`webdav`]  
...
- [go-gitea/gitea](https://github.com/go-gitea/gitea) ★50686 [`bitbucket`] [`cicd`] [`devops`] [`docker-registry-v2`] [`git`] [`git-gui`] [`git-server`] [`gitea`] [`github`] [`github-actions`] [`gitlab`] [`go`] [`golang`] [`hacktoberfest`] [`maven-server`] [`npm-registry`] [`vue`]  
...
- [gogs/gogs](https://github.com/gogs/gogs) ★46908 [`docker`] [`git`] [`go`] [`gogs`] [`mysql`] [`postgresql`] [`raspberry-pi`] [`scip-enabled`] [`self-hosted`] [`sqlite3`]  
...
- [v2ray/v2ray-core](https://github.com/v2ray/v2ray-core) ★46393 [`golang`] [`http-proxy`] [`proxy`] [`shadowsocks`] [`socks`] [`socks5`] [`v2ray`] [`vmess`]  
...
[查看更多 Go 仓库 →](dist/2025091506/LANG_Go.md)
...
- [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) ★112034 [`awesome-list`] [`free-for-developers`]  
...
- [vernesong/OpenClash](https://github.com/vernesong/OpenClash) ★21819 [`clash`] [`luci`] [`mihomo`] [`openclash`] [`openwrt`] [`shadowsocks`] [`snell`] [`v2ray`] [`vmess`]  
...
- [Lerist/FakeLocation](https://github.com/Lerist/FakeLocation) ★6346  
...
[查看更多 HTML 仓库 →](dist/2025091506/LANG_HTML.md)

## Java

- [Stirling-Tools/Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF) ★67215 [`docker`] [`java`] [`pdf`] [`pdf-converter`] [`pdf-editor`] [`pdf-manipulation`] [`pdf-merger`] [`pdf-ocr`] [`pdf-tools`] [`pdf-web-apps`] [`pdfmerger`]  
...
- [skylot/jadx](https://github.com/skylot/jadx) ★45470 [`android`] [`decompiler`] [`dex`] [`java`]  
...
- [dbeaver/dbeaver](https://github.com/dbeaver/dbeaver) ★45374 [`ai`] [`copilot`] [`database`] [`db2`] [`dbeaver`] [`erd`] [`gui`] [`java`] [`jdbc`] [`mysql`] [`nosql`] [`openai`] [`oracle`] [`postgresql`] [`redshift`] [`sql`] [`sqlite`] [`sqlserver`]  
...
- [termux/termux-app](https://github.com/termux/termux-app) ★45039 [`android`] [`hacktoberfest`] [`linux`] [`terminal`] [`termux`]  
...
- [halo-dev/halo](https://github.com/halo-dev/halo) ★36905 [`blog`] [`blog-engine`] [`cms`] [`content-management-system`] [`halo`] [`halocms`]  
...
[查看更多 Java 仓库 →](dist/2025091506/LANG_Java.md)
...
[查看更多 JavaScript 仓库 →](dist/2025091506/LANG_JavaScript.md)
...
- [topjohnwu/Magisk](https://github.com/topjohnwu/Magisk) ★55838  
...
- [2dust/v2rayNG](https://github.com/2dust/v2rayNG) ★44859 [`android`] [`proxy`] [`shadowsocks`] [`socks5`] [`trojan`] [`v2fly`] [`v2ray`] [`vless`] [`vmess`] [`vpn`] [`xray`] [`xtls`]  
...
- [gkd-kit/gkd](https://github.com/gkd-kit/gkd) ★30824 [`accessibility`] [`android`] [`auto`] [`click`] [`compose`] [`jetpack-compose`] [`kotlin`] [`kotlin-js`] [`kotlin-multiplatform`] [`webassembly`]  
...
- [MetaCubeX/ClashMetaForAndroid](https://github.com/MetaCubeX/ClashMetaForAndroid) ★26919  
...
- [pppscn/SmsForwarder](https://github.com/pppscn/SmsForwarder) ★22707 [`android`] [`api`] [`app`] [`bark`] [`call`] [`chatgpt`] [`dingding`] [`forward`] [`mqtt`] [`pushdear`] [`pushplus`] [`serverchan`] [`sms`] [`smtp`] [`telegram`] [`webhook`] [`wechatapp`]  
...
- [RikkaApps/Shizuku](https://github.com/RikkaApps/Shizuku) ★17074  
...
- [MatsuriDayo/NekoBoxForAndroid](https://github.com/MatsuriDayo/NekoBoxForAndroid) ★15979 [`android`] [`gfw`] [`proxy`] [`shadowsocks`] [`sing-box`] [`trojan`] [`vmess`] [`vpn`]  
...
[查看更多 Kotlin 仓库 →](dist/2025091506/LANG_Kotlin.md)
...
- [Kong/kong](https://github.com/Kong/kong) ★41756 [`ai`] [`ai-gateway`] [`api-gateway`] [`api-management`] [`apis`] [`artificial-intelligence`] [`cloud-native`] [`devops`] [`kubernetes`] [`kubernetes-ingress`] [`kubernetes-ingress-controller`] [`llm-gateway`] [`llm-ops`] [`luajit`] [`microservice`] [`microservices`] [`nginx`] [`openai-proxy`] [`reverse-proxy`] [`serverless`]  
...
- [iDvel/rime-ice](https://github.com/iDvel/rime-ice) ★12831 [`rime`] [`rime-config`] [`rime-custom`] [`rime-schema`] [`rime-squirrel`] [`rime-weasel`]  
...
- [996icu/996.ICU](https://github.com/996icu/996.ICU) ★274328  
  该项目是一个关于中国程序员工作强度和压力的匿名吐槽平台。用户可以通过匿名发表帖子，分享工作经历和感受。平台使用简单的文本格式，并支持搜索和过滤功能。该项目主要使用PHP语言开发，并使用数据库存储用户数据和帖子信息。
- [awesome-selfhosted/awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ★246948 [`awesome`] [`awesome-list`] [`cloud`] [`free-software`] [`hosting`] [`privacy`] [`self-hosted`] [`selfhosted`]  
  这是一个收集各种可自托管软件的资源列表。涵盖了从博客和论坛到视频会议和VPN等各种应用。列表按类别组织，便于用户快速找到所需的自托管工具。该项目使用纯文本格式维护，便于轻松更新和浏览。
- [justjavac/free-programming-books-zh_CN](https://github.com/justjavac/free-programming-books-zh_CN) ★115184 [`android`] [`angular`] [`books`] [`free`] [`ios`] [`javascript`] [`kotlin`] [`pdf`] [`programming`] [`python`] [`react`] [`react-native`] [`swift`] [`vue`]  
...
- [ruanyf/weekly](https://github.com/ruanyf/weekly) ★75345  
...
- [justjavac/awesome-wechat-weapp](https://github.com/justjavac/awesome-wechat-weapp) ★49028 [`demo`] [`minapp`] [`miniprogram`] [`weapp-demo`] [`wechat`] [`wechat-weapp`] [`wepy`] [`wxapp`] [`wxml`]  
...
[查看更多 NaN 仓库 →](dist/2025091506/LANG_NaN.md)
...
- [opa334/TrollStore](https://github.com/opa334/TrollStore) ★20153  
...
[查看更多 Objective-C 仓库 →](dist/2025091506/LANG_Objective-C.md)
...
- [cheat-engine/cheat-engine](https://github.com/cheat-engine/cheat-engine) ★16937  
...
- [stascorp/rdpwrap](https://github.com/stascorp/rdpwrap) ★15843  
...
- [nextcloud/server](https://github.com/nextcloud/server) ★30762 [`cloud`] [`collaboration`] [`decentralized`] [`design`] [`distributed`] [`enterprise`] [`federation`] [`file-sharing`] [`free-software`] [`hacktoberfest`] [`javascript`] [`nextcloud`] [`open-source`] [`opensource`] [`owncloud`] [`php`] [`self-hosting`] [`sharing`] [`usability`] [`ux`]  
...
- [easychen/howto-make-more-money](https://github.com/easychen/howto-make-more-money) ★17845  
...
[查看更多 PHP 仓库 →](dist/2025091506/LANG_PHP.md)
...
- [EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books) ★368150 [`books`] [`education`] [`hacktoberfest`] [`list`] [`resource`]  
...
- [public-apis/public-apis](https://github.com/public-apis/public-apis) ★365032 [`api`] [`apis`] [`dataset`] [`development`] [`free`] [`list`] [`lists`] [`open-source`] [`public`] [`public-api`] [`public-apis`] [`resources`] [`software`]  
...
- [deepseek-ai/DeepSeek-V3](https://github.com/deepseek-ai/DeepSeek-V3) ★99247  
...
- [home-assistant/core](https://github.com/home-assistant/core) ★81306 [`asyncio`] [`hacktoberfest`] [`home-automation`] [`internet-of-things`] [`iot`] [`mqtt`] [`python`] [`raspberry-pi`]  
...
- [fighting41love/funNLP](https://github.com/fighting41love/funNLP) ★75971  
...
- [sherlock-project/sherlock](https://github.com/sherlock-project/sherlock) ★68634 [`cli`] [`cti`] [`cybersecurity`] [`forensics`] [`hacktoberfest`] [`information-gathering`] [`infosec`] [`linux`] [`osint`] [`pentesting`] [`python`] [`python3`] [`reconnaissance`] [`redteam`] [`sherlock`] [`tools`]  
...
- [xtekky/gpt4free](https://github.com/xtekky/gpt4free) ★65108 [`chatbot`] [`chatbots`] [`chatgpt`] [`chatgpt-4`] [`chatgpt-api`] [`chatgpt-free`] [`chatgpt4`] [`deepseek`] [`deepseek-api`] [`deepseek-r1`] [`gpt`] [`gpt-4`] [`gpt-4o`] [`gpt4`] [`gpt4-api`] [`language-model`] [`openai`] [`openai-api`] [`openai-chatgpt`] [`reverse-engineering`]  
  该项目提供一个基于GPT-4的免费API访问途径。用户无需付费即可调用GPT-4模型进行文本生成、翻译等任务。该项目使用Python和OpenAI API进行开发，核心功能包括API接口封装和请求管理，并提供简易的调用示例。
- [scrapy/scrapy](https://github.com/scrapy/scrapy) ★58221 [`crawler`] [`crawling`] [`framework`] [`hacktoberfest`] [`python`] [`scraping`] [`web-scraping`] [`web-scraping-python`]  
...
[查看更多 Python 仓库 →](dist/2025091506/LANG_Python.md)
...
- [TapXWorld/ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook) ★49565  
...
- [discourse/discourse](https://github.com/discourse/discourse) ★45063 [`discourse`] [`ember`] [`forum`] [`javascript`] [`postgresql`] [`rails`] [`ruby`]  
...
- [greatghoul/remote-working](https://github.com/greatghoul/remote-working) ★11060 [`china`] [`freelancer`] [`remote-work`] [`remote-workers`] [`soho`] [`telecommunications`] [`work-from-home`]  
...
- [rustdesk/rustdesk](https://github.com/rustdesk/rustdesk) ★98227 [`android`] [`anydesk`] [`dart`] [`flatpak`] [`flutter`] [`flutter-apps`] [`ios`] [`linux`] [`macos`] [`p2p`] [`rdp`] [`remote-control`] [`remote-desktop`] [`rust`] [`rust-lang`] [`teamviewer`] [`vnc`] [`wayland`] [`windows`]  
...
- [zed-industries/zed](https://github.com/zed-industries/zed) ★65554 [`gpui`] [`rust-lang`] [`text-editor`] [`zed`]  
...
- [starship/starship](https://github.com/starship/starship) ★51156 [`bash`] [`fish`] [`fish-prompt`] [`fish-theme`] [`oh-my-zsh`] [`powershell`] [`rust`] [`shell-prompt`] [`starship`] [`zsh`] [`zsh-prompt`] [`zsh-theme`]  
...
- [dani-garcia/vaultwarden](https://github.com/dani-garcia/vaultwarden) ★48993 [`bitwarden`] [`bitwarden-rs`] [`docker`] [`rocket`] [`rust`] [`vaultwarden`]  
...
- [tw93/Pake](https://github.com/tw93/Pake) ★42185 [`chatgpt`] [`claude`] [`desktop`] [`gemini`] [`hight-performance`] [`linux`] [`macos`] [`no-electron`] [`package`] [`rust`] [`tauri`] [`windows`] [`youtube`]  
...
- [TabbyML/tabby](https://github.com/TabbyML/tabby) ★32083 [`ai`] [`codegen`] [`coding-assistant`] [`coding-language`] [`developer-experience`] [`developer-tools`] [`gen-ai`] [`ide`] [`llms`]  
...
- [fish-shell/fish-shell](https://github.com/fish-shell/fish-shell) ★30883 [`fish`] [`rust`] [`shell`] [`terminal`]  
...
- [lsd-rs/lsd](https://github.com/lsd-rs/lsd) ★14838 [`color`] [`icons`] [`ls`] [`nerd-fonts`] [`rust`]  
...
[查看更多 Rust 仓库 →](dist/2025091506/LANG_Rust.md)
...
- [ohmyzsh/ohmyzsh](https://github.com/ohmyzsh/ohmyzsh) ★181392 [`cli`] [`cli-app`] [`hacktoberfest`] [`oh-my-zsh`] [`oh-my-zsh-plugin`] [`oh-my-zsh-theme`] [`ohmyzsh`] [`plugin-framework`] [`plugins`] [`productivity`] [`shell`] [`terminal`] [`theme`] [`themes`] [`zsh`] [`zsh-configuration`]  
...
- [sickcodes/Docker-OSX](https://github.com/sickcodes/Docker-OSX) ★51381 [`container`] [`docker`] [`docker-osx`] [`kvm`] [`macos`] [`os`] [`osx`] [`osx-kvm`] [`x`] [`x11`]  
...
- [dockur/windows](https://github.com/dockur/windows) ★45352 [`docker`] [`docker-container`] [`virtualization`] [`windows`] [`windows-virtual-desktop`] [`windows-virtual-machine`] [`windows-virtual-machines`] [`windows-vm`]  
...
- [233boy/v2ray](https://github.com/233boy/v2ray) ★26920 [`shell-script`] [`v2ray`] [`vmess`]  
...
- [lxgw/LxgwWenKai](https://github.com/lxgw/LxgwWenKai) ★21503 [`cjk`] [`font`] [`typeface`]  
...
[查看更多 Shell 仓库 →](dist/2025091506/LANG_Shell.md)

## Svelte

- [imputnet/cobalt](https://github.com/imputnet/cobalt) ★36158 [`collaboration`] [`downloader`] [`instagram`] [`javascript`] [`music`] [`reddit`] [`social-media`] [`soundcloud`] [`svelte`] [`tiktok`] [`twitter`] [`typescript`] [`video`] [`vimeo`] [`vk`] [`webapp`] [`youtube`] [`youtube-downloader`]  
...
- [iptv-org/iptv](https://github.com/iptv-org/iptv) ★97092 [`iptv`] [`m3u`] [`playlist`] [`streams`] [`tv`]  
...
- [ant-design/ant-design](https://github.com/ant-design/ant-design) ★96022 [`ant-design`] [`antd`] [`design-systems`] [`react`] [`typescript`] [`ui-kit`] [`ui-library`]  
...
- [tailwindlabs/tailwindcss](https://github.com/tailwindlabs/tailwindcss) ★90134 [`css`] [`css-framework`] [`functional-css`] [`postcss`] [`responsive`] [`tailwindcss`] [`utility-classes`]  
...
- [ChatGPTNextWeb/NextChat](https://github.com/ChatGPTNextWeb/NextChat) ★85824 [`calclaude`] [`chatgpt`] [`claude`] [`cross-platform`] [`desktop`] [`fe`] [`gemini`] [`gemini-pro`] [`gemini-server`] [`gemini-ultra`] [`gpt-4o`] [`groq`] [`nextjs`] [`ollama`] [`react`] [`tauri`] [`tauri-app`] [`vercel`] [`webui`]  
...
- [mermaid-js/mermaid](https://github.com/mermaid-js/mermaid) ★82885 [`diagrams`] [`diagrams-as-code`] [`documentation`] [`flowchart`] [`javascript`] [`mindmap`] [`typescript`] [`uml-diagrams`]  
...
- [immich-app/immich](https://github.com/immich-app/immich) ★76778 [`backup-tool`] [`flutter`] [`google-photos`] [`google-photos-alternative`] [`javascript`] [`mobile-app`] [`nestjs`] [`nodejs`] [`photo-gallery`] [`photos`] [`photos-management`] [`self-hosted`] [`svelte`] [`sveltekit`] [`typescript`] [`videos`]  
...
- [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) ★75137 [`gemini`] [`gemini-api`]  
...
- [clash-verge-rev/clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev) ★74465 [`clash`] [`clash-meta`] [`clash-verge`] [`linux`] [`mac`] [`mihomo`] [`tauri-app`] [`windows`]  
...
- [hoppscotch/hoppscotch](https://github.com/hoppscotch/hoppscotch) ★74379 [`api`] [`api-client`] [`api-rest`] [`api-testing`] [`developer-tools`] [`graphql`] [`hacktoberfest`] [`http`] [`http-client`] [`pwa`] [`rest`] [`rest-api`] [`spa`] [`testing`] [`testing-tools`] [`tools`] [`vue`] [`vuejs`] [`websocket`]  
...
- [lobehub/lobe-chat](https://github.com/lobehub/lobe-chat) ★65538 [`agent`] [`ai`] [`artifacts`] [`chat`] [`chatgpt`] [`claude`] [`deepseek`] [`deepseek-r1`] [`function-calling`] [`gemini`] [`gpt`] [`knowledge-base`] [`mcp`] [`nextjs`] [`ollama`] [`openai`] [`rag`]  
...
[查看更多 TypeScript 仓库 →](dist/2025091506/LANG_TypeScript.md)
...
- [vbenjs/vue-vben-admin](https://github.com/vbenjs/vue-vben-admin) ★29904 [`admin-template`] [`ant-design`] [`element-plus`] [`monorepo`] [`naive-ui`] [`shadcn-ui`] [`tsx`] [`typescript`] [`vben`] [`vite`] [`vite-template`] [`vue-router`] [`vue3`] [`vuex`]  
...
- [requarks/wiki](https://github.com/requarks/wiki) ★27011 [`cross-platform`] [`documentation`] [`git`] [`markdown`] [`nodejs`] [`open-source`] [`wiki`]  
...
- [Lissy93/dashy](https://github.com/Lissy93/dashy) ★22493 [`awesome`] [`dashboard`] [`docker`] [`hacktoberfest`] [`homelab`] [`homepage`] [`mit`] [`nodejs`] [`organization`] [`productivity`] [`pwa`] [`self-hosted`] [`startpage`] [`vue`]  
...
- [doocs/md](https://github.com/doocs/md) ★10566 [`ai-bot`] [`doocs`] [`editor`] [`llm`] [`markdown`] [`markdown-editor`] [`tailwindcss`] [`vite`] [`vue`] [`vue3`] [`wechat`] [`weixin`]  
...
[查看更多 Vue 仓库 →](dist/2025091506/LANG_Vue.md)
