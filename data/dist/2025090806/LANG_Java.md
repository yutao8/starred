...
- [justauth/JustAuth](https://github.com/justauth/JustAuth) ★17176 [`googlelogin`] [`justauth`] [`oauth2`] [`qqlogin`] [`weixinlogin`]  
...
- [theonedev/onedev](https://github.com/theonedev/onedev) ★14237 [`ci-cd`] [`devops`] [`git`] [`kanban`] [`packages`] [`self-hosted`]  
