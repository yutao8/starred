...
- [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) ★142922 [`activator`] [`hwid`] [`kms`] [`kms38`] [`massgrave`] [`massgravel`] [`microsoft`] [`microsoft365`] [`office`] [`office365`] [`ohook`] [`powershell`] [`tsforge`] [`windows`] [`windows-10`] [`windows-11`]  
...
- [microsoft/PowerToys](https://github.com/microsoft/PowerToys) ★121595 [`color-picker`] [`desktop`] [`fancyzones`] [`keyboard-manager`] [`microsoft-powertoys`] [`powerrename`] [`powertoys`] [`windows`]  
...
- [2dust/v2rayN](https://github.com/2dust/v2rayN) ★83966 [`proxy`] [`shadowsocks`] [`socks5`] [`trojan`] [`v2fly`] [`v2ray`] [`vless`] [`vmess`] [`windows`] [`xray`] [`xtls`]  
...
- [huiyadanli/RevokeMsgPatcher](https://github.com/huiyadanli/RevokeMsgPatcher) ★33641 [`hex-editor`] [`patch`] [`pc`] [`qq`] [`revoke`] [`revokemsg`] [`tim`] [`tool`] [`wechat`] [`windows`]  
...
- [AvaloniaUI/Avalonia](https://github.com/AvaloniaUI/Avalonia) ★28283 [`android`] [`app-framework`] [`avalonia`] [`avaloniaui`] [`browser`] [`c-sharp`] [`cross-platform`] [`csharp`] [`desktop`] [`dotnet`] [`gui`] [`ios`] [`linux`] [`macos`] [`mobile`] [`mvvm`] [`wasm`] [`windows`] [`xamarin`] [`xaml`]  
...
- [nilaoda/N_m3u8DL-CLI](https://github.com/nilaoda/N_m3u8DL-CLI) ★15300 [`command-line`] [`downloader`] [`m3u8`] [`m3u8-downloader`] [`m3u8-parser`] [`m3u8dl-cli`] [`windows`]  
...
- [d2phap/ImageGlass](https://github.com/d2phap/ImageGlass) ★10872 [`avif`] [`csharp`] [`direct2d`] [`dotnet`] [`heic`] [`heif`] [`image-viewer`] [`imageglass`] [`jpeg-xl`] [`jxl`] [`photo-viewer`] [`picture-gallery`] [`picture-viewer`] [`raw`] [`raw-image`] [`svg`] [`svg-viewer`] [`winforms`]  
...
- [OdysseusYuan/LKY_OfficeTools](https://github.com/OdysseusYuan/LKY_OfficeTools) ★10321 [`access`] [`email`] [`excel`] [`kms`] [`lync`] [`microsoft`] [`msoffice`] [`office`] [`office-free`] [`office365`] [`onedrive`] [`onenote`] [`outlook`] [`ppt`] [`project`] [`publisher`] [`skype`] [`teams`] [`visio`] [`word`]  
...
- [studyzy/imewlconverter](https://github.com/studyzy/imewlconverter) ★8762 [`c-sharp`] [`chinese-characters`] [`converter`] [`dotnet`] [`dotnet-core`] [`ime`]  
...
- [dnSpyEx/dnSpy](https://github.com/dnSpyEx/dnSpy) ★8677 [`baml`] [`csharp`] [`debug`] [`debugger`] [`decompile`] [`decompiler`] [`dotnet`] [`dotnetcore`] [`dotnetframework`] [`mono`] [`unity`] [`vbnet`] [`xaml`]  
...
- [git-ecosystem/git-credential-manager](https://github.com/git-ecosystem/git-credential-manager) ★7904 [`aad`] [`authentication`] [`azure-devops`] [`azure-repos`] [`bitbucket`] [`credential`] [`cross-platform`] [`git`] [`github`] [`gitlab`]  
...
- [nilaoda/N_m3u8DL-RE](https://github.com/nilaoda/N_m3u8DL-RE) ★6203 [`dash`] [`ffmpeg`] [`hls`] [`ism`] [`live`] [`m3u8`] [`m3u8-downloader`] [`mpd`] [`recorder`]  
...
- [TechnitiumSoftware/DnsServer](https://github.com/TechnitiumSoftware/DnsServer) ★5866 [`cross-platform`] [`dhcp-server`] [`dns`] [`dns-client`] [`dns-over-https`] [`dns-over-quic`] [`dns-over-tls`] [`dns-over-tor`] [`dns-server`] [`dotnet`] [`privacy`] [`technitium-dns-server`]  
...
- [Richasy/Bili.Copilot](https://github.com/Richasy/Bili.Copilot) ★4629 [`bilibili`] [`windows-app-sdk`] [`winui3`]  
...
- [Jeric-X/SyncClipboard](https://github.com/Jeric-X/SyncClipboard) ★3052  
...
- [chenxuuu/llcom](https://github.com/chenxuuu/llcom) ★1038 [`com`] [`encoding-decoding`] [`ipv6-support`] [`libusb`] [`lua`] [`mqtt-client`] [`rs232`] [`serial-port`] [`serial-port-monitor`] [`ssl-server`] [`tcp-client`] [`tcp-server`] [`udp-client`] [`udp-server`] [`winusb`]  
...
- [zero-peak/ZeroOmega](https://github.com/zero-peak/ZeroOmega) ★5723 [`proxy`] [`switchyomega`] [`zeroomega`]  
...
- [AppFlowy-IO/AppFlowy](https://github.com/AppFlowy-IO/AppFlowy) ★64656 [`blog`] [`confluence-alternative`] [`content-management`] [`content-services`] [`documentation`] [`flutter`] [`note-taking`] [`notion-alternative`] [`project-management`] [`task-management`] [`team-collaboration`] [`wiki`]  
...
- [wanghongenpin/proxypin](https://github.com/wanghongenpin/proxypin) ★9781 [`capture-traffic`] [`httpdebug`] [`proxy`] [`proxypin`] [`zhuabao`]  
...
- [Anduin2017/HowToCook](https://github.com/Anduin2017/HowToCook) ★91635 [`chinese`] [`cookbook`] [`cooking`] [`dishes`] [`recipes`]  
...
- [fatedier/frp](https://github.com/fatedier/frp) ★96697 [`expose`] [`firewall`] [`frp`] [`go`] [`http-proxy`] [`nat`] [`p2p`] [`proxy`] [`reverse-proxy`] [`tunnel`]  
...
- [syncthing/syncthing](https://github.com/syncthing/syncthing) ★73972 [`go`] [`p2p`] [`peer-to-peer`] [`synchronization`]  
...
- [junegunn/fzf](https://github.com/junegunn/fzf) ★72409 [`bash`] [`cli`] [`fish`] [`fzf`] [`go`] [`neovim`] [`tmux`] [`unix`] [`vim`] [`zsh`]  
...
- [FiloSottile/mkcert](https://github.com/FiloSottile/mkcert) ★54955 [`certificates`] [`chrome`] [`firefox`] [`https`] [`ios`] [`linux`] [`local-development`] [`localhost`] [`macos`] [`root-ca`] [`tls`] [`windows`]  
...
- [minio/minio](https://github.com/minio/minio) ★54235 [`amazon-s3`] [`cloud`] [`cloudnative`] [`cloudstorage`] [`go`] [`k8s`] [`kubernetes`] [`multi-cloud`] [`multi-cloud-kubernetes`] [`objectstorage`] [`s3`] [`storage`]  
...
- [rclone/rclone](https://github.com/rclone/rclone) ★51728 [`azure-blob`] [`azure-blob-storage`] [`azure-files`] [`backblaze-b2`] [`cloud-storage`] [`dropbox`] [`encryption`] [`ftp`] [`fuse-filesystem`] [`go`] [`golang`] [`google-cloud-storage`] [`google-drive`] [`onedrive`] [`openstack-swift`] [`rclone`] [`s3`] [`sftp`] [`sync`] [`webdav`]  
...
- [go-gitea/gitea](https://github.com/go-gitea/gitea) ★49789 [`bitbucket`] [`cicd`] [`devops`] [`docker-registry-v2`] [`git`] [`git-gui`] [`git-server`] [`gitea`] [`github`] [`github-actions`] [`gitlab`] [`go`] [`golang`] [`hacktoberfest`] [`maven-server`] [`npm-registry`] [`vue`]  
...
- [AlistGo/alist](https://github.com/AlistGo/alist) ★48409 [`file-server`] [`gin`] [`golang`] [`onedrive`] [`solidjs`] [`webdav`]  
...
- [usememos/memos](https://github.com/usememos/memos) ★43218 [`docker`] [`foss`] [`go`] [`markdown`] [`memo`] [`microblog`] [`note-taking`] [`notecard`] [`react`] [`self-hosted`] [`social-network`] [`sqlite`]  
...
- [coreybutler/nvm-windows](https://github.com/coreybutler/nvm-windows) ★42161 [`go`] [`management`] [`node`] [`node-version-manager`] [`nodejs`] [`nvm`] [`switch`] [`version`] [`version-manager`] [`versioning`] [`windows`]  
...
- [ehang-io/nps](https://github.com/ehang-io/nps) ★33192 [`dns`] [`firewall`] [`go`] [`gzip`] [`http`] [`https`] [`nat`] [`nps`] [`snnapy`] [`socks`] [`socks5`] [`ssh`] [`tcp`] [`tunnel`] [`udp`]  
...
- [filebrowser/filebrowser](https://github.com/filebrowser/filebrowser) ★30593 [`file-browser`] [`file-manager`] [`file-sharing`] [`go`] [`material-design`] [`self-hosted`] [`vue`]  
  这是一个用于浏览和管理文件的Web应用程序。它使用Python和Flask框架构建，提供文件上传、下载、删除、重命名等基本操作。用户可以通过Web界面直观地查看和操作文件，支持多种文件类型。项目包含用户认证模块，确保文件访问权限安全。
- [juanfont/headscale](https://github.com/juanfont/headscale) ★30125 [`tailscale`] [`tailscale-control-server`] [`tailscale-server`] [`wireguard`]  
...
- [binwiederhier/ntfy](https://github.com/binwiederhier/ntfy) ★25439 [`curl`] [`notifications`] [`ntfy`] [`ntfysh`] [`pubsub`] [`push-notifications`] [`rest-api`]  
...
- [cloudreve/cloudreve](https://github.com/cloudreve/cloudreve) ★24309 [`cloud`] [`cloud-storage`] [`cloudreve`] [`file`] [`file-manager`] [`file-sharing`] [`golang`]  
...
- [tailscale/tailscale](https://github.com/tailscale/tailscale) ★23988 [`2fa`] [`oauth`] [`sso`] [`tailscale`] [`vpn`] [`wireguard`]  
...
- [containrrr/watchtower](https://github.com/containrrr/watchtower) ★22790 [`automation`] [`continuous-delivery`] [`devops`] [`docker`] [`hacktoberfest`] [`notifications`] [`receive-notifications`] [`registry`] [`update-checker`] [`watchtower`]  
...
- [XIU2/CloudflareSpeedTest](https://github.com/XIU2/CloudflareSpeedTest) ★22489 [`cdn`] [`cloudflare`] [`go`] [`golang`] [`speedtest`]  
...
- [chaitin/SafeLine](https://github.com/chaitin/SafeLine) ★17230 [`api-gateway`] [`application-security`] [`appsec`] [`blueteam`] [`bruteforce`] [`captcha`] [`cve`] [`cybersecurity`] [`firewall`] [`hackers`] [`http-flood`] [`security`] [`self-hosted`] [`sql-injection`] [`vulnerability`] [`waf`] [`web-application-firewall`] [`web-security`] [`websecurity`] [`xss`]  
...
- [apernet/hysteria](https://github.com/apernet/hysteria) ★16947 [`censorship-circumvention`] [`golang`] [`http-proxy`] [`hysteria`] [`proxy`] [`quic`] [`relay`] [`reliable-udp`] [`socks5`] [`tun`] [`vpn`]  
...
- [ory/hydra](https://github.com/ory/hydra) ★16393 [`authorization`] [`cloud`] [`docker`] [`federation`] [`hacktoberfest`] [`hydra`] [`identity`] [`oauth`] [`oauth-provider`] [`oauth2`] [`oauth2-provider`] [`oauth2-server`] [`oidc`] [`openid`] [`openid-connect`] [`openid-connect-provider`] [`openid-provider`] [`security`] [`server`] [`sso`]  
...
- [m1k1o/neko](https://github.com/m1k1o/neko) ★14357 [`docker`] [`golang`] [`media-streaming`] [`remote-control`] [`remote-desktop`] [`self-hosted`] [`virtual-browser`] [`vue`] [`webrtc`]  
...
- [OpenListTeam/OpenList](https://github.com/OpenListTeam/OpenList) ★13403 [`alist`] [`aliyunpan`] [`baidupan`] [`openlist`]  
...
- [coredns/coredns](https://github.com/coredns/coredns) ★13218 [`cncf`] [`coredns`] [`dns-server`] [`go`] [`plugin`] [`service-discovery`]  
...
- [gotify/server](https://github.com/gotify/server) ★13108 [`api`] [`cloud`] [`free-software`] [`golang`] [`gotify`] [`hosting`] [`javascript`] [`notifications`] [`privacy`] [`react`] [`self-hosted`] [`self-hosting`] [`selfhosted`]  
...
- [fullstorydev/grpcurl](https://github.com/fullstorydev/grpcurl) ★11849 [`golang`] [`grpc`] [`protobuf`]  
...
- [0xJacky/nginx-ui](https://github.com/0xJacky/nginx-ui) ★9183 [`chatgpt-app`] [`code-completion`] [`copilot`] [`cron`] [`deepseek-r1`] [`docker`] [`go`] [`letsencrypt`] [`linux`] [`macos`] [`mcp`] [`mcp-server`] [`nginx`] [`self-hosted`] [`vue`] [`webui`] [`windows`]  
...
- [putyy/res-downloader](https://github.com/putyy/res-downloader) ★9146 [`douyin`] [`kuaishou`] [`res-downloader`] [`wechat`] [`wechat-video`] [`xiaohongshu`]  
...
- [QuantumNous/new-api](https://github.com/QuantumNous/new-api) ★9104 [`ai-gateway`] [`claude`] [`deepseek`] [`gemini`] [`openai`] [`rerank`]  
...
- [certimate-go/certimate](https://github.com/certimate-go/certimate) ★7112 [`acme`] [`automation`] [`certbot`] [`hacktoberfest`] [`https`] [`https-certificate`] [`lego`] [`letsencrypt`] [`ssl`] [`ssl-cert`] [`ssl-certificate`] [`ssl-certificates`]  
...
- [nxtrace/NTrace-core](https://github.com/nxtrace/NTrace-core) ★6922 [`api`] [`as-path`] [`asn-lookup`] [`geoip`] [`geolocation`] [`ip-lookup`] [`network-analysis`] [`next-trace`] [`nexttrace`] [`traceroute`] [`utility`]  
...
- [goravel/goravel](https://github.com/goravel/goravel) ★3937 [`framework`] [`go`] [`golang`] [`laravel`] [`performance`] [`web`]  
...
- [qjfoidnh/BaiduPCS-Go](https://github.com/qjfoidnh/BaiduPCS-Go) ★3766 [`baidupcs`]  
...
- [kingwrcy/moments](https://github.com/kingwrcy/moments) ★1715  
  这是一个用于生成动态壁纸的Python项目。它使用Pillow库处理图像，并提供多种动态效果，例如渐变、循环、粒子特效等。用户可以通过配置参数自定义壁纸的样式和动画。项目包含预设模板和可定制参数，方便用户快速生成个性化壁纸。
- [koho/frpmgr](https://github.com/koho/frpmgr) ★1689 [`frp`] [`frpc`] [`go`] [`gui`] [`proxy`] [`reverse-proxy`] [`windows`]  
...
- [zhanghanyun/backtrace](https://github.com/zhanghanyun/backtrace) ★1205  
...
- [samwafgo/SamWaf](https://github.com/samwafgo/SamWaf) ★1060  
...
- [jgm/pandoc](https://github.com/jgm/pandoc) ★38560 [`commonmark`] [`converter`] [`document`] [`haskell`] [`markdown`] [`markup`] [`pandoc`] [`presentation`] [`publishing`]  
...
- [Stirling-Tools/Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF) ★63840 [`docker`] [`java`] [`pdf`] [`pdf-converter`] [`pdf-editor`] [`pdf-manipulation`] [`pdf-merger`] [`pdf-ocr`] [`pdf-tools`] [`pdf-web-apps`] [`pdfmerger`]  
...
- [skylot/jadx](https://github.com/skylot/jadx) ★44919 [`android`] [`decompiler`] [`dex`] [`java`]  
...
- [dbeaver/dbeaver](https://github.com/dbeaver/dbeaver) ★44591 [`database`] [`db2`] [`dbeaver`] [`erd`] [`gui`] [`java`] [`jdbc`] [`mysql`] [`nosql`] [`oracle`] [`postgresql`] [`redshift`] [`sql`] [`sqlite`] [`sqlserver`]  
...
- [termux/termux-app](https://github.com/termux/termux-app) ★43607 [`android`] [`hacktoberfest`] [`linux`] [`terminal`] [`termux`]  
...
- [halo-dev/halo](https://github.com/halo-dev/halo) ★36155 [`blog`] [`blog-engine`] [`cms`] [`content-management-system`] [`halo`] [`halocms`]  
...
- [DrKLO/Telegram](https://github.com/DrKLO/Telegram) ★27252 [`telegram`]  
...
- [microg/GmsCore](https://github.com/microg/GmsCore) ★10432 [`android`] [`auth`] [`cloud-messaging`] [`firebase`] [`geolocation`] [`google`] [`google-cloud-messaging`] [`java`] [`kotlin`] [`kotlin-android`] [`maps`] [`microg`] [`mobile`] [`push-notifications`]  
...
- [wildfirechat/im-server](https://github.com/wildfirechat/im-server) ★8250 [`im`] [`voip`]  
...
- [201206030/novel](https://github.com/201206030/novel) ★5388 [`book`] [`cms`] [`mybatis`] [`novel`] [`read`] [`springboot`]  
...
- [Fuzion24/JustTrustMe](https://github.com/Fuzion24/JustTrustMe) ★5101  
...
- [Exrick/xpay](https://github.com/Exrick/xpay) ★5006  
...
- [SuperMonster003/AutoJs6](https://github.com/SuperMonster003/AutoJs6) ★4328 [`android`] [`autojs`] [`autojs6`] [`automated-tool`] [`automation`] [`javascript`]  
...
- [niumoo/bing-wallpaper](https://github.com/niumoo/bing-wallpaper) ★2895 [`bing`] [`bing-image`] [`bing-wallpaper`] [`wallpaper`]  
...
- [qaiu/netdisk-fast-download](https://github.com/qaiu/netdisk-fast-download) ★1989 [`api`] [`download`] [`drive`] [`file-server`] [`ilanzou`] [`java`] [`netdisk-fast-download`] [`onedrive`] [`parser`] [`share`] [`vertx`] [`webserver`] [`yunpan`]  
...
- [aizuda/snail-job](https://github.com/aizuda/snail-job) ★667 [`mybatis-plus`] [`retry`] [`scheduler`]  
...
- [louislam/uptime-kuma](https://github.com/louislam/uptime-kuma) ★72495 [`docker`] [`monitor`] [`monitoring`] [`responsive`] [`self-hosted`] [`selfhosted`] [`single-page-app`] [`socket-io`] [`uptime`] [`uptime-monitoring`] [`webapp`] [`websocket`]  
...
- [mozilla/pdf.js](https://github.com/mozilla/pdf.js) ★51407  
...
- [marktext/marktext](https://github.com/marktext/marktext) ★50680 [`dark-mode`] [`editor`] [`electron`] [`element-ui`] [`emoji`] [`focus-mode`] [`latex`] [`linux`] [`mac`] [`macos`] [`markdown`] [`marktext`] [`next-generation`] [`source-code`] [`typewriter-mode`] [`vue`] [`windows`]  
...
- [agalwood/Motrix](https://github.com/agalwood/Motrix) ★48598 [`aria2`] [`bittorrent`] [`bt`] [`download`] [`download-manager`] [`electron`] [`linux`] [`mac`] [`macos`] [`magnet`] [`motrix`] [`torrent`] [`windows`]  
...
- [LeCoupa/awesome-cheatsheets](https://github.com/LeCoupa/awesome-cheatsheets) ★43117 [`backend`] [`bash`] [`cheatsheet`] [`cheatsheets`] [`database`] [`django`] [`docker`] [`feathersjs`] [`frontend`] [`javascript`] [`kubernetes`] [`language`] [`nodejs`] [`php`] [`programming-language`] [`redis`] [`sailsjs`] [`vim`] [`vuejs`] [`xcode`]  
...
- [NaiboWang/EasySpider](https://github.com/NaiboWang/EasySpider) ★41072 [`batch-processing`] [`batch-script`] [`code-free`] [`crawler`] [`data-collection`] [`frontend`] [`gui`] [`html`] [`input-parameters`] [`layman`] [`parameters`] [`robotics`] [`rpa`] [`scraper`] [`spider`] [`visual`] [`visualization`] [`visualprogramming`] [`web`] [`www`]  
...
- [HeyPuter/puter](https://github.com/HeyPuter/puter) ★34362 [`cloud`] [`cloud-os`] [`cloud-storage`] [`desktop`] [`desktop-environment`] [`dropbox`] [`good-first-issue`] [`gui`] [`javascript`] [`nas`] [`open-source`] [`operating-system`] [`os`] [`osjs`] [`puter`] [`remote-desktop`] [`storage`] [`web-desktop`] [`web-os`] [`webtop`]  
...
- [qishibo/AnotherRedisDesktopManager](https://github.com/qishibo/AnotherRedisDesktopManager) ★32831 [`redis`] [`redis-client`] [`redis-cluster`] [`redis-desktop-manager`] [`redis-gui`]  
...
- [NginxProxyManager/nginx-proxy-manager](https://github.com/NginxProxyManager/nginx-proxy-manager) ★27737 [`nginx`] [`nginx-proxy`]  
...
- [quasarframework/quasar](https://github.com/quasarframework/quasar) ★26741 [`android`] [`browser-extension`] [`electron`] [`ios`] [`javascript`] [`material`] [`material-components`] [`material-design`] [`material-theme`] [`pwa`] [`quasar-framework`] [`server-side-rendering`] [`ssr`] [`vue`] [`vue-component`] [`vue-components`] [`vue3`] [`vuejs`] [`vuejs3`]  
...
- [songquanpeng/one-api](https://github.com/songquanpeng/one-api) ★26424 [`api`] [`api-gateway`] [`azure-openai-api`] [`chatgpt`] [`claude`] [`ernie-bot`] [`gemini`] [`gpt`] [`openai`] [`openai-api`] [`proxy`]  
...
- [fanmingming/live](https://github.com/fanmingming/live) ★26094 [`china`] [`converter`] [`epg`] [`iptv`] [`ipv6`] [`live`] [`m3u`] [`m3u8`] [`mp4`] [`radio`] [`television`] [`tv`] [`txt`] [`workers`]  
...
- [Z-Siqi/Clash-for-Windows_Chinese](https://github.com/Z-Siqi/Clash-for-Windows_Chinese) ★25504 [`chinese`] [`clash`] [`clash-chinese`] [`shadowsocks`] [`windows`] [`zh-cn`]  
...
- [tailwindlabs/heroicons](https://github.com/tailwindlabs/heroicons) ★22706  
...
- [blackmatrix7/ios_rule_script](https://github.com/blackmatrix7/ios_rule_script) ★21940  
...
- [chokcoco/iCSS](https://github.com/chokcoco/iCSS) ★20518 [`css`] [`css3`]  
...
- [liriliri/eruda](https://github.com/liriliri/eruda) ★19960 [`console`] [`debugger`] [`developer-tools`] [`eruda`] [`mobile`]  
...
- [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) ★19664 [`address`] [`administrative-divisions`] [`area`] [`china`] [`city`] [`csv`] [`json`] [`nodejs`] [`province`] [`street`]  
...
- [SnapDrop/snapdrop](https://github.com/SnapDrop/snapdrop) ★19446 [`pwa`] [`snapdrop`] [`webrtc`]  
...
- [docmirror/dev-sidecar](https://github.com/docmirror/dev-sidecar) ★18761 [`dev-sidecar`] [`dns-ip`] [`electron`] [`fastgit`] [`fastgithub`] [`gfw`] [`internet`] [`lerna`] [`mitmproxy`] [`proxy`]  
...
- [SocialSisterYi/bilibili-API-collect](https://github.com/SocialSisterYi/bilibili-API-collect) ★18319 [`api`] [`bilibili`] [`bilibili-api`] [`bilibili-comment`] [`bilibili-danmaku`] [`bilibili-download`] [`bilibili-live`] [`bilibili-login`] [`grpc`] [`json`]  
...
- [sweetalert2/sweetalert2](https://github.com/sweetalert2/sweetalert2) ★17776 [`accessible`] [`alert`] [`angular`] [`confirm`] [`confirmation-dialog`] [`dialog`] [`modal`] [`notifications`] [`popup`] [`prompt`] [`react`] [`sweetalert`] [`sweetalert2`] [`toast`] [`vue`] [`wai-aria`]  
...
- [SillyTavern/SillyTavern](https://github.com/SillyTavern/SillyTavern) ★16823 [`ai`] [`chat`] [`llm`]  
...
- [xifangczy/cat-catch](https://github.com/xifangczy/cat-catch) ★14816 [`chrome`] [`chrome-extension`] [`firefox`] [`firefox-extension`] [`javascript`] [`jquery`] [`m3u8-downloader`] [`video-downloader`]  
  这是一个用于捕捉图像中猫的Python项目。它利用OpenCV库进行图像处理，并使用深度学习模型（例如YOLOv5）来检测和定位猫。项目提供预训练模型，并支持自定义模型训练。用户可以轻松地将项目集成到其他应用程序中，以实现猫的自动识别和追踪。
- [pot-app/pot-desktop](https://github.com/pot-app/pot-desktop) ★14600 [`linux`] [`macos`] [`ocr`] [`pot`] [`pot-app`] [`recognize`] [`tauri`] [`translate`] [`translation`] [`tts`] [`windows`]  
...
- [dexie/Dexie.js](https://github.com/dexie/Dexie.js) ★13339 [`database`] [`indexeddb`] [`javascript`] [`offline`] [`offline-storage`] [`storage`]  
...
- [Semporia/TikTok-Unlock](https://github.com/Semporia/TikTok-Unlock) ★11378 [`tiktok`] [`tiktok-unlock`] [`unlock`]  
...
- [stevenjoezhang/live2d-widget](https://github.com/stevenjoezhang/live2d-widget) ★9880 [`javascript-plugin`] [`live2d`]  
...
- [tangly1024/NotionNext](https://github.com/tangly1024/NotionNext) ★9830 [`blog`] [`nextjs`] [`notion`] [`react`] [`tailwindcss`] [`vercel`] [`zeabur`]  
...
- [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) ★9773 [`analytics`] [`bot-detection`] [`browser-detection`] [`client-hints`] [`device-detection`] [`mobile-detection`] [`user-agent`] [`user-agent-parser`]  
...
- [cmliu/CF-Workers-docker.io](https://github.com/cmliu/CF-Workers-docker.io) ★8448 [`cloudflare-pages`] [`cloudflare-workers`] [`docker`] [`dockerhub`]  
...
- [bndw/wifi-card](https://github.com/bndw/wifi-card) ★6895 [`dogs-over-cats`] [`qrcode`] [`react`] [`wifi`] [`wificard`]  
...
- [lrsjng/h5ai](https://github.com/lrsjng/h5ai) ★5801 [`apache`] [`apache2`] [`h5ai`] [`index`] [`lighttpd`] [`nginx`]  
...
- [zumerlab/snapdom](https://github.com/zumerlab/snapdom) ★3892 [`capture-screenshots`] [`clone`] [`dom`] [`js`] [`screenshot`]  
...
- [BrowserBox/BrowserBox](https://github.com/BrowserBox/BrowserBox) ★3657 [`browser`] [`cdr`] [`chrome`] [`cobrowsing`] [`cybersecurity`] [`embeddable`] [`hidden-services`] [`multiplayer`] [`onion-service`] [`proxy-server`] [`rbi`] [`remote-browser-isolation`] [`remote-browsers`] [`reverse-proxy`] [`sanitization`] [`tor`] [`web-browser`] [`web-isolation`] [`webrtc`] [`zero-trust`]  
...
- [tangyoha/telegram_media_downloader](https://github.com/tangyoha/telegram_media_downloader) ★3650 [`cosplatfrom`] [`cross-platform`] [`downloader`] [`flask`] [`media-downloader`] [`telegram-bot`]  
...
- [certd/certd](https://github.com/certd/certd) ★3459 [`acme`] [`auto`] [`automation`] [`cert`] [`certbot`] [`letencrypt`] [`ssl`] [`ssl-certificate`]  
...
- [gongfuxiang/shopxo](https://github.com/gongfuxiang/shopxo) ★2952 [`b2c`] [`shop`] [`shopxo`] [`shopxo-b2c`] [`thinkphp`]  
...
- [PublicAffairs/openai-gemini](https://github.com/PublicAffairs/openai-gemini) ★2634 [`chatgpt-api`] [`gemini`] [`gemini-ai`] [`openai`] [`proxy`] [`serverless`]  
...
- [FranckFreiburger/vue-pdf](https://github.com/FranckFreiburger/vue-pdf) ★2289 [`component`] [`pdf`] [`pdf-viewer`] [`vue-pdf`] [`vuejs2`]  
...
- [monkeyWie/gopeed-extension-baiduwp](https://github.com/monkeyWie/gopeed-extension-baiduwp) ★1526 [`baidunetdisk`] [`baiduwangpan`] [`baiduyun`] [`gopeed-extension`]  
...
- [Pactum7/ticket-grabbing](https://github.com/Pactum7/ticket-grabbing) ★1392  
...
- [CcSimple/vue-plugin-hiprint](https://github.com/CcSimple/vue-plugin-hiprint) ★1379 [`design`] [`print`] [`report`] [`vue`]  
...
- [acgotaku/YAAW-for-Chrome](https://github.com/acgotaku/YAAW-for-Chrome) ★1225  
  Y
...
- [xianhu/LearnPython](https://github.com/xianhu/LearnPython) ★8090 [`learning-python`] [`python`] [`python-flask`] [`python-requests`]  
...
- [topjohnwu/Magisk](https://github.com/topjohnwu/Magisk) ★54799  
...
- [2dust/v2rayNG](https://github.com/2dust/v2rayNG) ★43191 [`android`] [`proxy`] [`shadowsocks`] [`socks5`] [`trojan`] [`v2fly`] [`v2ray`] [`vless`] [`vmess`] [`vpn`] [`xray`] [`xtls`]  
...
- [gkd-kit/gkd](https://github.com/gkd-kit/gkd) ★29861 [`accessibility`] [`android`] [`auto`] [`click`] [`compose`] [`jetpack-compose`] [`kotlin`] [`kotlin-js`] [`kotlin-multiplatform`] [`webassembly`]  
...
- [MetaCubeX/ClashMetaForAndroid](https://github.com/MetaCubeX/ClashMetaForAndroid) ★25183  
...
- [pppscn/SmsForwarder](https://github.com/pppscn/SmsForwarder) ★22087 [`android`] [`api`] [`app`] [`bark`] [`call`] [`chatgpt`] [`dingding`] [`forward`] [`mqtt`] [`pushdear`] [`pushplus`] [`serverchan`] [`sms`] [`smtp`] [`telegram`] [`webhook`] [`wechatapp`]  
...
- [RikkaApps/Shizuku](https://github.com/RikkaApps/Shizuku) ★15904  
...
- [MatsuriDayo/NekoBoxForAndroid](https://github.com/MatsuriDayo/NekoBoxForAndroid) ★15218 [`android`] [`gfw`] [`proxy`] [`shadowsocks`] [`sing-box`] [`trojan`] [`vmess`] [`vpn`]  
...
- [mihonapp/mihon](https://github.com/mihonapp/mihon) ★14780 [`android`] [`kotlin`] [`manga`] [`manga-downloader`] [`manga-reader`] [`mangadownloader`] [`mangareader`] [`tachiyomi`] [`tachiyomi-alternative`]  
...
- [open-ani/animeko](https://github.com/open-ani/animeko) ★9227 [`android`] [`ani`] [`anime`] [`bangumi`] [`bittorrent`] [`bt`] [`compose`] [`compose-multiplatform`] [`danmaku`] [`ios`] [`jetpack-compose`] [`kotlin`] [`kotlin-multiplatform`] [`linux`] [`macos`] [`player`] [`torrent`] [`video`] [`windows`]  
...
- [bitwarden/android](https://github.com/bitwarden/android) ★7626 [`android`] [`bitwarden`] [`compose`] [`jetpack`] [`kotlin`]  
...
- [zhanghai/MaterialFiles](https://github.com/zhanghai/MaterialFiles) ★7203 [`android`] [`android-application`] [`file-manager`] [`kotlin`] [`kotlin-android`] [`material-design`]  
...
- [running-libo/Tiktok](https://github.com/running-libo/Tiktok) ★2944  
...
- [Kong/kong](https://github.com/Kong/kong) ★41413 [`ai`] [`ai-gateway`] [`api-gateway`] [`api-management`] [`apis`] [`artificial-intelligence`] [`cloud-native`] [`devops`] [`kubernetes`] [`kubernetes-ingress`] [`kubernetes-ingress-controller`] [`llm-gateway`] [`llm-ops`] [`luajit`] [`microservice`] [`microservices`] [`nginx`] [`openai-proxy`] [`reverse-proxy`] [`serverless`]  
...
- [iDvel/rime-ice](https://github.com/iDvel/rime-ice) ★12354 [`rime`] [`rime-config`] [`rime-custom`] [`rime-schema`] [`rime-squirrel`] [`rime-weasel`]  
...
- [cheat-engine/cheat-engine](https://github.com/cheat-engine/cheat-engine) ★16638  
...
- [ScoopInstaller/Scoop](https://github.com/ScoopInstaller/Scoop) ★22678 [`installer`] [`powershell`] [`scoop`] [`windows`]  
...
- [TapXWorld/ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook) ★46184  
...
- [pyenv/pyenv](https://github.com/pyenv/pyenv) ★42747 [`python`] [`shell`]  
...
- [greatghoul/remote-working](https://github.com/greatghoul/remote-working) ★11011 [`china`] [`freelancer`] [`remote-work`] [`remote-workers`] [`soho`] [`telecommunications`] [`work-from-home`]  
...
- [imputnet/cobalt](https://github.com/imputnet/cobalt) ★35407 [`collaboration`] [`downloader`] [`instagram`] [`javascript`] [`music`] [`reddit`] [`social-media`] [`soundcloud`] [`svelte`] [`tiktok`] [`twitter`] [`typescript`] [`video`] [`vimeo`] [`vk`] [`webapp`] [`youtube`] [`youtube-downloader`]  
...
- [iptv-org/iptv](https://github.com/iptv-org/iptv) ★95830 [`iptv`] [`m3u`] [`playlist`] [`streams`] [`tv`]  
...
- [ant-design/ant-design](https://github.com/ant-design/ant-design) ★95501 [`ant-design`] [`antd`] [`design-systems`] [`react`] [`typescript`] [`ui-kit`] [`ui-library`]  
...
- [tailwindlabs/tailwindcss](https://github.com/tailwindlabs/tailwindcss) ★89306 [`css`] [`css-framework`] [`functional-css`] [`postcss`] [`responsive`] [`tailwindcss`] [`utility-classes`]  
...
- [ChatGPTNextWeb/NextChat](https://github.com/ChatGPTNextWeb/NextChat) ★85219 [`calclaude`] [`chatgpt`] [`claude`] [`cross-platform`] [`desktop`] [`fe`] [`gemini`] [`gemini-pro`] [`gemini-server`] [`gemini-ultra`] [`gpt-4o`] [`groq`] [`nextjs`] [`ollama`] [`react`] [`tauri`] [`tauri-app`] [`vercel`] [`webui`]  
...
- [mermaid-js/mermaid](https://github.com/mermaid-js/mermaid) ★81708 [`diagrams`] [`diagrams-as-code`] [`documentation`] [`flowchart`] [`javascript`] [`mindmap`] [`typescript`] [`uml-diagrams`]  
...
- [hoppscotch/hoppscotch](https://github.com/hoppscotch/hoppscotch) ★73223 [`api`] [`api-client`] [`api-rest`] [`api-testing`] [`developer-tools`] [`graphql`] [`hacktoberfest`] [`http`] [`http-client`] [`pwa`] [`rest`] [`rest-api`] [`spa`] [`testing`] [`testing-tools`] [`tools`] [`vue`] [`vuejs`] [`websocket`]  
...
- [immich-app/immich](https://github.com/immich-app/immich) ★71656 [`backup-tool`] [`flutter`] [`google-photos`] [`google-photos-alternative`] [`javascript`] [`mobile-app`] [`nestjs`] [`nodejs`] [`photo-gallery`] [`photos`] [`photos-management`] [`self-hosted`] [`svelte`] [`sveltekit`] [`typescript`] [`videos`]  
...
- [clash-verge-rev/clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev) ★67968 [`clash`] [`clash-meta`] [`clash-verge`] [`linux`] [`mac`] [`mihomo`] [`tauri-app`] [`windows`]  
...
- [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) ★65579 [`gemini`] [`gemini-api`]  
...
- [lobehub/lobe-chat](https://github.com/lobehub/lobe-chat) ★63909 [`agent`] [`ai`] [`artifacts`] [`chat`] [`chatgpt`] [`claude`] [`deepseek`] [`deepseek-r1`] [`function-calling`] [`gemini`] [`gpt`] [`knowledge-base`] [`mcp`] [`nextjs`] [`ollama`] [`openai`] [`rag`]  
...
- [nocodb/nocodb](https://github.com/nocodb/nocodb) ★56132 [`airtable`] [`airtable-alternative`] [`automatic-api`] [`hacktoberfest`] [`low-code`] [`no-code`] [`no-code-database`] [`no-code-platform`] [`postgresql`] [`rest-api`] [`restful-api`] [`spreadsheet`] [`sqlite`] [`swagger`]  
...
- [lyswhut/lx-music-desktop](https://github.com/lyswhut/lx-music-desktop) ★45483 [`electron`] [`javascript`] [`music-player`] [`vue`]  
...
- [mendableai/firecrawl](https://github.com/mendableai/firecrawl) ★43741 [`ai`] [`ai-scraping`] [`crawler`] [`data`] [`html-to-markdown`] [`llm`] [`markdown`] [`rag`] [`scraper`] [`scraping`] [`web-crawler`] [`webscraping`]  
...
- [DIYgod/RSSHub](https://github.com/DIYgod/RSSHub) ★38032 [`bilibili`] [`douban`] [`dribbble`] [`instagram`] [`lofter`] [`pixiv`] [`rss`] [`rsshub`] [`spotify`] [`telegram`] [`tiktok`] [`twitter`] [`v2ex`] [`wechat`] [`weibo`] [`ximalaya`] [`youtube`] [`zhihu`]  
...
- [RSSNext/Folo](https://github.com/RSSNext/Folo) ★30362 [`ai`] [`blockchain`] [`reader`] [`rss`] [`rss-reader`]  
...
- [umami-software/umami](https://github.com/umami-software/umami) ★27536 [`analytics`] [`charts`] [`google-analytics`] [`statistics`] [`web-analytics`]  
...
- [oldj/SwitchHosts](https://github.com/oldj/SwitchHosts) ★25429 [`electron`] [`hosts`] [`hostseditor`] [`hostsfile`] [`switch-hosts`] [`switchhosts`]  
...
- [fingerprintjs/fingerprintjs](https://github.com/fingerprintjs/fingerprintjs) ★25158 [`audio-fingerprinting`] [`browser`] [`browser-fingerprint`] [`browser-fingerprinting`] [`detection`] [`fingerprint`] [`fingerprinting`] [`fingerprintjs`] [`fraud`] [`fraud-detection`] [`identification`] [`javascript`] [`visitor-identifier`]  
...
- [blakeblackshear/frigate](https://github.com/blakeblackshear/frigate) ★24141 [`ai`] [`camera`] [`google-coral`] [`home-assistant`] [`home-automation`] [`homeautomation`] [`mqtt`] [`nvr`] [`object-detection`] [`realtime`] [`rtsp`] [`tensorflow`]  
...
- [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ★20493  
...
- [maotoumao/MusicFree](https://github.com/maotoumao/MusicFree) ★19076 [`free`] [`music-player`] [`musicfree`] [`plugin`] [`react`] [`react-native`] [`typescript`]  
...
- [louislam/dockge](https://github.com/louislam/dockge) ★18882 [`docker`] [`docker-compose`] [`docker-deployment`] [`docker-stack`] [`docker-stack-deploy`] [`docker-ui`] [`responsive`] [`self-hosted`] [`selfhosted`] [`single-page-app`] [`socket-io`] [`webapp`] [`websocket`]  
...
- [whyour/qinglong](https://github.com/whyour/qinglong) ★18097 [`crontab`] [`docker`] [`javascript`] [`python`] [`shell`] [`task-manager`] [`typescript`]  
...
- [wangeditor-team/wangEditor](https://github.com/wangeditor-team/wangEditor) ★18022 [`rich-text`] [`rich-text-html-editor`] [`typescript`] [`wangeditor`] [`wysiwyg`] [`wysiwyg-editor`]  
...
- [apitable/apitable](https://github.com/apitable/apitable) ★14747 [`admin-dashboard`] [`airtable`] [`airtable-alternative`] [`api`] [`automatic-api`] [`embed`] [`hacktoberfest`] [`internal-tool`] [`javascript`] [`low-code`] [`nestjs`] [`nextjs`] [`no-code`] [`nocodb`] [`notion`] [`react`] [`spreadsheet`] [`spring`] [`typescript`]  
...
- [ag-grid/ag-grid](https://github.com/ag-grid/ag-grid) ★14240 [`angular`] [`angular-grid`] [`angular-table`] [`charting`] [`datagrid`] [`datatable`] [`excel`] [`filtering`] [`grid`] [`grouping`] [`javascript-table`] [`pagination`] [`pivoting`] [`react`] [`react-grid`] [`react-table`] [`sorting`] [`table`] [`vue-table`] [`vuejs`]  
...
- [ourongxing/newsnow](https://github.com/ourongxing/newsnow) ★12229 [`elegant`] [`news`]  
...
- [idootop/mi-gpt](https://github.com/idootop/mi-gpt) ★11390  
...
- [getAsterisk/claudia](https://github.com/getAsterisk/claudia) ★10193 [`anthropic`] [`anthropic-claude`] [`claude`] [`claude-4`] [`claude-4-opus`] [`claude-4-sonnet`] [`claude-ai`] [`claude-code`] [`claude-code-sdk`] [`cursor`] [`ide`] [`llm`] [`llm-code`] [`rust`] [`tauri`]  
...
- [jackyzha0/quartz](https://github.com/jackyzha0/quartz) ★9654 [`digital-garden`] [`networked-thought`] [`obsidian`] [`obsidian-md`] [`quartz-ssg`] [`static-site-generator`]  
...
- [dream-num/univer](https://github.com/dream-num/univer) ★9467 [`appscript`] [`collaboration`] [`data-table`] [`doc`] [`document`] [`excel`] [`grid`] [`live-share`] [`office`] [`powerpoint`] [`ppt`] [`productivity`] [`sdk`] [`sheet`] [`slide`] [`spreadsheet`] [`word`] [`xlsx`]  
  这是一个用于生成各种类型的数字序列的工具。它支持算术、几何、斐波那契、卢卡斯等多种序列类型，并允许用户自定义序列规则。该工具使用Python语言开发，基于NumPy库进行数值计算，并提供简洁的API接口，方便用户快速生成所需序列。
- [ayangweb/BongoCat](https://github.com/ayangweb/BongoCat) ★8908 [`bongo-cat`] [`bongocat`] [`cross-platform`] [`desktop-app`] [`desktop-pet`] [`linux`] [`macos`] [`pet`] [`pet-project`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [musistudio/claude-code-router](https://github.com/musistudio/claude-code-router) ★8804  
...
- [gridstack/gridstack.js](https://github.com/gridstack/gridstack.js) ★8203 [`angular`] [`dashboard`] [`grid`] [`gridster`] [`javascript`] [`react`] [`typescript`] [`vue`] [`widget`]  
...
- [alibaba/x-render](https://github.com/alibaba/x-render) ★7567 [`ant`] [`ant-design`] [`chart`] [`form`] [`formrender`] [`javascript`] [`json-schema`] [`list`] [`react`] [`table`] [`typescript`] [`webpack`] [`widget`]  
...
- [AIsouler/GKD_subscription](https://github.com/AIsouler/GKD_subscription) ★7060 [`gkd`] [`gkd-subscription`] [`typescript`]  
...
- [remotely-save/remotely-save](https://github.com/remotely-save/remotely-save) ★5827  
...
- [dushixiang/next-terminal](https://github.com/dushixiang/next-terminal) ★5126 [`antd`] [`antd-design`] [`docker`] [`go`] [`golang`] [`guacamole`] [`rdp`] [`react`] [`ssh`] [`vnc`]  
...
- [EcoPasteHub/EcoPaste](https://github.com/EcoPasteHub/EcoPaste) ★4854 [`application`] [`clipboard`] [`clipboard-manager`] [`cross-platform`] [`desktop-app`] [`desktop-application`] [`linux`] [`macos`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [drawrowfly/tiktok-scraper](https://github.com/drawrowfly/tiktok-scraper) ★4785  
...
- [galaxy-s10/billd-desk](https://github.com/galaxy-s10/billd-desk) ★3571 [`coturn`] [`electron`] [`flutter`] [`nodejs`] [`parsec`] [`remote-desktop`] [`rustdesk`] [`socket-io`] [`todesk`] [`typescript`] [`vue3`] [`webrtc`]  
...
- [LLOneBot/LLOneBot](https://github.com/LLOneBot/LLOneBot) ★2685 [`llob`] [`llonebot`] [`onebot`] [`onebot11`] [`qqbot`] [`satori`]  
...
- [NetrisTV/ws-scrcpy](https://github.com/NetrisTV/ws-scrcpy) ★2049 [`android`] [`browser`] [`control`] [`javascript`] [`mirroring`] [`mobile`] [`phone`] [`remote`] [`remote-control`] [`scrcpy`] [`screen`] [`typescript`] [`websocket`]  
...
- [xpf0000/FlyEnv](https://github.com/xpf0000/FlyEnv) ★1900 [`development-environment`] [`electron`] [`laravel`] [`laravel-herd`] [`local-dns-server`] [`local-web-server`] [`mamp`] [`mamp-pro`] [`php`] [`php-environment`] [`php-obfuscator`] [`phpstudy`] [`web-ide`] [`wordpress`] [`xampp`]  
...
- [pt-plugins/PT-depiler](https://github.com/pt-plugins/PT-depiler) ★939 [`private-tracker`]  
...
- [Cloxl/CursorPool_Client](https://github.com/Cloxl/CursorPool_Client) ★543  
