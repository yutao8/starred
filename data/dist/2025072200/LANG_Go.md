...
- [ehang-io/nps](https://github.com/ehang-io/nps) ★33135 [`dns`] [`firewall`] [`go`] [`gzip`] [`http`] [`https`] [`nat`] [`nps`] [`snnapy`] [`socks`] [`socks5`] [`ssh`] [`tcp`] [`tunnel`] [`udp`]  
...
- [schollz/croc](https://github.com/schollz/croc) ★30624 [`data-transfer`] [`file-sharing`] [`golang`] [`pake`] [`peer-to-peer`] [`tcp`] [`transfer`]  
...
- [filebrowser/filebrowser](https://github.com/filebrowser/filebrowser) ★30426 [`file-browser`] [`file-manager`] [`file-sharing`] [`go`] [`material-design`] [`self-hosted`] [`vue`]  
  这是一个用于浏览和管理文件的Web应用程序。它使用Python和Flask框架构建，提供文件上传、下载、删除、重命名等基本操作。用户可以通过Web界面直观地查看和操作文件，支持多种文件类型。项目包含用户认证模块，确保文件访问权限安全。
- [juanfont/headscale](https://github.com/juanfont/headscale) ★29927 [`tailscale`] [`tailscale-control-server`] [`tailscale-server`] [`wireguard`]  
...
- [binwiederhier/ntfy](https://github.com/binwiederhier/ntfy) ★25237 [`curl`] [`notifications`] [`ntfy`] [`ntfysh`] [`pubsub`] [`push-notifications`] [`rest-api`]  
...
- [cloudreve/cloudreve](https://github.com/cloudreve/cloudreve) ★24128 [`cloud`] [`cloud-storage`] [`cloudreve`] [`file`] [`file-manager`] [`file-sharing`] [`golang`]  
...
- [tailscale/tailscale](https://github.com/tailscale/tailscale) ★23805 [`2fa`] [`oauth`] [`sso`] [`tailscale`] [`vpn`] [`wireguard`]  
...
- [containrrr/watchtower](https://github.com/containrrr/watchtower) ★22695 [`automation`] [`continuous-delivery`] [`devops`] [`docker`] [`hacktoberfest`] [`notifications`] [`receive-notifications`] [`registry`] [`update-checker`] [`watchtower`]  
...
- [XIU2/CloudflareSpeedTest](https://github.com/XIU2/CloudflareSpeedTest) ★22383 [`cdn`] [`cloudflare`] [`go`] [`golang`] [`speedtest`]  
...
- [chaitin/SafeLine](https://github.com/chaitin/SafeLine) ★17141 [`api-gateway`] [`application-security`] [`appsec`] [`blueteam`] [`bruteforce`] [`captcha`] [`cve`] [`cybersecurity`] [`firewall`] [`hackers`] [`http-flood`] [`security`] [`self-hosted`] [`sql-injection`] [`vulnerability`] [`waf`] [`web-application-firewall`] [`web-security`] [`websecurity`] [`xss`]  
...
- [jeessy2/ddns-go](https://github.com/jeessy2/ddns-go) ★14835 [`alidns`] [`baiduyun`] [`cloudflare`] [`ddns`] [`ddns-go`] [`dnspod`] [`godaddy-ddns`] [`google-domains`] [`porkbun`]  
...
- [gotify/server](https://github.com/gotify/server) ★13055 [`api`] [`cloud`] [`free-software`] [`golang`] [`gotify`] [`hosting`] [`javascript`] [`notifications`] [`privacy`] [`react`] [`self-hosted`] [`self-hosting`] [`selfhosted`]  
...
- [OpenListTeam/OpenList](https://github.com/OpenListTeam/OpenList) ★12601 [`alist`] [`aliyunpan`] [`baidupan`] [`openlist`]  
...
- [m1k1o/neko](https://github.com/m1k1o/neko) ★12026 [`docker`] [`golang`] [`media-streaming`] [`remote-control`] [`remote-desktop`] [`self-hosted`] [`virtual-browser`] [`vue`] [`webrtc`]  
...
- [casdoor/casdoor](https://github.com/casdoor/casdoor) ★11902 [`auth`] [`authentication`] [`authn`] [`casbin`] [`casdoor`] [`faceid`] [`iam`] [`kerberos`] [`ldap`] [`mfa`] [`oauth`] [`oidc`] [`payment-gateway`] [`radius`] [`saml`] [`scim`] [`single-sign-on`] [`sso`] [`totp`] [`webauthn`]  
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) ★11068 [`argo-tunnel`] [`cloudflare`] [`cloudflare-tunnel`] [`reverse-proxy`] [`zero-trust-network-access`]  
...
- [0xJacky/nginx-ui](https://github.com/0xJacky/nginx-ui) ★9123 [`chatgpt-app`] [`code-completion`] [`copilot`] [`cron`] [`deepseek-r1`] [`docker`] [`go`] [`letsencrypt`] [`linux`] [`macos`] [`mcp`] [`mcp-server`] [`nginx`] [`self-hosted`] [`vue`] [`webui`] [`windows`]  
...
- [putyy/res-downloader](https://github.com/putyy/res-downloader) ★8997 [`douyin`] [`kuaishou`] [`res-downloader`] [`wechat`] [`wechat-video`] [`xiaohongshu`]  
...
- [gokcehan/lf](https://github.com/gokcehan/lf) ★8409 [`file-manager`] [`terminal`]  
...
- [certimate-go/certimate](https://github.com/certimate-go/certimate) ★7057 [`acme`] [`automation`] [`certbot`] [`hacktoberfest`] [`https`] [`https-certificate`] [`lego`] [`letsencrypt`] [`ssl`] [`ssl-cert`] [`ssl-certificate`] [`ssl-certificates`]  
...
- [ViRb3/wgcf](https://github.com/ViRb3/wgcf) ★6892 [`client`] [`cloudflare`] [`plus`] [`security`] [`vpn`] [`warp`] [`wireguard`]  
...
- [gdy666/lucky](https://github.com/gdy666/lucky) ★6025 [`acme`] [`aliyunpan`] [`cron`] [`ddns`] [`dynadot`] [`filebrowser`] [`ftp`] [`ipv6`] [`socat`] [`stun`] [`vercel`] [`volcengine`] [`webdav`] [`wol`]  
...
- [git-jiadong/wechatDataBackup](https://github.com/git-jiadong/wechatDataBackup) ★5202 [`wechat`] [`wechat-app`] [`wechat-bot`]  
...
- [hacdias/webdav](https://github.com/hacdias/webdav) ★4546 [`filesystem`] [`go`] [`http`] [`server`] [`webdav`]  
...
- [qjfoidnh/BaiduPCS-Go](https://github.com/qjfoidnh/BaiduPCS-Go) ★3737 [`baidupcs`]  
...
- [samwafgo/SamWaf](https://github.com/samwafgo/SamWaf) ★1040  
