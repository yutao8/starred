...
- [rustdesk/rustdesk](https://github.com/rustdesk/rustdesk) ★94025 [`anydesk`] [`dart`] [`flutter`] [`flutter-apps`] [`flutter-desktop`] [`flutter-examples`] [`flutter-mobile`] [`flutter-ui`] [`flutter-web`] [`hacktoberfest`] [`linux`] [`p2p`] [`rdp`] [`remote-control`] [`remote-desktop`] [`rust`] [`rust-lang`] [`teamviewer`] [`vnc`] [`wayland`]  
...
- [zed-industries/zed](https://github.com/zed-industries/zed) ★63053 [`gpui`] [`rust-lang`] [`text-editor`] [`zed`]  
...
- [lencx/ChatGPT](https://github.com/lencx/ChatGPT) ★53929 [`ai`] [`app`] [`application`] [`chatgpt`] [`desktop-app`] [`gpt`] [`gpt-3`] [`linux`] [`macos`] [`notes-app`] [`openai`] [`rust`] [`tauri`] [`webview`] [`windows`]  
...
- [starship/starship](https://github.com/starship/starship) ★50186 [`bash`] [`fish`] [`fish-prompt`] [`fish-theme`] [`oh-my-zsh`] [`powershell`] [`rust`] [`shell-prompt`] [`starship`] [`zsh`] [`zsh-prompt`] [`zsh-theme`]  
...
- [dani-garcia/vaultwarden](https://github.com/dani-garcia/vaultwarden) ★47303 [`bitwarden`] [`bitwarden-rs`] [`docker`] [`rocket`] [`rust`] [`vaultwarden`]  
...
- [tw93/Pake](https://github.com/tw93/Pake) ★40379 [`chatgpt`] [`deepseek`] [`excalidraw`] [`gemini`] [`gemini-ai`] [`high-performance`] [`linux-desktop`] [`llm`] [`mac`] [`mac-desktop`] [`music`] [`no-electron`] [`openai`] [`productivity`] [`programming`] [`rust`] [`tauri`] [`twitter`] [`windows-desktop`] [`youtube`]  
...
- [TabbyML/tabby](https://github.com/TabbyML/tabby) ★31835 [`ai`] [`codegen`] [`coding-assistant`] [`coding-language`] [`developer-experience`] [`developer-tools`] [`gen-ai`] [`ide`] [`llms`]  
...
- [fish-shell/fish-shell](https://github.com/fish-shell/fish-shell) ★30444 [`fish`] [`rust`] [`shell`] [`terminal`]  
...
- [lsd-rs/lsd](https://github.com/lsd-rs/lsd) ★14620 [`color`] [`icons`] [`ls`] [`nerd-fonts`] [`rust`]  
...
- [rathole-org/rathole](https://github.com/rathole-org/rathole) ★11107 [`firewall`] [`frp`] [`http`] [`nat`] [`network`] [`ngrok`] [`noise`] [`noise-protocol`] [`proxy`] [`rust`] [`tunnel`]  
...
- [rustdesk/rustdesk-server](https://github.com/rustdesk/rustdesk-server) ★8263 [`remote-access`] [`remote-control`] [`remote-desktop`] [`tauri`]  
...
- [veeso/termscp](https://github.com/veeso/termscp) ★2427 [`aws-s3`] [`command-line-tool`] [`command-line-utility`] [`ftp-client`] [`ratatui`] [`rust`] [`rust-crate`] [`rust-lang`] [`scp`] [`sftp`] [`sftp-client`] [`ssh-client`] [`terminal`] [`terminal-app`] [`tui`] [`utility`] [`winscp`] [`winscp-equivalent-for-linux`] [`winscp-for-linux`] [`winscp-for-mac`]  
...
- [zdz/ServerStatus-Rust](https://github.com/zdz/ServerStatus-Rust) ★2164 [`probe`] [`railway`] [`rust`] [`serverstatus`] [`serverstatus-rust`] [`telegram`] [`vnstat`] [`webhook`] [`wechat`]  
