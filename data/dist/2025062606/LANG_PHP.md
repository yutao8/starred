...
- [nextcloud/server](https://github.com/nextcloud/server) ★29883 [`cloud`] [`collaboration`] [`decentralized`] [`design`] [`distributed`] [`enterprise`] [`federation`] [`file-sharing`] [`free-software`] [`hacktoberfest`] [`javascript`] [`nextcloud`] [`open-source`] [`opensource`] [`owncloud`] [`php`] [`self-hosting`] [`sharing`] [`usability`] [`ux`]  
...
- [fzaninotto/Faker](https://github.com/fzaninotto/Faker) ★26789  
...
- [guzzle/guzzle](https://github.com/guzzle/guzzle) ★23398 [`curl`] [`guzzle`] [`http-client`] [`httpclient`] [`php`] [`psr-7`] [`requests`] [`webservices`]  
...
- [easychen/howto-make-more-money](https://github.com/easychen/howto-make-more-money) ★17330  
...
- [flarum/flarum](https://github.com/flarum/flarum) ★15844 [`flarum`] [`forum`] [`laravel`] [`php`]  
...
- [thephpleague/flysystem](https://github.com/thephpleague/flysystem) ★13461 [`filesystem`] [`filesystem-library`] [`php`] [`thephpleague`]  
...
- [librespeed/speedtest](https://github.com/librespeed/speedtest) ★13205 [`hacktoberfest`] [`html5-speedtest`] [`internet-speed`] [`internet-speed-checker`] [`librespeed`] [`php`] [`speedtest`] [`web-worker`] [`xhr`]  
...
- [typecho/typecho](https://github.com/typecho/typecho) ★11863 [`blog`] [`markdown`] [`php`] [`typecho`]  
...
- [FreshRSS/FreshRSS](https://github.com/FreshRSS/FreshRSS) ★11809 [`feed`] [`freshrss`] [`news-aggregator`] [`php`] [`rss`] [`rss-aggregator`] [`rss-reader`] [`self-hosted`] [`websub`]  
...
- [tymondesigns/jwt-auth](https://github.com/tymondesigns/jwt-auth) ★11407 [`authentication`] [`jwt`] [`laravel`] [`php`]  
...
- [YOURLS/YOURLS](https://github.com/YOURLS/YOURLS) ★11318 [`bitly`] [`hacktoberfest`] [`php`] [`short-url`] [`shorten-urls`] [`shortener`] [`url-shortener`] [`url-shortner`] [`yourls`]  
...
- [assimon/dujiaoka](https://github.com/assimon/dujiaoka) ★10688 [`dujiaofaka`] [`dujiaoka`] [`faka`]  
...
- [Anankke/SSPanel-UIM](https://github.com/Anankke/SSPanel-UIM) ★9687  
...
- [roundcube/roundcubemail](https://github.com/roundcube/roundcubemail) ★6352  
...
- [vinkla/hashids](https://github.com/vinkla/hashids) ★5368 [`composer-packages`] [`database-ids`] [`encoding`] [`hash`] [`hashids`] [`ids`] [`php`] [`php-library`]  
...
- [nikic/FastRoute](https://github.com/nikic/FastRoute) ★5200  
...
- [spatie/browsershot](https://github.com/spatie/browsershot) ★5039 [`hacktoberfest`] [`phantomjs`] [`php`] [`screenshot`]  
  该
- [kuaifan/dootask](https://github.com/kuaifan/dootask) ★5034 [`dootask`] [`project-management`] [`project-manager`] [`remote-work`] [`task-management-system`] [`task-manager`] [`team-chat`] [`to-do`] [`todo`]  
...
- [wp-cli/wp-cli](https://github.com/wp-cli/wp-cli) ★4944 [`cli`] [`framework`] [`hacktoberfest`] [`php`] [`wordpress`] [`wp-cli`]  
...
- [catfan/Medoo](https://github.com/catfan/Medoo) ★4885 [`composer`] [`database`] [`hacktoberfest`] [`medoo`] [`mssql`] [`mysql`] [`php`] [`php-database-framework`] [`php-framework`] [`php-frameworks`] [`sqlite`]  
...
- [wikimedia/mediawiki](https://github.com/wikimedia/mediawiki) ★4627 [`mediawiki`] [`php`] [`wiki`] [`wikipedia`]  
...
- [endroid/qr-code](https://github.com/endroid/qr-code) ★4627 [`data-uri`] [`factory`] [`php`] [`qrcode`] [`reader`] [`twig-extension`]  
...
- [tecnickcom/TCPDF](https://github.com/tecnickcom/TCPDF) ★4380  
...
- [icret/EasyImages2.0](https://github.com/icret/EasyImages2.0) ★3342 [`api`] [`class-upload-php`] [`easyimage`] [`image-store`] [`images`] [`markdown`] [`php`] [`picture`] [`upload-images`] [`upload-pictures`] [`zui`]  
...
- [Bubka/2FAuth](https://github.com/Bubka/2FAuth) ★2835 [`2fa`] [`2factor`] [`hotp`] [`otp`] [`qrcode`] [`self-hosted`] [`totp`] [`two-factor`] [`two-factor-authentication`] [`webapp`]  
...
- [kalcaddle/kodbox](https://github.com/kalcaddle/kodbox) ★2569 [`docx`] [`file-explorer`] [`file-manager`] [`file-sharing`] [`file-upload`] [`file-viewer`] [`filemanager`] [`filesystem`] [`free-software`] [`javascript`] [`markdown-editor`] [`php`] [`text-editor`] [`webdav`] [`xlsx`]  
...
- [magicblack/maccms10](https://github.com/magicblack/maccms10) ★2526 [`maccms`] [`maccms10`]  
...
- [metowolf/Meting](https://github.com/metowolf/Meting) ★1784 [`api`] [`music`] [`php`]  
...
- [mineadmin/MineAdmin](https://github.com/mineadmin/MineAdmin) ★980 [`admin`] [`element-plus`] [`hyperf`] [`php`] [`swoole`] [`swow`] [`vue`]  
...
- [netcccyun/dnsmgr](https://github.com/netcccyun/dnsmgr) ★890  
...
- [Tzwcard/ChinaTelecom-GuangdongIPTV-RTP-List](https://github.com/Tzwcard/ChinaTelecom-GuangdongIPTV-RTP-List) ★885  
...
- [JaguarJack/catch-admin](https://github.com/JaguarJack/catch-admin) ★801 [`admin`] [`composer`] [`elementplus`] [`laravel`] [`laravel-admin`] [`php`] [`vue-admin`] [`vue3`]  
...
- [tsxcw/mtab](https://github.com/tsxcw/mtab) ★574  
...
- [250992941/iptv](https://github.com/250992941/iptv) ★79  
