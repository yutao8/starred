...
- [rustdesk/rustdesk-server](https://github.com/rustdesk/rustdesk-server) ★8187 [`remote-access`] [`remote-control`] [`remote-desktop`] [`tauri`]  
...
- [PoloDB/PoloDB](https://github.com/PoloDB/PoloDB) ★1108 [`cross-platform`] [`database`] [`document-database`] [`embedded-database`] [`localfirst`] [`nosql`] [`rust`]  
