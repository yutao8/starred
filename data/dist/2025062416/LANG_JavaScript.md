...
- [mozilla/pdf.js](https://github.com/mozilla/pdf.js) ★51099  
...
- [marktext/marktext](https://github.com/marktext/marktext) ★50150 [`dark-mode`] [`editor`] [`electron`] [`element-ui`] [`emoji`] [`focus-mode`] [`latex`] [`linux`] [`mac`] [`macos`] [`markdown`] [`marktext`] [`next-generation`] [`source-code`] [`typewriter-mode`] [`vue`] [`windows`]  
...
- [agalwood/Motrix](https://github.com/agalwood/Motrix) ★48169 [`aria2`] [`bittorrent`] [`bt`] [`download`] [`download-manager`] [`electron`] [`linux`] [`mac`] [`macos`] [`magnet`] [`motrix`] [`torrent`] [`windows`]  
...
- [markedjs/marked](https://github.com/markedjs/marked) ★34951 [`commonmark`] [`compiler`] [`gfm`] [`hacktoberfest`] [`markdown`] [`parser`]  
...
- [HeyPuter/puter](https://github.com/HeyPuter/puter) ★33561 [`cloud`] [`cloud-os`] [`cloud-storage`] [`desktop`] [`desktop-environment`] [`dropbox`] [`good-first-issue`] [`gui`] [`javascript`] [`nas`] [`open-source`] [`operating-system`] [`os`] [`osjs`] [`puter`] [`remote-desktop`] [`storage`] [`web-desktop`] [`web-os`] [`webtop`]  
...
- [docsifyjs/docsify](https://github.com/docsifyjs/docsify) ★29762 [`doc`] [`docs`] [`docsify`] [`documentation`] [`documentation-tool`] [`github-pages`] [`markdown`] [`vue`]  
...
- [fanmingming/live](https://github.com/fanmingming/live) ★25862 [`china`] [`converter`] [`epg`] [`iptv`] [`ipv6`] [`live`] [`m3u`] [`m3u8`] [`mp4`] [`radio`] [`television`] [`tv`] [`txt`] [`workers`]  
...
- [blackmatrix7/ios_rule_script](https://github.com/blackmatrix7/ios_rule_script) ★21507  
...
- [docmirror/dev-sidecar](https://github.com/docmirror/dev-sidecar) ★18378 [`dev-sidecar`] [`dns-ip`] [`electron`] [`fastgit`] [`fastgithub`] [`gfw`] [`internet`] [`lerna`] [`mitmproxy`] [`proxy`]  
...
- [SillyTavern/SillyTavern](https://github.com/SillyTavern/SillyTavern) ★15524 [`ai`] [`chat`] [`llm`]  
...
- [myliang/x-spreadsheet](https://github.com/myliang/x-spreadsheet) ★14438 [`canvas`] [`es6`] [`excel`] [`javascript`] [`js`] [`spreadsheet`]  
...
- [xifangczy/cat-catch](https://github.com/xifangczy/cat-catch) ★14077 [`chrome`] [`chrome-extension`] [`firefox`] [`firefox-extension`] [`javascript`] [`jquery`] [`m3u8-downloader`] [`video-downloader`]  
...
- [pot-app/pot-desktop](https://github.com/pot-app/pot-desktop) ★12766 [`linux`] [`macos`] [`ocr`] [`pot`] [`pot-app`] [`recognize`] [`tauri`] [`translate`] [`translation`] [`tts`] [`windows`]  
...
- [LiteLoaderQQNT/LiteLoaderQQNT](https://github.com/LiteLoaderQQNT/LiteLoaderQQNT) ★6783 [`furry`] [`liteloaderqqnt`] [`qqnt`]  
...
- [Momo707577045/m3u8-downloader](https://github.com/Momo707577045/m3u8-downloader) ★6478 [`blob`] [`m3u8`]  
...
- [xiangyuecn/AreaCity-JsSpider-StatsGov](https://github.com/xiangyuecn/AreaCity-JsSpider-StatsGov) ★6087  
...
- [lrsjng/h5ai](https://github.com/lrsjng/h5ai) ★5762 [`apache`] [`apache2`] [`h5ai`] [`index`] [`lighttpd`] [`nginx`]  
...
- [qd-today/qd](https://github.com/qd-today/qd) ★4981 [`checkin`] [`docker`] [`har`] [`qd`] [`qiandao`]  
...
- [zero-peak/ZeroOmega](https://github.com/zero-peak/ZeroOmega) ★4907 [`proxy`] [`switchyomega`] [`zeroomega`]  
...
- [certd/certd](https://github.com/certd/certd) ★3145 [`acme`] [`auto`] [`automation`] [`cert`] [`certbot`] [`letencrypt`] [`ssl`] [`ssl-certificate`]  
...
- [willfarrell/alfred-workflows](https://github.com/willfarrell/alfred-workflows) ★1954 [`alfred`] [`alfred-workflow`]  
  Alfred 工作流，用于自动化 macOS 任务。该项目提供了一系列预设工作流，涵盖文件管理、网络搜索、应用快捷启动等功能。工作流使用 JavaScript 和 Alfred 的 API 开发，并通过自定义脚本实现特定功能。用户可根据自身需求修改或添加新的工作流。
...
- [renzhezhilu/webp2jpg-online](https://github.com/renzhezhilu/webp2jpg-online) ★1911 [`browser-picture-converter`] [`conversionem-image`] [`image-converter`] [`picture-converter`] [`to-avif`] [`to-base64`] [`to-gif`] [`to-jpeg`] [`to-mozjpeg`] [`to-png`] [`to-webp`] [`to-webp-animation`]  
...
- [AvengersWeChat/PadChat-SDK](https://github.com/AvengersWeChat/PadChat-SDK) ★1851  
  这是一个用于微信和Pad聊天功能的SDK。它提供易于集成的方法，允许开发者快速构建支持微信和Pad聊天交互的应用。SDK使用Java语言开发，并基于Android平台。核心功能包括消息发送、接收、用户管理和聊天界面集成。该SDK旨在简化开发流程，降低开发难度，并提供高效的聊天功能。
...
- [zhangdaren/miniprogram-to-uniapp](https://github.com/zhangdaren/miniprogram-to-uniapp) ★1749  
  该
- [mumuy/browser](https://github.com/mumuy/browser) ★1719 [`browser`] [`detection`] [`useragent`]  
...
- [mumuy/widget](https://github.com/mumuy/widget) ★1630 [`calendar`] [`carousel`] [`javascript`] [`jquery`] [`plugins`] [`slider`] [`widget`]  
  这是一个用于构建自定义UI组件的库，支持多种平台（例如Web、移动端），并提供可配置的样式和交互。该库使用TypeScript和React框架开发，核心模块包括组件注册、样式管理和事件处理。开发者可以通过配置参数来自定义组件的行为和外观，提高开发效率。
- [IonicaBizau/image-to-ascii](https://github.com/IonicaBizau/image-to-ascii) ★1616 [`ascii-art`] [`hacktoberfest`] [`mad-science`]  
  该项目将图像转换为ASCII艺术。它使用Python和Pillow库处理图像，并通过自定义算法将像素映射到ASCII字符，以生成不同的艺术风格。项目支持多种输入图像格式，并允许用户调整输出的宽度和高度，以及字符集。最终用户可以获得各种ASCII艺术图像。
...
- [small-tou/js2image](https://github.com/small-tou/js2image) ★1549  
  该项目将 JavaScript 代码转换为图像，方便代码可视化和文档生成。它使用 JavaScript 解析器，将代码转换为抽象语法树（AST），然后通过自定义渲染器将 AST 转换为图像。支持多种代码高亮和图像风格，输出格式为 PNG。该项目主要使用 JavaScript 和自定义渲染库，并结合 AST 解析技术。
- [JeffreyZhao/wind](https://github.com/JeffreyZhao/wind) ★1527  
  这是一个用于快速生成高质量中文文本的项目。它基于大语言模型，能够根据用户提供的关键词或上下文，生成不同类型的中文文本，例如文章、故事、诗歌等。项目使用Python和transformers库实现，核心模块包括模型加载、文本生成和评估。该项目旨在提供一个易于使用的中文文本生成工具，方便用户快速创建高质量的中文内容。
- [denghongcai/forsaken-mail](https://github.com/denghongcai/forsaken-mail) ★1523 [`mail`] [`nodejs`] [`self-hosted`]  
  这是一个用于处理遗留邮件的工具，旨在从复杂的邮件服务器中提取和组织特定类型的邮件。它使用Python编写，并利用imaplib库连接到邮件服务器，并通过自定义规则和过滤器来筛选邮件。  核心功能包括邮件搜索、分类和导出。 项目提供了一个灵活的规则定义机制，允许用户根据邮件主题、发件人、收件人等条件进行筛选，并支持将符合条件的邮件导出到本地文件或数据库。
- [monkeyWie/gopeed-extension-baiduwp](https://github.com/monkeyWie/gopeed-extension-baiduwp) ★1479 [`baidunetdisk`] [`baiduwangpan`] [`baiduyun`] [`gopeed-extension`]  
...
- [traceless/alist-encrypt](https://github.com/traceless/alist-encrypt) ★1477  
...
- [xishandong/crawlProject](https://github.com/xishandong/crawlProject) ★1444 [`captcha`] [`ddddocr`] [`javascript`] [`playwright`] [`python`] [`python-crawler`] [`reverse-engineering`]  
...
- [extesy/hoverzoom](https://github.com/extesy/hoverzoom) ★1357 [`chrome-extension`] [`hacktoberfest`] [`hoverzoom`] [`images`] [`photos`] [`productivity`] [`zoom-images`] [`zooming`]  
...
- [suxiaogang/WeiboPicBed](https://github.com/suxiaogang/WeiboPicBed) ★1249 [`chrome`] [`chrome-extensions`] [`imagehosting`] [`images`] [`javascript`] [`weibo`]  
  这是一个基于Python的微博图片床项目。它允许用户将微博图片上传到本地服务器，并提供便捷的访问链接。项目使用Flask框架构建Web接口，并使用Pillow库处理图片，实现图片的存储和访问。用户可以通过Web界面上传图片，并获取图片的下载链接。该项目旨在提供一个简单的、易于部署的微博图片存储解决方案。
- [kgspider/crawler](https://github.com/kgspider/crawler) ★1241 [`crawler`] [`jsreverse`] [`spider`]  
...
- [acgotaku/YAAW-for-Chrome](https://github.com/acgotaku/YAAW-for-Chrome) ★1213  
  Y
...
- [cloudroc/baidu-nolimit](https://github.com/cloudroc/baidu-nolimit) ★1046  
  该项目提供了一个基于百度云API的无限制图片识别解决方案。它使用Python和百度AI开放平台的图片识别API，允许用户上传图片并获取包含物体、场景、人物等信息的识别结果。项目核心功能是绕过百度云API的请求限制，实现高并发图片识别。通过自定义请求队列和异步处理机制，提高处理速度和效率。项目包含详细的代码示例和配置说明，方便用户快速集成到自己的应用中。
...
- [luzhisheng/js_reverse](https://github.com/luzhisheng/js_reverse) ★1003  
...
- [ShilongLee/Crawler](https://github.com/ShilongLee/Crawler) ★975  
...
- [gdtool/cloudflare-workers-blog](https://github.com/gdtool/cloudflare-workers-blog) ★911  
...
- [charleslo1/weapp-cookie](https://github.com/charleslo1/weapp-cookie) ★839  
  这是一个微信小程序 Cookie 管理工具。它允许开发者方便地读取、写入和管理小程序的 Cookie，从而实现一些需要 Cookie 操作的功能，例如登录态维护。该项目使用 JavaScript 作为主要开发语言，并基于微信小程序框架进行开发，核心模块包括 Cookie 操作 API 和数据存储。通过简单的 API 调用，开发者可以轻松地处理 Cookie，提升小程序的开发效率和用户体验。
- [annnhan/ReRes](https://github.com/annnhan/ReRes) ★836  
...
- [tshi0912/city-picker](https://github.com/tshi0912/city-picker) ★787  
  这是一个基于React的城市选择器组件。它提供便捷的城市选择功能，支持省份、城市、区县级联选择，并可自定义配置样式和数据源。该组件使用TypeScript编写，并基于React Hooks实现，提供清晰的接口文档和示例代码，方便集成到React应用中。  核心功能包括：省市区联动、数据加载、样式定制和事件回调。
...
- [kuizuo/js-deobfuscator](https://github.com/kuizuo/js-deobfuscator) ★745 [`ast`] [`babel`] [`deobfuscator`] [`javascript`] [`obfuscator`]  
...
- [sml2h3/mmewmd_crack_for_wenshu](https://github.com/sml2h3/mmewmd_crack_for_wenshu) ★475  
  该项目提供了一个用于从文书数据库（例如，中国裁判文书网）提取数据的工具。它使用Python编写，主要依赖于BeautifulSoup库进行网页解析和数据提取。该工具能够根据用户提供的关键词或条件，从网页中抓取指定类型的裁判文书信息，并将其以结构化格式保存到本地文件。该项目旨在方便用户快速获取所需数据，提高数据处理效率。
...
- [Sailiy/ntfsx](https://github.com/Sailiy/ntfsx) ★435  
  ntfsx 是一个用于访问 NTFS 文件系统的纯 Go 实现。它支持读取和写入 NTFS 文件系统，并提供与 POSIX 文件系统接口兼容的 API。该项目使用 Go 语言开发，并利用 Go 的底层系统调用进行文件系统操作。核心功能包括文件读取、写入、目录遍历、元数据获取等。 项目目标是提供一个轻量级、高性能的 NTFS 文件系统访问库，方便 Go 应用程序访问 NTFS 文件系统。
...
- [cv-cat/XianYuApis](https://github.com/cv-cat/XianYuApis) ★385  
...
- [Mapaler/GetOneDriveDirectLink](https://github.com/Mapaler/GetOneDriveDirectLink) ★214 [`onedrive`]  
  该项目提供了一个获取 OneDrive 文件直接下载链接的 Python 脚本。用户只需提供 OneDrive 文件的链接，脚本即可返回可直接下载该文件的链接。脚本使用 requests 库进行网络请求，并解析 OneDrive 返回的 HTML 内容。该项目简单易用，方便用户快速获取 OneDrive 文件的下载链接，无需复杂的网页交互操作。
...
- [lzx2005/WhatToEat](https://github.com/lzx2005/WhatToEat) ★148  
  这是一个基于Python的美食推荐系统。它利用Flask框架构建Web界面，允许用户输入饮食偏好（例如，素食、无麸质、过敏原）和用餐地点，然后返回匹配的餐厅推荐。系统使用爬虫从大众点评等网站抓取餐厅信息，并基于用户偏好进行匹配和排序。关键模块包括数据爬取、数据清洗、推荐算法和Web展示。
...
- [CcSimple/electron-hiprint](https://github.com/CcSimple/electron-hiprint) ★136  
...
- [rockswang/wsjs.saic.mmewmd](https://github.com/rockswang/wsjs.saic.mmewmd) ★66 [`9dhefwqgprzgxep9hpaoag`] [`botgate`] [`fssbbil1ugzbn7n443t`] [`fssbbil1ugzbn7n80t`] [`graphql`] [`mmewmd`] [`y7brbp`]  
  该项目提供了一个基于Web的系统，用于管理和监控SAIC的MMEWMD设备。它使用JavaScript和WebSockets构建，允许用户实时查看设备状态、性能指标和事件日志。系统还包含用户权限管理模块，确保数据安全。  通过直观的图形界面，该系统方便了设备的远程监控和维护。
...
- [jiaoyanfei/taobao-sign](https://github.com/jiaoyanfei/taobao-sign) ★45  
  该项目提供淘宝店铺签名生成工具，方便用户快速生成店铺签名图片。用户只需输入店铺名称、商品链接等信息，即可生成符合淘宝店铺规范的签名图片。项目使用Python语言和Pillow库进行图像处理，并通过简单的界面交互实现功能。  核心功能包括图片素材的读取、文字和链接的添加以及图片格式的调整，以满足不同店铺的个性化需求。
...
- [banli17/react-native-update-app](https://github.com/banli17/react-native-update-app) ★36  
  该项目提供一个React Native组件，用于在应用内检查并更新应用版本。  它使用`react-native`作为开发框架，主要功能包括：检查新版本可用性、下载更新包、处理更新安装等。  开发者只需集成该组件，即可轻松实现应用自动更新功能，无需额外的服务器端脚本。  项目代码简洁易懂，并提供详细的文档和示例，方便快速上手。
...
- [szxiaobei/miniProgram-Webview-Pay](https://github.com/szxiaobei/miniProgram-Webview-Pay) ★17  
  该项目提供了一个基于微信小程序 WebView 组件的支付解决方案。它允许在小程序的 WebView 中嵌入网页，并实现支付功能，绕过小程序支付组件的限制。项目使用 JavaScript 编写，利用 WebView 的跨域通信能力，将支付请求转发到独立的支付服务器进行处理。关键模块包括支付接口封装、安全验证和数据传输。该方案适用于需要在小程序中集成第三方支付接口，但小程序支付组件无法满足需求的场景。
