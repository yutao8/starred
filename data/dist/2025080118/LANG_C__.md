...
- [zerotier/ZeroTierOne](https://github.com/zerotier/ZeroTierOne) ★15698 [`decentralization`] [`networking`] [`peer-to-peer`] [`sd-wan`] [`sdn`] [`virtual-network`] [`vpn`]  
...
- [BlackINT3/OpenArk](https://github.com/BlackINT3/OpenArk) ★11610 [`anti-malware`] [`ark`] [`windows-hacking`]  
...
- [kiwibrowser/src.next](https://github.com/kiwibrowser/src.next) ★3080  
...
- [qiin2333/Sunshine-Foundation](https://github.com/qiin2333/Sunshine-Foundation) ★2579 [`cloudgaming`] [`game-streaming`] [`moonlight`] [`remote-desktop`] [`stream`] [`sunshine`]  
