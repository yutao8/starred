...
- [mattpocock/skills](https://github.com/mattpocock/skills) ★245437  
...
- [ohmyzsh/ohmyzsh](https://github.com/ohmyzsh/ohmyzsh) ★189512 [`cli`] [`cli-app`] [`oh-my-zsh`] [`oh-my-zsh-plugin`] [`oh-my-zsh-theme`] [`ohmyzsh`] [`plugin-framework`] [`plugins`] [`productivity`] [`shell`] [`terminal`] [`theme`] [`themes`] [`zsh`] [`zsh-configuration`]  
...
- [dockur/windows](https://github.com/dockur/windows) ★53141 [`docker`] [`docker-container`] [`virtualization`] [`windows`] [`windows-virtual-desktop`] [`windows-virtual-machine`] [`windows-virtual-machines`] [`windows-vm`]  
...
- [acmesh-official/acme.sh](https://github.com/acmesh-official/acme.sh) ★47572 [`acme`] [`acme-challenge`] [`acme-protocol`] [`acme-v2`] [`ash`] [`bash`] [`buypass`] [`certbot`] [`lets-encrypt`] [`posix`] [`posix-sh`] [`shell`] [`ssl`] [`ssl-certificate`] [`ssl-certificates`] [`tls`] [`tls-certificate`] [`zerossl`]  
...
- [pyenv/pyenv](https://github.com/pyenv/pyenv) ★45066 [`python`] [`shell`]  
...
- [233boy/v2ray](https://github.com/233boy/v2ray) ★29553 [`shell-script`] [`v2ray`] [`vmess`]  
...
- [hwdsl2/setup-ipsec-vpn](https://github.com/hwdsl2/setup-ipsec-vpn) ★28415 [`alpine-linux`] [`bash`] [`cisco-ipsec`] [`debian`] [`encryption`] [`ikev2`] [`installer`] [`ipsec`] [`l2tp`] [`libreswan`] [`linux`] [`network`] [`privacy`] [`raspberry-pi`] [`security`] [`self-hosted`] [`ubuntu`] [`vpn`] [`vpn-client`] [`vpn-server`]  
...
- [lxgw/LxgwWenKai](https://github.com/lxgw/LxgwWenKai) ★25797 [`cjk`] [`font`] [`typeface`]  
...
- [mack-a/v2ray-agent](https://github.com/mack-a/v2ray-agent) ★21799 [`cloudflare`] [`grpc-cloudflare`] [`httpupgrade`] [`hysteria2`] [`nginx`] [`reality`] [`reality-grpc`] [`shell`] [`sing-box`] [`trojan`] [`trojan-grpc`] [`tuic-v5`] [`v2ray`] [`vless`] [`vmess`] [`websockettlscdn-cloudflare-ip`] [`xray`] [`xray-core`] [`xray-install`] [`xtls-rprx-vision`]  
...
- [DaoCloud/public-image-mirror](https://github.com/DaoCloud/public-image-mirror) ★15003 [`mirror`] [`speedup`]  
...
- [hq450/fancyss](https://github.com/hq450/fancyss) ★13722 [`arm`] [`koolgame`] [`merlin`] [`naiveproxy`] [`shadowsocks`] [`shadowsocks-rust`] [`ss`] [`ssr`] [`trojan`] [`v2ray`] [`x64`] [`xray`]  
...
- [bin456789/reinstall](https://github.com/bin456789/reinstall) ★12943 [`alpine`] [`alpine-linux`] [`boot`] [`distro`] [`linux`] [`linux-distribution`] [`liveos`] [`netboot`] [`netinst`] [`netinstall`] [`operating-systems`] [`os`] [`reinstall`] [`shell-script`] [`vps`] [`windows`]  
  用于在 VPS 或云服务器上一键重装系统，支持常见 Linux 发行版和 Windows，适合需要更换系统、纯净安装或修复引导的场景。通过预置脚本和镜像源自动完成网络安装，通常由 SSH 远程执行，无需进入救援模式，操作简洁且对新手友好。
- [YanG-1989/m3u](https://github.com/YanG-1989/m3u) ★11391  
...
- [xykt/NetQuality](https://github.com/xykt/NetQuality) ★5601  
...
- [eooce/Sing-box](https://github.com/eooce/Sing-box) ★5064 [`argo`] [`hysteria2`] [`oneclick`] [`reality`] [`serv00`] [`sing-box`] [`tuic`] [`tunnel`] [`vmess-ws-tls`]  
