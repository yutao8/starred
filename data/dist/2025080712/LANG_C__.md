...
- [tindy2013/subconverter](https://github.com/tindy2013/subconverter) ★14865 [`clash`] [`clashr`] [`emoji`] [`gist`] [`quantumult`] [`quantumultx`] [`regular-expression`] [`rename`] [`ss`] [`ssr`] [`subconverter`] [`surfboard`] [`surge`] [`v2ray`]  
...
- [moonlight-stream/moonlight-qt](https://github.com/moonlight-stream/moonlight-qt) ★14012 [`gamestream`] [`linux-app`] [`macos-app`] [`moonlight`] [`nvidia`] [`qt`] [`sdl2`] [`steam-link`] [`windows-app`]  
...
- [BlackINT3/OpenArk](https://github.com/BlackINT3/OpenArk) ★11642 [`anti-malware`] [`ark`] [`windows-hacking`]  
...
- [rovo89/Xposed](https://github.com/rovo89/Xposed) ★7607 [`android`] [`xposed`]  
...
- [rime/weasel](https://github.com/rime/weasel) ★5639  
...
- [ttttupup/wxhelper](https://github.com/ttttupup/wxhelper) ★2827 [`hook`] [`reverse`] [`wechat`] [`weixin`]  
...
- [qiin2333/Sunshine-Foundation](https://github.com/qiin2333/Sunshine-Foundation) ★2621 [`cloudgaming`] [`game-streaming`] [`moonlight`] [`remote-desktop`] [`stream`] [`sunshine`]  
...
- [wangyu-/tinyfecVPN](https://github.com/wangyu-/tinyfecVPN) ★2472 [`fec`] [`proxy`] [`reed-solomon`] [`vpn`]  
