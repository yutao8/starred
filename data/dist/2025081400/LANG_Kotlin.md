...
- [tiann/KernelSU](https://github.com/tiann/KernelSU) ★13261 [`android`] [`kernel`] [`kernelsu`] [`root`] [`su`]  
...
- [ankidroid/Anki-Android](https://github.com/ankidroid/Anki-Android) ★9880 [`android`] [`anki`] [`ankidroid`] [`education`] [`flashcards`] [`kotlin`] [`learning`] [`srs`]  
...
- [open-ani/animeko](https://github.com/open-ani/animeko) ★9624 [`android`] [`ani`] [`anime`] [`bangumi`] [`bittorrent`] [`bt`] [`compose`] [`compose-multiplatform`] [`danmaku`] [`ios`] [`jetpack-compose`] [`kotlin`] [`kotlin-multiplatform`] [`linux`] [`macos`] [`player`] [`torrent`] [`video`] [`windows`]  
...
- [bitwarden/android](https://github.com/bitwarden/android) ★7687 [`android`] [`bitwarden`] [`compose`] [`jetpack`] [`kotlin`]  
...
- [zhanghai/MaterialFiles](https://github.com/zhanghai/MaterialFiles) ★7245 [`android`] [`android-application`] [`file-manager`] [`kotlin`] [`kotlin-android`] [`material-design`]  
...
- [ReadYouApp/ReadYou](https://github.com/ReadYouApp/ReadYou) ★6282 [`android`] [`compose`] [`f-droid`] [`kotlin`] [`material-design`] [`material-design-3`] [`material-ui`] [`material-you`] [`rss-reader`]  
...
- [osfans/trime](https://github.com/osfans/trime) ★3629 [`android`] [`chinese`] [`ime`] [`jni`] [`opencc`] [`rime`]  
...
- [easybangumiorg/EasyBangumi](https://github.com/easybangumiorg/EasyBangumi) ★3458 [`acg`] [`android`] [`android-application`] [`bangumi`] [`cartoon`] [`compose`]  
...
- [gallonyin/worktool](https://github.com/gallonyin/worktool) ★2745  
