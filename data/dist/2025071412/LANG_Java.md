...
- [justauth/JustAuth](https://github.com/justauth/JustAuth) ★17060 [`googlelogin`] [`justauth`] [`oauth2`] [`qqlogin`] [`weixinlogin`]  
...
- [jeecgboot/jimureport](https://github.com/jeecgboot/jimureport) ★7293 [`bi`] [`bigscreen`] [`birt`] [`data-analysis`] [`data-visualization`] [`dataease`] [`datav`] [`echart`] [`echarts`] [`finereport`] [`highcharts`] [`ireport`] [`jasperreport`] [`jfreechart`] [`metabase`] [`print`] [`redash`] [`report`] [`superset`] [`tableau`]  
...
- [FongMi/TV](https://github.com/FongMi/TV) ★6213 [`catvod`] [`danmaku`] [`leanback`] [`media3`] [`p2p`] [`thunder`] [`tvbus`]  
...
- [648540858/wvp-GB28181-pro](https://github.com/648540858/wvp-GB28181-pro) ★6046 [`28181`] [`28181web`] [`gb28181`] [`gb28181server`] [`wvp`]  
...
- [niumoo/bing-wallpaper](https://github.com/niumoo/bing-wallpaper) ★2831 [`bing`] [`bing-image`] [`bing-wallpaper`] [`wallpaper`]  
...
- [pengliangAndroid/VirtualLocation](https://github.com/pengliangAndroid/VirtualLocation) ★1003  
...
- [aizuda/snail-job](https://github.com/aizuda/snail-job) ★650 [`mybatis-plus`] [`retry`] [`scheduler`]  
