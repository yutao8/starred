...
- [krahets/hello-algo](https://github.com/krahets/hello-algo) ★121526 [`algo`] [`algorithm`] [`algorithms`] [`book`] [`data-structure`] [`data-structures`] [`data-structures-and-algorithms`] [`dsa`] [`education`] [`leetcode`] [`programming`]  
...
- [termux/termux-app](https://github.com/termux/termux-app) ★48804 [`android`] [`hacktoberfest`] [`linux`] [`terminal`] [`termux`]  
...
- [dbeaver/dbeaver](https://github.com/dbeaver/dbeaver) ★48216 [`ai`] [`copilot`] [`database`] [`db2`] [`dbeaver`] [`erd`] [`gui`] [`java`] [`jdbc`] [`mysql`] [`nosql`] [`openai`] [`oracle`] [`postgresql`] [`redshift`] [`sql`] [`sqlite`] [`sqlserver`]  
...
- [skylot/jadx](https://github.com/skylot/jadx) ★46873 [`android`] [`decompiler`] [`dex`] [`java`]  
...
- [halo-dev/halo](https://github.com/halo-dev/halo) ★37790 [`blog`] [`blog-engine`] [`cms`] [`content-management-system`] [`halo`] [`halocms`] [`website-builder`]  
...
- [dataease/dataease](https://github.com/dataease/dataease) ★23132 [`apache-doris`] [`business-intelligence`] [`data-analysis`] [`data-visualization`] [`echarts`] [`kettle`] [`superset`] [`tableau`]  
...
- [lionsoul2014/ip2region](https://github.com/lionsoul2014/ip2region) ★18591 [`ip-address`] [`ip-address-database`] [`ip-address-location`] [`ip-location`] [`ip-lookup`] [`ipv4-address`] [`ipv4-lookup`] [`ipv4-support`] [`ipv6-address`] [`ipv6-lookup`] [`ipv6-support`] [`xdb-engine`] [`xdb-ipv4`] [`xdb-ipv6`]  
...
- [justauth/JustAuth](https://github.com/justauth/JustAuth) ★17363 [`googlelogin`] [`justauth`] [`oauth2`] [`qqlogin`] [`weixinlogin`]  
...
- [microg/GmsCore](https://github.com/microg/GmsCore) ★11901 [`android`] [`auth`] [`cloud-messaging`] [`firebase`] [`geolocation`] [`google`] [`google-cloud-messaging`] [`java`] [`kotlin`] [`kotlin-android`] [`maps`] [`microg`] [`mobile`] [`push-notifications`]  
...
- [zfile-dev/zfile](https://github.com/zfile-dev/zfile) ★10611 [`clouddisk`] [`h2`] [`h5ai`] [`mysql`] [`spring-boot`] [`vue`]  
...
- [pentaho/pentaho-kettle](https://github.com/pentaho/pentaho-kettle) ★8279  
...
- [FongMi/TV](https://github.com/FongMi/TV) ★7102 [`catvod`] [`leanback`] [`media3`]  
...
- [SuperMonster003/AutoJs6](https://github.com/SuperMonster003/AutoJs6) ★5199 [`android`] [`autojs`] [`autojs6`] [`automated-tool`] [`automation`] [`javascript`]  
...
- [emanuele-f/PCAPdroid](https://github.com/emanuele-f/PCAPdroid) ★3594 [`android`] [`capture-traffic`] [`decryption`] [`firewall`] [`network-analysis`] [`no-root`] [`pcap`] [`pcap-files`] [`sniffer`] [`sniffing`] [`traffic-monitor`] [`wireshark`]  
...
- [niumoo/bing-wallpaper](https://github.com/niumoo/bing-wallpaper) ★3315 [`bing`] [`bing-image`] [`bing-wallpaper`] [`wallpaper`]  
...
- [qaiu/netdisk-fast-download](https://github.com/qaiu/netdisk-fast-download) ★2526 [`api`] [`download`] [`drive`] [`file-server`] [`ilanzou`] [`java`] [`netdisk-fast-download`] [`onedrive`] [`parser`] [`share`] [`vertx`] [`webserver`] [`yunpan`]  
...
- [semicons/java_oci_manage](https://github.com/semicons/java_oci_manage) ★1802 [`bot`] [`r-bot`] [`rbot`]  
