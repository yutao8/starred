...
- [jarun/nnn](https://github.com/jarun/nnn) ★20989 [`android`] [`batch-rename`] [`c`] [`cli`] [`command-line`] [`developer-tools`] [`disk-usage`] [`file-manager`] [`file-preview`] [`file-search`] [`filesystem`] [`launcher`] [`multi-platform`] [`ncurses`] [`productivity`] [`raspberry-pi`] [`terminal`] [`tui`] [`vim`] [`wsl`]  
...
- [coturn/coturn](https://github.com/coturn/coturn) ★13371 [`networking`] [`server`] [`turn`]  
...
- [xmrig/xmrig](https://github.com/xmrig/xmrig) ★9702 [`argon2`] [`cpuminer`] [`cryptocurrency`] [`cryptonight`] [`miner`] [`monero`] [`randomx`] [`xmr`] [`xmrig`]  
...
- [winfsp/winfsp](https://github.com/winfsp/winfsp) ★8166 [`driver`] [`filesystem`] [`fuse`] [`gplv3`] [`kernel`] [`windows`] [`windows-kernel`]  
...
- [istoreos/istoreos](https://github.com/istoreos/istoreos) ★7073 [`istore`] [`istoreos`] [`koolcenter`] [`linkease`] [`nas`] [`openwrt`] [`router`]  
...
- [ldcsaa/HP-Socket](https://github.com/ldcsaa/HP-Socket) ★6117 [`android`] [`c`] [`cpp`] [`cross-platform`] [`epoll`] [`hpsocket`] [`http`] [`https`] [`iocp`] [`linux`] [`ndk`] [`netcore`] [`network`] [`networking`] [`socket`] [`ssl`] [`tcp`] [`udp`] [`websocket`] [`windows`]  
...
- [sabrogden/Ditto](https://github.com/sabrogden/Ditto) ★5641 [`clipboard`] [`clipboard-manager`]  
...
- [3proxy/3proxy](https://github.com/3proxy/3proxy) ★4805 [`accounting`] [`c`] [`https-proxy`] [`ipv6`] [`network-management`] [`network-security`] [`portmap`] [`proxy`] [`proxy-server`] [`sni`] [`socks`] [`socks-proxy`] [`socks-server`] [`socks5`] [`socks5-proxy`] [`socks5-server`] [`stunnel`] [`tls-proxy`] [`traffic-shaping`]  
...
- [RsyncProject/rsync](https://github.com/RsyncProject/rsync) ★4065  
