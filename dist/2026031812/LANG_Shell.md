...
- [ohmyzsh/ohmyzsh](https://github.com/ohmyzsh/ohmyzsh) ★185418 [`cli`] [`cli-app`] [`oh-my-zsh`] [`oh-my-zsh-plugin`] [`oh-my-zsh-theme`] [`ohmyzsh`] [`plugin-framework`] [`plugins`] [`productivity`] [`shell`] [`terminal`] [`theme`] [`themes`] [`zsh`] [`zsh-configuration`]  
...
- [sickcodes/Docker-OSX](https://github.com/sickcodes/Docker-OSX) ★52301 [`container`] [`docker`] [`docker-osx`] [`kvm`] [`macos`] [`os`] [`osx`] [`osx-kvm`] [`x`] [`x11`]  
...
- [dockur/windows](https://github.com/dockur/windows) ★50556 [`docker`] [`docker-container`] [`virtualization`] [`windows`] [`windows-virtual-desktop`] [`windows-virtual-machine`] [`windows-virtual-machines`] [`windows-vm`]  
...
- [233boy/v2ray](https://github.com/233boy/v2ray) ★28431 [`shell-script`] [`v2ray`] [`vmess`]  
...
- [yuaotian/go-cursor-help](https://github.com/yuaotian/go-cursor-help) ★26103 [`cursor`] [`error`]  
...
- [mack-a/v2ray-agent](https://github.com/mack-a/v2ray-agent) ★19448 [`cloudflare`] [`grpc-cloudflare`] [`httpupgrade`] [`hysteria2`] [`nginx`] [`reality`] [`reality-grpc`] [`shell`] [`sing-box`] [`trojan`] [`trojan-grpc`] [`tuic-v5`] [`v2ray`] [`vless`] [`vmess`] [`websockettlscdn-cloudflare-ip`] [`xray`] [`xray-core`] [`xray-install`] [`xtls-rprx-vision`]  
...
- [unixorn/awesome-zsh-plugins](https://github.com/unixorn/awesome-zsh-plugins) ★17499 [`awesome`] [`awesome-list`] [`collection`] [`hacktoberfest`] [`list`] [`oh-my-zsh`] [`zgenom`] [`zsh-completions`] [`zsh-configuration`] [`zsh-framework`] [`zsh-plugin`] [`zsh-prompt`] [`zsh-theme`]  
...
- [DaoCloud/public-image-mirror](https://github.com/DaoCloud/public-image-mirror) ★13507 [`mirror`] [`speedup`]  
...
- [oh-my-fish/oh-my-fish](https://github.com/oh-my-fish/oh-my-fish) ★11221 [`fish`] [`fishshell`] [`fishshell-framework`] [`hacktoberfest`] [`oh-my-fish`] [`oh-my-zsh`] [`omf`] [`prompt`] [`shell`] [`terminal`]  
...
- [bin456789/reinstall](https://github.com/bin456789/reinstall) ★11160 [`alpine`] [`alpine-linux`] [`boot`] [`distro`] [`grub`] [`installer`] [`iso`] [`linux`] [`linux-distribution`] [`liveos`] [`netboot`] [`netinst`] [`netinstall`] [`operating-systems`] [`os`] [`reinstall`] [`shell-script`] [`vps`] [`windows`]  
...
- [YanG-1989/m3u](https://github.com/YanG-1989/m3u) ★11037  
...
- [angristan/wireguard-install](https://github.com/angristan/wireguard-install) ★10698 [`linux`] [`nat`] [`privacy`] [`vpn`] [`wireguard`]  
...
- [Gogh-Co/Gogh](https://github.com/Gogh-Co/Gogh) ★10139 [`bash`] [`color-scheme`] [`gnome-terminal`] [`iterm2`] [`linux`] [`mint`] [`pantheon-terminal`] [`shell`] [`terminal`]  
...
- [spiritLHLS/ecs](https://github.com/spiritLHLS/ecs) ★6500 [`almalinux`] [`arch`] [`astralinux`] [`bench-script`] [`benchmark`] [`cdn`] [`centos`] [`checker`] [`debian`] [`fedora`] [`goecs`] [`ipv6`] [`lemonbench`] [`openai`] [`oracle-linux`] [`rockylinux`] [`speedtest`] [`sysbench`] [`ubuntu`] [`vps`]  
...
- [xykt/NetQuality](https://github.com/xykt/NetQuality) ★4439  
...
- [yhan219/navicat_reset_mac](https://github.com/yhan219/navicat_reset_mac) ★2137 [`navicat`] [`navicat-keygen`] [`navicat-reset`]  
