...
- [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) ★118116 [`awesome-list`] [`free-for-developers`]  
...
- [vernesong/OpenClash](https://github.com/vernesong/OpenClash) ★24385 [`clash`] [`luci`] [`mihomo`] [`openclash`] [`openwrt`] [`shadowsocks`] [`snell`] [`v2ray`] [`vmess`]  
...
- [vbskycn/iptv](https://github.com/vbskycn/iptv) ★5613  
...
- [aoaostar/legado](https://github.com/aoaostar/legado) ★4670 [`legado`] [`legado3`]  
...
- [xfirefly/Airplay-SDK](https://github.com/xfirefly/Airplay-SDK) ★3906 [`airplay`] [`airplay-receiver`] [`android`] [`dlna`] [`windows`]  
