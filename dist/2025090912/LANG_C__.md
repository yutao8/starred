...
- [zerotier/ZeroTierOne](https://github.com/zerotier/ZeroTierOne) ★15857 [`decentralization`] [`networking`] [`peer-to-peer`] [`sd-wan`] [`sdn`] [`virtual-network`] [`vpn`]  
...
- [tindy2013/subconverter](https://github.com/tindy2013/subconverter) ★15018 [`clash`] [`clashr`] [`emoji`] [`gist`] [`quantumult`] [`quantumultx`] [`regular-expression`] [`rename`] [`ss`] [`ssr`] [`subconverter`] [`surfboard`] [`surge`] [`v2ray`]  
...
- [moonlight-stream/moonlight-qt](https://github.com/moonlight-stream/moonlight-qt) ★14337 [`gamestream`] [`linux-app`] [`macos-app`] [`moonlight`] [`nvidia`] [`qt`] [`sdl2`] [`steam-link`] [`windows-app`]  
...
- [wangyu-/udp2raw](https://github.com/wangyu-/udp2raw) ★7945 [`bypass-firewall`] [`fake-header`] [`faketcp`] [`icmp`] [`icmp-tunnel`] [`icmptunnel`] [`raw-socket`] [`raw-tunnel`] [`tcp`] [`tunnel`] [`udp`] [`udp-tunnel`]  
...
- [TigerVNC/tigervnc](https://github.com/TigerVNC/tigervnc) ★6430  
...
- [rime/weasel](https://github.com/rime/weasel) ★5792  
...
- [kiwibrowser/src.next](https://github.com/kiwibrowser/src.next) ★3180  
...
- [qiin2333/Sunshine-Foundation](https://github.com/qiin2333/Sunshine-Foundation) ★2884 [`cloudgaming`] [`game-streaming`] [`moonlight`] [`remote-desktop`] [`stream`] [`sunshine`]  
