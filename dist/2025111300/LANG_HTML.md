...
- [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) ★114897 [`awesome-list`] [`free-for-developers`]  
...
- [vernesong/OpenClash](https://github.com/vernesong/OpenClash) ★22642 [`clash`] [`luci`] [`mihomo`] [`openclash`] [`openwrt`] [`shadowsocks`] [`snell`] [`v2ray`] [`vmess`]  
...
- [Lerist/FakeLocation](https://github.com/Lerist/FakeLocation) ★6584  
...
- [CaiJimmy/hugo-theme-stack](https://github.com/CaiJimmy/hugo-theme-stack) ★6044 [`bloggers`] [`css`] [`hacktoberfest`] [`hugo`] [`hugo-theme`] [`theme`]  
...
- [webmin/webmin](https://github.com/webmin/webmin) ★5355  
...
- [vbskycn/iptv](https://github.com/vbskycn/iptv) ★4843  
...
- [aoaostar/legado](https://github.com/aoaostar/legado) ★4226 [`legado`] [`legado3`]  
...
- [xfirefly/Airplay-SDK](https://github.com/xfirefly/Airplay-SDK) ★3845 [`airplay`] [`airplay-receiver`] [`android`] [`dlna`] [`windows`]  
...
- [TIM168/technical_books](https://github.com/TIM168/technical_books) ★3354 [`books`] [`go`] [`html`] [`http`] [`it`] [`java`] [`linux`] [`php`] [`python`] [`technical`] [`technical-books`]  
