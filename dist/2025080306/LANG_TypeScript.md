...
- [nocodb/nocodb](https://github.com/nocodb/nocodb) ★56201 [`airtable`] [`airtable-alternative`] [`automatic-api`] [`hacktoberfest`] [`low-code`] [`no-code`] [`no-code-database`] [`no-code-platform`] [`postgresql`] [`rest-api`] [`restful-api`] [`spreadsheet`] [`sqlite`] [`swagger`]  
...
- [lyswhut/lx-music-desktop](https://github.com/lyswhut/lx-music-desktop) ★45536 [`electron`] [`javascript`] [`music-player`] [`vue`]  
...
- [mendableai/firecrawl](https://github.com/mendableai/firecrawl) ★44441 [`ai`] [`ai-scraping`] [`crawler`] [`data`] [`html-to-markdown`] [`llm`] [`markdown`] [`rag`] [`scraper`] [`scraping`] [`web-crawler`] [`webscraping`]  
...
- [DIYgod/RSSHub](https://github.com/DIYgod/RSSHub) ★38090 [`bilibili`] [`douban`] [`dribbble`] [`instagram`] [`lofter`] [`pixiv`] [`rss`] [`rsshub`] [`spotify`] [`telegram`] [`tiktok`] [`twitter`] [`v2ex`] [`wechat`] [`weibo`] [`ximalaya`] [`youtube`] [`zhihu`]  
...
- [markedjs/marked](https://github.com/markedjs/marked) ★35234 [`commonmark`] [`compiler`] [`gfm`] [`hacktoberfest`] [`markdown`] [`parser`]  
...
- [niklasvh/html2canvas](https://github.com/niklasvh/html2canvas) ★31421 [`dom`] [`javascript`] [`screenshot`]  
...
- [RSSNext/Folo](https://github.com/RSSNext/Folo) ★30567 [`ai`] [`blockchain`] [`reader`] [`rss`] [`rss-reader`]  
...
- [umami-software/umami](https://github.com/umami-software/umami) ★27593 [`analytics`] [`charts`] [`google-analytics`] [`statistics`] [`web-analytics`]  
...
- [Molunerfinn/PicGo](https://github.com/Molunerfinn/PicGo) ★25477 [`aliyun-oss`] [`electron`] [`electron-app`] [`electron-vue`] [`github`] [`imgur`] [`imgur-uploader`] [`qiniu`] [`smms`] [`tencent-cos`] [`upyun`] [`vue`] [`weibo`]  
...
- [blakeblackshear/frigate](https://github.com/blakeblackshear/frigate) ★24210 [`ai`] [`camera`] [`google-coral`] [`home-assistant`] [`home-automation`] [`homeautomation`] [`mqtt`] [`nvr`] [`object-detection`] [`realtime`] [`rtsp`] [`tensorflow`]  
...
- [GoogleChromeLabs/squoosh](https://github.com/GoogleChromeLabs/squoosh) ★23373  
...
- [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ★20686  
...
- [maotoumao/MusicFree](https://github.com/maotoumao/MusicFree) ★19186 [`free`] [`music-player`] [`musicfree`] [`plugin`] [`react`] [`react-native`] [`typescript`]  
...
- [louislam/dockge](https://github.com/louislam/dockge) ★18927 [`docker`] [`docker-compose`] [`docker-deployment`] [`docker-stack`] [`docker-stack-deploy`] [`docker-ui`] [`responsive`] [`self-hosted`] [`selfhosted`] [`single-page-app`] [`socket-io`] [`webapp`] [`websocket`]  
...
- [whyour/qinglong](https://github.com/whyour/qinglong) ★18115 [`crontab`] [`docker`] [`javascript`] [`python`] [`shell`] [`task-manager`] [`typescript`]  
...
- [vercel/vercel](https://github.com/vercel/vercel) ★13909 [`cli`] [`cloud`] [`command`] [`hosting`] [`jamstack`] [`ship`] [`vercel`]  
...
- [ourongxing/newsnow](https://github.com/ourongxing/newsnow) ★12319 [`elegant`] [`news`]  
...
- [bitwarden/clients](https://github.com/bitwarden/clients) ★10570 [`angular`] [`bitwarden`] [`browser-extension`] [`chrome`] [`cli`] [`desktop`] [`electron`] [`firefox`] [`javascript`] [`nodejs`] [`safari`] [`typescript`] [`webextension`]  
...
- [getAsterisk/claudia](https://github.com/getAsterisk/claudia) ★10481 [`anthropic`] [`anthropic-claude`] [`claude`] [`claude-4`] [`claude-4-opus`] [`claude-4-sonnet`] [`claude-ai`] [`claude-code`] [`claude-code-sdk`] [`cursor`] [`ide`] [`llm`] [`llm-code`] [`rust`] [`tauri`]  
...
- [jackyzha0/quartz](https://github.com/jackyzha0/quartz) ★9678 [`digital-garden`] [`networked-thought`] [`obsidian`] [`obsidian-md`] [`quartz-ssg`] [`static-site-generator`]  
...
- [musistudio/claude-code-router](https://github.com/musistudio/claude-code-router) ★9523  
...
- [dream-num/univer](https://github.com/dream-num/univer) ★9496 [`appscript`] [`collaboration`] [`data-table`] [`doc`] [`document`] [`excel`] [`grid`] [`live-share`] [`office`] [`powerpoint`] [`ppt`] [`productivity`] [`sdk`] [`sheet`] [`slide`] [`spreadsheet`] [`word`] [`xlsx`]  
  这是一个用于生成各种类型的数字序列的工具。它支持算术、几何、斐波那契、卢卡斯等多种序列类型，并允许用户自定义序列规则。该工具使用Python语言开发，基于NumPy库进行数值计算，并提供简洁的API接口，方便用户快速生成所需序列。
- [ayangweb/BongoCat](https://github.com/ayangweb/BongoCat) ★8999 [`bongo-cat`] [`bongocat`] [`cross-platform`] [`desktop-app`] [`desktop-pet`] [`linux`] [`macos`] [`pet`] [`pet-project`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [alibaba/x-render](https://github.com/alibaba/x-render) ★7601 [`ant`] [`ant-design`] [`chart`] [`form`] [`formrender`] [`javascript`] [`json-schema`] [`list`] [`react`] [`table`] [`typescript`] [`webpack`] [`widget`]  
...
- [AIsouler/GKD_subscription](https://github.com/AIsouler/GKD_subscription) ★7117 [`gkd`] [`gkd-subscription`] [`typescript`]  
...
- [EcoPasteHub/EcoPaste](https://github.com/EcoPasteHub/EcoPaste) ★4870 [`application`] [`clipboard`] [`clipboard-manager`] [`cross-platform`] [`desktop-app`] [`desktop-application`] [`linux`] [`macos`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [browser-use/workflow-use](https://github.com/browser-use/workflow-use) ★3598  
...
- [korbinjoe/excalidraw-cn](https://github.com/korbinjoe/excalidraw-cn) ★2165 [`canvas`] [`chinese-fonts`] [`draw`] [`excalidraw`] [`hand`] [`handraw`] [`whiteboard`]  
...
- [pt-plugins/PT-depiler](https://github.com/pt-plugins/PT-depiler) ★978 [`private-tracker`]  
