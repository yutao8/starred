...
- [mattpocock/skills](https://github.com/mattpocock/skills) ★172150  
...
- [dockur/windows](https://github.com/dockur/windows) ★52440 [`docker`] [`docker-container`] [`virtualization`] [`windows`] [`windows-virtual-desktop`] [`windows-virtual-machine`] [`windows-virtual-machines`] [`windows-vm`]  
  该项目主要用于在Windows系统上运行Docker容器，提供对Docker工具链的集成支持，使开发者能够通过容器化方式部署和管理应用，适用于本地开发、测试及CI/CD流程中的容器化需求。
- [acmesh-official/acme.sh](https://github.com/acmesh-official/acme.sh) ★47186 [`acme`] [`acme-challenge`] [`acme-protocol`] [`acme-v2`] [`ash`] [`bash`] [`buypass`] [`certbot`] [`lets-encrypt`] [`posix`] [`posix-sh`] [`shell`] [`ssl`] [`ssl-certificate`] [`ssl-certificates`] [`tls`] [`tls-certificate`] [`zerossl`]  
...
- [pyenv/pyenv](https://github.com/pyenv/pyenv) ★44953 [`python`] [`shell`]  
...
- [hwdsl2/setup-ipsec-vpn](https://github.com/hwdsl2/setup-ipsec-vpn) ★28189 [`alpine-linux`] [`bash`] [`cisco-ipsec`] [`debian`] [`encryption`] [`ikev2`] [`installer`] [`ipsec`] [`l2tp`] [`libreswan`] [`linux`] [`network`] [`privacy`] [`raspberry-pi`] [`security`] [`self-hosted`] [`ubuntu`] [`vpn`] [`vpn-client`] [`vpn-server`]  
...
- [lxgw/LxgwWenKai](https://github.com/lxgw/LxgwWenKai) ★25152 [`cjk`] [`font`] [`typeface`]  
...
- [DaoCloud/public-image-mirror](https://github.com/DaoCloud/public-image-mirror) ★14615 [`mirror`] [`speedup`]  
  用于镜像同步和加速公开 Docker 镜像的公共服务，帮助用户解决海外镜像拉取慢的问题，支持常见官方镜像的快速下载，提升容器镜像分发效率，适用于国内开发者和企业构建云原生应用。
- [hq450/fancyss](https://github.com/hq450/fancyss) ★13662 [`arm`] [`koolgame`] [`merlin`] [`naiveproxy`] [`shadowsocks`] [`shadowsocks-rust`] [`ss`] [`ssr`] [`trojan`] [`v2ray`] [`x64`] [`xray`]  
...
- [spiritLHLS/ecs](https://github.com/spiritLHLS/ecs) ★7033 [`almalinux`] [`arch`] [`astralinux`] [`bench-script`] [`benchmark`] [`cdn`] [`centos`] [`checker`] [`debian`] [`fedora`] [`goecs`] [`ipv6`] [`lemonbench`] [`openai`] [`oracle-linux`] [`rockylinux`] [`speedtest`] [`sysbench`] [`ubuntu`] [`vps`]  
...
- [eooce/Sing-box](https://github.com/eooce/Sing-box) ★4903 [`argo`] [`hysteria2`] [`oneclick`] [`reality`] [`serv00`] [`sing-box`] [`tuic`] [`tunnel`] [`vmess-ws-tls`]  
