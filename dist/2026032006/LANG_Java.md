...
- [krahets/hello-algo](https://github.com/krahets/hello-algo) ★123516 [`algo`] [`algorithm`] [`algorithms`] [`book`] [`data-structure`] [`data-structures`] [`data-structures-and-algorithms`] [`dsa`] [`education`] [`leetcode`] [`programming`]  
...
- [NationalSecurityAgency/ghidra](https://github.com/NationalSecurityAgency/ghidra) ★65921 [`disassembler`] [`reverse-engineering`] [`software-analysis`]  
...
- [termux/termux-app](https://github.com/termux/termux-app) ★52197 [`android`] [`hacktoberfest`] [`linux`] [`terminal`] [`termux`]  
...
- [dbeaver/dbeaver](https://github.com/dbeaver/dbeaver) ★49184 [`ai`] [`copilot`] [`database`] [`db2`] [`dbeaver`] [`erd`] [`gui`] [`java`] [`jdbc`] [`mysql`] [`nosql`] [`openai`] [`oracle`] [`postgresql`] [`redshift`] [`sql`] [`sqlite`] [`sqlserver`]  
...
- [DrKLO/Telegram](https://github.com/DrKLO/Telegram) ★28733 [`telegram`]  
...
- [microg/GmsCore](https://github.com/microg/GmsCore) ★12623 [`android`] [`auth`] [`cloud-messaging`] [`firebase`] [`geolocation`] [`google`] [`google-cloud-messaging`] [`java`] [`kotlin`] [`kotlin-android`] [`maps`] [`microg`] [`mobile`] [`push-notifications`]  
...
- [Exrick/xpay](https://github.com/Exrick/xpay) ★5165  
...
- [pqpo/SmartCropper](https://github.com/pqpo/SmartCropper) ★4124 [`detection`] [`hed-net`] [`image`] [`image-cropper`] [`opencv`] [`pytorch`] [`smartcropper`] [`tensorflow`]  
  Smart
- [emanuele-f/PCAPdroid](https://github.com/emanuele-f/PCAPdroid) ★3829 [`android`] [`capture-traffic`] [`decryption`] [`firewall`] [`network-analysis`] [`no-root`] [`pcap`] [`pcap-files`] [`sniffer`] [`sniffing`] [`traffic-monitor`] [`wireshark`]  
...
- [qaiu/netdisk-fast-download](https://github.com/qaiu/netdisk-fast-download) ★2691 [`api`] [`download`] [`drive`] [`file-server`] [`ilanzou`] [`java`] [`netdisk-fast-download`] [`onedrive`] [`parser`] [`share`] [`vertx`] [`webserver`] [`yunpan`]  
