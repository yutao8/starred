...
- [Cenmrev/V2RayX](https://github.com/Cenmrev/V2RayX) ★7660  
...
- [syncthing/syncthing-macos](https://github.com/syncthing/syncthing-macos) ★3557 [`apple`] [`backup`] [`cloud-sync`] [`file-sharing`] [`file-sync`] [`frugal`] [`mac`] [`macos`] [`macosx`] [`objective-c`] [`osx`] [`p2p`] [`peer-to-peer`] [`simple`] [`swift`] [`sync`] [`sync-files`] [`synchronization`] [`syncthing`]  
