...
- [vbenjs/vue-vben-admin](https://github.com/vbenjs/vue-vben-admin) ★30243 [`admin-template`] [`ant-design`] [`element-plus`] [`monorepo`] [`naive-ui`] [`shadcn-ui`] [`tsx`] [`typescript`] [`vben`] [`vite`] [`vite-template`] [`vue-router`] [`vue3`] [`vuex`]  
...
- [requarks/wiki](https://github.com/requarks/wiki) ★27151 [`cross-platform`] [`documentation`] [`git`] [`markdown`] [`nodejs`] [`open-source`] [`wiki`]  
...
- [Lissy93/dashy](https://github.com/Lissy93/dashy) ★22734 [`awesome`] [`dashboard`] [`docker`] [`hacktoberfest`] [`homelab`] [`homepage`] [`mit`] [`nodejs`] [`organization`] [`productivity`] [`pwa`] [`self-hosted`] [`startpage`] [`vue`]  
...
- [pure-admin/vue-pure-admin](https://github.com/pure-admin/vue-pure-admin) ★19017 [`admin`] [`element-plus`] [`esm`] [`pinia`] [`tailwindcss`] [`typescript`] [`vite`] [`vue3`]  
...
- [wechat-article/wechat-article-exporter](https://github.com/wechat-article/wechat-article-exporter) ★4580 [`download`] [`wechat`] [`wechat-article`] [`wechat-download`]  
...
- [hslr-s/sun-panel](https://github.com/hslr-s/sun-panel) ★4515 [`docker`] [`gin`] [`golang`] [`homelab`] [`homepage`] [`nas`] [`navigationpage`] [`raspberry-pi`] [`self-hosted`] [`startpage`] [`synology`] [`vue3`]  
...
- [palxiao/poster-design](https://github.com/palxiao/poster-design) ★4514 [`canvas`] [`design`] [`image`] [`moveable`] [`nodejs`] [`poster`] [`puppeteer`] [`vue3`]  
...
- [HuLaSpark/HuLa](https://github.com/HuLaSpark/HuLa) ★3778 [`chatbot`] [`macos`] [`rust`] [`tauri`] [`tsx`] [`vue3`] [`webview`] [`windows`] [`windows-10`] [`windows-11`]  
...
- [Super-Badmen-Viper/NSMusicS](https://github.com/Super-Badmen-Viper/NSMusicS) ★2200 [`audio-player`] [`emby`] [`jellyfin`] [`media-server`] [`music`] [`music-player`] [`music-server`] [`naiveui`] [`navidrome`] [`ninesong`] [`nsmusics`] [`player`] [`server`] [`vue3`] [`xiaomi-smart-home`]  
...
- [build-admin/buildadmin](https://github.com/build-admin/buildadmin) ★2035 [`admin`] [`element-plus`] [`php`] [`thinkphp8`] [`typescript`] [`vite`] [`vue3`] [`workerman`]  
