...
- [ohmyzsh/ohmyzsh](https://github.com/ohmyzsh/ohmyzsh) ★186951 [`cli`] [`cli-app`] [`oh-my-zsh`] [`oh-my-zsh-plugin`] [`oh-my-zsh-theme`] [`ohmyzsh`] [`plugin-framework`] [`plugins`] [`productivity`] [`shell`] [`terminal`] [`theme`] [`themes`] [`zsh`] [`zsh-configuration`]  
...
- [dockur/windows](https://github.com/dockur/windows) ★51322 [`docker`] [`docker-container`] [`virtualization`] [`windows`] [`windows-virtual-desktop`] [`windows-virtual-machine`] [`windows-virtual-machines`] [`windows-vm`]  
...
- [acmesh-official/acme.sh](https://github.com/acmesh-official/acme.sh) ★46539 [`acme`] [`acme-challenge`] [`acme-protocol`] [`acme-v2`] [`ash`] [`bash`] [`buypass`] [`certbot`] [`lets-encrypt`] [`posix`] [`posix-sh`] [`shell`] [`ssl`] [`ssl-certificate`] [`ssl-certificates`] [`tls`] [`tls-certificate`] [`zerossl`]  
...
- [pyenv/pyenv](https://github.com/pyenv/pyenv) ★44745 [`python`] [`shell`]  
...
- [zsh-users/zsh-autosuggestions](https://github.com/zsh-users/zsh-autosuggestions) ★35477 [`autocomplete`] [`autosuggest`] [`fish`] [`shell`] [`zsh`] [`zsh-autosuggestions`]  
...
- [233boy/v2ray](https://github.com/233boy/v2ray) ★28960 [`shell-script`] [`v2ray`] [`vmess`]  
  这是一个基于Go语言开发的V2Ray代理服务器。它提供快速、稳定的代理连接，支持多种协议和配置。项目包含了核心代理服务以及客户端配置文件生成工具，用户可以方便地配置和管理V2Ray连接。代码结构清晰，易于维护和扩展。
- [hwdsl2/setup-ipsec-vpn](https://github.com/hwdsl2/setup-ipsec-vpn) ★27809 [`alpine-linux`] [`bash`] [`cisco-ipsec`] [`debian`] [`encryption`] [`ikev2`] [`ipsec`] [`l2tp`] [`libreswan`] [`linux`] [`network`] [`raspberry-pi`] [`security`] [`self-hosted`] [`shell`] [`strongswan`] [`ubuntu`] [`vpn`] [`vpn-client`] [`vpn-server`]  
...
- [lxgw/LxgwWenKai](https://github.com/lxgw/LxgwWenKai) ★24263 [`cjk`] [`font`] [`typeface`]  
...
- [mack-a/v2ray-agent](https://github.com/mack-a/v2ray-agent) ★20591 [`cloudflare`] [`grpc-cloudflare`] [`httpupgrade`] [`hysteria2`] [`nginx`] [`reality`] [`reality-grpc`] [`shell`] [`sing-box`] [`trojan`] [`trojan-grpc`] [`tuic-v5`] [`v2ray`] [`vless`] [`vmess`] [`websockettlscdn-cloudflare-ip`] [`xray`] [`xray-core`] [`xray-install`] [`xtls-rprx-vision`]  
...
- [DaoCloud/public-image-mirror](https://github.com/DaoCloud/public-image-mirror) ★14063 [`mirror`] [`speedup`]  
...
- [hq450/fancyss](https://github.com/hq450/fancyss) ★13536 [`arm`] [`koolgame`] [`merlin`] [`naiveproxy`] [`shadowsocks`] [`shadowsocks-rust`] [`ss`] [`ssr`] [`trojan`] [`v2ray`] [`x64`] [`xray`]  
...
- [bin456789/reinstall](https://github.com/bin456789/reinstall) ★11820 [`alpine`] [`alpine-linux`] [`boot`] [`distro`] [`linux`] [`linux-distribution`] [`liveos`] [`netboot`] [`netinst`] [`netinstall`] [`operating-systems`] [`os`] [`reinstall`] [`shell-script`] [`vps`] [`windows`]  
...
- [spiritLHLS/ecs](https://github.com/spiritLHLS/ecs) ★6796 [`almalinux`] [`arch`] [`astralinux`] [`bench-script`] [`benchmark`] [`cdn`] [`centos`] [`checker`] [`debian`] [`fedora`] [`goecs`] [`ipv6`] [`lemonbench`] [`openai`] [`oracle-linux`] [`rockylinux`] [`speedtest`] [`sysbench`] [`ubuntu`] [`vps`]  
...
- [lmc999/RegionRestrictionCheck](https://github.com/lmc999/RegionRestrictionCheck) ★5020  
...
- [xykt/NetQuality](https://github.com/xykt/NetQuality) ★4805  
...
- [eooce/Sing-box](https://github.com/eooce/Sing-box) ★4584 [`argo`] [`hysteria2`] [`oneclick`] [`reality`] [`serv00`] [`sing-box`] [`tuic`] [`tunnel`] [`vmess-ws-tls`]  
...
- [AuxXxilium/arc](https://github.com/AuxXxilium/arc) ★3300 [`arc`] [`arc-loader`] [`diskstation`] [`dsm`] [`nas`] [`network`] [`redpill`] [`redpill-load`] [`storage`] [`synology`] [`xpenology`]  
...
- [tom-snow/wechat-windows-versions](https://github.com/tom-snow/wechat-windows-versions) ★3082  
