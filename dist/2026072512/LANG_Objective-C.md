...
- [opa334/TrollStore](https://github.com/opa334/TrollStore) ★21807  
...
- [syncthing/syncthing-macos](https://github.com/syncthing/syncthing-macos) ★3825 [`apple`] [`backup`] [`cloud-sync`] [`file-sharing`] [`file-sync`] [`frugal`] [`mac`] [`macos`] [`macosx`] [`objective-c`] [`osx`] [`p2p`] [`peer-to-peer`] [`simple`] [`swift`] [`sync`] [`sync-files`] [`synchronization`] [`syncthing`]  
