...
- [Genymobile/scrcpy](https://github.com/Genymobile/scrcpy) ★143224 [`android`] [`c`] [`ffmpeg`] [`libav`] [`mirroring`] [`recording`] [`screen`] [`sdl2`]  
...
- [ventoy/Ventoy](https://github.com/ventoy/Ventoy) ★77116 [`arm64`] [`auto-install`] [`bootable-usb`] [`bsd`] [`chromeos`] [`iso-files`] [`legacy`] [`linux`] [`multiboot`] [`persistence`] [`secure-boot`] [`uefi`] [`unattended`] [`unix`] [`usb`] [`windows`] [`x86`] [`x86-64`]  
...
- [jqlang/jq](https://github.com/jqlang/jq) ★34839 [`jq`]  
...
- [valinet/ExplorerPatcher](https://github.com/valinet/ExplorerPatcher) ★32771  
...
- [kingToolbox/WindTerm](https://github.com/kingToolbox/WindTerm) ★31266 [`bash`] [`client`] [`cmd`] [`linux`] [`mac`] [`powershell`] [`serial`] [`sftp`] [`shell`] [`ssh`] [`telnet`] [`terminal`] [`tmux`] [`windows`] [`wsl`] [`x11`] [`xmodem`] [`xterm`] [`ymodem`] [`zmodem`]  
...
- [openssl/openssl](https://github.com/openssl/openssl) ★30278 [`cryptography`] [`decryption`] [`encryption`] [`openssl`] [`ssl`] [`tls`]  
...
- [facebook/zstd](https://github.com/facebook/zstd) ★27222  
...
- [coturn/coturn](https://github.com/coturn/coturn) ★14079 [`networking`] [`server`] [`turn`]  
...
- [wireshark/wireshark](https://github.com/wireshark/wireshark) ★9445 [`packet-capture`] [`stratoshark`] [`tshark`] [`wireshark`]  
...
- [sabrogden/Ditto](https://github.com/sabrogden/Ditto) ★6536 [`clipboard`] [`clipboard-manager`]  
...
- [RsyncProject/rsync](https://github.com/RsyncProject/rsync) ★4784  
