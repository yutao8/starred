...
- [vanhauser-thc/thc-hydra](https://github.com/vanhauser-thc/thc-hydra) ★10915 [`brute-force`] [`brute-force-attacks`] [`brute-force-passwords`] [`bruteforce`] [`bruteforce-attacks`] [`bruteforcer`] [`bruteforcing`] [`hydra`] [`network-security`] [`password-cracker`] [`password-cracking`] [`penetration-testing`] [`pentest`] [`pentest-tool`] [`pentesting`] [`thc`]  
...
- [phpredis/phpredis](https://github.com/phpredis/phpredis) ★10155 [`c`] [`cluster`] [`php`] [`redis`] [`redis-cluster`]  
...
- [sabrogden/Ditto](https://github.com/sabrogden/Ditto) ★5265 [`clipboard`] [`clipboard-manager`]  
