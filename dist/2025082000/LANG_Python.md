...
- [Z4nzu/hackingtool](https://github.com/Z4nzu/hackingtool) ★53309 [`allinonehackingtool`] [`besthackingtool`] [`ctf-tools`] [`ddos-attack-tool`] [`hacker`] [`hacking`] [`linux`] [`password-attack`] [`steganography`] [`web-attack`] [`wireless-attack`] [`xss-attacks`] [`xss-detection`]  
...
- [harry0703/MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo) ★39282 [`ai`] [`automation`] [`chatgpt`] [`moviepy`] [`python`] [`shortvideo`] [`tiktok`]  
...
- [2noise/ChatTTS](https://github.com/2noise/ChatTTS) ★37555 [`agent`] [`chat`] [`chatgpt`] [`chattts`] [`chinese`] [`chinese-language`] [`english`] [`english-language`] [`gpt`] [`llm`] [`llm-agent`] [`natural-language-inference`] [`python`] [`text-to-speech`] [`torch`] [`torchaudio`] [`tts`]  
...
- [NanmiCoder/MediaCrawler](https://github.com/NanmiCoder/MediaCrawler) ★35975  
...
- [yeongpin/cursor-free-vip](https://github.com/yeongpin/cursor-free-vip) ★34581 [`automation`] [`cursor`] [`cursor-ai`] [`cursor-ide`] [`cursorai`] [`cursors`] [`free`] [`freetrial`] [`pro`]  
...
- [python-telegram-bot/python-telegram-bot](https://github.com/python-telegram-bot/python-telegram-bot) ★28013 [`bot`] [`chatbot`] [`framework`] [`python`] [`telegram`]  
...
- [521xueweihan/GitHub520](https://github.com/521xueweihan/GitHub520) ★26555 [`dns`] [`github`] [`hosts`]  
...
- [dgtlmoon/changedetection.io](https://github.com/dgtlmoon/changedetection.io) ★26232 [`back-in-stock`] [`change-alert`] [`change-detection`] [`change-monitoring`] [`monitoring`] [`notifications`] [`restock-monitor`] [`rss`] [`self-hosted`] [`url-monitor`] [`web-scraping`] [`website-change-detection`] [`website-change-detector`] [`website-change-monitor`] [`website-change-notification`] [`website-change-tracker`] [`website-defacement-monitoring`] [`website-monitor`] [`website-monitoring`] [`website-watcher`]  
...
- [Delgan/loguru](https://github.com/Delgan/loguru) ★22510 [`log`] [`logger`] [`logging`] [`python`]  
...
- [LiLittleCat/awesome-free-chatgpt](https://github.com/LiLittleCat/awesome-free-chatgpt) ★20346 [`awesome`] [`awesome-list`] [`chat`] [`chatgpt`] [`free`] [`freechatgpt`]  
...
- [fastapi/sqlmodel](https://github.com/fastapi/sqlmodel) ★16592 [`fastapi`] [`json`] [`json-schema`] [`pydantic`] [`python`] [`sql`] [`sqlalchemy`]  
...
- [lss233/kirara-ai](https://github.com/lss233/kirara-ai) ★16312 [`bard`] [`bot`] [`chatglm-6b`] [`chatgpt`] [`deepseek`] [`discord`] [`ernie`] [`go-cqhttp`] [`grok`] [`mirai`] [`new-bing`] [`ollama`] [`openai`] [`poe`] [`qq`] [`qqbot`] [`sydney`] [`telegram`] [`wechat`] [`xinghuo`]  
...
- [langbot-app/LangBot](https://github.com/langbot-app/LangBot) ★13049 [`agent`] [`ai`] [`chatgpt`] [`deepseek`] [`dify`] [`dingtalk`] [`discord`] [`feishu`] [`kimi`] [`langbot`] [`lark`] [`llm`] [`n8n`] [`ollama`] [`openai`] [`plugins`] [`qq`] [`rag`] [`telegram`] [`wechat`]  
...
- [sml2h3/ddddocr](https://github.com/sml2h3/ddddocr) ★12506 [`captcha`] [`ddddocr`] [`ocr`]  
...
- [dwyl/english-words](https://github.com/dwyl/english-words) ★11502  
...
- [shidahuilang/shuyuan](https://github.com/shidahuilang/shuyuan) ★8213 [`aiyueshuxiang`] [`ipa`] [`iptv`] [`reader`] [`shuyuan`] [`trollstore`] [`tts`] [`xiangsegige`] [`yuanyuedu`] [`yuedu`]  
...
- [jackhawks/rectg](https://github.com/jackhawks/rectg) ★7977 [`rectg`] [`telegram`] [`telegram-bot`] [`telegram-channel`] [`telegram-group`]  
...
- [vastsa/FileCodeBox](https://github.com/vastsa/FileCodeBox) ★7047 [`anonymous`] [`fastapi`] [`filecodebox`] [`python`] [`tool`] [`vue`]  
...
- [nonebot/nonebot2](https://github.com/nonebot/nonebot2) ★6948 [`bot`] [`chatbot`] [`cqhttp`] [`dingtalk-robot`] [`fastapi`] [`lark-bot`] [`mirai-bot`] [`nonebot`] [`nonebot2`] [`onebot`] [`python`] [`qq`] [`qq-guild`] [`telegram-bot`]  
...
- [tconbeer/harlequin](https://github.com/tconbeer/harlequin) ★4845  
...
- [vbskycn/iptv](https://github.com/vbskycn/iptv) ★4342  
...
- [mofeng-git/One-KVM](https://github.com/mofeng-git/One-KVM) ★1673  
...
- [ChenZixinn/spider_reverse](https://github.com/ChenZixinn/spider_reverse) ★761 [`crawler`] [`python`] [`requests`] [`spider`]  
