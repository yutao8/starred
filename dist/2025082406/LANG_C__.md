...
- [tindy2013/subconverter](https://github.com/tindy2013/subconverter) ★14930 [`clash`] [`clashr`] [`emoji`] [`gist`] [`quantumult`] [`quantumultx`] [`regular-expression`] [`rename`] [`ss`] [`ssr`] [`subconverter`] [`surfboard`] [`surge`] [`v2ray`]  
...
- [moonlight-stream/moonlight-qt](https://github.com/moonlight-stream/moonlight-qt) ★14189 [`gamestream`] [`linux-app`] [`macos-app`] [`moonlight`] [`nvidia`] [`qt`] [`sdl2`] [`steam-link`] [`windows-app`]  
...
- [BlackINT3/OpenArk](https://github.com/BlackINT3/OpenArk) ★11743 [`anti-malware`] [`ark`] [`windows-hacking`]  
...
- [wangyu-/udp2raw](https://github.com/wangyu-/udp2raw) ★7914 [`bypass-firewall`] [`fake-header`] [`faketcp`] [`icmp`] [`icmp-tunnel`] [`icmptunnel`] [`raw-socket`] [`raw-tunnel`] [`tcp`] [`tunnel`] [`udp`] [`udp-tunnel`]  
...
- [BlueMatthew/WechatExporter](https://github.com/BlueMatthew/WechatExporter) ★6991 [`backup`] [`chat`] [`dump`] [`export`] [`friend`] [`history`] [`itunes`] [`libmp3lame`] [`libplist`] [`silk`] [`wechat`]  
...
- [rime/weasel](https://github.com/rime/weasel) ★5715  
...
- [zhongyang219/MusicPlayer2](https://github.com/zhongyang219/MusicPlayer2) ★5709  
...
- [xfangfang/wiliwili](https://github.com/xfangfang/wiliwili) ★4407 [`bilibili`] [`mpv`] [`nanovg`] [`nintendo-switch`] [`nintendo-switch-homebrew`] [`opencc`] [`opengl`] [`ps4`] [`psv`] [`xbox`]  
...
- [kiwibrowser/src.next](https://github.com/kiwibrowser/src.next) ★3138  
...
- [qiin2333/Sunshine-Foundation](https://github.com/qiin2333/Sunshine-Foundation) ★2758 [`cloudgaming`] [`game-streaming`] [`moonlight`] [`remote-desktop`] [`stream`] [`sunshine`]  
