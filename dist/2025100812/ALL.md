...
- [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) ★151233 [`activator`] [`hwid`] [`kms`] [`kms38`] [`massgrave`] [`massgravel`] [`microsoft`] [`microsoft365`] [`office`] [`office365`] [`ohook`] [`powershell`] [`tsforge`] [`windows`] [`windows-10`] [`windows-11`]  
...
- [FongMi/Release](https://github.com/FongMi/Release) ★4827  
...
- [kkkgo/LTSC-Add-MicrosoftStore](https://github.com/kkkgo/LTSC-Add-MicrosoftStore) ★3737  
...
- [Genymobile/scrcpy](https://github.com/Genymobile/scrcpy) ★129389 [`android`] [`c`] [`ffmpeg`] [`libav`] [`mirroring`] [`recording`] [`screen`] [`sdl2`]  
...
- [ventoy/Ventoy](https://github.com/ventoy/Ventoy) ★71065 [`auto-install`] [`bootable-usb`] [`bsd`] [`chromeos`] [`iso-files`] [`legacy`] [`linux`] [`multiboot`] [`persistence`] [`secure-boot`] [`uefi`] [`unattended`] [`unix`] [`usb`] [`windows`]  
...
- [jqlang/jq](https://github.com/jqlang/jq) ★32719 [`jq`]  
...
- [valinet/ExplorerPatcher](https://github.com/valinet/ExplorerPatcher) ★29079  
...
- [kingToolbox/WindTerm](https://github.com/kingToolbox/WindTerm) ★28208 [`bash`] [`client`] [`cmd`] [`linux`] [`mac`] [`powershell`] [`serial`] [`sftp`] [`shell`] [`ssh`] [`telnet`] [`terminal`] [`tmux`] [`windows`] [`wsl`] [`x11`] [`xmodem`] [`xterm`] [`ymodem`] [`zmodem`]  
...
- [ggreer/the_silver_searcher](https://github.com/ggreer/the_silver_searcher) ★27001 [`ag`] [`c`] [`command-line-tool`] [`pcre`] [`search-in-text`] [`silver-searcher`]  
...
- [jarun/nnn](https://github.com/jarun/nnn) ★20685 [`android`] [`batch-rename`] [`c`] [`cli`] [`command-line`] [`developer-tools`] [`disk-usage`] [`file-manager`] [`file-preview`] [`file-search`] [`filesystem`] [`launcher`] [`multi-platform`] [`ncurses`] [`productivity`] [`raspberry-pi`] [`terminal`] [`tui`] [`vim`] [`wsl`]  
...
- [coturn/coturn](https://github.com/coturn/coturn) ★13019 [`networking`] [`server`] [`turn`]  
...
- [SoftEtherVPN/SoftEtherVPN](https://github.com/SoftEtherVPN/SoftEtherVPN) ★12607 [`etherip`] [`ike`] [`ipsec`] [`l2tp`] [`l2tpv3`] [`openvpn`] [`softether-vpn`] [`softethervpn`] [`ssl-vpn`] [`sstp`] [`tls`] [`vpn`] [`vpn-protocols`] [`vpn-server`] [`vpn-tunnel`] [`wfh`] [`wireguard`] [`work-from-home`]  
...
- [vanhauser-thc/thc-hydra](https://github.com/vanhauser-thc/thc-hydra) ★10923 [`brute-force`] [`brute-force-attacks`] [`brute-force-passwords`] [`bruteforce`] [`bruteforce-attacks`] [`bruteforcer`] [`bruteforcing`] [`hydra`] [`network-security`] [`password-cracker`] [`password-cracking`] [`penetration-testing`] [`pentest`] [`pentest-tool`] [`pentesting`] [`thc`]  
...
- [pymumu/smartdns](https://github.com/pymumu/smartdns) ★10008 [`c`] [`dns`] [`dns-over-https`] [`dns-over-tls`] [`dns-server`] [`dns64`] [`doh`] [`doh3`] [`doq`] [`dot`] [`nftables`] [`nftables-sets`] [`openwrt`] [`openwrt-package`] [`smartdns`] [`stubby`]  
...
- [esnet/iperf](https://github.com/esnet/iperf) ★7911  
...
- [winfsp/winfsp](https://github.com/winfsp/winfsp) ★7879 [`driver`] [`filesystem`] [`fuse`] [`gplv3`] [`kernel`] [`windows`] [`windows-kernel`]  
...
- [akopytov/sysbench](https://github.com/akopytov/sysbench) ★6507 [`benchmark`] [`console`] [`freebsd`] [`linux`] [`lua`] [`luajit`] [`macos`] [`micro-benchmarks`] [`mysql`] [`oltp`] [`postgresql`] [`sysbench`]  
...
- [pawelsalawa/sqlitestudio](https://github.com/pawelsalawa/sqlitestudio) ★6175 [`cpp`] [`database`] [`database-management`] [`qt`] [`qt5`] [`sqlcipher`] [`sqlite`] [`sqlite3-database`] [`wxsqlite3`]  
...
- [tinyproxy/tinyproxy](https://github.com/tinyproxy/tinyproxy) ★5444  
...
- [sabrogden/Ditto](https://github.com/sabrogden/Ditto) ★5271 [`clipboard`] [`clipboard-manager`]  
...
- [3proxy/3proxy](https://github.com/3proxy/3proxy) ★4605 [`accounting`] [`c`] [`https-proxy`] [`ipv6`] [`network-management`] [`network-security`] [`portmap`] [`proxy`] [`proxy-server`] [`sni`] [`socks`] [`socks-proxy`] [`socks-server`] [`socks5`] [`socks5-proxy`] [`socks5-server`] [`stunnel`] [`tls-proxy`] [`traffic-shaping`]  
...
- [RsyncProject/rsync](https://github.com/RsyncProject/rsync) ★3872  
...
- [TurboVNC/turbovnc](https://github.com/TurboVNC/turbovnc) ★918  
...
- [microsoft/PowerToys](https://github.com/microsoft/PowerToys) ★124116 [`color-picker`] [`command-palette`] [`desktop`] [`fancyzones`] [`keyboard-manager`] [`microsoft-powertoys`] [`powerrename`] [`powertoys`] [`windows`] [`windows-10`] [`windows-11`]  
...
- [2dust/v2rayN](https://github.com/2dust/v2rayN) ★87722 [`proxy`] [`shadowsocks`] [`socks5`] [`trojan`] [`v2fly`] [`v2ray`] [`vless`] [`vmess`] [`windows`] [`xray`] [`xtls`]  
...
- [shadowsocks/shadowsocks-windows](https://github.com/shadowsocks/shadowsocks-windows) ★59052 [`c-sharp`] [`proxy`] [`shadowsocks`]  
...
- [PowerShell/PowerShell](https://github.com/PowerShell/PowerShell) ★50180 [`command-line`] [`hacktoberfest`] [`linux`] [`macos`] [`netcore`] [`powershell`] [`shell`] [`windows`]  
  这是一个用于PowerShell的项目，具体功能不明确。  需要更多信息才能生成合适的项目描述。 请提供GitHub项目链接。
- [huiyadanli/RevokeMsgPatcher](https://github.com/huiyadanli/RevokeMsgPatcher) ★34805 [`hex-editor`] [`patch`] [`pc`] [`qq`] [`revoke`] [`revokemsg`] [`tim`] [`tool`] [`wechat`] [`windows`]  
...
- [AvaloniaUI/Avalonia](https://github.com/AvaloniaUI/Avalonia) ★28853 [`android`] [`app-framework`] [`avalonia`] [`avaloniaui`] [`browser`] [`c-sharp`] [`cross-platform`] [`csharp`] [`desktop`] [`dotnet`] [`gui`] [`ios`] [`linux`] [`macos`] [`mobile`] [`mvvm`] [`wasm`] [`windows`] [`xamarin`] [`xaml`]  
...
- [rocksdanister/lively](https://github.com/rocksdanister/lively) ★17288 [`csharp`] [`desktop`] [`desktop-wallpaper`] [`dynamic-desktop`] [`dynamic-wallpaper`] [`fluent-design`] [`live-wallpaper`] [`screensavers`] [`wallpaper`] [`wallpaper-app`] [`wallpaper-changer`] [`wallpaper-engine`] [`wallpaperengine`] [`wallpapers`] [`widgets`] [`windows-10`] [`windows-11`] [`windows-app`] [`winui`] [`winui3`]  
...
- [bitwarden/server](https://github.com/bitwarden/server) ★17258 [`api`] [`aspnet`] [`aspnetcore`] [`bitwarden`] [`csharp`] [`docker`] [`dotnet`] [`dotnet-core`] [`signalr`] [`sql`] [`sql-server`]  
...
- [netchx/netch](https://github.com/netchx/netch) ★16959 [`fullcone`] [`netch`] [`netfiltersdk`] [`shadowsocks`] [`shadowsocksr`] [`socks`] [`tun2socks`] [`vless`] [`vmess`]  
...
- [winsw/winsw](https://github.com/winsw/winsw) ★13305 [`csharp`] [`dotnet`] [`nuget`] [`windows-service`] [`windows-service-wrapper`]  
...
- [d2phap/ImageGlass](https://github.com/d2phap/ImageGlass) ★11336 [`avif`] [`csharp`] [`direct2d`] [`dotnet`] [`heic`] [`heif`] [`image-viewer`] [`imageglass`] [`jpeg-xl`] [`jxl`] [`photo-viewer`] [`picture-gallery`] [`picture-viewer`] [`raw`] [`raw-image`] [`svg`] [`svg-viewer`] [`winforms`]  
...
- [OdysseusYuan/LKY_OfficeTools](https://github.com/OdysseusYuan/LKY_OfficeTools) ★10677 [`access`] [`email`] [`excel`] [`kms`] [`lync`] [`microsoft`] [`msoffice`] [`office`] [`office-free`] [`office365`] [`onedrive`] [`onenote`] [`outlook`] [`ppt`] [`project`] [`publisher`] [`skype`] [`teams`] [`visio`] [`word`]  
...
- [quasar/Quasar](https://github.com/quasar/Quasar) ★9516 [`administration`] [`c-sharp`] [`dotnet`] [`mono`] [`net`] [`protobuf`] [`rat`] [`red-team`] [`remote`] [`remote-control`] [`remote-desktop`] [`security`] [`windows`]  
...
- [studyzy/imewlconverter](https://github.com/studyzy/imewlconverter) ★9107 [`c-sharp`] [`chinese-characters`] [`converter`] [`dotnet`] [`dotnet-core`] [`ime`]  
...
- [dnSpyEx/dnSpy](https://github.com/dnSpyEx/dnSpy) ★9042 [`baml`] [`csharp`] [`debug`] [`debugger`] [`decompile`] [`decompiler`] [`dotnet`] [`dotnetcore`] [`dotnetframework`] [`mono`] [`unity`] [`vbnet`] [`xaml`]  
...
- [HMBSbige/NatTypeTester](https://github.com/HMBSbige/NatTypeTester) ★4213 [`csharp`] [`nat`] [`rfc3489`] [`rfc5389`] [`rfc5780`] [`rfc8489`] [`stun`] [`tcp`] [`tls`] [`udp`] [`winui3`] [`wpf`]  
...
- [kerryjiang/SuperSocket](https://github.com/kerryjiang/SuperSocket) ★4167 [`csharp`] [`dotnet`] [`network-protocol-decoding`] [`realtime-communication`] [`socket`] [`socketserver`] [`tcp`] [`udp`] [`websocket`]  
...
- [TheJoeFin/Text-Grab](https://github.com/TheJoeFin/Text-Grab) ★3993 [`dotnet`] [`msix`] [`ocr`] [`window-10`] [`windows`] [`windows-11`] [`wpf`]  
...
- [Jeric-X/SyncClipboard](https://github.com/Jeric-X/SyncClipboard) ★3501  
...
- [LorenzCK/OnTopReplica](https://github.com/LorenzCK/OnTopReplica) ★2744 [`dwm`] [`thumbnails`] [`tool`] [`windowing`] [`windows`] [`windows-desktop`]  
...
- [SuperStudio/SuperCom](https://github.com/SuperStudio/SuperCom) ★1085  
...
- [electron/electron](https://github.com/electron/electron) ★118577 [`c-plus-plus`] [`chrome`] [`css`] [`electron`] [`html`] [`javascript`] [`nodejs`] [`v8`] [`works-with-codespaces`]  
...
- [tesseract-ocr/tesseract](https://github.com/tesseract-ocr/tesseract) ★70101 [`hacktoberfest`] [`lstm`] [`machine-learning`] [`ocr`] [`ocr-engine`] [`tesseract`] [`tesseract-ocr`]  
...
- [aria2/aria2](https://github.com/aria2/aria2) ★38885 [`bittorrent`] [`cpp11`] [`download`] [`ftp`] [`http`] [`metalink`] [`rpc`] [`sftp`]  
...
- [qbittorrent/qBittorrent](https://github.com/qbittorrent/qBittorrent) ★33238 [`bittorrent`] [`bittorrent-client`] [`c-plus-plus`] [`crossplatform`] [`torrent`] [`torrent-client`]  
...
- [LizardByte/Sunshine](https://github.com/LizardByte/Sunshine) ★29773 [`cpp`] [`docker`] [`flathub-pkg`] [`game-stream`] [`game-streaming`] [`game-streaming-server`] [`geforce-experience`] [`homebrew-pkg`] [`maintainer-wanted`] [`moonlight`] [`pacman-pkg`] [`python`] [`remote-desktop`] [`replicator-custom-issues`] [`replicator-release-notifications`] [`rtd`] [`winget-pkg`]  
...
- [cmderdev/cmder](https://github.com/cmderdev/cmder) ★26566 [`c-plus-plus`] [`cmder`] [`color-scheme`] [`command-line`] [`conemu`] [`mintty`] [`portable`] [`powershell`] [`shell`] [`ssh-agent`] [`windows`]  
...
- [c0re100/qBittorrent-Enhanced-Edition](https://github.com/c0re100/qBittorrent-Enhanced-Edition) ★23967 [`bittorrent`] [`bittorrent-client`]  
...
- [google/filament](https://github.com/google/filament) ★18885 [`3d-graphics`] [`android`] [`gltf`] [`gltf-viewer`] [`graphics`] [`metal`] [`opengl`] [`opengl-es`] [`pbr`] [`real-time`] [`vulkan`] [`wasm`] [`webgl`]  
...
- [moonlight-stream/moonlight-qt](https://github.com/moonlight-stream/moonlight-qt) ★14625 [`gamestream`] [`linux-app`] [`macos-app`] [`moonlight`] [`nvidia`] [`qt`] [`sdl2`] [`steam-link`] [`windows-app`]  
...
- [wkhtmltopdf/wkhtmltopdf](https://github.com/wkhtmltopdf/wkhtmltopdf) ★14382  
...
- [wangyu-/udp2raw](https://github.com/wangyu-/udp2raw) ★7987 [`bypass-firewall`] [`fake-header`] [`faketcp`] [`icmp`] [`icmp-tunnel`] [`icmptunnel`] [`raw-socket`] [`raw-tunnel`] [`tcp`] [`tunnel`] [`udp`] [`udp-tunnel`]  
...
- [rime/weasel](https://github.com/rime/weasel) ★6004  
...
- [zhongyang219/MusicPlayer2](https://github.com/zhongyang219/MusicPlayer2) ★5808  
...
- [Tatsu-syo/noMeiryoUI](https://github.com/Tatsu-syo/noMeiryoUI) ★5730  
...
- [xfangfang/wiliwili](https://github.com/xfangfang/wiliwili) ★4526 [`bilibili`] [`mpv`] [`nanovg`] [`nintendo-switch`] [`nintendo-switch-homebrew`] [`opencc`] [`opengl`] [`ps4`] [`psv`] [`xbox`]  
...
- [jwise/HoRNDIS](https://github.com/jwise/HoRNDIS) ★3127  
...
- [qiin2333/Sunshine-Foundation](https://github.com/qiin2333/Sunshine-Foundation) ★3088 [`cloudgaming`] [`game-streaming`] [`moonlight`] [`remote-desktop`] [`stream`] [`sunshine`]  
...
- [zero-peak/ZeroOmega](https://github.com/zero-peak/ZeroOmega) ★6301 [`proxy`] [`switchyomega`] [`zeroomega`]  
...
- [ColorlibHQ/AdminLTE](https://github.com/ColorlibHQ/AdminLTE) ★45048 [`admin`] [`admin-dashboard`] [`admin-dashboard-template`] [`admin-dashboard-ui`] [`admin-panel`] [`admin-template`] [`admin-ui`] [`bootstrap`] [`css`] [`dashboard`] [`dashboard-template`] [`dashboard-templates`] [`dashboards`] [`html`]  
...
- [houshanren/hangzhou_house_knowledge](https://github.com/houshanren/hangzhou_house_knowledge) ★27091 [`hangzhou`] [`knowledge`]  
...
- [AppFlowy-IO/AppFlowy](https://github.com/AppFlowy-IO/AppFlowy) ★65832 [`blog`] [`confluence-alternative`] [`content-management`] [`content-services`] [`documentation`] [`flutter`] [`note-taking`] [`notion-alternative`] [`project-management`] [`task-management`] [`team-collaboration`] [`wiki`]  
...
- [GopeedLab/gopeed](https://github.com/GopeedLab/gopeed) ★20562 [`android`] [`bittorrent`] [`cross-platform`] [`debian`] [`downloader`] [`flutter`] [`golang`] [`http`] [`https`] [`ios`] [`macos`] [`magnet`] [`torrent`] [`ubuntu`] [`windows`]  
...
- [wanghongenpin/proxypin](https://github.com/wanghongenpin/proxypin) ★10667 [`capture-traffic`] [`charles`] [`fiddler`] [`proxy`] [`proxypin`] [`zhuabao`]  
...
- [ComicSparks/pikapika](https://github.com/ComicSparks/pikapika) ★7538 [`acg`] [`android`] [`bika`] [`comic-books`] [`cosplay`] [`cross-platform`] [`e-hentai`] [`flutter`] [`game`] [`go`] [`golang`] [`hentai`] [`ios`] [`picacg`] [`picacomic`] [`r-18`]  
...
- [Anduin2017/HowToCook](https://github.com/Anduin2017/HowToCook) ★94594 [`chinese`] [`cookbook`] [`cooking`] [`dishes`] [`recipes`]  
...
- [Fechin/reference](https://github.com/Fechin/reference) ★9204 [`awk`] [`bash`] [`chatgpt`] [`cheatsheet`] [`cheatsheets`] [`css`] [`golang`] [`grep`] [`markdown`] [`python`] [`reference`] [`sed`] [`snippets`] [`vim`]  
...
- [fatedier/frp](https://github.com/fatedier/frp) ★99364 [`expose`] [`firewall`] [`frp`] [`go`] [`http-proxy`] [`nat`] [`p2p`] [`proxy`] [`reverse-proxy`] [`tunnel`]  
...
- [syncthing/syncthing](https://github.com/syncthing/syncthing) ★76628 [`go`] [`p2p`] [`peer-to-peer`] [`synchronization`]  
...
- [junegunn/fzf](https://github.com/junegunn/fzf) ★74229 [`bash`] [`cli`] [`fish`] [`fzf`] [`go`] [`neovim`] [`tmux`] [`unix`] [`vim`] [`zsh`]  
...
- [FiloSottile/mkcert](https://github.com/FiloSottile/mkcert) ★56756 [`certificates`] [`chrome`] [`firefox`] [`https`] [`ios`] [`linux`] [`local-development`] [`localhost`] [`macos`] [`root-ca`] [`tls`] [`windows`]  
...
- [minio/minio](https://github.com/minio/minio) ★55597 [`amazon-s3`] [`cloud`] [`cloudnative`] [`cloudstorage`] [`go`] [`k8s`] [`kubernetes`] [`multi-cloud`] [`multi-cloud-kubernetes`] [`objectstorage`] [`s3`] [`storage`]  
...
- [rclone/rclone](https://github.com/rclone/rclone) ★52839 [`azure-blob`] [`azure-blob-storage`] [`azure-files`] [`backblaze-b2`] [`cloud-storage`] [`dropbox`] [`encryption`] [`ftp`] [`fuse-filesystem`] [`go`] [`golang`] [`google-cloud-storage`] [`google-drive`] [`onedrive`] [`openstack-swift`] [`rclone`] [`s3`] [`sftp`] [`sync`] [`webdav`]  
...
- [go-gitea/gitea](https://github.com/go-gitea/gitea) ★51019 [`bitbucket`] [`cicd`] [`devops`] [`docker-registry-v2`] [`git`] [`git-gui`] [`git-server`] [`gitea`] [`github`] [`github-actions`] [`gitlab`] [`go`] [`golang`] [`hacktoberfest`] [`maven-server`] [`npm-registry`] [`vue`]  
...
- [gogs/gogs](https://github.com/gogs/gogs) ★47057 [`docker`] [`git`] [`go`] [`gogs`] [`mysql`] [`postgresql`] [`raspberry-pi`] [`scip-enabled`] [`self-hosted`] [`sqlite3`]  
...
- [v2ray/v2ray-core](https://github.com/v2ray/v2ray-core) ★46531 [`golang`] [`http-proxy`] [`proxy`] [`shadowsocks`] [`socks`] [`socks5`] [`v2ray`] [`vmess`]  
...
- [usememos/memos](https://github.com/usememos/memos) ★44781 [`docker`] [`foss`] [`go`] [`markdown`] [`memo`] [`microblog`] [`note-taking`] [`notecard`] [`react`] [`self-hosted`] [`social-network`] [`sqlite`]  
...
- [coreybutler/nvm-windows](https://github.com/coreybutler/nvm-windows) ★43099 [`go`] [`management`] [`node`] [`node-version-manager`] [`nodejs`] [`nvm`] [`switch`] [`version`] [`version-manager`] [`versioning`] [`windows`]  
...
- [ehang-io/nps](https://github.com/ehang-io/nps) ★33475 [`dns`] [`firewall`] [`go`] [`gzip`] [`http`] [`https`] [`nat`] [`nps`] [`snnapy`] [`socks`] [`socks5`] [`ssh`] [`tcp`] [`tunnel`] [`udp`]  
...
- [juanfont/headscale](https://github.com/juanfont/headscale) ★31537 [`tailscale`] [`tailscale-control-server`] [`tailscale-server`] [`wireguard`]  
...
- [filebrowser/filebrowser](https://github.com/filebrowser/filebrowser) ★31459 [`file-browser`] [`file-manager`] [`file-sharing`] [`go`] [`material-design`] [`self-hosted`] [`vue`]  
  这是一个用于浏览和管理文件的Web应用程序。它使用Python和Flask框架构建，提供文件上传、下载、删除、重命名等基本操作。用户可以通过Web界面直观地查看和操作文件，支持多种文件类型。项目包含用户认证模块，确保文件访问权限安全。
- [schollz/croc](https://github.com/schollz/croc) ★31243 [`data-transfer`] [`file-sharing`] [`golang`] [`pake`] [`peer-to-peer`] [`tcp`] [`transfer`]  
...
- [binwiederhier/ntfy](https://github.com/binwiederhier/ntfy) ★26504 [`curl`] [`notifications`] [`ntfy`] [`ntfysh`] [`pubsub`] [`push-notifications`] [`rest-api`]  
...
- [Wox-launcher/Wox](https://github.com/Wox-launcher/Wox) ★26174 [`alfred`] [`launcher`] [`launchy`] [`linux`] [`macos`] [`raycast`] [`spotlight`] [`windows`] [`wox`]  
...
- [tailscale/tailscale](https://github.com/tailscale/tailscale) ★25205 [`2fa`] [`oauth`] [`sso`] [`tailscale`] [`vpn`] [`wireguard`]  
...
- [cloudreve/cloudreve](https://github.com/cloudreve/cloudreve) ★25094 [`cloud`] [`cloud-storage`] [`cloudreve`] [`file`] [`file-manager`] [`file-sharing`] [`golang`]  
...
- [containrrr/watchtower](https://github.com/containrrr/watchtower) ★23694 [`automation`] [`continuous-delivery`] [`devops`] [`docker`] [`hacktoberfest`] [`notifications`] [`receive-notifications`] [`registry`] [`update-checker`] [`watchtower`]  
...
- [chaitin/SafeLine](https://github.com/chaitin/SafeLine) ★18184 [`api-gateway`] [`application-security`] [`appsec`] [`blueteam`] [`bruteforce`] [`captcha`] [`cve`] [`cybersecurity`] [`firewall`] [`hackers`] [`http-flood`] [`security`] [`self-hosted`] [`sql-injection`] [`vulnerability`] [`waf`] [`web-application-firewall`] [`web-security`] [`websecurity`] [`xss`]  
...
- [apernet/hysteria](https://github.com/apernet/hysteria) ★17463 [`censorship-circumvention`] [`golang`] [`http-proxy`] [`hysteria`] [`proxy`] [`quic`] [`relay`] [`reliable-udp`] [`socks5`] [`tun`] [`vpn`]  
...
- [OpenListTeam/OpenList](https://github.com/OpenListTeam/OpenList) ★16564 [`alist`] [`aliyunpan`] [`baidupan`] [`openlist`]  
...
- [ory/hydra](https://github.com/ory/hydra) ★16563 [`authorization`] [`cloud`] [`docker`] [`federation`] [`hacktoberfest`] [`hydra`] [`identity`] [`oauth`] [`oauth-provider`] [`oauth2`] [`oauth2-provider`] [`oauth2-server`] [`oidc`] [`openid`] [`openid-connect`] [`openid-connect-provider`] [`openid-provider`] [`security`] [`server`] [`sso`]  
...
- [slackhq/nebula](https://github.com/slackhq/nebula) ★16265  
...
- [m1k1o/neko](https://github.com/m1k1o/neko) ★15559 [`docker`] [`golang`] [`media-streaming`] [`remote-control`] [`remote-desktop`] [`self-hosted`] [`virtual-browser`] [`vue`] [`webrtc`]  
...
- [jeessy2/ddns-go](https://github.com/jeessy2/ddns-go) ★15399 [`alidns`] [`baiduyun`] [`cloudflare`] [`ddns`] [`ddns-go`] [`dnspod`] [`godaddy-ddns`] [`google-domains`] [`porkbun`]  
...
- [gotify/server](https://github.com/gotify/server) ★13819 [`api`] [`cloud`] [`free-software`] [`golang`] [`gotify`] [`hosting`] [`javascript`] [`notifications`] [`privacy`] [`react`] [`self-hosted`] [`self-hosting`] [`selfhosted`]  
...
- [tinode/chat](https://github.com/tinode/chat) ★12800 [`chat`] [`chat-application`] [`chatapp`] [`chatbots`] [`chatserver`] [`collaboration`] [`go`] [`golang`] [`instant-messaging`] [`messaging`] [`messaging-api`] [`messenger`] [`telegram`] [`video-call`] [`video-chat`] [`video-conferencing`] [`webchat-server`] [`webrtc`] [`whatsapp`] [`xmpp`]  
  这是一个开源的即时通讯平台，基于WebSockets协议，提供可靠的实时消息传递。它使用Go语言开发，采用模块化设计，包含服务器端和客户端库，支持多种平台和设备。该平台易于扩展和定制，适合构建各种需要实时通信的应用，例如聊天室、协作工具等。
- [casdoor/casdoor](https://github.com/casdoor/casdoor) ★12328 [`auth`] [`authentication`] [`authn`] [`casbin`] [`casdoor`] [`faceid`] [`iam`] [`kerberos`] [`ldap`] [`mfa`] [`oauth`] [`oidc`] [`payment-gateway`] [`radius`] [`saml`] [`scim`] [`single-sign-on`] [`sso`] [`totp`] [`webauthn`]  
...
- [fullstorydev/grpcurl](https://github.com/fullstorydev/grpcurl) ★12104 [`golang`] [`grpc`] [`protobuf`]  
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) ★11682 [`argo-tunnel`] [`cloudflare`] [`cloudflare-tunnel`] [`reverse-proxy`] [`zero-trust-network-access`]  
...
- [therecipe/qt](https://github.com/therecipe/qt) ★10729 [`android`] [`asteroidos`] [`cross-platform-gui`] [`felgo`] [`freebsd`] [`go`] [`golang`] [`gui-framework`] [`ios`] [`javascript`] [`linux`] [`macos`] [`qt`] [`raspberry-pi`] [`sailfish-os`] [`ubuntu-touch`] [`webassembly`] [`windows`]  
...
- [putyy/res-downloader](https://github.com/putyy/res-downloader) ★10558 [`douyin`] [`kuaishou`] [`res-downloader`] [`wechat`] [`wechat-video`] [`xiaohongshu`]  
...
- [0xJacky/nginx-ui](https://github.com/0xJacky/nginx-ui) ★9677 [`chatgpt-app`] [`code-completion`] [`copilot`] [`cron`] [`deepseek-r1`] [`docker`] [`go`] [`letsencrypt`] [`linux`] [`macos`] [`mcp`] [`mcp-server`] [`nginx`] [`self-hosted`] [`vue`] [`webui`] [`windows`]  
...
- [gokcehan/lf](https://github.com/gokcehan/lf) ★8628 [`file-manager`] [`terminal`]  
...
- [certimate-go/certimate](https://github.com/certimate-go/certimate) ★7540 [`acme`] [`acme-client`] [`automation`] [`certbot`] [`hacktoberfest`] [`https`] [`https-certificate`] [`lego`] [`letsencrypt`] [`ssl`] [`ssl-cert`] [`ssl-certificate`] [`ssl-certificates`]  
...
- [ViRb3/wgcf](https://github.com/ViRb3/wgcf) ★7157 [`client`] [`cloudflare`] [`plus`] [`security`] [`vpn`] [`warp`] [`wireguard`]  
...
- [Hackl0us/GeoIP2-CN](https://github.com/Hackl0us/GeoIP2-CN) ★7097 [`clash`] [`geoip`] [`geoip2`] [`proxy`] [`quantumultx`] [`shadowrocket`] [`shadowsocks`] [`surge`]  
...
- [gdy666/lucky](https://github.com/gdy666/lucky) ★6554 [`acme`] [`aliyunpan`] [`cron`] [`ddns`] [`dynadot`] [`filebrowser`] [`ftp`] [`ipv6`] [`socat`] [`stun`] [`vercel`] [`volcengine`] [`webdav`] [`wol`]  
...
- [ouqiang/gocron](https://github.com/ouqiang/gocron) ★6197 [`cron`] [`crontab`] [`golang`] [`scheduler`]  
...
- [git-jiadong/wechatDataBackup](https://github.com/git-jiadong/wechatDataBackup) ★5734 [`wechat`] [`wechat-app`] [`wechat-bot`]  
...
- [hacdias/webdav](https://github.com/hacdias/webdav) ★4790 [`filesystem`] [`go`] [`http`] [`server`] [`webdav`]  
...
- [qjfoidnh/BaiduPCS-Go](https://github.com/qjfoidnh/BaiduPCS-Go) ★3982 [`baidupcs`]  
...
- [yunionio/cloudpods](https://github.com/yunionio/cloudpods) ★2799 [`architecture`] [`aws`] [`azure`] [`baremetal`] [`baremetal-provisioning`] [`cloud`] [`cmp`] [`enterprises`] [`gcp`] [`hybridcloud`] [`iaas`] [`infrastructure`] [`kubernetes`] [`kvm`] [`multi-cloud`] [`multicloud`] [`openstack`] [`private-cloud`] [`qemu`] [`vsphere`]  
...
- [trzsz/trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ★2263 [`openssh`] [`openssh-client`] [`rz`] [`ssh`] [`ssh-client`] [`sz`] [`tmux`] [`trz`] [`trzsz`] [`tsz`] [`zmodem`]  
...
- [koho/frpmgr](https://github.com/koho/frpmgr) ★1778 [`frp`] [`frpc`] [`go`] [`gui`] [`proxy`] [`reverse-proxy`] [`windows`]  
...
- [kingwrcy/moments](https://github.com/kingwrcy/moments) ★1776  
...
- [samwafgo/SamWaf](https://github.com/samwafgo/SamWaf) ★1167  
...
- [jgm/pandoc](https://github.com/jgm/pandoc) ★39504 [`commonmark`] [`converter`] [`document`] [`haskell`] [`markdown`] [`markup`] [`pandoc`] [`presentation`] [`publishing`]  
...
- [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) ★113519 [`awesome-list`] [`free-for-developers`]  
...
- [vernesong/OpenClash](https://github.com/vernesong/OpenClash) ★22105 [`clash`] [`luci`] [`mihomo`] [`openclash`] [`openwrt`] [`shadowsocks`] [`snell`] [`v2ray`] [`vmess`]  
...
- [uikit/uikit](https://github.com/uikit/uikit) ★18487  
...
- [CaiJimmy/hugo-theme-stack](https://github.com/CaiJimmy/hugo-theme-stack) ★5961 [`bloggers`] [`css`] [`hacktoberfest`] [`hugo`] [`hugo-theme`] [`theme`]  
...
- [vbskycn/iptv](https://github.com/vbskycn/iptv) ★4661  
...
- [cf-pages/Telegraph-Image](https://github.com/cf-pages/Telegraph-Image) ★4187 [`cloudflare`] [`cloudflare-pages`] [`flickr`] [`image`] [`image-host`] [`image-hosting`] [`image-sharing`] [`imgur`] [`serverless`] [`telegraph`] [`upload-images`]  
...
- [aoaostar/legado](https://github.com/aoaostar/legado) ★4038 [`legado`] [`legado3`]  
...
- [EvilCult/iptv-m3u-maker](https://github.com/EvilCult/iptv-m3u-maker) ★2843 [`iptv`] [`m3u`] [`m3u8-playlist`] [`python`] [`tv`]  
...
- [xisohi/CHINA-IPTV](https://github.com/xisohi/CHINA-IPTV) ★880  
...
- [Stirling-Tools/Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF) ★68379 [`docker`] [`java`] [`pdf`] [`pdf-converter`] [`pdf-editor`] [`pdf-manipulation`] [`pdf-merger`] [`pdf-ocr`] [`pdf-tools`] [`pdf-web-apps`] [`pdfmerger`]  
...
- [termux/termux-app](https://github.com/termux/termux-app) ★45723 [`android`] [`hacktoberfest`] [`linux`] [`terminal`] [`termux`]  
...
- [skylot/jadx](https://github.com/skylot/jadx) ★45696 [`android`] [`decompiler`] [`dex`] [`java`]  
...
- [dbeaver/dbeaver](https://github.com/dbeaver/dbeaver) ★45673 [`ai`] [`copilot`] [`database`] [`db2`] [`dbeaver`] [`erd`] [`gui`] [`java`] [`jdbc`] [`mysql`] [`nosql`] [`openai`] [`oracle`] [`postgresql`] [`redshift`] [`sql`] [`sqlite`] [`sqlserver`]  
...
- [halo-dev/halo](https://github.com/halo-dev/halo) ★37055 [`blog`] [`blog-engine`] [`cms`] [`content-management-system`] [`halo`] [`halocms`] [`website-builder`]  
...
- [DrKLO/Telegram](https://github.com/DrKLO/Telegram) ★27664 [`telegram`]  
...
- [dataease/dataease](https://github.com/dataease/dataease) ★22017 [`apache-doris`] [`business-intelligence`] [`data-analysis`] [`data-visualization`] [`echarts`] [`kettle`] [`superset`] [`tableau`]  
...
- [pxb1988/dex2jar](https://github.com/pxb1988/dex2jar) ★12924  
...
- [microg/GmsCore](https://github.com/microg/GmsCore) ★11105 [`android`] [`auth`] [`cloud-messaging`] [`firebase`] [`geolocation`] [`google`] [`google-cloud-messaging`] [`java`] [`kotlin`] [`kotlin-android`] [`maps`] [`microg`] [`mobile`] [`push-notifications`]  
...
- [jeecgboot/jimureport](https://github.com/jeecgboot/jimureport) ★7615 [`bi`] [`bigscreen`] [`birt`] [`data-analysis`] [`data-visualization`] [`dataease`] [`datav`] [`echart`] [`echarts`] [`finereport`] [`highcharts`] [`ireport`] [`jasperreport`] [`jfreechart`] [`metabase`] [`print`] [`redash`] [`report`] [`superset`] [`tableau`]  
...
- [SuperMonster003/AutoJs6](https://github.com/SuperMonster003/AutoJs6) ★4706 [`android`] [`autojs`] [`autojs6`] [`automated-tool`] [`automation`] [`javascript`]  
...
- [niumoo/bing-wallpaper](https://github.com/niumoo/bing-wallpaper) ★3103 [`bing`] [`bing-image`] [`bing-wallpaper`] [`wallpaper`]  
...
- [qaiu/netdisk-fast-download](https://github.com/qaiu/netdisk-fast-download) ★2184 [`api`] [`download`] [`drive`] [`file-server`] [`ilanzou`] [`java`] [`netdisk-fast-download`] [`onedrive`] [`parser`] [`share`] [`vertx`] [`webserver`] [`yunpan`]  
...
- [louislam/uptime-kuma](https://github.com/louislam/uptime-kuma) ★75743 [`docker`] [`monitor`] [`monitoring`] [`responsive`] [`self-hosted`] [`selfhosted`] [`single-page-app`] [`socket-io`] [`uptime`] [`uptime-monitoring`] [`webapp`] [`websocket`]  
...
- [mozilla/pdf.js](https://github.com/mozilla/pdf.js) ★52009  
...
- [marktext/marktext](https://github.com/marktext/marktext) ★51791 [`dark-mode`] [`editor`] [`electron`] [`element-ui`] [`emoji`] [`focus-mode`] [`latex`] [`linux`] [`mac`] [`macos`] [`markdown`] [`marktext`] [`next-generation`] [`source-code`] [`typewriter-mode`] [`vue`] [`windows`]  
...
- [agalwood/Motrix](https://github.com/agalwood/Motrix) ★49404 [`aria2`] [`bittorrent`] [`bt`] [`download`] [`download-manager`] [`electron`] [`linux`] [`mac`] [`macos`] [`magnet`] [`motrix`] [`torrent`] [`windows`]  
...
- [LeCoupa/awesome-cheatsheets](https://github.com/LeCoupa/awesome-cheatsheets) ★44447 [`backend`] [`bash`] [`cheatsheet`] [`cheatsheets`] [`database`] [`django`] [`docker`] [`feathersjs`] [`frontend`] [`javascript`] [`kubernetes`] [`language`] [`nodejs`] [`php`] [`programming-language`] [`redis`] [`sailsjs`] [`vim`] [`vuejs`] [`xcode`]  
...
- [HeyPuter/puter](https://github.com/HeyPuter/puter) ★36700 [`cloud`] [`cloud-os`] [`cloud-storage`] [`desktop`] [`desktop-environment`] [`dropbox`] [`good-first-issue`] [`gui`] [`javascript`] [`nas`] [`open-source`] [`operating-system`] [`os`] [`osjs`] [`puter`] [`remote-desktop`] [`storage`] [`web-desktop`] [`web-os`] [`webtop`]  
...
- [markedjs/marked](https://github.com/markedjs/marked) ★35799 [`commonmark`] [`compiler`] [`gfm`] [`hacktoberfest`] [`markdown`] [`parser`]  
...
- [qishibo/AnotherRedisDesktopManager](https://github.com/qishibo/AnotherRedisDesktopManager) ★33211 [`redis`] [`redis-client`] [`redis-cluster`] [`redis-desktop-manager`] [`redis-gui`]  
...
- [webtorrent/webtorrent](https://github.com/webtorrent/webtorrent) ★30493 [`bittorrent`] [`browser`] [`hacktoberfest`] [`javascript`] [`nodejs`] [`p2p`] [`streaming`] [`torrent`] [`webrtc`] [`webtorrent`]  
...
- [docsifyjs/docsify](https://github.com/docsifyjs/docsify) ★30482 [`doc`] [`docs`] [`docsify`] [`documentation`] [`documentation-tool`] [`github-pages`] [`markdown`] [`vue`]  
...
- [layui/layui](https://github.com/layui/layui) ★30372 [`component-library`] [`css`] [`html`] [`javascript`] [`layui`] [`ui-kit`] [`ui-library`]  
...
- [NginxProxyManager/nginx-proxy-manager](https://github.com/NginxProxyManager/nginx-proxy-manager) ★28729 [`nginx`] [`nginx-proxy`]  
...
- [songquanpeng/one-api](https://github.com/songquanpeng/one-api) ★27438 [`api`] [`api-gateway`] [`azure-openai-api`] [`chatgpt`] [`claude`] [`ernie-bot`] [`gemini`] [`gpt`] [`openai`] [`openai-api`] [`proxy`]  
...
- [fanmingming/live](https://github.com/fanmingming/live) ★26658 [`china`] [`converter`] [`epg`] [`iptv`] [`ipv6`] [`live`] [`m3u`] [`m3u8`] [`mp4`] [`radio`] [`television`] [`tv`] [`txt`] [`workers`]  
...
- [Z-Siqi/Clash-for-Windows_Chinese](https://github.com/Z-Siqi/Clash-for-Windows_Chinese) ★26443 [`chinese`] [`clash`] [`clash-chinese`] [`shadowsocks`] [`windows`] [`zh-cn`]  
...
- [localForage/localForage](https://github.com/localForage/localForage) ★25609 [`indexeddb`] [`javascript`] [`localforage`] [`localstorage`] [`offline`] [`storage`] [`websql`]  
...
- [blackmatrix7/ios_rule_script](https://github.com/blackmatrix7/ios_rule_script) ★22728  
...
- [handsontable/handsontable](https://github.com/handsontable/handsontable) ★21494 [`angular-datagrid`] [`angular-table`] [`component`] [`crud-operations`] [`data-editing`] [`data-grid`] [`data-management`] [`data-tables`] [`datagrid`] [`datatable`] [`excel`] [`excel-javascript`] [`grid`] [`grid-component`] [`react-datatable`] [`react-grid`] [`spreadsheet`] [`table`] [`vue-table`]  
...
- [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) ★20046 [`address`] [`administrative-divisions`] [`area`] [`china`] [`city`] [`csv`] [`json`] [`nodejs`] [`province`] [`street`]  
...
- [docmirror/dev-sidecar](https://github.com/docmirror/dev-sidecar) ★19608 [`dev-sidecar`] [`dns-ip`] [`electron`] [`fastgit`] [`fastgithub`] [`gfw`] [`internet`] [`lerna`] [`mitmproxy`] [`proxy`]  
...
- [SnapDrop/snapdrop](https://github.com/SnapDrop/snapdrop) ★19538 [`pwa`] [`snapdrop`] [`webrtc`]  
...
- [SocialSisterYi/bilibili-API-collect](https://github.com/SocialSisterYi/bilibili-API-collect) ★19083 [`api`] [`bilibili`] [`bilibili-api`] [`bilibili-comment`] [`bilibili-danmaku`] [`bilibili-download`] [`bilibili-live`] [`bilibili-login`] [`grpc`] [`json`]  
...
- [SillyTavern/SillyTavern](https://github.com/SillyTavern/SillyTavern) ★18971 [`ai`] [`chat`] [`llm`]  
...
- [HelloZeroNet/ZeroNet](https://github.com/HelloZeroNet/ZeroNet) ★18661 [`anonymity`] [`anticensorship`] [`bitcoin`] [`bittorrent`] [`decentralized`] [`internet-freedom`] [`p2p`] [`python`] [`realtime`] [`tor`] [`torrent`] [`web`]  
...
- [GoogleChrome/chrome-extensions-samples](https://github.com/GoogleChrome/chrome-extensions-samples) ★16907 [`chrome`]  
...
- [xifangczy/cat-catch](https://github.com/xifangczy/cat-catch) ★15924 [`chrome`] [`chrome-extension`] [`firefox`] [`firefox-extension`] [`javascript`] [`jquery`] [`m3u8-downloader`] [`video-downloader`]  
  这是一个用于捕捉图像中猫的Python项目。它利用OpenCV库进行图像处理，并使用深度学习模型（例如YOLOv5）来检测和定位猫。项目提供预训练模型，并支持自定义模型训练。用户可以轻松地将项目集成到其他应用程序中，以实现猫的自动识别和追踪。
- [pot-app/pot-desktop](https://github.com/pot-app/pot-desktop) ★15444 [`linux`] [`macos`] [`ocr`] [`pot`] [`pot-app`] [`recognize`] [`tauri`] [`translate`] [`translation`] [`tts`] [`windows`]  
...
- [pandao/editor.md](https://github.com/pandao/editor.md) ★14254 [`codemirror`] [`commonmark`] [`documentation`] [`editor`] [`flowchart`] [`gfm`] [`javascript`] [`jquery`] [`katex`] [`markdown`] [`markdown-editor`] [`markdown-writer`] [`marked`] [`sequence-diagram`] [`toc`]  
...
- [electerm/electerm](https://github.com/electerm/electerm) ★13082 [`electerm`] [`electron`] [`file-manager`] [`ftp`] [`linux-app`] [`macos-app`] [`open-source`] [`rdp`] [`serialport`] [`sftp`] [`ssh`] [`telnet`] [`terminal`] [`vnc`] [`windows-app`]  
...
- [mickael-kerjean/filestash](https://github.com/mickael-kerjean/filestash) ★12811 [`dwg`] [`file-manager`] [`file-sharing`] [`filemanager`] [`ftp`] [`git`] [`ldap`] [`mcp`] [`nfs`] [`raw`] [`s3`] [`sftp`] [`smb`] [`webdav`]  
...
- [mayswind/AriaNg](https://github.com/mayswind/AriaNg) ★12587 [`aria2`] [`ariang`] [`download`] [`gui`] [`html`] [`javascript`] [`ui`] [`web`] [`web-frontend`] [`webui`]  
...
- [QuantumNous/new-api](https://github.com/QuantumNous/new-api) ★11077 [`ai-gateway`] [`claude`] [`deepseek`] [`gemini`] [`openai`] [`rerank`]  
...
- [tangly1024/NotionNext](https://github.com/tangly1024/NotionNext) ★10334 [`blog`] [`nextjs`] [`notion`] [`react`] [`tailwindcss`] [`vercel`] [`zeabur`]  
...
- [gskinner/regexr](https://github.com/gskinner/regexr) ★10236  
...
- [stevenjoezhang/live2d-widget](https://github.com/stevenjoezhang/live2d-widget) ★10085 [`javascript-plugin`] [`live2d`]  
...
- [webtorrent/webtorrent-desktop](https://github.com/webtorrent/webtorrent-desktop) ★9946 [`bittorrent`] [`electron`] [`hacktoberfest`] [`javascript`] [`linux`] [`macos`] [`nodejs`] [`p2p`] [`streaming`] [`webrtc`] [`webtorrent`] [`windows`]  
...
- [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) ★9863 [`analytics`] [`bot-detection`] [`browser-detection`] [`client-hints`] [`device-detection`] [`mobile-detection`] [`user-agent`] [`user-agent-parser`]  
...
- [cmliu/CF-Workers-docker.io](https://github.com/cmliu/CF-Workers-docker.io) ★8707 [`cloudflare-pages`] [`cloudflare-workers`] [`docker`] [`dockerhub`]  
...
- [is-a-dev/register](https://github.com/is-a-dev/register) ★8426 [`cloudflare`] [`dev`] [`developer`] [`dns`] [`domain`] [`foss`] [`free`] [`free-domain`] [`free-for-dev`] [`free-for-developers`] [`github-pages`] [`oss`] [`subdomain`] [`website`]  
...
- [codecombat/codecombat](https://github.com/codecombat/codecombat) ★8283  
...
- [fishjar/kiss-translator](https://github.com/fishjar/kiss-translator) ★7540 [`extension`] [`translate`] [`translation`] [`translator`] [`userscript`] [`userscripts`]  
...
- [floccusaddon/floccus](https://github.com/floccusaddon/floccus) ★7117 [`bookmark`] [`bookmarks`] [`browser-bookmarks`] [`chrome`] [`chrome-extension`] [`edge-extension`] [`firefox`] [`firefox-addon`] [`firefox-extension`] [`nextcloud`] [`nextcloud-bookmarks`] [`owncloud`] [`sync`] [`sync-solution`] [`syncing-bookmarks`] [`webdav`] [`webextension`]  
...
- [LiteLoaderQQNT/LiteLoaderQQNT](https://github.com/LiteLoaderQQNT/LiteLoaderQQNT) ★6934 [`furry`] [`liteloaderqqnt`] [`qqnt`]  
...
- [zumerlab/snapdom](https://github.com/zumerlab/snapdom) ★6272 [`capture-screenshots`] [`clone`] [`dom`] [`js`] [`screenshot`]  
...
- [metowolf/vCards](https://github.com/metowolf/vCards) ★5994 [`china`] [`ios`] [`macos`] [`vcards`]  
...
- [2hacc/TVBox](https://github.com/2hacc/TVBox) ★5581 [`tvbox`]  
...
- [samyk/evercookie](https://github.com/samyk/evercookie) ★4676  
...
- [tangyoha/telegram_media_downloader](https://github.com/tangyoha/telegram_media_downloader) ★3903 [`cosplatfrom`] [`cross-platform`] [`downloader`] [`flask`] [`media-downloader`] [`telegram-bot`]  
...
- [songquanpeng/message-pusher](https://github.com/songquanpeng/message-pusher) ★3470 [`bark`] [`dingtalk`] [`discord`] [`email`] [`feishu`] [`lark`] [`message-pusher`] [`telegram`] [`websocket`] [`wechat`]  
...
- [NeverDecaf/chromium-web-store](https://github.com/NeverDecaf/chromium-web-store) ★2777 [`chrome-extension`] [`chromium`] [`ungoogled-chromium`]  
...
- [mayswind/AriaNg-Native](https://github.com/mayswind/AriaNg-Native) ★2540 [`aria2`] [`ariang`] [`desktop`] [`download`] [`electron`] [`gui`] [`html`] [`javascript`] [`ui`] [`web`]  
...
- [vertex-app/vertex](https://github.com/vertex-app/vertex) ★1567  
...
- [Pactum7/ticket-grabbing](https://github.com/Pactum7/ticket-grabbing) ★1527  
...
- [Cay-Zhang/RSSBud](https://github.com/Cay-Zhang/RSSBud) ★1440 [`ios`] [`rss`] [`rss-generator`] [`rssbud`] [`rsshub`] [`rsshub-radar`] [`swiftui`]  
...
- [ShilongLee/Crawler](https://github.com/ShilongLee/Crawler) ★1157  
...
- [aiselp/AutoX](https://github.com/aiselp/AutoX) ★1088  
...
- [lkmvip/netflix-4K-DDplus](https://github.com/lkmvip/netflix-4K-DDplus) ★717 [`4k`] [`chromium`] [`ddplus`] [`edge`] [`netflix`]  
...
- [cv-cat/XianYuApis](https://github.com/cv-cat/XianYuApis) ★693  
...
- [2dust/v2rayNG](https://github.com/2dust/v2rayNG) ★45508 [`android`] [`proxy`] [`shadowsocks`] [`socks5`] [`trojan`] [`v2fly`] [`v2ray`] [`vless`] [`vmess`] [`vpn`] [`xray`] [`xtls`]  
...
- [bannedbook/fanqiang](https://github.com/bannedbook/fanqiang) ★40623 [`brook`] [`daze`] [`fanqiang`] [`goflyway`] [`lightsocks`] [`proxy`] [`psiphon`] [`shadowsocks`] [`ssr`] [`trojan`] [`v2ray`]  
  这是一个用于科学上网的翻墙工具，提供多种连接方式，支持多种操作系统。它使用Go语言开发，核心模块包括代理服务器和连接管理，并整合了多种开源库。该项目旨在为用户提供快速、稳定、便捷的网络访问方式，绕过地区限制。
- [gkd-kit/gkd](https://github.com/gkd-kit/gkd) ★31305 [`accessibility`] [`android`] [`auto`] [`click`] [`compose`] [`jetpack-compose`] [`kotlin`] [`kotlin-js`] [`kotlin-multiplatform`] [`webassembly`]  
...
- [MetaCubeX/ClashMetaForAndroid](https://github.com/MetaCubeX/ClashMetaForAndroid) ★27791  
...
- [pppscn/SmsForwarder](https://github.com/pppscn/SmsForwarder) ★22941 [`android`] [`api`] [`app`] [`bark`] [`call`] [`chatgpt`] [`dingding`] [`forward`] [`mqtt`] [`pushdear`] [`pushplus`] [`serverchan`] [`sms`] [`smtp`] [`telegram`] [`webhook`] [`wechatapp`]  
...
- [RikkaApps/Shizuku](https://github.com/RikkaApps/Shizuku) ★17630  
...
- [MatsuriDayo/NekoBoxForAndroid](https://github.com/MatsuriDayo/NekoBoxForAndroid) ★16415 [`android`] [`gfw`] [`proxy`] [`shadowsocks`] [`sing-box`] [`trojan`] [`vmess`] [`vpn`]  
...
- [mihonapp/mihon](https://github.com/mihonapp/mihon) ★16126 [`android`] [`kotlin`] [`manga`] [`manga-downloader`] [`manga-reader`] [`mangadownloader`] [`mangareader`] [`tachiyomi`] [`tachiyomi-alternative`]  
...
- [tiann/KernelSU](https://github.com/tiann/KernelSU) ★13655 [`android`] [`kernel`] [`kernelsu`] [`root`] [`su`]  
...
- [open-ani/animeko](https://github.com/open-ani/animeko) ★11817 [`android`] [`ani`] [`anime`] [`bangumi`] [`bittorrent`] [`bt`] [`compose`] [`compose-multiplatform`] [`danmaku`] [`ios`] [`jetpack-compose`] [`kotlin`] [`kotlin-multiplatform`] [`linux`] [`macos`] [`player`] [`torrent`] [`video`] [`windows`]  
...
- [ankidroid/Anki-Android](https://github.com/ankidroid/Anki-Android) ★10083 [`android`] [`anki`] [`ankidroid`] [`education`] [`flashcards`] [`kotlin`] [`learning`] [`srs`]  
...
- [zhanghai/MaterialFiles](https://github.com/zhanghai/MaterialFiles) ★7453 [`android`] [`android-application`] [`file-manager`] [`kotlin`] [`kotlin-android`] [`material-design`]  
...
- [aaa1115910/bv](https://github.com/aaa1115910/bv) ★3231  
...
- [gallonyin/worktool](https://github.com/gallonyin/worktool) ★2828  
...
- [KDE/kdeconnect-android](https://github.com/KDE/kdeconnect-android) ★1218  
...
- [Kong/kong](https://github.com/Kong/kong) ★41897 [`ai`] [`ai-gateway`] [`api-gateway`] [`api-management`] [`apis`] [`artificial-intelligence`] [`cloud-native`] [`devops`] [`kubernetes`] [`kubernetes-ingress`] [`kubernetes-ingress-controller`] [`llm-gateway`] [`llm-ops`] [`mcp`] [`mcp-gateway`] [`microservice`] [`microservices`] [`openai-proxy`] [`reverse-proxy`] [`serverless`]  
...
- [iDvel/rime-ice](https://github.com/iDvel/rime-ice) ★13261 [`rime`] [`rime-config`] [`rime-custom`] [`rime-schema`] [`rime-squirrel`] [`rime-weasel`]  
  这是一个基于Rime输入法的冰岛语输入方案。它提供准确的冰岛语字符输入，支持各种冰岛语字母组合和特殊字符。该方案使用Python编写，并利用Rime的规则引擎实现。项目包含详细的配置说明，方便用户快速上手并自定义输入习惯。
- [luarocks/luarocks](https://github.com/luarocks/luarocks) ★3576 [`lua`] [`lua-modules`] [`luajit`] [`luarocks`] [`package-management`] [`package-manager`]  
...
- [jaywcjlove/linux-command](https://github.com/jaywcjlove/linux-command) ★34589 [`bash`] [`chrome`] [`chrome-extension`] [`command-line`] [`gh-pages`] [`linux`] [`linux-command`] [`ls`] [`screen`] [`screenshot`] [`search`] [`ssh`] [`tools`] [`web-tools`]  
...
- [twbs/bootstrap](https://github.com/twbs/bootstrap) ★173509 [`bootstrap`] [`css`] [`css-framework`] [`html`] [`javascript`] [`sass`] [`scss`]  
...
- [996icu/996.ICU](https://github.com/996icu/996.ICU) ★274486  
  该项目是一个关于中国程序员工作强度和压力的匿名吐槽平台。用户可以通过匿名发表帖子，分享工作经历和感受。平台使用简单的文本格式，并支持搜索和过滤功能。该项目主要使用PHP语言开发，并使用数据库存储用户数据和帖子信息。
- [awesome-selfhosted/awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ★251458 [`awesome`] [`awesome-list`] [`cloud`] [`free-software`] [`hosting`] [`privacy`] [`self-hosted`] [`selfhosted`]  
  这是一个收集各种可自托管软件的资源列表。涵盖了从博客和论坛到视频会议和VPN等各种应用。列表按类别组织，便于用户快速找到所需的自托管工具。该项目使用纯文本格式维护，便于轻松更新和浏览。
- [justjavac/free-programming-books-zh_CN](https://github.com/justjavac/free-programming-books-zh_CN) ★115371 [`android`] [`angular`] [`books`] [`free`] [`ios`] [`javascript`] [`kotlin`] [`pdf`] [`programming`] [`python`] [`react`] [`react-native`] [`swift`] [`vue`]  
...
- [deepseek-ai/DeepSeek-R1](https://github.com/deepseek-ai/DeepSeek-R1) ★91244  
...
- [ruanyf/weekly](https://github.com/ruanyf/weekly) ★76519  
...
- [PlexPt/awesome-chatgpt-prompts-zh](https://github.com/PlexPt/awesome-chatgpt-prompts-zh) ★56405 [`chat-gpt`] [`chatgpt`] [`chatgpt3`] [`chatgpt4`] [`gpt`]  
...
- [justjavac/awesome-wechat-weapp](https://github.com/justjavac/awesome-wechat-weapp) ★49247 [`demo`] [`minapp`] [`miniprogram`] [`weapp-demo`] [`wechat`] [`wechat-weapp`] [`wepy`] [`wxapp`] [`wxml`]  
...
- [SheetJS/sheetjs](https://github.com/SheetJS/sheetjs) ★35951 [`angular`] [`bun`] [`csv`] [`data`] [`database`] [`deno`] [`excel`] [`grid`] [`html`] [`html5`] [`ios`] [`javascript`] [`json`] [`nodejs`] [`react`] [`spreadsheet`] [`table`] [`vue`] [`xlsx`] [`xml`]  
...
- [ziadoz/awesome-php](https://github.com/ziadoz/awesome-php) ★31970 [`awesome`] [`awesome-lists`] [`php`] [`php-applications`] [`php-framework`] [`php-installation`] [`php-library`]  
...
- [XIU2/TrackersListCollection](https://github.com/XIU2/TrackersListCollection) ★29483 [`aria2`] [`aria2-format-tracker`] [`bittorrent`] [`bittorrent-trackers`] [`qbittorrent`] [`torrent`] [`torrent-tracker`] [`tracker`] [`trackers`] [`trackerslist`] [`utorrent`]  
...
- [geekcompany/ResumeSample](https://github.com/geekcompany/ResumeSample) ★27882  
...
- [imDazui/Tvlist-awesome-m3u-m3u8](https://github.com/imDazui/Tvlist-awesome-m3u-m3u8) ★27632 [`awesome`] [`iptv`] [`iptv-channels`] [`iptv-free`] [`iptv-m3u8`] [`iptv-playlist`] [`kodi`] [`kodi-addons`] [`kodi-plugin`] [`m3u`] [`m3u8`]  
...
- [gfwlist/gfwlist](https://github.com/gfwlist/gfwlist) ★24622 [`anticensorship`] [`censorship`] [`censorship-circumvention`] [`china`] [`gfw`]  
...
- [zijie0/HumanSystemOptimization](https://github.com/zijie0/HumanSystemOptimization) ★20620  
...
- [AZeC4/TelegramGroup](https://github.com/AZeC4/TelegramGroup) ★18834 [`telegram`] [`telegram-api`] [`telegram-bot`] [`telegram-bot-api`] [`telegram-bots`] [`telegram-channel`] [`telegramgroups`]  
...
- [Johnshall/Shadowrocket-ADBlock-Rules-Forever](https://github.com/Johnshall/Shadowrocket-ADBlock-Rules-Forever) ★17423 [`adblock`] [`gfw`] [`proxy`] [`shadowrocket`] [`v2ray`]  
  该项目提供了一套用于Shadowrocket的广告拦截规则，旨在永久性地屏蔽广告。规则集包含广泛的广告域名和资源，并持续更新。使用Swift编写，通过配置文件实现规则管理，方便用户导入和导出。项目结构清晰，易于维护和扩展。
- [xiaye13579/BBLL](https://github.com/xiaye13579/BBLL) ★16845 [`android`] [`apk`] [`bilibili`] [`bilibili-client`] [`bilibili-tv`] [`tv`]  
...
- [sparanoid/chinese-copywriting-guidelines](https://github.com/sparanoid/chinese-copywriting-guidelines) ★15003 [`chinese`] [`chinese-simplified`] [`chinese-traditional`] [`copywriting`] [`css`] [`documentation`] [`guideline`] [`leancloud`] [`markdown`]  
...
- [taowen/awesome-lowcode](https://github.com/taowen/awesome-lowcode) ★14528 [`awesome`] [`awsome`] [`low-code`] [`lowcode`] [`nocode`]  
...
- [AUK9527/Are-u-ok](https://github.com/AUK9527/Are-u-ok) ★12046  
...
- [mzlogin/awesome-adb](https://github.com/mzlogin/awesome-adb) ★11951 [`android`] [`android-adb`] [`android-debug-bridge`]  
...
- [privacy-protection-tools/anti-AD](https://github.com/privacy-protection-tools/anti-AD) ★9727 [`adblock`] [`adguardhome`] [`dnsmasq`] [`easylist`] [`neohosts`] [`php`] [`pi-hole`] [`surge`]  
...
- [dongyubin/DockerHub](https://github.com/dongyubin/DockerHub) ★5902 [`cloudflare`] [`docker`] [`docker-image`] [`docker-registry`] [`dockerhub`] [`proxy`]  
...
- [reqable/reqable-app](https://github.com/reqable/reqable-app) ★5352 [`android-app`] [`capture`] [`debugging-tool`] [`desktop-app`] [`flutter`] [`http`] [`http2`] [`http3`] [`https`] [`ios-app`] [`quic`] [`rest-api`]  
...
- [ACL4SSR/ACL4SSR](https://github.com/ACL4SSR/ACL4SSR) ★5206 [`acl`] [`acl4ssr`] [`clash`] [`gfwlist`]  
...
- [awesome-vpn/awesome-vpn](https://github.com/awesome-vpn/awesome-vpn) ★4549 [`clash`] [`fanqiang`] [`free`] [`geopolitics`] [`gfw`] [`great-firewall`] [`shadowsocks`] [`shadowsocksr`] [`ss`] [`trojan`] [`v2ray`] [`vless`] [`vmess`] [`vpn-server`] [`xray`]  
...
- [suxuang/myIPTV](https://github.com/suxuang/myIPTV) ★4066  
...
- [AttemptD/AfuseKt-release](https://github.com/AttemptD/AfuseKt-release) ★3890  
...
- [dweinstein/awesome-frida](https://github.com/dweinstein/awesome-frida) ★3332 [`android`] [`awesome`] [`dynamic-analysis`] [`frida`] [`hooking`] [`ios`] [`r2frida`]  
...
- [aardio/ImTip](https://github.com/aardio/ImTip) ★2331 [`aardio`] [`ime`] [`input-method`] [`input-method-editor`] [`win32`] [`windows`] [`windows10`]  
...
- [tech-shrimp/me](https://github.com/tech-shrimp/me) ★779  
...
- [swyefun/BBLLV5](https://github.com/swyefun/BBLLV5) ★591  
...
- [opa334/TrollStore](https://github.com/opa334/TrollStore) ★20245  
...
- [Sequel-Ace/Sequel-Ace](https://github.com/Sequel-Ace/Sequel-Ace) ★7149 [`hacktoberfest`] [`hacktoberfest2023`] [`macos`] [`mariadb`] [`mysql`] [`objective-c`] [`sequel`] [`sequelace`] [`sequelpro`]  
...
- [cheat-engine/cheat-engine](https://github.com/cheat-engine/cheat-engine) ★17044  
...
- [nextcloud/server](https://github.com/nextcloud/server) ★32817 [`cloud`] [`collaboration`] [`decentralized`] [`design`] [`distributed`] [`enterprise`] [`federation`] [`file-sharing`] [`free-software`] [`hacktoberfest`] [`javascript`] [`nextcloud`] [`open-source`] [`opensource`] [`owncloud`] [`php`] [`self-hosting`] [`sharing`] [`usability`] [`ux`]  
...
- [Seldaek/monolog](https://github.com/Seldaek/monolog) ★21326 [`hacktoberfest`] [`logger`] [`logging`] [`php`] [`psr-3`]  
...
- [easychen/howto-make-more-money](https://github.com/easychen/howto-make-more-money) ★17932  
...
- [koel/koel](https://github.com/koel/koel) ★16773 [`audio`] [`hacktoberfest`] [`laravel`] [`music`] [`music-player`] [`streaming`] [`vue`]  
...
- [flarum/flarum](https://github.com/flarum/flarum) ★16026 [`flarum`] [`forum`] [`laravel`] [`php`]  
...
- [barryvdh/laravel-ide-helper](https://github.com/barryvdh/laravel-ide-helper) ★14736 [`autocompletion`] [`hacktoberfest`] [`laravel`]  
...
- [FreshRSS/FreshRSS](https://github.com/FreshRSS/FreshRSS) ★12660 [`feed`] [`freshrss`] [`news-aggregator`] [`php`] [`rss`] [`rss-aggregator`] [`rss-reader`] [`self-hosted`] [`websub`]  
...
- [typecho/typecho](https://github.com/typecho/typecho) ★12051 [`blog`] [`markdown`] [`php`] [`typecho`]  
...
- [walkor/workerman](https://github.com/walkor/workerman) ★11471 [`asynchronous`] [`event-driven`] [`high-performance`] [`php`] [`socket`] [`socket-server`] [`tcp`] [`timer`] [`websocket`] [`ws`] [`wss`]  
...
- [assimon/dujiaoka](https://github.com/assimon/dujiaoka) ★11301 [`dujiaofaka`] [`dujiaoka`] [`faka`]  
...
- [vrana/adminer](https://github.com/vrana/adminer) ★7062 [`database`] [`mssql`] [`mysql`] [`php`] [`postgresql`] [`sqlite`]  
...
- [Respect/Validation](https://github.com/Respect/Validation) ★5884 [`components`] [`fluent-interface`] [`php`] [`standalone`] [`validation`] [`validation-engine`] [`validator`]  
...
- [hlmd/Postman-cn](https://github.com/hlmd/Postman-cn) ★5568 [`chinese`] [`postman`]  
...
- [nikic/FastRoute](https://github.com/nikic/FastRoute) ★5222  
...
- [jqhph/dcat-admin](https://github.com/jqhph/dcat-admin) ★4006 [`laravel`] [`laravel-admin`]  
...
- [mevdschee/php-crud-api](https://github.com/mevdschee/php-crud-api) ★3711 [`api-server`] [`automatic-api`] [`crud`] [`database`] [`geojson`] [`geospatial`] [`multi-database`] [`mysql`] [`openapi`] [`php`] [`php-api`] [`postgis`] [`postgresql`] [`rest-api`] [`restful`] [`sql-database`] [`sqlite`] [`sqlserver`] [`swagger`]  
...
- [icret/EasyImages2.0](https://github.com/icret/EasyImages2.0) ★3510 [`api`] [`class-upload-php`] [`easyimage`] [`image-store`] [`images`] [`markdown`] [`php`] [`picture`] [`upload-images`] [`upload-pictures`] [`zui`]  
...
- [Bubka/2FAuth](https://github.com/Bubka/2FAuth) ★3433 [`2fa`] [`2factor`] [`hotp`] [`otp`] [`qrcode`] [`self-hosted`] [`totp`] [`two-factor`] [`two-factor-authentication`] [`webapp`]  
...
- [mochat-cloud/mochat](https://github.com/mochat-cloud/mochat) ★2469 [`mochat`] [`wecom`] [`weixin`] [`wework`]  
...
- [netcccyun/dnsmgr](https://github.com/netcccyun/dnsmgr) ★1042  
...
- [guanguans/music-dl](https://github.com/guanguans/music-dl) ★714 [`command`] [`command-line-tool`] [`commandline`] [`download`] [`downloader`] [`music`] [`php`] [`search`] [`song`]  
...
- [aazooo/zjmf](https://github.com/aazooo/zjmf) ★538  
...
- [ScoopInstaller/Scoop](https://github.com/ScoopInstaller/Scoop) ★22953 [`installer`] [`powershell`] [`scoop`] [`windows`]  
...
- [Atlas-OS/Atlas](https://github.com/Atlas-OS/Atlas) ★16890 [`ame-wizard`] [`atlas`] [`atlasos`] [`debloat`] [`fps`] [`gaming`] [`latency`] [`open-source`] [`opensource`] [`performance`] [`privacy`] [`security`] [`tweaks`] [`windows`]  
...
- [EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books) ★371905 [`books`] [`education`] [`hacktoberfest`] [`list`] [`resource`]  
...
- [public-apis/public-apis](https://github.com/public-apis/public-apis) ★367729 [`api`] [`apis`] [`dataset`] [`development`] [`free`] [`list`] [`lists`] [`open-source`] [`public`] [`public-api`] [`public-apis`] [`resources`] [`software`]  
...
- [ytdl-org/youtube-dl](https://github.com/ytdl-org/youtube-dl) ★138279  
...
- [deepseek-ai/DeepSeek-V3](https://github.com/deepseek-ai/DeepSeek-V3) ★99569  
...
- [nvbn/thefuck](https://github.com/nvbn/thefuck) ★94250 [`python`] [`shell`]  
...
- [home-assistant/core](https://github.com/home-assistant/core) ★81814 [`asyncio`] [`hacktoberfest`] [`home-automation`] [`internet-of-things`] [`iot`] [`mqtt`] [`python`] [`raspberry-pi`]  
...
- [fighting41love/funNLP](https://github.com/fighting41love/funNLP) ★76415  
...
- [sherlock-project/sherlock](https://github.com/sherlock-project/sherlock) ★69270 [`cli`] [`cti`] [`cybersecurity`] [`forensics`] [`hacktoberfest`] [`information-gathering`] [`infosec`] [`linux`] [`osint`] [`pentesting`] [`python`] [`python3`] [`reconnaissance`] [`redteam`] [`sherlock`] [`tools`]  
...
- [scrapy/scrapy](https://github.com/scrapy/scrapy) ★58516 [`crawler`] [`crawling`] [`framework`] [`hacktoberfest`] [`python`] [`scraping`] [`web-scraping`] [`web-scraping-python`]  
...
- [Z4nzu/hackingtool](https://github.com/Z4nzu/hackingtool) ★53695 [`allinonehackingtool`] [`besthackingtool`] [`ctf-tools`] [`ddos-attack-tool`] [`hacker`] [`hacking`] [`linux`] [`password-attack`] [`steganography`] [`web-attack`] [`wireless-attack`] [`xss-attacks`] [`xss-detection`]  
...
- [harry0703/MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo) ★45823 [`ai`] [`automation`] [`chatgpt`] [`moviepy`] [`python`] [`shortvideo`] [`tiktok`]  
...
- [mitmproxy/mitmproxy](https://github.com/mitmproxy/mitmproxy) ★40758 [`debugging`] [`http`] [`http2`] [`man-in-the-middle`] [`mitmproxy`] [`proxy`] [`python`] [`security`] [`ssl`] [`tls`] [`websocket`]  
...
- [zhayujie/chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat) ★39279 [`ai`] [`ai-agent`] [`chatgpt`] [`claude-4`] [`deepseek`] [`dingtalk`] [`feishu-bot`] [`gemini`] [`gpt-4`] [`kimi`] [`linkai`] [`llm`] [`mcp`] [`multi-agent`] [`openai`] [`python3`] [`qwen`] [`rag`] [`wechat`] [`wechat-bot`]  
...
- [hiroi-sora/Umi-OCR](https://github.com/hiroi-sora/Umi-OCR) ★38302 [`ocr`] [`ocr-python`] [`paddleocr`] [`qml`] [`qt`] [`screenshot`] [`umi-ocr`]  
...
- [2noise/ChatTTS](https://github.com/2noise/ChatTTS) ★37924 [`agent`] [`chat`] [`chatgpt`] [`chattts`] [`chinese`] [`chinese-language`] [`english`] [`english-language`] [`gpt`] [`llm`] [`llm-agent`] [`natural-language-inference`] [`python`] [`text-to-speech`] [`torch`] [`torchaudio`] [`tts`]  
...
- [NanmiCoder/MediaCrawler](https://github.com/NanmiCoder/MediaCrawler) ★37663  
...
- [yeongpin/cursor-free-vip](https://github.com/yeongpin/cursor-free-vip) ★36082 [`automation`] [`cursor`] [`cursor-ai`] [`cursor-ide`] [`cursorai`] [`cursors`] [`free`] [`freetrial`] [`pro`]  
...
- [certbot/certbot](https://github.com/certbot/certbot) ★32490 [`acme`] [`acme-client`] [`certbot`] [`certificate`] [`letsencrypt`] [`python`]  
...
- [python-telegram-bot/python-telegram-bot](https://github.com/python-telegram-bot/python-telegram-bot) ★28246 [`bot`] [`chatbot`] [`framework`] [`python`] [`telegram`]  
...
- [dgtlmoon/changedetection.io](https://github.com/dgtlmoon/changedetection.io) ★27459 [`back-in-stock`] [`change-alert`] [`change-detection`] [`change-monitoring`] [`monitoring`] [`notifications`] [`restock-monitor`] [`rss`] [`self-hosted`] [`url-monitor`] [`web-scraping`] [`website-change-detection`] [`website-change-detector`] [`website-change-monitor`] [`website-change-notification`] [`website-change-tracker`] [`website-defacement-monitoring`] [`website-monitor`] [`website-monitoring`] [`website-watcher`]  
...
- [521xueweihan/GitHub520](https://github.com/521xueweihan/GitHub520) ★27016 [`dns`] [`github`] [`hosts`]  
...
- [littlecodersh/ItChat](https://github.com/littlecodersh/ItChat) ★26511 [`api`] [`itchat`] [`robot`] [`wechat`]  
...
- [jhao104/proxy_pool](https://github.com/jhao104/proxy_pool) ★22847 [`crawler`] [`http`] [`proxy`] [`redis`] [`spider`]  
...
- [Delgan/loguru](https://github.com/Delgan/loguru) ★22836 [`log`] [`logger`] [`logging`] [`python`]  
...
- [LiLittleCat/awesome-free-chatgpt](https://github.com/LiLittleCat/awesome-free-chatgpt) ★20450 [`awesome`] [`awesome-list`] [`chat`] [`chatgpt`] [`free`] [`freechatgpt`]  
  这是一个收集免费 ChatGPT 替代方案的资源库。涵盖各种类型的免费或开源聊天机器人，包括代码生成、文本摘要、翻译等功能。该资源库主要使用 Markdown 格式组织，方便用户快速筛选和了解不同工具的特点。
- [bee-san/Ciphey](https://github.com/bee-san/Ciphey) ★20009 [`artificial-intelligence`] [`cipher`] [`cpp`] [`cryptography`] [`ctf`] [`ctf-tools`] [`cyberchef-magic`] [`decryption`] [`deep-neural-network`] [`encodings`] [`encryptions`] [`hacking`] [`hacktoberfest`] [`hashes`] [`natural-language-processing`] [`pentesting`] [`python`]  
...
- [Zeyi-Lin/HivisionIDPhotos](https://github.com/Zeyi-Lin/HivisionIDPhotos) ★19444 [`cnn`] [`demo`] [`docker`] [`face-recognition`] [`fastapi`] [`gradio`] [`idphoto`] [`machine-learning`] [`matting`] [`mtcnn`] [`tools`] [`unet`]  
...
- [Jack-Cherish/python-spider](https://github.com/Jack-Cherish/python-spider) ★19194 [`python`] [`python-spider`] [`python3`] [`webspider`]  
...
- [Guovin/iptv-api](https://github.com/Guovin/iptv-api) ★18963 [`amd64`] [`api`] [`arm64`] [`armv7`] [`auto`] [`diy`] [`docker`] [`epg`] [`ipdb`] [`iptv`] [`ipv4`] [`ipv6`] [`m3u`] [`m3u8`] [`rtmp`] [`tv`] [`tvbox`] [`workflow`]  
...
- [binux/pyspider](https://github.com/binux/pyspider) ★16913 [`crawler`] [`python`]  
...
- [fastapi/sqlmodel](https://github.com/fastapi/sqlmodel) ★16891 [`fastapi`] [`json`] [`json-schema`] [`pydantic`] [`python`] [`sql`] [`sqlalchemy`]  
...
- [Evil0ctal/Douyin_TikTok_Download_API](https://github.com/Evil0ctal/Douyin_TikTok_Download_API) ★14491 [`api`] [`async`] [`crawler`] [`douyin`] [`douyin-api`] [`douyin-scraper`] [`douyin-tiktok-api`] [`douyin-tiktok-download`] [`fastapi`] [`no-watermark`] [`online-parsing`] [`python`] [`pywebio`] [`scraper`] [`spider`] [`tiktok`] [`tiktok-api`] [`tiktok-scraper`] [`tiktok-signature`] [`web-scraping`]  
...
- [langbot-app/LangBot](https://github.com/langbot-app/LangBot) ★13678 [`agent`] [`ai`] [`chatgpt`] [`deepseek`] [`dify`] [`dingtalk`] [`discord`] [`feishu`] [`langbot`] [`lark`] [`line`] [`llm`] [`n8n`] [`ollama`] [`openai`] [`plugins`] [`qq`] [`rag`] [`telegram`] [`wechat`]  
...
- [zai-org/CogVideo](https://github.com/zai-org/CogVideo) ★11986 [`cogvideox`] [`image-to-video`] [`llm`] [`sora`] [`text-to-video`] [`video-generation`]  
...
- [chengazhen/cursor-auto-free](https://github.com/chengazhen/cursor-auto-free) ★9542  
...
- [shidahuilang/shuyuan](https://github.com/shidahuilang/shuyuan) ★8567 [`aiyueshuxiang`] [`ipa`] [`iptv`] [`reader`] [`shuyuan`] [`trollstore`] [`tts`] [`xiangsegige`] [`yuanyuedu`] [`yuedu`]  
...
- [PantsuDango/Dango-Translator](https://github.com/PantsuDango/Dango-Translator) ★8015  
...
- [bytedance/Dolphin](https://github.com/bytedance/Dolphin) ★7326 [`document-analysis`] [`layout-analysis`] [`ocr`] [`parser`] [`pdf`] [`pdf-converter`] [`pdf-parser`] [`python`] [`vlm-ocr`]  
...
- [nonebot/nonebot2](https://github.com/nonebot/nonebot2) ★7073 [`bot`] [`chatbot`] [`cqhttp`] [`dingtalk-robot`] [`fastapi`] [`lark-bot`] [`mirai-bot`] [`nonebot`] [`nonebot2`] [`onebot`] [`python`] [`qq`] [`qq-guild`] [`telegram-bot`]  
...
- [davidteather/TikTok-Api](https://github.com/davidteather/TikTok-Api) ★5792 [`api`] [`download-tiktoks`] [`hacktoberfest`] [`python`] [`tik`] [`tiktok`] [`tiktok-api`] [`tiktok-automation`] [`tiktok-compilations`] [`tiktok-downloader`] [`tiktok-python`] [`tiktok-scraper`] [`tiktok-signature`] [`tiktok-trending-page`] [`tiktokapi`] [`tok`] [`trending`]  
...
- [tconbeer/harlequin](https://github.com/tconbeer/harlequin) ★5094  
...
- [WECENG/ticket-purchase](https://github.com/WECENG/ticket-purchase) ★4174  
...
- [shaxiu/XianyuAutoAgent](https://github.com/shaxiu/XianyuAutoAgent) ★4002 [`agent`] [`chatbot`] [`llm`]  
...
- [ScottSloan/Bili23-Downloader](https://github.com/ScottSloan/Bili23-Downloader) ★2716 [`bili23`] [`bilibili`] [`bilibili-downloader`] [`crawler`] [`linux`] [`macos`] [`python`] [`videodownloader`] [`windows`] [`wxpython`]  
...
- [Cp0204/quark-auto-save](https://github.com/Cp0204/quark-auto-save) ★1987  
...
- [mofeng-git/One-KVM](https://github.com/mofeng-git/One-KVM) ★1799  
...
- [Hsury/BiliDrive](https://github.com/Hsury/BiliDrive) ★1463 [`bilibili`] [`python`]  
...
- [TapXWorld/ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook) ★51321  
...
- [pyenv/pyenv](https://github.com/pyenv/pyenv) ★43313 [`python`] [`shell`]  
...
- [discourse/discourse](https://github.com/discourse/discourse) ★45230 [`discourse`] [`ember`] [`forum`] [`javascript`] [`postgresql`] [`rails`] [`ruby`]  
...
- [Mark24Code/rime-auto-deploy](https://github.com/Mark24Code/rime-auto-deploy) ★1654 [`cli`] [`cli-app`] [`comand-line`] [`command-line-tool`] [`repl`] [`rime`] [`rime-config`] [`ruby`] [`terminal`] [`toolkit`]  
...
- [rustdesk/rustdesk](https://github.com/rustdesk/rustdesk) ★99347 [`android`] [`anydesk`] [`dart`] [`flatpak`] [`flutter`] [`flutter-apps`] [`ios`] [`linux`] [`macos`] [`p2p`] [`rdp`] [`remote-control`] [`remote-desktop`] [`rust`] [`rust-lang`] [`teamviewer`] [`vnc`] [`wayland`] [`windows`]  
...
- [zed-industries/zed](https://github.com/zed-industries/zed) ★66779 [`gpui`] [`rust-lang`] [`text-editor`] [`zed`]  
...
- [topjohnwu/Magisk](https://github.com/topjohnwu/Magisk) ★56246  
...
- [lencx/ChatGPT](https://github.com/lencx/ChatGPT) ★54145 [`ai`] [`app`] [`application`] [`chatgpt`] [`desktop-app`] [`gpt`] [`gpt-3`] [`linux`] [`macos`] [`notes-app`] [`openai`] [`rust`] [`tauri`] [`webview`] [`windows`]  
...
- [starship/starship](https://github.com/starship/starship) ★51501 [`bash`] [`fish`] [`fish-prompt`] [`fish-theme`] [`oh-my-zsh`] [`powershell`] [`rust`] [`shell-prompt`] [`starship`] [`zsh`] [`zsh-prompt`] [`zsh-theme`]  
...
- [dani-garcia/vaultwarden](https://github.com/dani-garcia/vaultwarden) ★49593 [`bitwarden`] [`bitwarden-rs`] [`docker`] [`rocket`] [`rust`] [`vaultwarden`]  
...
- [tw93/Pake](https://github.com/tw93/Pake) ★42581 [`chatgpt`] [`claude`] [`desktop`] [`gemini`] [`hight-performance`] [`linux`] [`macos`] [`no-electron`] [`package`] [`rust`] [`tauri`] [`windows`] [`youtube`]  
...
- [TabbyML/tabby](https://github.com/TabbyML/tabby) ★32192 [`ai`] [`codegen`] [`coding-assistant`] [`coding-language`] [`developer-experience`] [`developer-tools`] [`gen-ai`] [`ide`] [`llms`]  
...
- [fish-shell/fish-shell](https://github.com/fish-shell/fish-shell) ★31143 [`fish`] [`rust`] [`shell`] [`terminal`]  
...
- [lsd-rs/lsd](https://github.com/lsd-rs/lsd) ★14907 [`color`] [`hacktoberfest`] [`icons`] [`ls`] [`nerd-fonts`] [`rust`]  
...
- [rathole-org/rathole](https://github.com/rathole-org/rathole) ★12046 [`firewall`] [`frp`] [`http`] [`nat`] [`network`] [`ngrok`] [`noise`] [`noise-protocol`] [`proxy`] [`rust`] [`tunnel`]  
...
- [EasyTier/EasyTier](https://github.com/EasyTier/EasyTier) ★7409 [`nat-traversal`] [`p2p`] [`rust`] [`tailscale`] [`vpn`] [`zerotier`]  
...
- [veeso/termscp](https://github.com/veeso/termscp) ★2551 [`aws-s3`] [`command-line-tool`] [`command-line-utility`] [`ftp-client`] [`ratatui`] [`rust`] [`rust-crate`] [`rust-lang`] [`scp`] [`sftp`] [`sftp-client`] [`ssh-client`] [`terminal`] [`terminal-app`] [`tui`] [`utility`] [`winscp`] [`winscp-equivalent-for-linux`] [`winscp-for-linux`] [`winscp-for-mac`]  
...
- [PoloDB/PoloDB](https://github.com/PoloDB/PoloDB) ★1133 [`cross-platform`] [`database`] [`document-database`] [`embedded-database`] [`localfirst`] [`nosql`] [`rust`]  
...
- [djkato/m0nkrus-adobe-tracker](https://github.com/djkato/m0nkrus-adobe-tracker) ★197 [`adobe`] [`m0nkrus`] [`monkrus`] [`torrent`]  
...
- [rtyley/bfg-repo-cleaner](https://github.com/rtyley/bfg-repo-cleaner) ★11776 [`git`]  
...
- [ohmyzsh/ohmyzsh](https://github.com/ohmyzsh/ohmyzsh) ★181875 [`cli`] [`cli-app`] [`oh-my-zsh`] [`oh-my-zsh-plugin`] [`oh-my-zsh-theme`] [`ohmyzsh`] [`plugin-framework`] [`plugins`] [`productivity`] [`shell`] [`terminal`] [`theme`] [`themes`] [`zsh`] [`zsh-configuration`]  
...
- [dockur/windows](https://github.com/dockur/windows) ★46652 [`docker`] [`docker-container`] [`virtualization`] [`windows`] [`windows-virtual-desktop`] [`windows-virtual-machine`] [`windows-virtual-machines`] [`windows-vm`]  
...
- [acmesh-official/acme.sh](https://github.com/acmesh-official/acme.sh) ★44167 [`acme`] [`acme-client`] [`acme-protocol`] [`ash`] [`bash`] [`buypass`] [`certbot`] [`letsencrypt`] [`posix`] [`posix-sh`] [`shell`] [`zerossl`]  
...
- [zsh-users/zsh-autosuggestions](https://github.com/zsh-users/zsh-autosuggestions) ★33943 [`autocomplete`] [`autosuggest`] [`fish`] [`shell`] [`zsh`] [`zsh-autosuggestions`]  
...
- [233boy/v2ray](https://github.com/233boy/v2ray) ★27074 [`shell-script`] [`v2ray`] [`vmess`]  
  这是一个基于Go语言开发的V2Ray代理服务器。它提供快速、稳定的代理连接，支持多种协议和配置。项目包含了核心代理服务以及客户端配置文件生成工具，用户可以方便地配置和管理V2Ray连接。代码结构清晰，易于维护和扩展。
- [hwdsl2/setup-ipsec-vpn](https://github.com/hwdsl2/setup-ipsec-vpn) ★26829 [`cisco-ipsec`] [`docker`] [`encryption`] [`ikev2`] [`ipsec`] [`l2tp`] [`libreswan`] [`linux`] [`network`] [`raspberry-pi`] [`security`] [`vpn`] [`vpn-client`] [`vpn-server`]  
...
- [yuaotian/go-cursor-help](https://github.com/yuaotian/go-cursor-help) ★24734 [`cursor`] [`error`]  
...
- [StreisandEffect/streisand](https://github.com/StreisandEffect/streisand) ★23607 [`ansible`] [`anyconnect`] [`censorship`] [`openconnect`] [`openvpn`] [`shadowsocks`] [`ssh`] [`streisand`] [`stunnel`] [`tor`] [`vpn`] [`wireguard`]  
...
- [lxgw/LxgwWenKai](https://github.com/lxgw/LxgwWenKai) ★21729 [`cjk`] [`font`] [`typeface`]  
...
- [spaceship-prompt/spaceship-prompt](https://github.com/spaceship-prompt/spaceship-prompt) ★20196 [`oh-my-zsh`] [`prompt`] [`shell`] [`shell-prompt`] [`shell-theme`] [`spaceship`] [`terminal`] [`zsh`] [`zsh-theme`] [`zsh-users`]  
...
- [mack-a/v2ray-agent](https://github.com/mack-a/v2ray-agent) ★17381 [`cloudflare`] [`grpc-cloudflare`] [`httpupgrade`] [`hysteria2`] [`nginx`] [`reality`] [`reality-grpc`] [`shell`] [`sing-box`] [`trojan`] [`trojan-grpc`] [`tuic-v5`] [`v2ray`] [`vless`] [`vmess`] [`websockettlscdn-cloudflare-ip`] [`xray`] [`xray-core`] [`xray-install`] [`xtls-rprx-vision`]  
...
- [DaoCloud/public-image-mirror](https://github.com/DaoCloud/public-image-mirror) ★11760 [`mirror`] [`speedup`]  
...
- [oh-my-fish/oh-my-fish](https://github.com/oh-my-fish/oh-my-fish) ★11042 [`fish`] [`fishshell`] [`fishshell-framework`] [`hacktoberfest`] [`oh-my-fish`] [`oh-my-zsh`] [`omf`] [`prompt`] [`shell`] [`terminal`]  
...
- [YanG-1989/m3u](https://github.com/YanG-1989/m3u) ★10291  
...
- [angristan/wireguard-install](https://github.com/angristan/wireguard-install) ★9938 [`linux`] [`nat`] [`privacy`] [`vpn`] [`wireguard`]  
...
- [teddysun/shadowsocks_install](https://github.com/teddysun/shadowsocks_install) ★8195 [`shadowsocks`] [`shadowsocks-libev`] [`shadowsocks-server`] [`shadowsocksr`] [`ssr`]  
  该
- [bin456789/reinstall](https://github.com/bin456789/reinstall) ★8034 [`alpine`] [`alpine-linux`] [`boot`] [`distro`] [`grub`] [`installer`] [`iso`] [`linux`] [`linux-distribution`] [`liveos`] [`netboot`] [`netinst`] [`netinstall`] [`operating-systems`] [`os`] [`reinstall`] [`shell-script`] [`vps`] [`windows`]  
...
- [spiritLHLS/ecs](https://github.com/spiritLHLS/ecs) ★5831 [`almalinux`] [`arch`] [`astralinux`] [`bench-script`] [`benchmark`] [`cdn`] [`centos`] [`checker`] [`debian`] [`fedora`] [`goecs`] [`ipv6`] [`lemonbench`] [`openai`] [`oracle-linux`] [`rockylinux`] [`speedtest`] [`sysbench`] [`ubuntu`] [`vps`]  
...
- [Nyr/wireguard-install](https://github.com/Nyr/wireguard-install) ★4646 [`almalinux`] [`bash`] [`centos`] [`debian`] [`fedora`] [`rockylinux`] [`shell`] [`ubuntu`] [`vpn`] [`wireguard`]  
...
- [firehol/blocklist-ipsets](https://github.com/firehol/blocklist-ipsets) ★3588 [`abuses`] [`attacks`] [`blocklists`] [`command-and-control`] [`ipset`] [`ipset-lists`] [`malware`]  
...
- [vdsm/virtual-dsm](https://github.com/vdsm/virtual-dsm) ★3400 [`docker`] [`docker-image`] [`dsm`] [`kvm`] [`qemu`] [`synology`] [`synology-docker`] [`synology-dsm`] [`synology-nas`]  
...
- [ylx2016/Linux-NetSpeed](https://github.com/ylx2016/Linux-NetSpeed) ★2222  
...
- [imputnet/cobalt](https://github.com/imputnet/cobalt) ★36659 [`collaboration`] [`downloader`] [`instagram`] [`javascript`] [`music`] [`reddit`] [`social-media`] [`soundcloud`] [`svelte`] [`tiktok`] [`twitter`] [`typescript`] [`video`] [`vimeo`] [`vk`] [`webapp`] [`youtube`] [`youtube-downloader`]  
...
- [iptv-org/iptv](https://github.com/iptv-org/iptv) ★97619 [`iptv`] [`m3u`] [`playlist`] [`streams`] [`tv`]  
...
- [ant-design/ant-design](https://github.com/ant-design/ant-design) ★96290 [`ant-design`] [`antd`] [`design-systems`] [`react`] [`typescript`] [`ui-kit`] [`ui-library`]  
...
- [tailwindlabs/tailwindcss](https://github.com/tailwindlabs/tailwindcss) ★90490 [`css`] [`css-framework`] [`functional-css`] [`postcss`] [`responsive`] [`tailwindcss`] [`utility-classes`]  
...
- [ChatGPTNextWeb/NextChat](https://github.com/ChatGPTNextWeb/NextChat) ★86018 [`calclaude`] [`chatgpt`] [`claude`] [`cross-platform`] [`desktop`] [`fe`] [`gemini`] [`gemini-pro`] [`gemini-server`] [`gemini-ultra`] [`gpt-4o`] [`groq`] [`nextjs`] [`ollama`] [`react`] [`tauri`] [`tauri-app`] [`vercel`] [`webui`]  
...
- [mermaid-js/mermaid](https://github.com/mermaid-js/mermaid) ★83324 [`diagrams`] [`diagrams-as-code`] [`documentation`] [`flowchart`] [`javascript`] [`mindmap`] [`typescript`] [`uml-diagrams`]  
...
- [immich-app/immich](https://github.com/immich-app/immich) ★80396 [`backup-tool`] [`flutter`] [`google-photos`] [`google-photos-alternative`] [`javascript`] [`mobile-app`] [`nestjs`] [`nodejs`] [`photo-gallery`] [`photos`] [`photos-management`] [`self-hosted`] [`svelte`] [`sveltekit`] [`typescript`] [`videos`]  
...
- [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) ★78217 [`gemini`] [`gemini-api`]  
...
- [clash-verge-rev/clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev) ★76941 [`clash`] [`clash-meta`] [`clash-verge`] [`linux`] [`mac`] [`mihomo`] [`tauri-app`] [`windows`]  
...
- [hoppscotch/hoppscotch](https://github.com/hoppscotch/hoppscotch) ★74876 [`api`] [`api-client`] [`api-rest`] [`api-testing`] [`developer-tools`] [`graphql`] [`hacktoberfest`] [`http`] [`http-client`] [`pwa`] [`rest`] [`rest-api`] [`spa`] [`testing`] [`testing-tools`] [`tools`] [`vue`] [`vuejs`] [`websocket`]  
...
- [lobehub/lobe-chat](https://github.com/lobehub/lobe-chat) ★66485 [`agent`] [`ai`] [`artifacts`] [`chat`] [`chatgpt`] [`claude`] [`deepseek`] [`deepseek-r1`] [`function-calling`] [`gemini`] [`gpt`] [`knowledge-base`] [`mcp`] [`nextjs`] [`ollama`] [`openai`] [`rag`]  
...
- [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) ★61847 [`ai`] [`ai-agents`] [`ai-crawler`] [`ai-scraping`] [`ai-search`] [`crawler`] [`data-extraction`] [`html-to-markdown`] [`llm`] [`markdown`] [`scraper`] [`scraping`] [`web-crawler`] [`web-data`] [`web-data-extraction`] [`web-scraper`] [`web-scraping`] [`web-search`] [`webscraping`]  
...
- [nocodb/nocodb](https://github.com/nocodb/nocodb) ★58046 [`airtable`] [`airtable-alternative`] [`automatic-api`] [`hacktoberfest`] [`low-code`] [`no-code`] [`no-code-database`] [`no-code-platform`] [`postgresql`] [`rest-api`] [`restful-api`] [`spreadsheet`] [`sqlite`] [`swagger`]  
...
- [lyswhut/lx-music-desktop](https://github.com/lyswhut/lx-music-desktop) ★46497 [`electron`] [`javascript`] [`music-player`] [`vue`]  
...
- [RocketChat/Rocket.Chat](https://github.com/RocketChat/Rocket.Chat) ★43560 [`chat`] [`collaboration`] [`foss`] [`free`] [`hacktoberfest`] [`javascript`] [`meteor`] [`mit`] [`real-time`] [`slack`] [`webrtc`]  
...
- [DIYgod/RSSHub](https://github.com/DIYgod/RSSHub) ★39002 [`bilibili`] [`douban`] [`dribbble`] [`instagram`] [`lofter`] [`pixiv`] [`rss`] [`rsshub`] [`spotify`] [`telegram`] [`tiktok`] [`twitter`] [`v2ex`] [`wechat`] [`weibo`] [`ximalaya`] [`youtube`] [`zhihu`]  
...
- [RSSNext/Folo](https://github.com/RSSNext/Folo) ★34667 [`ai`] [`blockchain`] [`reader`] [`rss`] [`rss-reader`]  
...
- [umami-software/umami](https://github.com/umami-software/umami) ★31007 [`analytics`] [`charts`] [`google-analytics`] [`statistics`] [`web-analytics`]  
...
- [blakeblackshear/frigate](https://github.com/blakeblackshear/frigate) ★26291 [`ai`] [`camera`] [`google-coral`] [`home-assistant`] [`home-automation`] [`homeautomation`] [`mqtt`] [`nvr`] [`object-detection`] [`realtime`] [`rtsp`] [`tensorflow`]  
...
- [Molunerfinn/PicGo](https://github.com/Molunerfinn/PicGo) ★25721 [`aliyun-oss`] [`electron`] [`electron-app`] [`electron-vue`] [`github`] [`imgur`] [`imgur-uploader`] [`qiniu`] [`smms`] [`tencent-cos`] [`upyun`] [`vue`] [`weibo`]  
...
- [oldj/SwitchHosts](https://github.com/oldj/SwitchHosts) ★25709 [`electron`] [`hosts`] [`hostseditor`] [`hostsfile`] [`switch-hosts`] [`switchhosts`]  
...
- [fingerprintjs/fingerprintjs](https://github.com/fingerprintjs/fingerprintjs) ★25566 [`audio-fingerprinting`] [`browser`] [`browser-fingerprint`] [`browser-fingerprinting`] [`detection`] [`fingerprint`] [`fingerprinting`] [`fingerprintjs`] [`fraud`] [`fraud-detection`] [`identification`] [`javascript`] [`visitor-identifier`]  
...
- [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ★22793  
...
- [zzzgydi/clash-verge](https://github.com/zzzgydi/clash-verge) ★21963 [`clash`] [`cross-platform`] [`react`] [`rust`] [`tauri`]  
...
- [maotoumao/MusicFree](https://github.com/maotoumao/MusicFree) ★20704 [`free`] [`music-player`] [`musicfree`] [`plugin`] [`react`] [`react-native`] [`typescript`]  
...
- [louislam/dockge](https://github.com/louislam/dockge) ★19783 [`docker`] [`docker-compose`] [`docker-deployment`] [`docker-stack`] [`docker-stack-deploy`] [`docker-ui`] [`responsive`] [`self-hosted`] [`selfhosted`] [`single-page-app`] [`socket-io`] [`webapp`] [`websocket`]  
...
- [musistudio/claude-code-router](https://github.com/musistudio/claude-code-router) ★19070  
...
- [wulkano/Kap](https://github.com/wulkano/Kap) ★18880 [`aperture`] [`app`] [`capture`] [`communication`] [`electron`] [`javascript`] [`kap`] [`mac`] [`macos`] [`nextjs`] [`open-source`] [`oss`] [`productivity`] [`record`] [`screen-capture`] [`screen-recorder`]  
...
- [whyour/qinglong](https://github.com/whyour/qinglong) ★18470 [`crontab`] [`docker`] [`javascript`] [`python`] [`shell`] [`task-manager`] [`typescript`]  
...
- [wangeditor-team/wangEditor](https://github.com/wangeditor-team/wangEditor) ★18140 [`rich-text`] [`rich-text-html-editor`] [`typescript`] [`wangeditor`] [`wysiwyg`] [`wysiwyg-editor`]  
...
- [winfunc/opcode](https://github.com/winfunc/opcode) ★17915 [`anthropic`] [`anthropic-claude`] [`claude`] [`claude-4`] [`claude-4-opus`] [`claude-4-sonnet`] [`claude-ai`] [`claude-code`] [`claude-code-sdk`] [`cursor`] [`ide`] [`llm`] [`llm-code`] [`rust`] [`tauri`]  
...
- [apitable/apitable](https://github.com/apitable/apitable) ★14929 [`admin-dashboard`] [`airtable`] [`airtable-alternative`] [`api`] [`automatic-api`] [`embed`] [`hacktoberfest`] [`internal-tool`] [`javascript`] [`low-code`] [`nestjs`] [`nextjs`] [`no-code`] [`nocodb`] [`notion`] [`react`] [`spreadsheet`] [`spring`] [`typescript`]  
...
- [electron-userland/electron-builder](https://github.com/electron-userland/electron-builder) ★14292 [`appx`] [`auto-update`] [`builder`] [`contributions-welcome`] [`deb`] [`distribution-electron`] [`dmg`] [`electron`] [`electron-builder`] [`electron-updater`] [`help-wanted`] [`linux`] [`macos`] [`msi`] [`muon`] [`nsis`] [`pkg`] [`rpm`] [`snap`] [`squirrel`]  
...
- [dexie/Dexie.js](https://github.com/dexie/Dexie.js) ★13586 [`database`] [`indexeddb`] [`javascript`] [`offline`] [`offline-storage`] [`storage`]  
...
- [ourongxing/newsnow](https://github.com/ourongxing/newsnow) ★13124 [`elegant`] [`news`]  
...
- [plait-board/drawnix](https://github.com/plait-board/drawnix) ★11900 [`collaboration`] [`drawing`] [`flowchart`] [`localfirst`] [`mindmap`] [`productivity`] [`whiteboard`]  
...
- [dream-num/univer](https://github.com/dream-num/univer) ★11243 [`ai-excel`] [`ai-sheet`] [`ai-spreadsheet`] [`appscript`] [`collaboration`] [`data-table`] [`doc`] [`excel`] [`excel-mcp`] [`grid`] [`live-share`] [`ppt`] [`sdk`] [`sheet`] [`sheet-mcp`] [`spreadsheet`] [`spreadsheet-mcp`] [`univer-mcp`] [`word`] [`xlsx`]  
  这是一个用于生成各种类型的数字序列的工具。它支持算术、几何、斐波那契、卢卡斯等多种序列类型，并允许用户自定义序列规则。该工具使用Python语言开发，基于NumPy库进行数值计算，并提供简洁的API接口，方便用户快速生成所需序列。
- [ayangweb/BongoCat](https://github.com/ayangweb/BongoCat) ★10731 [`bongo-cat`] [`bongocat`] [`cross-platform`] [`desktop-app`] [`desktop-pet`] [`linux`] [`macos`] [`pet`] [`pet-project`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [jackyzha0/quartz](https://github.com/jackyzha0/quartz) ★10212 [`digital-garden`] [`networked-thought`] [`obsidian`] [`obsidian-md`] [`quartz-ssg`] [`static-site-generator`]  
...
- [gridstack/gridstack.js](https://github.com/gridstack/gridstack.js) ★8409 [`angular`] [`dashboard`] [`grid`] [`gridster`] [`javascript`] [`react`] [`typescript`] [`vue`] [`widget`]  
...
- [AIsouler/GKD_subscription](https://github.com/AIsouler/GKD_subscription) ★7984 [`gkd`] [`gkd-subscription`] [`typescript`]  
...
- [alibaba/x-render](https://github.com/alibaba/x-render) ★7728 [`ant`] [`ant-design`] [`chart`] [`form`] [`formrender`] [`javascript`] [`json-schema`] [`list`] [`react`] [`table`] [`typescript`] [`webpack`] [`widget`]  
...
- [EcoPasteHub/EcoPaste](https://github.com/EcoPasteHub/EcoPaste) ★6212 [`application`] [`clipboard`] [`clipboard-manager`] [`cross-platform`] [`desktop-app`] [`desktop-application`] [`linux`] [`macos`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [remotely-save/remotely-save](https://github.com/remotely-save/remotely-save) ★6147  
...
- [isaacs/rimraf](https://github.com/isaacs/rimraf) ★5797  
...
- [humanlayer/humanlayer](https://github.com/humanlayer/humanlayer) ★5686 [`agents`] [`ai`] [`amp`] [`claude-code`] [`codex`] [`human-in-the-loop`] [`humanlayer`] [`llm`] [`llms`] [`opencode`]  
...
- [zh-lx/pinyin-pro](https://github.com/zh-lx/pinyin-pro) ★4399 [`hanzi`] [`hanzi-pinyin`] [`hanzi2pinyin`] [`js-pinyin`] [`pinyin`] [`pinyin-match`] [`pinyin-pro`]  
...
- [galaxy-s10/billd-desk](https://github.com/galaxy-s10/billd-desk) ★4390 [`coturn`] [`electron`] [`flutter`] [`nodejs`] [`parsec`] [`remote-desktop`] [`rustdesk`] [`socket-io`] [`todesk`] [`typescript`] [`vue3`] [`webrtc`]  
...
- [meowtec/Imagine](https://github.com/meowtec/Imagine) ★4172 [`cross-platform`] [`desktop`] [`image-compression`] [`jpeg`] [`jpegmini`] [`linux-app`] [`macos`] [`pngquant`] [`save-for-web`] [`tinypng`] [`webp`]  
...
- [BilibiliVideoDownload/BilibiliVideoDownload](https://github.com/BilibiliVideoDownload/BilibiliVideoDownload) ★3390 [`ant-design-vue`] [`bilibili-download`] [`electron`] [`electron-builder`] [`ffmpeg-installer`] [`node-js`] [`typescript`] [`vuejs`]  
...
- [nwtgck/piping-server](https://github.com/nwtgck/piping-server) ★3087 [`data-transfer`] [`http`] [`nat-traversal`] [`stream`] [`transfer`] [`web`]  
...
- [pure-admin/pure-admin-thin](https://github.com/pure-admin/pure-admin-thin) ★2662 [`pure-admin-thin`] [`vue-pure-admin`]  
...
- [salarcode/SmartProxy](https://github.com/salarcode/SmartProxy) ★2502 [`browser-extension`] [`chrome`] [`chrome-extension`] [`edge-extension`] [`firefox`] [`firefox-addon`] [`firefox-extension`] [`proxy`] [`proxy-list`] [`proxy-switcher`] [`webextension`] [`webextensions`]  
...
- [Pintree-io/pintree](https://github.com/Pintree-io/pintree) ★2478 [`bookmark`] [`directory`] [`directory-website`]  
...
- [ipfs/public-gateway-checker](https://github.com/ipfs/public-gateway-checker) ★2092 [`ipfs`] [`ipfs-gui`]  
...
- [xpf0000/FlyEnv](https://github.com/xpf0000/FlyEnv) ★2082 [`development-environment`] [`electron`] [`laravel`] [`laravel-herd`] [`local-dns-server`] [`local-web-server`] [`mamp`] [`mamp-pro`] [`php`] [`php-environment`] [`php-obfuscator`] [`phpstudy`] [`web-ide`] [`wordpress`] [`xampp`]  
...
- [baiy/Ctool](https://github.com/baiy/Ctool) ★1895 [`chrome-extension`] [`crx`] [`developer-tools`] [`development`] [`electron-app`] [`firefox-extension`] [`qrcode`]  
...
- [Adpro-Team/GKD_subscription](https://github.com/Adpro-Team/GKD_subscription) ★1667 [`gkd`] [`gkd-subscription`] [`nodejs`] [`subscription`] [`typescript`]  
...
- [pt-plugins/PT-depiler](https://github.com/pt-plugins/PT-depiler) ★1532 [`private-tracker`]  
...
- [ipid/unlock-music](https://github.com/ipid/unlock-music) ★1426  
...
- [all-in-aigc/sorafm](https://github.com/all-in-aigc/sorafm) ★1074 [`ai-video-generator`] [`ai-video-showcase`] [`sora`]  
...
- [samuelmaddock/electron-browser-shell](https://github.com/samuelmaddock/electron-browser-shell) ★592 [`browser`] [`chrome-extension`] [`electron`]  
...
- [abbodi1406/vcredist](https://github.com/abbodi1406/vcredist) ★6993  
...
- [PanJiaChen/vue-element-admin](https://github.com/PanJiaChen/vue-element-admin) ★89937 [`admin`] [`admin-dashboard`] [`admin-template`] [`axios`] [`dashboard`] [`desktop`] [`element`] [`element-ui`] [`i18n`] [`management-system`] [`mock`] [`tinymce`] [`vue`] [`vue-admin`] [`vue-cli`] [`vuex`] [`webpack`] [`webpack4`] [`xlsx`]  
...
- [vbenjs/vue-vben-admin](https://github.com/vbenjs/vue-vben-admin) ★30145 [`admin-template`] [`ant-design`] [`element-plus`] [`monorepo`] [`naive-ui`] [`shadcn-ui`] [`tsx`] [`typescript`] [`vben`] [`vite`] [`vite-template`] [`vue-router`] [`vue3`] [`vuex`]  
...
- [requarks/wiki](https://github.com/requarks/wiki) ★27110 [`cross-platform`] [`documentation`] [`git`] [`markdown`] [`nodejs`] [`open-source`] [`wiki`]  
...
- [Lissy93/dashy](https://github.com/Lissy93/dashy) ★22681 [`awesome`] [`dashboard`] [`docker`] [`hacktoberfest`] [`homelab`] [`homepage`] [`mit`] [`nodejs`] [`organization`] [`productivity`] [`pwa`] [`self-hosted`] [`startpage`] [`vue`]  
...
- [pure-admin/vue-pure-admin](https://github.com/pure-admin/vue-pure-admin) ★18973 [`admin`] [`element-plus`] [`esm`] [`pinia`] [`tailwindcss`] [`typescript`] [`vite`] [`vue3`]  
...
- [zyronon/douyin](https://github.com/zyronon/douyin) ★11084 [`douyin`] [`js`] [`tiktok`] [`vue`] [`vue3`]  
...
- [doocs/md](https://github.com/doocs/md) ★10730 [`ai-bot`] [`doocs`] [`editor`] [`llm`] [`markdown`] [`markdown-editor`] [`tailwindcss`] [`vite`] [`vue`] [`vue3`] [`wechat`] [`weixin`]  
...
- [jason5ng32/MyIP](https://github.com/jason5ng32/MyIP) ★9110 [`awesome`] [`censorship`] [`chatgpt`] [`dns`] [`ip`] [`ipinfo`] [`leaks`] [`myip`] [`network`] [`pingchecker`] [`proxy`] [`security`] [`security-tools`] [`speedtest`] [`vercel`] [`webrtc`] [`whatismyip`] [`whatismyipaddress`] [`whois`] [`whois-lookup`]  
...
- [luckjiawei/frpc-desktop](https://github.com/luckjiawei/frpc-desktop) ★6131 [`desktop`] [`electron`] [`frp`] [`frp-desktop`] [`frp-linux`] [`frp-macos`] [`frp-window`] [`frpc`] [`javascript`] [`tailwindcss`] [`typescript`] [`vite`] [`vue`]  
...
- [wechat-article/wechat-article-exporter](https://github.com/wechat-article/wechat-article-exporter) ★4543 [`download`] [`wechat`] [`wechat-article`] [`wechat-download`]  
...
- [palxiao/poster-design](https://github.com/palxiao/poster-design) ★4505 [`canvas`] [`design`] [`image`] [`moveable`] [`nodejs`] [`poster`] [`puppeteer`] [`vue3`]  
...
- [hslr-s/sun-panel](https://github.com/hslr-s/sun-panel) ★4492 [`docker`] [`gin`] [`golang`] [`homelab`] [`homepage`] [`nas`] [`navigationpage`] [`raspberry-pi`] [`self-hosted`] [`startpage`] [`synology`] [`vue3`]  
