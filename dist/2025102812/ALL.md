...
- [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) ★153969 [`activator`] [`hwid`] [`kms`] [`kms38`] [`massgrave`] [`massgravel`] [`microsoft`] [`microsoft365`] [`office`] [`office365`] [`ohook`] [`powershell`] [`tsforge`] [`windows`] [`windows-10`] [`windows-11`]  
...
- [Atlas-OS/Atlas](https://github.com/Atlas-OS/Atlas) ★18186 [`ame-wizard`] [`atlas`] [`atlasos`] [`debloat`] [`fps`] [`gaming`] [`latency`] [`open-source`] [`opensource`] [`performance`] [`privacy`] [`security`] [`tweaks`] [`windows`]  
...
- [FongMi/Release](https://github.com/FongMi/Release) ★4944  
...
- [Genymobile/scrcpy](https://github.com/Genymobile/scrcpy) ★130278 [`android`] [`c`] [`ffmpeg`] [`libav`] [`mirroring`] [`recording`] [`screen`] [`sdl2`]  
...
- [ventoy/Ventoy](https://github.com/ventoy/Ventoy) ★71485 [`auto-install`] [`bootable-usb`] [`bsd`] [`chromeos`] [`iso-files`] [`legacy`] [`linux`] [`multiboot`] [`persistence`] [`secure-boot`] [`uefi`] [`unattended`] [`unix`] [`usb`] [`windows`]  
...
- [bilibili/ijkplayer](https://github.com/bilibili/ijkplayer) ★33022 [`android`] [`ffmpeg`] [`ijkplayer`] [`ios`] [`player`] [`video`]  
...
- [jqlang/jq](https://github.com/jqlang/jq) ★32880 [`jq`]  
...
- [coolsnowwolf/lede](https://github.com/coolsnowwolf/lede) ★31033 [`lede`] [`lua`] [`openwrt-feed`] [`openwrt-package`] [`openwrt-zh-cn`]  
...
- [valinet/ExplorerPatcher](https://github.com/valinet/ExplorerPatcher) ★29677  
...
- [kingToolbox/WindTerm](https://github.com/kingToolbox/WindTerm) ★28415 [`bash`] [`client`] [`cmd`] [`linux`] [`mac`] [`powershell`] [`serial`] [`sftp`] [`shell`] [`ssh`] [`telnet`] [`terminal`] [`tmux`] [`windows`] [`wsl`] [`x11`] [`xmodem`] [`xterm`] [`ymodem`] [`zmodem`]  
...
- [ggreer/the_silver_searcher](https://github.com/ggreer/the_silver_searcher) ★27053 [`ag`] [`c`] [`command-line-tool`] [`pcre`] [`search-in-text`] [`silver-searcher`]  
...
- [jarun/nnn](https://github.com/jarun/nnn) ★20779 [`android`] [`batch-rename`] [`c`] [`cli`] [`command-line`] [`developer-tools`] [`disk-usage`] [`file-manager`] [`file-preview`] [`file-search`] [`filesystem`] [`launcher`] [`multi-platform`] [`ncurses`] [`productivity`] [`raspberry-pi`] [`terminal`] [`tui`] [`vim`] [`wsl`]  
...
- [gojue/ecapture](https://github.com/gojue/ecapture) ★14716 [`android`] [`android-https-capture`] [`ebpf`] [`ebpf-go`] [`ebpf-tc`] [`ebpf-uprobe`] [`golang`] [`https`] [`linux`] [`network-capture`] [`security-audit`] [`ssl`] [`ssldump`] [`tcpdump`] [`tls`]  
...
- [coturn/coturn](https://github.com/coturn/coturn) ★13104 [`networking`] [`server`] [`turn`]  
...
- [SoftEtherVPN/SoftEtherVPN](https://github.com/SoftEtherVPN/SoftEtherVPN) ★12673 [`etherip`] [`ike`] [`ipsec`] [`l2tp`] [`l2tpv3`] [`openvpn`] [`softether-vpn`] [`softethervpn`] [`ssl-vpn`] [`sstp`] [`tls`] [`vpn`] [`vpn-protocols`] [`vpn-server`] [`vpn-tunnel`] [`wfh`] [`wireguard`] [`work-from-home`]  
...
- [rofl0r/proxychains-ng](https://github.com/rofl0r/proxychains-ng) ★10321 [`hack`] [`hook`] [`http`] [`preload`] [`proxy`] [`proxychains`] [`socks`]  
...
- [pymumu/smartdns](https://github.com/pymumu/smartdns) ★10070 [`c`] [`dns`] [`dns-over-https`] [`dns-over-tls`] [`dns-server`] [`dns64`] [`doh`] [`doh3`] [`doq`] [`dot`] [`nftables`] [`nftables-sets`] [`openwrt`] [`openwrt-package`] [`smartdns`] [`stubby`]  
...
- [xmrig/xmrig](https://github.com/xmrig/xmrig) ★9546 [`argon2`] [`cpuminer`] [`cryptocurrency`] [`cryptonight`] [`miner`] [`monero`] [`randomx`] [`xmr`] [`xmrig`]  
...
- [esnet/iperf](https://github.com/esnet/iperf) ★7973  
...
- [winfsp/winfsp](https://github.com/winfsp/winfsp) ★7939 [`driver`] [`filesystem`] [`fuse`] [`gplv3`] [`kernel`] [`windows`] [`windows-kernel`]  
...
- [tinyproxy/tinyproxy](https://github.com/tinyproxy/tinyproxy) ★5485  
...
- [baidu/dperf](https://github.com/baidu/dperf) ★5459 [`benchmark`] [`dpdk`] [`l4lb`] [`linux-networking`] [`load-testing`] [`network-benchmarking`] [`packet-generator`] [`performance`] [`performance-testing`] [`tcp`] [`user-space-networking`] [`user-space-tcp`]  
...
- [TelegramMessenger/MTProxy](https://github.com/TelegramMessenger/MTProxy) ★5438  
...
- [easychen/pushdeer](https://github.com/easychen/pushdeer) ★4939 [`app`] [`clip`] [`notification-service`] [`push`]  
...
- [3proxy/3proxy](https://github.com/3proxy/3proxy) ★4656 [`accounting`] [`c`] [`https-proxy`] [`ipv6`] [`network-management`] [`network-security`] [`portmap`] [`proxy`] [`proxy-server`] [`sni`] [`socks`] [`socks-proxy`] [`socks-server`] [`socks5`] [`socks5-proxy`] [`socks5-server`] [`stunnel`] [`tls-proxy`] [`traffic-shaping`]  
...
- [RsyncProject/rsync](https://github.com/RsyncProject/rsync) ★3924  
...
- [schwabe/ics-openvpn](https://github.com/schwabe/ics-openvpn) ★3676 [`android`] [`openvpn`]  
...
- [apple/cups](https://github.com/apple/cups) ★2092 [`ipp`] [`ipp-protocol`] [`printer`] [`printing`] [`snmp`]  
...
- [heiher/natmap](https://github.com/heiher/natmap) ★1766 [`bsd`] [`linux`] [`macos`] [`nat1`] [`port-mapping`] [`tcp`] [`udp`] [`windows`]  
...
- [microsoft/PowerToys](https://github.com/microsoft/PowerToys) ★125260 [`color-picker`] [`command-palette`] [`desktop`] [`fancyzones`] [`keyboard-manager`] [`microsoft-powertoys`] [`powerrename`] [`powertoys`] [`windows`] [`windows-10`] [`windows-11`]  
...
- [2dust/v2rayN](https://github.com/2dust/v2rayN) ★88921 [`proxy`] [`shadowsocks`] [`socks5`] [`trojan`] [`v2fly`] [`v2ray`] [`vless`] [`vmess`] [`windows`] [`xray`] [`xtls`]  
...
- [shadowsocks/shadowsocks-windows](https://github.com/shadowsocks/shadowsocks-windows) ★59097 [`c-sharp`] [`proxy`] [`shadowsocks`]  
...
- [PowerShell/PowerShell](https://github.com/PowerShell/PowerShell) ★50577 [`command-line`] [`hacktoberfest`] [`linux`] [`macos`] [`netcore`] [`powershell`] [`shell`] [`windows`]  
  这是一个用于PowerShell的项目，具体功能不明确。  需要更多信息才能生成合适的项目描述。 请提供GitHub项目链接。
- [huiyadanli/RevokeMsgPatcher](https://github.com/huiyadanli/RevokeMsgPatcher) ★35014 [`hex-editor`] [`patch`] [`pc`] [`qq`] [`revoke`] [`revokemsg`] [`tim`] [`tool`] [`wechat`] [`windows`]  
...
- [AvaloniaUI/Avalonia](https://github.com/AvaloniaUI/Avalonia) ★29046 [`android`] [`app-framework`] [`avalonia`] [`avaloniaui`] [`browser`] [`c-sharp`] [`cross-platform`] [`csharp`] [`desktop`] [`dotnet`] [`gui`] [`ios`] [`linux`] [`macos`] [`mobile`] [`mvvm`] [`wasm`] [`windows`] [`xamarin`] [`xaml`]  
...
- [rocksdanister/lively](https://github.com/rocksdanister/lively) ★17440 [`csharp`] [`desktop`] [`desktop-wallpaper`] [`dynamic-desktop`] [`dynamic-wallpaper`] [`fluent-design`] [`live-wallpaper`] [`screensavers`] [`wallpaper`] [`wallpaper-app`] [`wallpaper-changer`] [`wallpaper-engine`] [`wallpaperengine`] [`wallpapers`] [`widgets`] [`windows-10`] [`windows-11`] [`windows-app`] [`winui`] [`winui3`]  
...
- [bitwarden/server](https://github.com/bitwarden/server) ★17333 [`api`] [`aspnet`] [`aspnetcore`] [`bitwarden`] [`csharp`] [`docker`] [`dotnet`] [`dotnet-core`] [`signalr`] [`sql`] [`sql-server`]  
...
- [netchx/netch](https://github.com/netchx/netch) ★16986 [`fullcone`] [`netch`] [`netfiltersdk`] [`shadowsocks`] [`shadowsocksr`] [`socks`] [`tun2socks`] [`vless`] [`vmess`]  
...
- [nilaoda/N_m3u8DL-CLI](https://github.com/nilaoda/N_m3u8DL-CLI) ★15533 [`command-line`] [`downloader`] [`m3u8`] [`m3u8-downloader`] [`m3u8-parser`] [`m3u8dl-cli`] [`windows`]  
...
- [winsw/winsw](https://github.com/winsw/winsw) ★13360 [`csharp`] [`dotnet`] [`nuget`] [`windows-service`] [`windows-service-wrapper`]  
...
- [d2phap/ImageGlass](https://github.com/d2phap/ImageGlass) ★11456 [`avif`] [`csharp`] [`direct2d`] [`dotnet`] [`heic`] [`heif`] [`image-viewer`] [`imageglass`] [`jpeg-xl`] [`jxl`] [`photo-viewer`] [`picture-gallery`] [`picture-viewer`] [`raw`] [`raw-image`] [`svg`] [`svg-viewer`] [`winforms`]  
...
- [OdysseusYuan/LKY_OfficeTools](https://github.com/OdysseusYuan/LKY_OfficeTools) ★10810 [`access`] [`email`] [`excel`] [`kms`] [`lync`] [`microsoft`] [`msoffice`] [`office`] [`office-free`] [`office365`] [`onedrive`] [`onenote`] [`outlook`] [`ppt`] [`project`] [`publisher`] [`skype`] [`teams`] [`visio`] [`word`]  
...
- [dnSpyEx/dnSpy](https://github.com/dnSpyEx/dnSpy) ★9151 [`baml`] [`csharp`] [`debug`] [`debugger`] [`decompile`] [`decompiler`] [`dotnet`] [`dotnetcore`] [`dotnetframework`] [`mono`] [`unity`] [`vbnet`] [`xaml`]  
...
- [git-ecosystem/git-credential-manager](https://github.com/git-ecosystem/git-credential-manager) ★8211 [`aad`] [`authentication`] [`azure-devops`] [`azure-repos`] [`bitbucket`] [`credential`] [`cross-platform`] [`git`] [`github`] [`gitlab`]  
...
- [nilaoda/N_m3u8DL-RE](https://github.com/nilaoda/N_m3u8DL-RE) ★6626 [`dash`] [`ffmpeg`] [`hls`] [`ism`] [`live`] [`m3u8`] [`m3u8-downloader`] [`mpd`] [`recorder`]  
...
- [TechnitiumSoftware/DnsServer](https://github.com/TechnitiumSoftware/DnsServer) ★6464 [`cross-platform`] [`dhcp-server`] [`dns`] [`dns-client`] [`dns-over-https`] [`dns-over-quic`] [`dns-over-tls`] [`dns-over-tor`] [`dns-server`] [`dotnet`] [`privacy`] [`technitium-dns-server`]  
...
- [BililiveRecorder/BililiveRecorder](https://github.com/BililiveRecorder/BililiveRecorder) ★4388 [`bilibili`] [`bilibili-live`] [`dotnet-core`] [`flv`] [`stream`] [`wpf`]  
...
- [HMBSbige/NatTypeTester](https://github.com/HMBSbige/NatTypeTester) ★4243 [`csharp`] [`nat`] [`rfc3489`] [`rfc5389`] [`rfc5780`] [`rfc8489`] [`stun`] [`tcp`] [`tls`] [`udp`] [`winui3`] [`wpf`]  
...
- [Jeric-X/SyncClipboard](https://github.com/Jeric-X/SyncClipboard) ★3576  
...
- [LorenzCK/OnTopReplica](https://github.com/LorenzCK/OnTopReplica) ★3098 [`dwm`] [`thumbnails`] [`tool`] [`windowing`] [`windows`] [`windows-desktop`]  
...
- [kenvix/USBCopyer](https://github.com/kenvix/USBCopyer) ★2805 [`copy`] [`tool`]  
...
- [ClassIsland/ClassIsland](https://github.com/ClassIsland/ClassIsland) ★1818 [`automation`] [`avalonia`] [`classisland`] [`classroom`] [`dotnet`] [`education`] [`fluent-design`] [`fluentavalonia`] [`linux`] [`macos`] [`plugins`] [`tools`] [`windows`]  
...
- [SuperStudio/SuperCom](https://github.com/SuperStudio/SuperCom) ★1121  
...
- [snltty/linker](https://github.com/snltty/linker) ★994 [`giscus`]  
...
- [electron/electron](https://github.com/electron/electron) ★118856 [`c-plus-plus`] [`chrome`] [`css`] [`electron`] [`html`] [`javascript`] [`nodejs`] [`v8`] [`works-with-codespaces`]  
...
- [microsoft/terminal](https://github.com/microsoft/terminal) ★100744 [`cmd`] [`command-line`] [`console`] [`contributions-welcome`] [`good-first-issue`] [`hacktoberfest`] [`terminal`] [`windows`] [`windows-console`] [`windows-terminal`] [`wsl`]  
...
- [tesseract-ocr/tesseract](https://github.com/tesseract-ocr/tesseract) ★70539 [`hacktoberfest`] [`lstm`] [`machine-learning`] [`ocr`] [`ocr-engine`] [`tesseract`] [`tesseract-ocr`]  
...
- [aria2/aria2](https://github.com/aria2/aria2) ★39049 [`bittorrent`] [`cpp11`] [`download`] [`ftp`] [`http`] [`metalink`] [`rpc`] [`sftp`]  
...
- [qbittorrent/qBittorrent](https://github.com/qbittorrent/qBittorrent) ★33660 [`bittorrent`] [`bittorrent-client`] [`c-plus-plus`] [`crossplatform`] [`torrent`] [`torrent-client`]  
...
- [LizardByte/Sunshine](https://github.com/LizardByte/Sunshine) ★30641 [`cpp`] [`docker`] [`flathub-pkg`] [`game-stream`] [`game-streaming`] [`game-streaming-server`] [`geforce-experience`] [`homebrew-pkg`] [`maintainer-wanted`] [`moonlight`] [`pacman-pkg`] [`python`] [`remote-desktop`] [`replicator-custom-issues`] [`replicator-release-notifications`] [`rtd`] [`winget-pkg`]  
...
- [cmderdev/cmder](https://github.com/cmderdev/cmder) ★26602 [`c-plus-plus`] [`cmder`] [`color-scheme`] [`command-line`] [`conemu`] [`mintty`] [`portable`] [`powershell`] [`shell`] [`ssh-agent`] [`windows`]  
...
- [google/filament](https://github.com/google/filament) ★18974 [`3d-graphics`] [`android`] [`gltf`] [`gltf-viewer`] [`graphics`] [`metal`] [`opengl`] [`opengl-es`] [`pbr`] [`real-time`] [`vulkan`] [`wasm`] [`webgl`]  
...
- [zerotier/ZeroTierOne](https://github.com/zerotier/ZeroTierOne) ★16054 [`decentralization`] [`networking`] [`peer-to-peer`] [`sd-wan`] [`sdn`] [`virtual-network`] [`vpn`]  
...
- [tindy2013/subconverter](https://github.com/tindy2013/subconverter) ★15232 [`clash`] [`clashr`] [`emoji`] [`gist`] [`quantumult`] [`quantumultx`] [`regular-expression`] [`rename`] [`ss`] [`ssr`] [`subconverter`] [`surfboard`] [`surge`] [`v2ray`]  
...
- [moonlight-stream/moonlight-qt](https://github.com/moonlight-stream/moonlight-qt) ★14866 [`gamestream`] [`linux-app`] [`macos-app`] [`moonlight`] [`nvidia`] [`qt`] [`sdl2`] [`steam-link`] [`windows-app`]  
...
- [wkhtmltopdf/wkhtmltopdf](https://github.com/wkhtmltopdf/wkhtmltopdf) ★14416  
...
- [cxasm/notepad--](https://github.com/cxasm/notepad--) ★8246  
...
- [wangyu-/udp2raw](https://github.com/wangyu-/udp2raw) ★8106 [`bypass-firewall`] [`fake-header`] [`faketcp`] [`icmp`] [`icmp-tunnel`] [`icmptunnel`] [`raw-socket`] [`raw-tunnel`] [`tcp`] [`tunnel`] [`udp`] [`udp-tunnel`]  
...
- [TigerVNC/tigervnc](https://github.com/TigerVNC/tigervnc) ★6553  
...
- [rime/weasel](https://github.com/rime/weasel) ★6097  
...
- [zhongyang219/MusicPlayer2](https://github.com/zhongyang219/MusicPlayer2) ★5846  
...
- [qiin2333/Sunshine-Foundation](https://github.com/qiin2333/Sunshine-Foundation) ★3267 [`cloudgaming`] [`game-streaming`] [`moonlight`] [`remote-desktop`] [`stream`] [`sunshine`]  
...
- [variar/klogg](https://github.com/variar/klogg) ★3052 [`cpp`] [`cross-platform`] [`hacktoberfest`] [`linux`] [`log-analyzer`] [`log-monitor`] [`log-viewer`] [`logs`] [`macos`] [`qt`] [`tail`] [`windows`]  
...
- [swigger/wechat-ocr](https://github.com/swigger/wechat-ocr) ★795  
...
- [zero-peak/ZeroOmega](https://github.com/zero-peak/ZeroOmega) ★6391 [`proxy`] [`switchyomega`] [`zeroomega`]  
...
- [joyqi/sfz](https://github.com/joyqi/sfz) ★752  
...
- [ColorlibHQ/AdminLTE](https://github.com/ColorlibHQ/AdminLTE) ★45098 [`admin`] [`admin-dashboard`] [`admin-dashboard-template`] [`admin-dashboard-ui`] [`admin-panel`] [`admin-template`] [`admin-ui`] [`bootstrap`] [`css`] [`dashboard`] [`dashboard-template`] [`dashboard-templates`] [`dashboards`] [`html`]  
...
- [WebStackPage/WebStackPage.github.io](https://github.com/WebStackPage/WebStackPage.github.io) ★7079 [`bookmark`] [`dao-hang`] [`nav`] [`navigation`] [`tags`] [`website`] [`webstack`]  
...
- [thedevdojo/wave](https://github.com/thedevdojo/wave) ★6330 [`devdojo`] [`hacktoberfest`] [`laravel`] [`php`] [`saas`] [`saas-boilerplate`] [`subscription`] [`tailwindcss`] [`voyager`] [`wave`]  
...
- [Mhy278/MinecraftServerHostGuide](https://github.com/Mhy278/MinecraftServerHostGuide) ★179  
...
- [AppFlowy-IO/AppFlowy](https://github.com/AppFlowy-IO/AppFlowy) ★66163 [`blog`] [`confluence-alternative`] [`content-management`] [`content-services`] [`documentation`] [`flutter`] [`note-taking`] [`notion-alternative`] [`project-management`] [`task-management`] [`team-collaboration`] [`wiki`]  
...
- [GopeedLab/gopeed](https://github.com/GopeedLab/gopeed) ★20775 [`android`] [`bittorrent`] [`cross-platform`] [`debian`] [`downloader`] [`flutter`] [`golang`] [`http`] [`https`] [`ios`] [`macos`] [`magnet`] [`torrent`] [`ubuntu`] [`windows`]  
...
- [wanghongenpin/proxypin](https://github.com/wanghongenpin/proxypin) ★10841 [`capture-traffic`] [`charles`] [`fiddler`] [`proxy`] [`proxypin`] [`zhuabao`]  
...
- [Predidit/oneAnime](https://github.com/Predidit/oneAnime) ★1757 [`android`] [`anime`] [`anime1`] [`danmaku`] [`flutter`] [`ios`] [`linux-desktop`] [`macos`] [`windows`]  
...
- [Anduin2017/HowToCook](https://github.com/Anduin2017/HowToCook) ★95410 [`chinese`] [`cookbook`] [`cooking`] [`dishes`] [`recipes`]  
...
- [Fechin/reference](https://github.com/Fechin/reference) ★9339 [`awk`] [`bash`] [`chatgpt`] [`cheatsheet`] [`cheatsheets`] [`css`] [`golang`] [`grep`] [`markdown`] [`python`] [`reference`] [`sed`] [`snippets`] [`vim`]  
...
- [fatedier/frp](https://github.com/fatedier/frp) ★100030 [`expose`] [`firewall`] [`frp`] [`go`] [`http-proxy`] [`nat`] [`p2p`] [`proxy`] [`reverse-proxy`] [`tunnel`]  
...
- [syncthing/syncthing](https://github.com/syncthing/syncthing) ★77144 [`go`] [`p2p`] [`peer-to-peer`] [`synchronization`]  
...
- [junegunn/fzf](https://github.com/junegunn/fzf) ★74720 [`bash`] [`cli`] [`fish`] [`fzf`] [`go`] [`neovim`] [`tmux`] [`unix`] [`vim`] [`zsh`]  
...
- [minio/minio](https://github.com/minio/minio) ★57467 [`amazon-s3`] [`cloud`] [`cloudnative`] [`cloudstorage`] [`go`] [`k8s`] [`kubernetes`] [`multi-cloud`] [`multi-cloud-kubernetes`] [`objectstorage`] [`s3`] [`storage`]  
...
- [FiloSottile/mkcert](https://github.com/FiloSottile/mkcert) ★56954 [`certificates`] [`chrome`] [`firefox`] [`https`] [`ios`] [`linux`] [`local-development`] [`localhost`] [`macos`] [`root-ca`] [`tls`] [`windows`]  
...
- [rclone/rclone](https://github.com/rclone/rclone) ★53187 [`azure-blob`] [`azure-blob-storage`] [`azure-files`] [`backblaze-b2`] [`cloud-storage`] [`dropbox`] [`encryption`] [`ftp`] [`fuse-filesystem`] [`go`] [`golang`] [`google-cloud-storage`] [`google-drive`] [`onedrive`] [`openstack-swift`] [`rclone`] [`s3`] [`sftp`] [`sync`] [`webdav`]  
...
- [go-gitea/gitea](https://github.com/go-gitea/gitea) ★51645 [`bitbucket`] [`cicd`] [`devops`] [`docker-registry-v2`] [`git`] [`git-gui`] [`git-server`] [`gitea`] [`github`] [`github-actions`] [`gitlab`] [`go`] [`golang`] [`hacktoberfest`] [`maven-server`] [`npm-registry`] [`vue`]  
...
- [gogs/gogs](https://github.com/gogs/gogs) ★47127 [`docker`] [`git`] [`go`] [`gogs`] [`mysql`] [`postgresql`] [`raspberry-pi`] [`scip-enabled`] [`self-hosted`] [`sqlite3`]  
...
- [v2ray/v2ray-core](https://github.com/v2ray/v2ray-core) ★46602 [`golang`] [`http-proxy`] [`proxy`] [`shadowsocks`] [`socks`] [`socks5`] [`v2ray`] [`vmess`]  
...
- [usememos/memos](https://github.com/usememos/memos) ★45306 [`docker`] [`foss`] [`go`] [`markdown`] [`memo`] [`microblog`] [`note-taking`] [`notecard`] [`react`] [`self-hosted`] [`social-network`] [`sqlite`]  
...
- [coreybutler/nvm-windows](https://github.com/coreybutler/nvm-windows) ★43379 [`go`] [`management`] [`node`] [`node-version-manager`] [`nodejs`] [`nvm`] [`switch`] [`version`] [`version-manager`] [`versioning`] [`windows`]  
...
- [ehang-io/nps](https://github.com/ehang-io/nps) ★33565 [`dns`] [`firewall`] [`go`] [`gzip`] [`http`] [`https`] [`nat`] [`nps`] [`snnapy`] [`socks`] [`socks5`] [`ssh`] [`tcp`] [`tunnel`] [`udp`]  
...
- [juanfont/headscale](https://github.com/juanfont/headscale) ★32003 [`tailscale`] [`tailscale-control-server`] [`tailscale-server`] [`wireguard`]  
...
- [filebrowser/filebrowser](https://github.com/filebrowser/filebrowser) ★31725 [`file-browser`] [`file-manager`] [`file-sharing`] [`go`] [`material-design`] [`self-hosted`] [`vue`]  
  这是一个用于浏览和管理文件的Web应用程序。它使用Python和Flask框架构建，提供文件上传、下载、删除、重命名等基本操作。用户可以通过Web界面直观地查看和操作文件，支持多种文件类型。项目包含用户认证模块，确保文件访问权限安全。
- [schollz/croc](https://github.com/schollz/croc) ★31722 [`data-transfer`] [`file-sharing`] [`golang`] [`pake`] [`peer-to-peer`] [`tcp`] [`transfer`]  
...
- [iawia002/lux](https://github.com/iawia002/lux) ★30560 [`bilibili`] [`crawler`] [`download`] [`downloader`] [`go`] [`golang`] [`iqiyi`] [`qq`] [`scraper`] [`tumblr`] [`video`] [`youku`] [`youtube`]  
...
- [binwiederhier/ntfy](https://github.com/binwiederhier/ntfy) ★27020 [`curl`] [`notifications`] [`ntfy`] [`ntfysh`] [`pubsub`] [`push-notifications`] [`rest-api`]  
...
- [Wox-launcher/Wox](https://github.com/Wox-launcher/Wox) ★26265 [`alfred`] [`launcher`] [`launchy`] [`linux`] [`macos`] [`raycast`] [`spotlight`] [`windows`] [`wox`]  
...
- [tailscale/tailscale](https://github.com/tailscale/tailscale) ★25627 [`2fa`] [`oauth`] [`sso`] [`tailscale`] [`vpn`] [`wireguard`]  
...
- [cloudreve/cloudreve](https://github.com/cloudreve/cloudreve) ★25312 [`cloud`] [`cloud-storage`] [`cloudreve`] [`file`] [`file-manager`] [`file-sharing`] [`golang`]  
...
- [containrrr/watchtower](https://github.com/containrrr/watchtower) ★23925 [`automation`] [`continuous-delivery`] [`devops`] [`docker`] [`hacktoberfest`] [`notifications`] [`receive-notifications`] [`registry`] [`update-checker`] [`watchtower`]  
...
- [XIU2/CloudflareSpeedTest](https://github.com/XIU2/CloudflareSpeedTest) ★23263 [`cdn`] [`cloudflare`] [`go`] [`golang`] [`speedtest`]  
...
- [chaitin/SafeLine](https://github.com/chaitin/SafeLine) ★18666 [`api-gateway`] [`application-security`] [`appsec`] [`blueteam`] [`bruteforce`] [`captcha`] [`cve`] [`cybersecurity`] [`firewall`] [`hackers`] [`http-flood`] [`security`] [`self-hosted`] [`sql-injection`] [`vulnerability`] [`waf`] [`web-application-firewall`] [`web-security`] [`websecurity`] [`xss`]  
...
- [apernet/hysteria](https://github.com/apernet/hysteria) ★17597 [`censorship-circumvention`] [`golang`] [`http-proxy`] [`hysteria`] [`proxy`] [`quic`] [`relay`] [`reliable-udp`] [`socks5`] [`tun`] [`vpn`]  
...
- [OpenListTeam/OpenList](https://github.com/OpenListTeam/OpenList) ★17252 [`alist`] [`aliyunpan`] [`baidupan`] [`openlist`]  
...
- [ginuerzh/gost](https://github.com/ginuerzh/gost) ★17224 [`dns`] [`go`] [`golang`] [`http2`] [`kcp`] [`obfs4`] [`quic`] [`shadowsocks`] [`sni`] [`socks5`] [`ssh`] [`tls`] [`tunnel`] [`tuntap`] [`udp`]  
...
- [ory/hydra](https://github.com/ory/hydra) ★16622 [`authorization`] [`cloud`] [`docker`] [`federation`] [`hacktoberfest`] [`hydra`] [`identity`] [`oauth`] [`oauth-provider`] [`oauth2`] [`oauth2-provider`] [`oauth2-server`] [`oidc`] [`openid`] [`openid-connect`] [`openid-connect-provider`] [`openid-provider`] [`security`] [`server`] [`sso`]  
...
- [slackhq/nebula](https://github.com/slackhq/nebula) ★16377  
...
- [m1k1o/neko](https://github.com/m1k1o/neko) ★15722 [`docker`] [`golang`] [`media-streaming`] [`remote-control`] [`remote-desktop`] [`self-hosted`] [`virtual-browser`] [`vue`] [`webrtc`]  
...
- [jeessy2/ddns-go](https://github.com/jeessy2/ddns-go) ★15525 [`alidns`] [`baiduyun`] [`cloudflare`] [`ddns`] [`ddns-go`] [`dnspod`] [`godaddy-ddns`] [`google-domains`] [`porkbun`]  
...
- [gotify/server](https://github.com/gotify/server) ★13954 [`api`] [`cloud`] [`free-software`] [`golang`] [`gotify`] [`hosting`] [`javascript`] [`notifications`] [`privacy`] [`react`] [`self-hosted`] [`self-hosting`] [`selfhosted`]  
...
- [shadow1ng/fscan](https://github.com/shadow1ng/fscan) ★12844  
...
- [casdoor/casdoor](https://github.com/casdoor/casdoor) ★12472 [`auth`] [`authentication`] [`authn`] [`casbin`] [`casdoor`] [`faceid`] [`iam`] [`kerberos`] [`ldap`] [`mfa`] [`oauth`] [`oidc`] [`payment-gateway`] [`radius`] [`saml`] [`scim`] [`single-sign-on`] [`sso`] [`totp`] [`webauthn`]  
...
- [fullstorydev/grpcurl](https://github.com/fullstorydev/grpcurl) ★12151 [`golang`] [`grpc`] [`protobuf`]  
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) ★11826 [`argo-tunnel`] [`cloudflare`] [`cloudflare-tunnel`] [`reverse-proxy`] [`zero-trust-network-access`]  
...
- [putyy/res-downloader](https://github.com/putyy/res-downloader) ★11106 [`douyin`] [`kuaishou`] [`res-downloader`] [`wechat`] [`wechat-video`] [`xiaohongshu`]  
...
- [Mrs4s/go-cqhttp](https://github.com/Mrs4s/go-cqhttp) ★10601 [`bot`] [`coolq`] [`coolq-http-api`] [`qqbot`] [`qqrobot`]  
...
- [claudiodangelis/qrcp](https://github.com/claudiodangelis/qrcp) ★10352 [`cli`] [`command-line`] [`golang`] [`qrcode`] [`utility`]  
...
- [certimate-go/certimate](https://github.com/certimate-go/certimate) ★7623 [`acme`] [`acme-client`] [`automation`] [`certbot`] [`hacktoberfest`] [`https`] [`https-certificate`] [`lego`] [`letsencrypt`] [`ssl`] [`ssl-cert`] [`ssl-certificate`] [`ssl-certificates`]  
...
- [Hackl0us/GeoIP2-CN](https://github.com/Hackl0us/GeoIP2-CN) ★7131 [`clash`] [`geoip`] [`geoip2`] [`proxy`] [`quantumultx`] [`shadowrocket`] [`shadowsocks`] [`surge`]  
...
- [nxtrace/NTrace-core](https://github.com/nxtrace/NTrace-core) ★7119 [`api`] [`as-path`] [`asn-lookup`] [`geoip`] [`geolocation`] [`ip-lookup`] [`network-analysis`] [`next-trace`] [`nexttrace`] [`traceroute`] [`utility`]  
...
- [gdy666/lucky](https://github.com/gdy666/lucky) ★6679 [`acme`] [`aliyunpan`] [`cron`] [`ddns`] [`dynadot`] [`filebrowser`] [`ftp`] [`ipv6`] [`socat`] [`stun`] [`vercel`] [`volcengine`] [`webdav`] [`wol`]  
...
- [iyear/tdl](https://github.com/iyear/tdl) ★5965 [`bash`] [`download`] [`downloader`] [`telegram`] [`telegram-api`] [`telegram-bot`] [`telegram-bots`] [`telegram-channel`] [`telegram-userbot`]  
...
- [git-jiadong/wechatDataBackup](https://github.com/git-jiadong/wechatDataBackup) ★5875 [`wechat`] [`wechat-app`] [`wechat-bot`]  
...
- [ngoduykhanh/wireguard-ui](https://github.com/ngoduykhanh/wireguard-ui) ★4907 [`wireguard`] [`wireguard-admin`] [`wireguard-config-gen`] [`wireguard-go`] [`wireguard-ui`] [`wireguard-vpn`] [`wireguard-web`]  
...
- [hacdias/webdav](https://github.com/hacdias/webdav) ★4876 [`filesystem`] [`go`] [`http`] [`server`] [`webdav`]  
...
- [tickstep/aliyunpan](https://github.com/tickstep/aliyunpan) ★4807 [`adrive`] [`backup`] [`linux`] [`macos`] [`sync`] [`windows`]  
...
- [goravel/goravel](https://github.com/goravel/goravel) ★4223 [`framework`] [`go`] [`golang`] [`laravel`] [`performance`] [`web`]  
...
- [qjfoidnh/BaiduPCS-Go](https://github.com/qjfoidnh/BaiduPCS-Go) ★4053 [`baidupcs`]  
...
- [mzz2017/gg](https://github.com/mzz2017/gg) ★1809 [`go-graft`] [`graftcp`] [`proxy`] [`proxychains`] [`v2ray`]  
...
- [koho/frpmgr](https://github.com/koho/frpmgr) ★1800 [`frp`] [`frpc`] [`go`] [`gui`] [`proxy`] [`reverse-proxy`] [`windows`]  
...
- [msterzhang/onelist](https://github.com/msterzhang/onelist) ★1524  
...
- [samwafgo/SamWaf](https://github.com/samwafgo/SamWaf) ★1196  
...
- [mudkipme/mortis](https://github.com/mudkipme/mortis) ★51  
...
- [jgm/pandoc](https://github.com/jgm/pandoc) ★39832 [`commonmark`] [`converter`] [`document`] [`haskell`] [`markdown`] [`markup`] [`pandoc`] [`presentation`] [`publishing`]  
...
- [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) ★114113 [`awesome-list`] [`free-for-developers`]  
...
- [vernesong/OpenClash](https://github.com/vernesong/OpenClash) ★22409 [`clash`] [`luci`] [`mihomo`] [`openclash`] [`openwrt`] [`shadowsocks`] [`snell`] [`v2ray`] [`vmess`]  
...
- [Lerist/FakeLocation](https://github.com/Lerist/FakeLocation) ★6505  
...
- [CaiJimmy/hugo-theme-stack](https://github.com/CaiJimmy/hugo-theme-stack) ★6013 [`bloggers`] [`css`] [`hacktoberfest`] [`hugo`] [`hugo-theme`] [`theme`]  
...
- [vbskycn/iptv](https://github.com/vbskycn/iptv) ★4765  
...
- [aoaostar/legado](https://github.com/aoaostar/legado) ★4153 [`legado`] [`legado3`]  
...
- [xfirefly/Airplay-SDK](https://github.com/xfirefly/Airplay-SDK) ★3828 [`airplay`] [`airplay-receiver`] [`android`] [`dlna`] [`windows`]  
...
- [TIM168/technical_books](https://github.com/TIM168/technical_books) ★3336 [`books`] [`go`] [`html`] [`http`] [`it`] [`java`] [`linux`] [`php`] [`python`] [`technical`] [`technical-books`]  
...
- [xisohi/CHINA-IPTV](https://github.com/xisohi/CHINA-IPTV) ★939  
...
- [Stirling-Tools/Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF) ★69228 [`docker`] [`hacktoberfest`] [`java`] [`pdf`] [`pdf-converter`] [`pdf-editor`] [`pdf-manipulation`] [`pdf-merger`] [`pdf-ocr`] [`pdf-tools`] [`pdf-web-apps`] [`pdfmerger`]  
...
- [termux/termux-app](https://github.com/termux/termux-app) ★46329 [`android`] [`hacktoberfest`] [`linux`] [`terminal`] [`termux`]  
...
- [dbeaver/dbeaver](https://github.com/dbeaver/dbeaver) ★45954 [`ai`] [`copilot`] [`database`] [`db2`] [`dbeaver`] [`erd`] [`gui`] [`java`] [`jdbc`] [`mysql`] [`nosql`] [`openai`] [`oracle`] [`postgresql`] [`redshift`] [`sql`] [`sqlite`] [`sqlserver`]  
...
- [skylot/jadx](https://github.com/skylot/jadx) ★45927 [`android`] [`decompiler`] [`dex`] [`java`]  
...
- [halo-dev/halo](https://github.com/halo-dev/halo) ★37167 [`blog`] [`blog-engine`] [`cms`] [`content-management-system`] [`halo`] [`halocms`] [`website-builder`]  
...
- [dataease/dataease](https://github.com/dataease/dataease) ★22180 [`apache-doris`] [`business-intelligence`] [`data-analysis`] [`data-visualization`] [`echarts`] [`kettle`] [`superset`] [`tableau`]  
...
- [CarGuo/GSYVideoPlayer](https://github.com/CarGuo/GSYVideoPlayer) ★21197 [`16k`] [`android`] [`exoplayer`] [`ffmpeg`] [`gsy`] [`ijkplayer`] [`player`] [`ssl`] [`video`] [`videocache`]  
...
- [lionsoul2014/ip2region](https://github.com/lionsoul2014/ip2region) ★18293 [`ip-address`] [`ip-address-database`] [`ip-address-location`] [`ip-location`] [`ip-lookup`] [`ipv4-address`] [`ipv4-lookup`] [`ipv4-support`] [`ipv6-address`] [`ipv6-lookup`] [`ipv6-support`] [`xdb-engine`] [`xdb-ipv4`] [`xdb-ipv6`]  
...
- [Tencent/APIJSON](https://github.com/Tencent/APIJSON) ★18251 [`baas`] [`clickhouse`] [`crud`] [`databricks`] [`elasticsearch`] [`hadoop`] [`hive`] [`influxdb`] [`low-code`] [`lowcode`] [`milvus`] [`nocode`] [`oracle`] [`postgresql`] [`postgresql-database`] [`serverless`] [`snowflake`] [`sqlserver`] [`tdengine`] [`tidb`]  
...
- [microg/GmsCore](https://github.com/microg/GmsCore) ★11253 [`android`] [`auth`] [`cloud-messaging`] [`firebase`] [`geolocation`] [`google`] [`google-cloud-messaging`] [`java`] [`kotlin`] [`kotlin-android`] [`maps`] [`microg`] [`mobile`] [`push-notifications`]  
...
- [zfile-dev/zfile](https://github.com/zfile-dev/zfile) ★10460 [`clouddisk`] [`h2`] [`h5ai`] [`mysql`] [`spring-boot`] [`vue`]  
...
- [wildfirechat/im-server](https://github.com/wildfirechat/im-server) ★8334 [`im`] [`voip`]  
...
- [FongMi/TV](https://github.com/FongMi/TV) ★6700 [`catvod`] [`danmaku`] [`leanback`] [`media3`] [`p2p`] [`thunder`] [`tvbus`]  
...
- [648540858/wvp-GB28181-pro](https://github.com/648540858/wvp-GB28181-pro) ★6367 [`1078`] [`28181`] [`28181web`] [`808`] [`gb28181`] [`gb28181server`] [`wvp`]  
...
- [SuperMonster003/AutoJs6](https://github.com/SuperMonster003/AutoJs6) ★4808 [`android`] [`autojs`] [`autojs6`] [`automated-tool`] [`automation`] [`javascript`]  
...
- [rememberber/WePush](https://github.com/rememberber/WePush) ★4596 [`gui`] [`java`] [`mail`] [`message`] [`push`] [`send`] [`sender`] [`sms`] [`swing`] [`wechat`] [`weixin`]  
...
- [javahuang/SurveyKing](https://github.com/javahuang/SurveyKing) ★3780 [`java`] [`react-survey`] [`springboot`] [`survey`] [`surveyjs`] [`surveymonkey`]  
...
- [niumoo/bing-wallpaper](https://github.com/niumoo/bing-wallpaper) ★3130 [`bing`] [`bing-image`] [`bing-wallpaper`] [`wallpaper`]  
...
- [qaiu/netdisk-fast-download](https://github.com/qaiu/netdisk-fast-download) ★2350 [`api`] [`download`] [`drive`] [`file-server`] [`ilanzou`] [`java`] [`netdisk-fast-download`] [`onedrive`] [`parser`] [`share`] [`vertx`] [`webserver`] [`yunpan`]  
...
- [louislam/uptime-kuma](https://github.com/louislam/uptime-kuma) ★77313 [`docker`] [`monitor`] [`monitoring`] [`responsive`] [`self-hosted`] [`selfhosted`] [`single-page-app`] [`socket-io`] [`uptime`] [`uptime-monitoring`] [`webapp`] [`websocket`]  
...
- [mozilla/pdf.js](https://github.com/mozilla/pdf.js) ★52134  
...
- [marktext/marktext](https://github.com/marktext/marktext) ★52085 [`dark-mode`] [`editor`] [`electron`] [`element-ui`] [`emoji`] [`focus-mode`] [`latex`] [`linux`] [`mac`] [`macos`] [`markdown`] [`marktext`] [`next-generation`] [`source-code`] [`typewriter-mode`] [`vue`] [`windows`]  
...
- [agalwood/Motrix](https://github.com/agalwood/Motrix) ★49591 [`aria2`] [`bittorrent`] [`bt`] [`download`] [`download-manager`] [`electron`] [`linux`] [`mac`] [`macos`] [`magnet`] [`motrix`] [`torrent`] [`windows`]  
...
- [LeCoupa/awesome-cheatsheets](https://github.com/LeCoupa/awesome-cheatsheets) ★44621 [`backend`] [`bash`] [`cheatsheet`] [`cheatsheets`] [`database`] [`django`] [`docker`] [`feathersjs`] [`frontend`] [`javascript`] [`kubernetes`] [`language`] [`nodejs`] [`php`] [`programming-language`] [`redis`] [`sailsjs`] [`vim`] [`vuejs`] [`xcode`]  
...
- [NaiboWang/EasySpider](https://github.com/NaiboWang/EasySpider) ★43198 [`batch-processing`] [`batch-script`] [`code-free`] [`crawler`] [`data-collection`] [`frontend`] [`gui`] [`html`] [`input-parameters`] [`layman`] [`parameters`] [`robotics`] [`rpa`] [`scraper`] [`spider`] [`visual`] [`visualization`] [`visualprogramming`] [`web`] [`www`]  
...
- [HeyPuter/puter](https://github.com/HeyPuter/puter) ★36933 [`cloud`] [`cloud-os`] [`cloud-storage`] [`desktop`] [`desktop-environment`] [`dropbox`] [`good-first-issue`] [`gui`] [`javascript`] [`nas`] [`open-source`] [`operating-system`] [`os`] [`osjs`] [`puter`] [`remote-desktop`] [`storage`] [`web-desktop`] [`web-os`] [`webtop`]  
...
- [markedjs/marked](https://github.com/markedjs/marked) ★35933 [`commonmark`] [`compiler`] [`gfm`] [`hacktoberfest`] [`markdown`] [`parser`]  
...
- [qishibo/AnotherRedisDesktopManager](https://github.com/qishibo/AnotherRedisDesktopManager) ★33305 [`redis`] [`redis-client`] [`redis-cluster`] [`redis-desktop-manager`] [`redis-gui`]  
...
- [webtorrent/webtorrent](https://github.com/webtorrent/webtorrent) ★30556 [`bittorrent`] [`browser`] [`hacktoberfest`] [`javascript`] [`nodejs`] [`p2p`] [`streaming`] [`torrent`] [`webrtc`] [`webtorrent`]  
...
- [layui/layui](https://github.com/layui/layui) ★30393 [`component-library`] [`css`] [`html`] [`javascript`] [`layui`] [`ui-kit`] [`ui-library`]  
...
- [NginxProxyManager/nginx-proxy-manager](https://github.com/NginxProxyManager/nginx-proxy-manager) ★28982 [`nginx`] [`nginx-proxy`]  
...
- [songquanpeng/one-api](https://github.com/songquanpeng/one-api) ★27737 [`api`] [`api-gateway`] [`azure-openai-api`] [`chatgpt`] [`claude`] [`ernie-bot`] [`gemini`] [`gpt`] [`openai`] [`openai-api`] [`proxy`]  
...
- [fanmingming/live](https://github.com/fanmingming/live) ★26746 [`china`] [`converter`] [`epg`] [`iptv`] [`ipv6`] [`live`] [`m3u`] [`m3u8`] [`mp4`] [`radio`] [`television`] [`tv`] [`txt`] [`workers`]  
...
- [Z-Siqi/Clash-for-Windows_Chinese](https://github.com/Z-Siqi/Clash-for-Windows_Chinese) ★26650 [`chinese`] [`clash`] [`clash-chinese`] [`shadowsocks`] [`windows`] [`zh-cn`]  
...
- [tailwindlabs/heroicons](https://github.com/tailwindlabs/heroicons) ★23031  
...
- [blackmatrix7/ios_rule_script](https://github.com/blackmatrix7/ios_rule_script) ★22970  
...
- [handsontable/handsontable](https://github.com/handsontable/handsontable) ★21551 [`angular-datagrid`] [`angular-table`] [`component`] [`crud-operations`] [`data-editing`] [`data-grid`] [`data-management`] [`data-tables`] [`datagrid`] [`datatable`] [`excel`] [`excel-javascript`] [`grid`] [`grid-component`] [`react-datatable`] [`react-grid`] [`spreadsheet`] [`table`] [`vue-table`]  
...
- [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) ★20168 [`address`] [`administrative-divisions`] [`area`] [`china`] [`city`] [`csv`] [`json`] [`nodejs`] [`province`] [`street`]  
...
- [SillyTavern/SillyTavern](https://github.com/SillyTavern/SillyTavern) ★19520 [`ai`] [`chat`] [`llm`]  
...
- [SocialSisterYi/bilibili-API-collect](https://github.com/SocialSisterYi/bilibili-API-collect) ★19312 [`api`] [`bilibili`] [`bilibili-api`] [`bilibili-comment`] [`bilibili-danmaku`] [`bilibili-download`] [`bilibili-live`] [`bilibili-login`] [`grpc`] [`json`]  
...
- [sweetalert2/sweetalert2](https://github.com/sweetalert2/sweetalert2) ★17958 [`accessible`] [`alert`] [`angular`] [`confirm`] [`confirmation-dialog`] [`dialog`] [`hacktoberfest`] [`modal`] [`notifications`] [`popup`] [`prompt`] [`react`] [`sweetalert`] [`sweetalert2`] [`toast`] [`vue`] [`wai-aria`]  
...
- [GoogleChrome/chrome-extensions-samples](https://github.com/GoogleChrome/chrome-extensions-samples) ★16984 [`chrome`]  
...
- [brix/crypto-js](https://github.com/brix/crypto-js) ★16328  
...
- [xifangczy/cat-catch](https://github.com/xifangczy/cat-catch) ★16211 [`chrome`] [`chrome-extension`] [`firefox`] [`firefox-extension`] [`javascript`] [`jquery`] [`m3u8-downloader`] [`video-downloader`]  
  这是一个用于捕捉图像中猫的Python项目。它利用OpenCV库进行图像处理，并使用深度学习模型（例如YOLOv5）来检测和定位猫。项目提供预训练模型，并支持自定义模型训练。用户可以轻松地将项目集成到其他应用程序中，以实现猫的自动识别和追踪。
- [pot-app/pot-desktop](https://github.com/pot-app/pot-desktop) ★15651 [`linux`] [`macos`] [`ocr`] [`pot`] [`pot-app`] [`recognize`] [`tauri`] [`translate`] [`translation`] [`tts`] [`windows`]  
...
- [electerm/electerm](https://github.com/electerm/electerm) ★13161 [`electerm`] [`electron`] [`file-manager`] [`ftp`] [`linux-app`] [`macos-app`] [`open-source`] [`rdp`] [`serialport`] [`sftp`] [`ssh`] [`telnet`] [`terminal`] [`vnc`] [`windows-app`]  
...
- [mickael-kerjean/filestash](https://github.com/mickael-kerjean/filestash) ★12928 [`dwg`] [`file-manager`] [`file-sharing`] [`filemanager`] [`ftp`] [`git`] [`ldap`] [`mcp`] [`nfs`] [`raw`] [`s3`] [`sftp`] [`smb`] [`webdav`]  
...
- [star7th/showdoc](https://github.com/star7th/showdoc) ★12663 [`api`] [`document`] [`documentation-tool`] [`showdoc`]  
...
- [mayswind/AriaNg](https://github.com/mayswind/AriaNg) ★12631 [`aria2`] [`ariang`] [`download`] [`gui`] [`html`] [`javascript`] [`ui`] [`web`] [`web-frontend`] [`webui`]  
...
- [listen1/listen1_chrome_extension](https://github.com/listen1/listen1_chrome_extension) ★11930 [`chrome-extension`] [`music-player`]  
...
- [QuantumNous/new-api](https://github.com/QuantumNous/new-api) ★11746 [`ai-gateway`] [`claude`] [`deepseek`] [`gemini`] [`openai`] [`rerank`]  
...
- [Semporia/TikTok-Unlock](https://github.com/Semporia/TikTok-Unlock) ★11495 [`tiktok`] [`tiktok-unlock`] [`unlock`]  
...
- [tangly1024/NotionNext](https://github.com/tangly1024/NotionNext) ★10512 [`blog`] [`nextjs`] [`notion`] [`react`] [`tailwindcss`] [`vercel`] [`zeabur`]  
...
- [ziahamza/webui-aria2](https://github.com/ziahamza/webui-aria2) ★10216  
...
- [Stuk/jszip](https://github.com/Stuk/jszip) ★10206 [`javascript`] [`zip`]  
...
- [webtorrent/webtorrent-desktop](https://github.com/webtorrent/webtorrent-desktop) ★9962 [`bittorrent`] [`electron`] [`hacktoberfest`] [`javascript`] [`linux`] [`macos`] [`nodejs`] [`p2p`] [`streaming`] [`webrtc`] [`webtorrent`] [`windows`]  
...
- [faisalman/ua-parser-js](https://github.com/faisalman/ua-parser-js) ★9898 [`analytics`] [`bot-detection`] [`browser-detection`] [`client-hints`] [`device-detection`] [`mobile-detection`] [`user-agent`] [`user-agent-parser`]  
...
- [is-a-dev/register](https://github.com/is-a-dev/register) ★8910 [`cloudflare`] [`dev`] [`developer`] [`dns`] [`domain`] [`foss`] [`free`] [`free-domain`] [`free-for-dev`] [`free-for-developers`] [`github-pages`] [`oss`] [`subdomain`] [`website`]  
...
- [cmliu/CF-Workers-docker.io](https://github.com/cmliu/CF-Workers-docker.io) ★8768 [`cloudflare-pages`] [`cloudflare-workers`] [`docker`] [`dockerhub`]  
...
- [Nickersoft/push.js](https://github.com/Nickersoft/push.js) ★8706 [`javascript`] [`javascript-library`] [`notification-api`] [`notifications`] [`push`] [`push-notifications`]  
...
- [joemccann/dillinger](https://github.com/joemccann/dillinger) ★8157 [`blog`] [`blogging`] [`editor`] [`ide`] [`javascript`] [`markdown`] [`md`] [`node`] [`nodejs`] [`writing`]  
...
- [fishjar/kiss-translator](https://github.com/fishjar/kiss-translator) ★7803 [`extension`] [`translate`] [`translation`] [`translator`] [`userscript`] [`userscripts`]  
...
- [Momo707577045/m3u8-downloader](https://github.com/Momo707577045/m3u8-downloader) ★6711 [`blob`] [`m3u8`]  
...
- [zumerlab/snapdom](https://github.com/zumerlab/snapdom) ★6525 [`capture-screenshots`] [`clone`] [`dom`] [`js`] [`screenshot`]  
...
- [Dooy/chatgpt-web-midjourney-proxy](https://github.com/Dooy/chatgpt-web-midjourney-proxy) ★6486 [`chatgpt-ui`] [`fal-ai`] [`flux`] [`gpts`] [`ideogram`] [`kling`] [`luma`] [`midjourney-ui`] [`pika`] [`realtime`] [`riffusion`] [`runway`] [`sora-video`] [`suno`] [`veo3`] [`viggle`]  
...
- [lrsjng/h5ai](https://github.com/lrsjng/h5ai) ★5903 [`apache`] [`apache2`] [`h5ai`] [`index`] [`lighttpd`] [`nginx`]  
...
- [tangyoha/telegram_media_downloader](https://github.com/tangyoha/telegram_media_downloader) ★4392 [`cosplatfrom`] [`cross-platform`] [`downloader`] [`flask`] [`media-downloader`] [`telegram-bot`]  
...
- [certd/certd](https://github.com/certd/certd) ★3778 [`acme`] [`auto`] [`automation`] [`cert`] [`certbot`] [`letencrypt`] [`ssl`] [`ssl-certificate`]  
...
- [dqzboy/Docker-Proxy](https://github.com/dqzboy/Docker-Proxy) ★3734 [`docker-proxy`] [`docker-registry`] [`gcr-registry`]  
...
- [songquanpeng/message-pusher](https://github.com/songquanpeng/message-pusher) ★3614 [`bark`] [`dingtalk`] [`discord`] [`email`] [`feishu`] [`lark`] [`message-pusher`] [`telegram`] [`websocket`] [`wechat`]  
...
- [PublicAffairs/openai-gemini](https://github.com/PublicAffairs/openai-gemini) ★3047 [`chatgpt-api`] [`gemini`] [`gemini-ai`] [`openai`] [`proxy`] [`serverless`]  
...
- [crossutility/Quantumult-X](https://github.com/crossutility/Quantumult-X) ★2964  
...
- [cilame/v_jstools](https://github.com/cilame/v_jstools) ★2738  
...
- [FranckFreiburger/vue-pdf](https://github.com/FranckFreiburger/vue-pdf) ★2295 [`component`] [`pdf`] [`pdf-viewer`] [`vue-pdf`] [`vuejs2`]  
...
- [easychen/checkchan-dist](https://github.com/easychen/checkchan-dist) ★2243 [`monitoring-server`] [`monitoring-tool`] [`wechat`]  
...
- [extesy/hoverzoom](https://github.com/extesy/hoverzoom) ★1901 [`chrome-extension`] [`hacktoberfest`] [`hoverzoom`] [`images`] [`photos`] [`productivity`] [`zoom-images`] [`zooming`]  
...
- [Pactum7/ticket-grabbing](https://github.com/Pactum7/ticket-grabbing) ★1541  
...
- [CcSimple/vue-plugin-hiprint](https://github.com/CcSimple/vue-plugin-hiprint) ★1470 [`design`] [`print`] [`report`] [`vue`]  
...
- [Tencent/nohost](https://github.com/Tencent/nohost) ★1463  
...
- [law-chain-hot/websocket-devtools](https://github.com/law-chain-hot/websocket-devtools) ★949 [`chrome-extensions`] [`devtools`] [`real-time`] [`real-time-chat`] [`real-time-monitoring`] [`socket-io`] [`webgame`] [`websocket`] [`websocket-chat`] [`websocket-client`]  
...
- [cv-cat/XianYuApis](https://github.com/cv-cat/XianYuApis) ★732  
...
- [2dust/v2rayNG](https://github.com/2dust/v2rayNG) ★46275 [`android`] [`proxy`] [`shadowsocks`] [`socks5`] [`trojan`] [`v2fly`] [`v2ray`] [`vless`] [`vmess`] [`vpn`] [`xray`] [`xtls`]  
...
- [bannedbook/fanqiang](https://github.com/bannedbook/fanqiang) ★40756 [`brook`] [`daze`] [`fanqiang`] [`goflyway`] [`lightsocks`] [`proxy`] [`psiphon`] [`shadowsocks`] [`ssr`] [`trojan`] [`v2ray`]  
  这是一个用于科学上网的翻墙工具，提供多种连接方式，支持多种操作系统。它使用Go语言开发，核心模块包括代理服务器和连接管理，并整合了多种开源库。该项目旨在为用户提供快速、稳定、便捷的网络访问方式，绕过地区限制。
- [gkd-kit/gkd](https://github.com/gkd-kit/gkd) ★32036 [`accessibility`] [`android`] [`auto`] [`click`] [`compose`] [`jetpack-compose`] [`kotlin`] [`kotlin-js`] [`kotlin-multiplatform`] [`webassembly`]  
...
- [MetaCubeX/ClashMetaForAndroid](https://github.com/MetaCubeX/ClashMetaForAndroid) ★28769  
...
- [pppscn/SmsForwarder](https://github.com/pppscn/SmsForwarder) ★23175 [`android`] [`api`] [`app`] [`bark`] [`call`] [`chatgpt`] [`dingding`] [`forward`] [`mqtt`] [`pushdear`] [`pushplus`] [`serverchan`] [`sms`] [`smtp`] [`telegram`] [`webhook`] [`wechatapp`]  
...
- [RikkaApps/Shizuku](https://github.com/RikkaApps/Shizuku) ★18159  
...
- [MatsuriDayo/NekoBoxForAndroid](https://github.com/MatsuriDayo/NekoBoxForAndroid) ★16727 [`android`] [`gfw`] [`proxy`] [`shadowsocks`] [`sing-box`] [`trojan`] [`vmess`] [`vpn`]  
...
- [mihonapp/mihon](https://github.com/mihonapp/mihon) ★16471 [`android`] [`kotlin`] [`manga`] [`manga-downloader`] [`manga-reader`] [`mangadownloader`] [`mangareader`] [`tachiyomi`] [`tachiyomi-alternative`]  
...
- [tiann/KernelSU](https://github.com/tiann/KernelSU) ★13815 [`android`] [`kernel`] [`kernelsu`] [`root`] [`su`]  
...
- [open-ani/animeko](https://github.com/open-ani/animeko) ★12573 [`android`] [`ani`] [`anime`] [`bangumi`] [`bittorrent`] [`bt`] [`compose`] [`compose-multiplatform`] [`danmaku`] [`ios`] [`jetpack-compose`] [`kotlin`] [`kotlin-multiplatform`] [`linux`] [`macos`] [`player`] [`torrent`] [`video`] [`windows`]  
...
- [ankidroid/Anki-Android](https://github.com/ankidroid/Anki-Android) ★10168 [`android`] [`anki`] [`ankidroid`] [`education`] [`flashcards`] [`kotlin`] [`learning`] [`srs`]  
...
- [bitwarden/android](https://github.com/bitwarden/android) ★7978 [`android`] [`bitwarden`] [`compose`] [`jetpack`] [`kotlin`]  
...
- [osfans/trime](https://github.com/osfans/trime) ★3793 [`android`] [`chinese`] [`ime`] [`jni`] [`opencc`] [`rime`]  
...
- [aaa1115910/bv](https://github.com/aaa1115910/bv) ★3336  
...
- [rosuH/EasyWatermark](https://github.com/rosuH/EasyWatermark) ★1764 [`android`] [`image`] [`image-watermark`] [`tools`] [`watermark`] [`watermwark`]  
...
- [tailscale/tailscale-android](https://github.com/tailscale/tailscale-android) ★1554 [`android`] [`chromeos`] [`tailscale`] [`vpn`] [`vpn-client`] [`wireguard`]  
...
- [mudkipme/MoeMemosAndroid](https://github.com/mudkipme/MoeMemosAndroid) ★872 [`android-application`] [`f-droid`] [`fdroid`] [`jetpack-compose`] [`kotlin-android`] [`memo`] [`note-taking`] [`self-hosted`]  
...
- [Kong/kong](https://github.com/Kong/kong) ★42054 [`ai`] [`ai-gateway`] [`api-gateway`] [`api-management`] [`apis`] [`artificial-intelligence`] [`cloud-native`] [`devops`] [`kubernetes`] [`kubernetes-ingress`] [`kubernetes-ingress-controller`] [`llm-gateway`] [`llm-ops`] [`mcp`] [`mcp-gateway`] [`microservice`] [`microservices`] [`openai-proxy`] [`reverse-proxy`] [`serverless`]  
...
- [iDvel/rime-ice](https://github.com/iDvel/rime-ice) ★13546 [`rime`] [`rime-config`] [`rime-custom`] [`rime-schema`] [`rime-squirrel`] [`rime-weasel`]  
...
- [zhihulite/Hydrogen](https://github.com/zhihulite/Hydrogen) ★1260  
...
- [twbs/bootstrap](https://github.com/twbs/bootstrap) ★173608 [`bootstrap`] [`css`] [`css-framework`] [`html`] [`javascript`] [`sass`] [`scss`]  
...
- [996icu/996.ICU](https://github.com/996icu/996.ICU) ★274703  
  该项目是一个关于中国程序员工作强度和压力的匿名吐槽平台。用户可以通过匿名发表帖子，分享工作经历和感受。平台使用简单的文本格式，并支持搜索和过滤功能。该项目主要使用PHP语言开发，并使用数据库存储用户数据和帖子信息。
- [awesome-selfhosted/awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ★255088 [`awesome`] [`awesome-list`] [`cloud`] [`free-software`] [`hosting`] [`privacy`] [`self-hosted`] [`selfhosted`]  
...
- [deepseek-ai/DeepSeek-R1](https://github.com/deepseek-ai/DeepSeek-R1) ★91400  
...
- [ruanyf/weekly](https://github.com/ruanyf/weekly) ★77889  
...
- [PlexPt/awesome-chatgpt-prompts-zh](https://github.com/PlexPt/awesome-chatgpt-prompts-zh) ★56655 [`chat-gpt`] [`chatgpt`] [`chatgpt3`] [`chatgpt4`] [`gpt`]  
...
- [justjavac/awesome-wechat-weapp](https://github.com/justjavac/awesome-wechat-weapp) ★49400 [`demo`] [`minapp`] [`miniprogram`] [`weapp-demo`] [`wechat`] [`wechat-weapp`] [`wepy`] [`wxapp`] [`wxml`]  
...
- [LC044/WeChatMsg](https://github.com/LC044/WeChatMsg) ★40088 [`chatgpt`] [`llms`] [`pyqt`] [`wechat`]  
...
- [SheetJS/sheetjs](https://github.com/SheetJS/sheetjs) ★35996 [`angular`] [`bun`] [`csv`] [`data`] [`database`] [`deno`] [`excel`] [`grid`] [`html`] [`html5`] [`ios`] [`javascript`] [`json`] [`nodejs`] [`react`] [`spreadsheet`] [`table`] [`vue`] [`xlsx`] [`xml`]  
...
- [ziadoz/awesome-php](https://github.com/ziadoz/awesome-php) ★32040 [`awesome`] [`awesome-lists`] [`php`] [`php-applications`] [`php-framework`] [`php-installation`] [`php-library`]  
...
- [XIU2/TrackersListCollection](https://github.com/XIU2/TrackersListCollection) ★29644 [`aria2`] [`aria2-format-tracker`] [`bittorrent`] [`bittorrent-trackers`] [`qbittorrent`] [`torrent`] [`torrent-tracker`] [`tracker`] [`trackers`] [`trackerslist`] [`utorrent`]  
...
- [geekcompany/ResumeSample](https://github.com/geekcompany/ResumeSample) ★27908  
...
- [gfwlist/gfwlist](https://github.com/gfwlist/gfwlist) ★24695 [`anticensorship`] [`censorship`] [`censorship-circumvention`] [`china`] [`gfw`]  
...
- [leiurayer/downkyi](https://github.com/leiurayer/downkyi) ★23753  
...
- [yanue/V2rayU](https://github.com/yanue/V2rayU) ★19611 [`mac-v2ray`] [`v2ray`] [`v2ray-core`] [`v2ray-gui`] [`v2ray-mac`] [`v2ray-shadowsocks`] [`v2rayu`] [`vmess`]  
...
- [AZeC4/TelegramGroup](https://github.com/AZeC4/TelegramGroup) ★18993 [`telegram`] [`telegram-api`] [`telegram-bot`] [`telegram-bot-api`] [`telegram-bots`] [`telegram-channel`] [`telegramgroups`]  
...
- [Johnshall/Shadowrocket-ADBlock-Rules-Forever](https://github.com/Johnshall/Shadowrocket-ADBlock-Rules-Forever) ★17922 [`adblock`] [`gfw`] [`proxy`] [`shadowrocket`] [`v2ray`]  
  该项目提供了一套用于Shadowrocket的广告拦截规则，旨在永久性地屏蔽广告。规则集包含广泛的广告域名和资源，并持续更新。使用Swift编写，通过配置文件实现规则管理，方便用户导入和导出。项目结构清晰，易于维护和扩展。
- [hzlzh/Best-App](https://github.com/hzlzh/Best-App) ★17463 [`app`] [`mac`] [`macos`]  
...
- [xiaye13579/BBLL](https://github.com/xiaye13579/BBLL) ★16919 [`android`] [`apk`] [`bilibili`] [`bilibili-client`] [`bilibili-tv`] [`tv`]  
...
- [sparanoid/chinese-copywriting-guidelines](https://github.com/sparanoid/chinese-copywriting-guidelines) ★15041 [`chinese`] [`chinese-simplified`] [`chinese-traditional`] [`copywriting`] [`css`] [`documentation`] [`guideline`] [`leancloud`] [`markdown`]  
...
- [AUK9527/Are-u-ok](https://github.com/AUK9527/Are-u-ok) ★12199  
...
- [joevess/IPTV](https://github.com/joevess/IPTV) ★10242  
...
- [privacy-protection-tools/anti-AD](https://github.com/privacy-protection-tools/anti-AD) ★9783 [`adblock`] [`adguardhome`] [`dnsmasq`] [`easylist`] [`neohosts`] [`php`] [`pi-hole`] [`surge`]  
...
- [ripperhe/Bob](https://github.com/ripperhe/Bob) ★9446 [`bobapp`] [`chatgpt`] [`deepseek`] [`doubao`] [`ernie`] [`gemini`] [`groq`] [`hunyuan`] [`kimi`] [`macos`] [`ocr`] [`openai`] [`qwen`] [`translate`] [`translation`] [`translator`] [`zhipuai`]  
...
- [pikvm/pikvm](https://github.com/pikvm/pikvm) ★9436 [`atx`] [`hardware`] [`hdmi`] [`ip-kvm`] [`ipkvm`] [`ipmi`] [`kvm`] [`mass-storage-device`] [`pi-kvm`] [`pikvm`] [`raspberry-pi`] [`raspberrypi`] [`vga`] [`video-capture-device`] [`vnc`]  
...
- [jackhawks/rectg](https://github.com/jackhawks/rectg) ★8177 [`rectg`] [`telegram`] [`telegram-bot`] [`telegram-channel`] [`telegram-group`]  
...
- [wuxingsanren/wildcat-vip-account](https://github.com/wuxingsanren/wildcat-vip-account) ★7895  
...
- [dongyubin/DockerHub](https://github.com/dongyubin/DockerHub) ★6179 [`cloudflare`] [`docker`] [`docker-image`] [`docker-registry`] [`dockerhub`] [`proxy`]  
...
- [ACL4SSR/ACL4SSR](https://github.com/ACL4SSR/ACL4SSR) ★5272 [`acl`] [`acl4ssr`] [`clash`] [`gfwlist`]  
...
- [awesome-vpn/awesome-vpn](https://github.com/awesome-vpn/awesome-vpn) ★4587 [`clash`] [`fanqiang`] [`free`] [`geopolitics`] [`gfw`] [`great-firewall`] [`shadowsocks`] [`shadowsocksr`] [`ss`] [`trojan`] [`v2ray`] [`vless`] [`vmess`] [`vpn-server`] [`xray`]  
...
- [Meroser/IPTV](https://github.com/Meroser/IPTV) ★4044  
...
- [MZCretin/RollToolsApi](https://github.com/MZCretin/RollToolsApi) ★3444 [`api`]  
...
- [sahibjotsaggu/San-Francisco-Pro-Fonts](https://github.com/sahibjotsaggu/San-Francisco-Pro-Fonts) ★1903 [`fonts`]  
...
- [hujingguang/ChinaIPTV](https://github.com/hujingguang/ChinaIPTV) ★1503  
...
- [ihmily/ip-info-api](https://github.com/ihmily/ip-info-api) ★1326 [`ip`] [`ip-geolocation`] [`ipaddress-tracker`] [`ipapi`] [`ipinfo`]  
...
- [submato/xhscrawl](https://github.com/submato/xhscrawl) ★1154  
...
- [fancyapps/ui](https://github.com/fancyapps/ui) ★989 [`carousel`] [`fancybox`] [`gallery`] [`javascript`] [`lightbox`] [`panzoom`]  
...
- [swyefun/BBLLV5](https://github.com/swyefun/BBLLV5) ★888  
...
- [opa334/TrollStore](https://github.com/opa334/TrollStore) ★20347  
...
- [sequelpro/sequelpro](https://github.com/sequelpro/sequelpro) ★9180 [`macos`] [`mysql`] [`objective-c`] [`sequelpro`]  
...
- [Sequel-Ace/Sequel-Ace](https://github.com/Sequel-Ace/Sequel-Ace) ★7173 [`hacktoberfest`] [`hacktoberfest2023`] [`macos`] [`mariadb`] [`mysql`] [`objective-c`] [`sequel`] [`sequelace`] [`sequelpro`]  
...
- [syncthing/syncthing-macos](https://github.com/syncthing/syncthing-macos) ★3283 [`apple`] [`backup`] [`cloud-sync`] [`file-sharing`] [`file-sync`] [`frugal`] [`mac`] [`macos`] [`macosx`] [`objective-c`] [`osx`] [`p2p`] [`peer-to-peer`] [`simple`] [`swift`] [`sync`] [`sync-files`] [`synchronization`] [`syncthing`]  
...
- [cheat-engine/cheat-engine](https://github.com/cheat-engine/cheat-engine) ★17172  
...
- [nextcloud/server](https://github.com/nextcloud/server) ★33203 [`cloud`] [`collaboration`] [`decentralized`] [`design`] [`distributed`] [`enterprise`] [`federation`] [`file-sharing`] [`free-software`] [`hacktoberfest`] [`javascript`] [`nextcloud`] [`open-source`] [`opensource`] [`owncloud`] [`php`] [`self-hosting`] [`sharing`] [`usability`] [`ux`]  
...
- [fzaninotto/Faker](https://github.com/fzaninotto/Faker) ★26756  
...
- [Seldaek/monolog](https://github.com/Seldaek/monolog) ★21339 [`hacktoberfest`] [`logger`] [`logging`] [`php`] [`psr-3`]  
...
- [koel/koel](https://github.com/koel/koel) ★16818 [`audio`] [`hacktoberfest`] [`laravel`] [`music`] [`music-player`] [`streaming`] [`vue`]  
...
- [getgrav/grav](https://github.com/getgrav/grav) ★15224 [`cms`] [`content`] [`content-management`] [`doctrine`] [`flat-file`] [`grav`] [`markdown`] [`php`] [`php7`] [`symfony`] [`twig`] [`website`] [`website-builder`] [`website-generation`] [`yaml`]  
...
- [librespeed/speedtest](https://github.com/librespeed/speedtest) ★13746 [`hacktoberfest`] [`html5-speedtest`] [`internet-speed`] [`internet-speed-checker`] [`librespeed`] [`php`] [`speedtest`] [`web-worker`] [`xhr`]  
...
- [thephpleague/flysystem](https://github.com/thephpleague/flysystem) ★13511 [`filesystem`] [`filesystem-library`] [`php`] [`thephpleague`]  
...
- [FreshRSS/FreshRSS](https://github.com/FreshRSS/FreshRSS) ★12889 [`feed`] [`freshrss`] [`news-aggregator`] [`php`] [`rss`] [`rss-aggregator`] [`rss-reader`] [`self-hosted`] [`websub`]  
...
- [YOURLS/YOURLS](https://github.com/YOURLS/YOURLS) ★11623 [`hacktoberfest`] [`php`] [`short-url`] [`url-shortener`] [`yourls`]  
...
- [assimon/dujiaoka](https://github.com/assimon/dujiaoka) ★11372 [`dujiaofaka`] [`dujiaoka`] [`faka`]  
...
- [z-song/laravel-admin](https://github.com/z-song/laravel-admin) ★11172 [`laravel-admin`] [`model-form`] [`model-grid`] [`model-show`] [`model-tree`]  
  Laravel
- [dompdf/dompdf](https://github.com/dompdf/dompdf) ★10968 [`css`] [`dompdf`] [`font`] [`html`] [`html-to-pdf`] [`pdf-generation`] [`php`]  
...
- [w7corp/easywechat](https://github.com/w7corp/easywechat) ★10357 [`easywechat`] [`php`] [`sdk`] [`wechat`]  
...
- [roundcube/roundcubemail](https://github.com/roundcube/roundcubemail) ★6583  
...
- [Respect/Validation](https://github.com/Respect/Validation) ★5890 [`components`] [`fluent-interface`] [`php`] [`standalone`] [`validation`] [`validation-engine`] [`validator`]  
...
- [vimeo/psalm](https://github.com/vimeo/psalm) ★5762 [`hacktoberfest`] [`php`] [`security-analysis`] [`static-analysis`] [`taint-analysis`] [`type-inference`]  
  Psalm是一个PHP静态分析工具，用于检测代码中的潜在错误和安全漏洞。它基于抽象语法树（AST）分析，并提供详细的错误报告。Psalm支持多种PHP版本，并能与各种IDE集成。该工具能够提高代码质量，并帮助开发者更早地发现潜在问题。
- [hlmd/Postman-cn](https://github.com/hlmd/Postman-cn) ★5581 [`chinese`] [`postman`]  
...
- [wikimedia/mediawiki](https://github.com/wikimedia/mediawiki) ★4781 [`mediawiki`] [`php`] [`wiki`] [`wikipedia`]  
...
- [jenssegers/agent](https://github.com/jenssegers/agent) ★4696 [`accept-language`] [`browser`] [`mobile-detect`] [`platform`] [`robot`] [`user-agent`]  
...
- [Hanson/vbot](https://github.com/Hanson/vbot) ★4355 [`php`] [`robot`] [`wechat`] [`weixin`]  
...
- [phpDocumentor/phpDocumentor](https://github.com/phpDocumentor/phpDocumentor) ★4285 [`docblock`] [`docblocks`] [`graphviz`] [`hacktoberfest`] [`php`] [`phpdocumentor`]  
...
- [Bubka/2FAuth](https://github.com/Bubka/2FAuth) ★3481 [`2fa`] [`2factor`] [`hotp`] [`otp`] [`qrcode`] [`self-hosted`] [`totp`] [`two-factor`] [`two-factor-authentication`] [`webapp`]  
...
- [thiagoalessio/tesseract-ocr-for-php](https://github.com/thiagoalessio/tesseract-ocr-for-php) ★3013 [`image-to-text`] [`ocr`] [`php`] [`tesseract`] [`text-recognition`]  
...
- [kalcaddle/kodbox](https://github.com/kalcaddle/kodbox) ★2726 [`docx`] [`file-explorer`] [`file-manager`] [`file-sharing`] [`file-upload`] [`file-viewer`] [`filemanager`] [`filesystem`] [`free-software`] [`javascript`] [`markdown-editor`] [`php`] [`text-editor`] [`webdav`] [`xlsx`]  
...
- [magicblack/maccms10](https://github.com/magicblack/maccms10) ★2664 [`maccms`] [`maccms10`]  
...
- [zoujingli/WeChatDeveloper](https://github.com/zoujingli/WeChatDeveloper) ★1605 [`developer`] [`phpsdk`] [`wechat`] [`wxpay`] [`wxsdk`]  
...
- [JaguarJack/catch-admin](https://github.com/JaguarJack/catch-admin) ★838 [`admin`] [`composer`] [`elementplus`] [`laravel`] [`laravel-admin`] [`php`] [`vue-admin`] [`vue3`]  
...
- [tsxcw/mtab](https://github.com/tsxcw/mtab) ★657  
...
- [aazooo/zjmf](https://github.com/aazooo/zjmf) ★568  
...
- [6tail/lunar-php](https://github.com/6tail/lunar-php) ★183 [`calendar`] [`lunar`] [`php`]  
...
- [HurryBy/CloudDiskAnalysis](https://github.com/HurryBy/CloudDiskAnalysis) ★132 [`123`] [`123pan`] [`lanzou`] [`lanzoucloud`] [`yidong`] [`yunkongjian`]  
...
- [ScoopInstaller/Scoop](https://github.com/ScoopInstaller/Scoop) ★23061 [`installer`] [`powershell`] [`scoop`] [`windows`]  
...
- [EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books) ★375250 [`books`] [`education`] [`hacktoberfest`] [`list`] [`resource`]  
...
- [public-apis/public-apis](https://github.com/public-apis/public-apis) ★373831 [`api`] [`apis`] [`dataset`] [`development`] [`free`] [`list`] [`lists`] [`open-source`] [`public`] [`public-api`] [`public-apis`] [`resources`] [`software`]  
...
- [ytdl-org/youtube-dl](https://github.com/ytdl-org/youtube-dl) ★138574  
...
- [521xueweihan/HelloGitHub](https://github.com/521xueweihan/HelloGitHub) ★132320 [`awesome`] [`github`] [`hellogithub`] [`python`]  
...
- [deepseek-ai/DeepSeek-V3](https://github.com/deepseek-ai/DeepSeek-V3) ★100010  
...
- [nvbn/thefuck](https://github.com/nvbn/thefuck) ★94492 [`python`] [`shell`]  
...
- [home-assistant/core](https://github.com/home-assistant/core) ★82212 [`asyncio`] [`hacktoberfest`] [`home-automation`] [`internet-of-things`] [`iot`] [`mqtt`] [`python`] [`raspberry-pi`]  
...
- [fighting41love/funNLP](https://github.com/fighting41love/funNLP) ★76855  
...
- [sherlock-project/sherlock](https://github.com/sherlock-project/sherlock) ★69879 [`cli`] [`cti`] [`cybersecurity`] [`forensics`] [`hacktoberfest`] [`information-gathering`] [`infosec`] [`linux`] [`osint`] [`pentesting`] [`python`] [`python3`] [`reconnaissance`] [`redteam`] [`sherlock`] [`tools`]  
...
- [xtekky/gpt4free](https://github.com/xtekky/gpt4free) ★65451 [`chatbot`] [`chatbots`] [`chatgpt`] [`chatgpt-4`] [`chatgpt-api`] [`chatgpt-free`] [`chatgpt4`] [`deepseek`] [`deepseek-api`] [`deepseek-r1`] [`gpt`] [`gpt-4`] [`gpt-4o`] [`gpt4`] [`gpt4-api`] [`language-model`] [`openai`] [`openai-api`] [`openai-chatgpt`] [`reverse-engineering`]  
  该项目提供一个基于GPT-4的免费API访问途径。用户无需付费即可调用GPT-4模型进行文本生成、翻译等任务。该项目使用Python和OpenAI API进行开发，核心功能包括API接口封装和请求管理，并提供简易的调用示例。
- [scrapy/scrapy](https://github.com/scrapy/scrapy) ★58779 [`crawler`] [`crawling`] [`framework`] [`hacktoberfest`] [`python`] [`scraping`] [`web-scraping`] [`web-scraping-python`]  
...
- [soimort/you-get](https://github.com/soimort/you-get) ★56514  
...
- [Z4nzu/hackingtool](https://github.com/Z4nzu/hackingtool) ★53873 [`allinonehackingtool`] [`besthackingtool`] [`ctf-tools`] [`ddos-attack-tool`] [`hacker`] [`hacking`] [`linux`] [`password-attack`] [`steganography`] [`web-attack`] [`wireless-attack`] [`xss-attacks`] [`xss-detection`]  
...
- [harry0703/MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo) ★47302 [`ai`] [`automation`] [`chatgpt`] [`moviepy`] [`python`] [`shortvideo`] [`tiktok`]  
...
- [mitmproxy/mitmproxy](https://github.com/mitmproxy/mitmproxy) ★40992 [`debugging`] [`http`] [`http2`] [`man-in-the-middle`] [`mitmproxy`] [`proxy`] [`python`] [`security`] [`ssl`] [`tls`] [`websocket`]  
...
- [zhayujie/chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat) ★39504 [`ai`] [`ai-agent`] [`chatgpt`] [`claude-4`] [`deepseek`] [`dingtalk`] [`feishu-bot`] [`gemini`] [`gpt-4`] [`kimi`] [`linkai`] [`llm`] [`mcp`] [`multi-agent`] [`openai`] [`python3`] [`qwen`] [`rag`] [`wechat`] [`wechat-bot`]  
...
- [hiroi-sora/Umi-OCR](https://github.com/hiroi-sora/Umi-OCR) ★39206 [`ocr`] [`ocr-python`] [`paddleocr`] [`qml`] [`qt`] [`screenshot`] [`umi-ocr`]  
...
- [yeongpin/cursor-free-vip](https://github.com/yeongpin/cursor-free-vip) ★38801 [`automation`] [`cursor`] [`cursor-ai`] [`cursor-ide`] [`cursorai`] [`cursors`] [`free`] [`freetrial`] [`pro`]  
...
- [NanmiCoder/MediaCrawler](https://github.com/NanmiCoder/MediaCrawler) ★38310  
...
- [2noise/ChatTTS](https://github.com/2noise/ChatTTS) ★38041 [`agent`] [`chat`] [`chatgpt`] [`chattts`] [`chinese`] [`chinese-language`] [`english`] [`english-language`] [`gpt`] [`llm`] [`llm-agent`] [`natural-language-inference`] [`python`] [`text-to-speech`] [`torch`] [`torchaudio`] [`tts`]  
...
- [certbot/certbot](https://github.com/certbot/certbot) ★32551 [`acme`] [`acme-client`] [`certbot`] [`certificate`] [`letsencrypt`] [`python`]  
...
- [dgtlmoon/changedetection.io](https://github.com/dgtlmoon/changedetection.io) ★28237 [`back-in-stock`] [`change-alert`] [`change-detection`] [`change-monitoring`] [`monitoring`] [`notifications`] [`restock-monitor`] [`rss`] [`self-hosted`] [`url-monitor`] [`web-scraping`] [`website-change-detection`] [`website-change-detector`] [`website-change-monitor`] [`website-change-notification`] [`website-change-tracker`] [`website-defacement-monitoring`] [`website-monitor`] [`website-monitoring`] [`website-watcher`]  
...
- [521xueweihan/GitHub520](https://github.com/521xueweihan/GitHub520) ★27167 [`dns`] [`github`] [`hosts`]  
...
- [littlecodersh/ItChat](https://github.com/littlecodersh/ItChat) ★26557 [`api`] [`itchat`] [`robot`] [`wechat`]  
...
- [Delgan/loguru](https://github.com/Delgan/loguru) ★22972 [`log`] [`logger`] [`logging`] [`python`]  
...
- [LiLittleCat/awesome-free-chatgpt](https://github.com/LiLittleCat/awesome-free-chatgpt) ★20522 [`awesome`] [`awesome-list`] [`chat`] [`chatgpt`] [`free`] [`freechatgpt`]  
  这是一个收集免费 ChatGPT 替代方案的资源库。涵盖各种类型的免费或开源聊天机器人，包括代码生成、文本摘要、翻译等功能。该资源库主要使用 Markdown 格式组织，方便用户快速筛选和了解不同工具的特点。
- [bee-san/Ciphey](https://github.com/bee-san/Ciphey) ★20099 [`artificial-intelligence`] [`cipher`] [`cpp`] [`cryptography`] [`ctf`] [`ctf-tools`] [`cyberchef-magic`] [`decryption`] [`deep-neural-network`] [`encodings`] [`encryptions`] [`hacking`] [`hacktoberfest`] [`hashes`] [`natural-language-processing`] [`pentesting`] [`python`]  
...
- [Zeyi-Lin/HivisionIDPhotos](https://github.com/Zeyi-Lin/HivisionIDPhotos) ★19953 [`cnn`] [`demo`] [`docker`] [`face-recognition`] [`fastapi`] [`gradio`] [`idphoto`] [`machine-learning`] [`matting`] [`mtcnn`] [`tools`] [`unet`]  
...
- [Guovin/iptv-api](https://github.com/Guovin/iptv-api) ★19518 [`amd64`] [`api`] [`arm64`] [`armv7`] [`auto`] [`diy`] [`docker`] [`epg`] [`ipdb`] [`iptv`] [`ipv4`] [`ipv6`] [`m3u`] [`m3u8`] [`rtmp`] [`tv`] [`tvbox`] [`workflow`]  
...
- [Jack-Cherish/python-spider](https://github.com/Jack-Cherish/python-spider) ★19239 [`python`] [`python-spider`] [`python3`] [`webspider`]  
...
- [pyscript/pyscript](https://github.com/pyscript/pyscript) ★18623 [`html`] [`javascript`] [`python`] [`wasm`]  
...
- [fastapi/sqlmodel](https://github.com/fastapi/sqlmodel) ★17015 [`fastapi`] [`json`] [`json-schema`] [`pydantic`] [`python`] [`sql`] [`sqlalchemy`]  
...
- [lss233/kirara-ai](https://github.com/lss233/kirara-ai) ★16896 [`bard`] [`bot`] [`chatglm-6b`] [`chatgpt`] [`deepseek`] [`discord`] [`ernie`] [`go-cqhttp`] [`grok`] [`mirai`] [`new-bing`] [`ollama`] [`openai`] [`poe`] [`qq`] [`qqbot`] [`sydney`] [`telegram`] [`wechat`] [`xinghuo`]  
...
- [xming521/WeClone](https://github.com/xming521/WeClone) ★15638 [`chat-history`] [`digital-avatar`] [`llm`] [`qwen`] [`telegram`]  
...
- [OpenEthan/SMSBoom](https://github.com/OpenEthan/SMSBoom) ★15344 [`deprecated`]  
...
- [Evil0ctal/Douyin_TikTok_Download_API](https://github.com/Evil0ctal/Douyin_TikTok_Download_API) ★14733 [`api`] [`async`] [`crawler`] [`douyin`] [`douyin-api`] [`douyin-scraper`] [`douyin-tiktok-api`] [`douyin-tiktok-download`] [`fastapi`] [`no-watermark`] [`online-parsing`] [`python`] [`pywebio`] [`scraper`] [`spider`] [`tiktok`] [`tiktok-api`] [`tiktok-scraper`] [`tiktok-signature`] [`web-scraping`]  
...
- [sivel/speedtest-cli](https://github.com/sivel/speedtest-cli) ★13961 [`python`] [`python-library`] [`python-script`] [`speedtest`]  
...
- [langbot-app/LangBot](https://github.com/langbot-app/LangBot) ★13846 [`agent`] [`ai`] [`coze`] [`deepseek`] [`dify`] [`dingtalk`] [`discord`] [`feishu`] [`langbot`] [`lark`] [`line`] [`llm`] [`n8n`] [`ollama`] [`openai`] [`plugins`] [`qq`] [`rag`] [`telegram`] [`wechat`]  
...
- [sml2h3/ddddocr](https://github.com/sml2h3/ddddocr) ★12918 [`captcha`] [`ddddocr`] [`ocr`]  
...
- [JoeanAmier/TikTokDownloader](https://github.com/JoeanAmier/TikTokDownloader) ★12107 [`abogus`] [`api`] [`csv`] [`docker`] [`douyin`] [`downloader`] [`ffmpeg`] [`httpx`] [`linux`] [`macos`] [`mstoken`] [`pyinstaller`] [`python`] [`rich`] [`server`] [`sqlite`] [`tiktok`] [`ttwid`] [`windows`] [`xlsx`]  
...
- [zai-org/CogVideo](https://github.com/zai-org/CogVideo) ★12063 [`cogvideox`] [`image-to-video`] [`llm`] [`sora`] [`text-to-video`] [`video-generation`]  
...
- [LonamiWebs/Telethon](https://github.com/LonamiWebs/Telethon) ★11453 [`hacktoberfest`] [`library`] [`mtproto`] [`python-library`] [`telegram`] [`telegram-api`] [`telethon`]  
...
- [injetlee/Python](https://github.com/injetlee/Python) ★10345 [`crawler`] [`excel`] [`python`] [`wechat`]  
...
- [guofei9987/blind_watermark](https://github.com/guofei9987/blind_watermark) ★10341 [`blind-watermark`] [`image-processing`] [`watermark`] [`watermark-image`]  
...
- [chengazhen/cursor-auto-free](https://github.com/chengazhen/cursor-auto-free) ★9615  
...
- [hoochanlon/hamulete](https://github.com/hoochanlon/hamulete) ★9253 [`chatgpt`] [`cnki`] [`it`] [`mirrors`] [`social`] [`university`]  
...
- [shidahuilang/shuyuan](https://github.com/shidahuilang/shuyuan) ★8723 [`aiyueshuxiang`] [`ipa`] [`iptv`] [`reader`] [`shuyuan`] [`trollstore`] [`tts`] [`xiangsegige`] [`yuanyuedu`] [`yuedu`]  
...
- [houtianze/bypy](https://github.com/houtianze/bypy) ★8397  
...
- [hunshcn/gh-proxy](https://github.com/hunshcn/gh-proxy) ★8371  
...
- [EstrellaXD/Auto_Bangumi](https://github.com/EstrellaXD/Auto_Bangumi) ★7748 [`anime`] [`auto-downloader`] [`docker`] [`python`] [`qbittorrent`] [`rss-parser`]  
...
- [bytedance/Dolphin](https://github.com/bytedance/Dolphin) ★7666 [`document-analysis`] [`layout-analysis`] [`ocr`] [`parser`] [`pdf`] [`pdf-converter`] [`pdf-parser`] [`python`] [`vlm-ocr`]  
...
- [vastsa/FileCodeBox](https://github.com/vastsa/FileCodeBox) ★7483 [`anonymous`] [`fastapi`] [`filecodebox`] [`python`] [`tool`] [`vue`]  
...
- [mli/autocut](https://github.com/mli/autocut) ★7432  
...
- [zhiyiYo/PyQt-Fluent-Widgets](https://github.com/zhiyiYo/PyQt-Fluent-Widgets) ★7291 [`custom`] [`fluent`] [`fluent-design`] [`fluentui`] [`gui`] [`modern`] [`pyqt5`] [`pyqt6`] [`pyside2`] [`pyside6`] [`python`] [`qt`] [`qt5`] [`qt6`] [`software`] [`ui`] [`widgets`] [`win11`] [`winui`] [`winui3`]  
...
- [autoscrape-labs/pydoll](https://github.com/autoscrape-labs/pydoll) ★5893 [`anti-detection`] [`automation`] [`browser-automation`] [`cdp`] [`chromium`] [`crawler`] [`e2e-tests`] [`fingerprinting`] [`headless`] [`playwright`] [`puppeteer`] [`recaptcha-v3`] [`scraping`] [`selenium`] [`testing`] [`testing-tools`] [`turnstile-solver`] [`web-scraping`] [`webdriver`]  
...
- [davidteather/TikTok-Api](https://github.com/davidteather/TikTok-Api) ★5843 [`api`] [`download-tiktoks`] [`hacktoberfest`] [`python`] [`tik`] [`tiktok`] [`tiktok-api`] [`tiktok-automation`] [`tiktok-compilations`] [`tiktok-downloader`] [`tiktok-python`] [`tiktok-scraper`] [`tiktok-signature`] [`tiktok-trending-page`] [`tiktokapi`] [`tok`] [`trending`]  
...
- [WECENG/ticket-purchase](https://github.com/WECENG/ticket-purchase) ★5381  
...
- [qd-today/qd](https://github.com/qd-today/qd) ★5203 [`checkin`] [`docker`] [`har`] [`qd`] [`qiandao`]  
...
- [googlefonts/noto-emoji](https://github.com/googlefonts/noto-emoji) ★4371  
...
- [shaxiu/XianyuAutoAgent](https://github.com/shaxiu/XianyuAutoAgent) ★4195 [`agent`] [`chatbot`] [`llm`]  
...
- [browser-use/workflow-use](https://github.com/browser-use/workflow-use) ★3740  
...
- [ScottSloan/Bili23-Downloader](https://github.com/ScottSloan/Bili23-Downloader) ★2851 [`bili23`] [`bilibili`] [`bilibili-downloader`] [`crawler`] [`linux`] [`macos`] [`python`] [`videodownloader`] [`windows`] [`wxpython`]  
...
- [Neutree/COMTool](https://github.com/Neutree/COMTool) ★2244 [`assistant`] [`debug`] [`network`] [`plugin`] [`protocol`] [`python`] [`serial`] [`tcp`] [`terminal`] [`tool`] [`udp`]  
...
- [Cp0204/quark-auto-save](https://github.com/Cp0204/quark-auto-save) ★2071  
...
- [MikeWang000000/Natter](https://github.com/MikeWang000000/Natter) ★2013  
...
- [y9nhjy/Proxifier-Keygen](https://github.com/y9nhjy/Proxifier-Keygen) ★1233  
...
- [Litre-WU/Sign](https://github.com/Litre-WU/Sign) ★228  
...
- [TapXWorld/ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook) ★54131  
...
- [pyenv/pyenv](https://github.com/pyenv/pyenv) ★43499 [`python`] [`shell`]  
...
- [discourse/discourse](https://github.com/discourse/discourse) ★45381 [`discourse`] [`ember`] [`forum`] [`javascript`] [`postgresql`] [`rails`] [`ruby`]  
...
- [greatghoul/remote-working](https://github.com/greatghoul/remote-working) ★11103 [`china`] [`freelancer`] [`remote-work`] [`remote-workers`] [`soho`] [`telecommunications`] [`work-from-home`]  
...
- [rustdesk/rustdesk](https://github.com/rustdesk/rustdesk) ★101504 [`android`] [`anydesk`] [`dart`] [`flatpak`] [`flutter`] [`flutter-apps`] [`ios`] [`linux`] [`macos`] [`p2p`] [`rdp`] [`remote-control`] [`remote-desktop`] [`rust`] [`rust-lang`] [`teamviewer`] [`vnc`] [`wayland`] [`windows`]  
...
- [zed-industries/zed](https://github.com/zed-industries/zed) ★68553 [`gpui`] [`rust-lang`] [`text-editor`] [`zed`]  
...
- [topjohnwu/Magisk](https://github.com/topjohnwu/Magisk) ★56601  
...
- [starship/starship](https://github.com/starship/starship) ★51877 [`bash`] [`fish`] [`fish-prompt`] [`fish-theme`] [`oh-my-zsh`] [`powershell`] [`rust`] [`shell-prompt`] [`starship`] [`zsh`] [`zsh-prompt`] [`zsh-theme`]  
...
- [dani-garcia/vaultwarden](https://github.com/dani-garcia/vaultwarden) ★50240 [`bitwarden`] [`bitwarden-rs`] [`docker`] [`rocket`] [`rust`] [`vaultwarden`]  
...
- [tw93/Pake](https://github.com/tw93/Pake) ★43147 [`chatgpt`] [`claude`] [`desktop`] [`gemini`] [`hight-performance`] [`linux`] [`macos`] [`no-electron`] [`package`] [`rust`] [`tauri`] [`windows`] [`youtube`]  
...
- [TabbyML/tabby](https://github.com/TabbyML/tabby) ★32316 [`ai`] [`codegen`] [`coding-assistant`] [`coding-language`] [`developer-experience`] [`developer-tools`] [`gen-ai`] [`ide`] [`llms`]  
...
- [fish-shell/fish-shell](https://github.com/fish-shell/fish-shell) ★31356 [`fish`] [`rust`] [`shell`] [`terminal`]  
...
- [lsd-rs/lsd](https://github.com/lsd-rs/lsd) ★14994 [`color`] [`hacktoberfest`] [`icons`] [`ls`] [`nerd-fonts`] [`rust`]  
...
- [rustdesk/rustdesk-server](https://github.com/rustdesk/rustdesk-server) ★8745 [`remote-access`] [`remote-control`] [`remote-desktop`] [`tauri`]  
...
- [EasyTier/EasyTier](https://github.com/EasyTier/EasyTier) ★7753 [`nat-traversal`] [`p2p`] [`rust`] [`tailscale`] [`vpn`] [`zerotier`]  
...
- [ohmyzsh/ohmyzsh](https://github.com/ohmyzsh/ohmyzsh) ★182321 [`cli`] [`cli-app`] [`oh-my-zsh`] [`oh-my-zsh-plugin`] [`oh-my-zsh-theme`] [`ohmyzsh`] [`plugin-framework`] [`plugins`] [`productivity`] [`shell`] [`terminal`] [`theme`] [`themes`] [`zsh`] [`zsh-configuration`]  
...
- [sickcodes/Docker-OSX](https://github.com/sickcodes/Docker-OSX) ★51639 [`container`] [`docker`] [`docker-osx`] [`kvm`] [`macos`] [`os`] [`osx`] [`osx-kvm`] [`x`] [`x11`]  
...
- [dockur/windows](https://github.com/dockur/windows) ★48011 [`docker`] [`docker-container`] [`virtualization`] [`windows`] [`windows-virtual-desktop`] [`windows-virtual-machine`] [`windows-virtual-machines`] [`windows-vm`]  
...
- [acmesh-official/acme.sh](https://github.com/acmesh-official/acme.sh) ★44347 [`acme`] [`acme-client`] [`acme-protocol`] [`ash`] [`bash`] [`buypass`] [`certbot`] [`letsencrypt`] [`posix`] [`posix-sh`] [`shell`] [`zerossl`]  
...
- [zsh-users/zsh-autosuggestions](https://github.com/zsh-users/zsh-autosuggestions) ★34070 [`autocomplete`] [`autosuggest`] [`fish`] [`shell`] [`zsh`] [`zsh-autosuggestions`]  
...
- [233boy/v2ray](https://github.com/233boy/v2ray) ★27216 [`shell-script`] [`v2ray`] [`vmess`]  
  这是一个基于Go语言开发的V2Ray代理服务器。它提供快速、稳定的代理连接，支持多种协议和配置。项目包含了核心代理服务以及客户端配置文件生成工具，用户可以方便地配置和管理V2Ray连接。代码结构清晰，易于维护和扩展。
- [hwdsl2/setup-ipsec-vpn](https://github.com/hwdsl2/setup-ipsec-vpn) ★26911 [`cisco-ipsec`] [`docker`] [`encryption`] [`ikev2`] [`ipsec`] [`l2tp`] [`libreswan`] [`linux`] [`network`] [`raspberry-pi`] [`security`] [`vpn`] [`vpn-client`] [`vpn-server`]  
...
- [yuaotian/go-cursor-help](https://github.com/yuaotian/go-cursor-help) ★24903 [`cursor`] [`error`]  
...
- [lxgw/LxgwWenKai](https://github.com/lxgw/LxgwWenKai) ★21956 [`cjk`] [`font`] [`typeface`]  
...
- [spaceship-prompt/spaceship-prompt](https://github.com/spaceship-prompt/spaceship-prompt) ★20230 [`oh-my-zsh`] [`prompt`] [`shell`] [`shell-prompt`] [`shell-theme`] [`spaceship`] [`terminal`] [`zsh`] [`zsh-theme`] [`zsh-users`]  
...
- [unixorn/awesome-zsh-plugins](https://github.com/unixorn/awesome-zsh-plugins) ★16965 [`awesome`] [`awesome-list`] [`collection`] [`hacktoberfest`] [`list`] [`oh-my-zsh`] [`zgenom`] [`zsh-completions`] [`zsh-configuration`] [`zsh-framework`] [`zsh-plugin`] [`zsh-prompt`] [`zsh-theme`]  
...
- [DaoCloud/public-image-mirror](https://github.com/DaoCloud/public-image-mirror) ★11966 [`mirror`] [`speedup`]  
...
- [oh-my-fish/oh-my-fish](https://github.com/oh-my-fish/oh-my-fish) ★11068 [`fish`] [`fishshell`] [`fishshell-framework`] [`hacktoberfest`] [`oh-my-fish`] [`oh-my-zsh`] [`omf`] [`prompt`] [`shell`] [`terminal`]  
...
- [YanG-1989/m3u](https://github.com/YanG-1989/m3u) ★10443  
...
- [angristan/wireguard-install](https://github.com/angristan/wireguard-install) ★10026 [`linux`] [`nat`] [`privacy`] [`vpn`] [`wireguard`]  
...
- [Gogh-Co/Gogh](https://github.com/Gogh-Co/Gogh) ★9926 [`bash`] [`color-scheme`] [`gnome-terminal`] [`iterm2`] [`linux`] [`mint`] [`pantheon-terminal`] [`shell`] [`terminal`]  
...
- [bin456789/reinstall](https://github.com/bin456789/reinstall) ★8379 [`alpine`] [`alpine-linux`] [`boot`] [`distro`] [`grub`] [`installer`] [`iso`] [`linux`] [`linux-distribution`] [`liveos`] [`netboot`] [`netinst`] [`netinstall`] [`operating-systems`] [`os`] [`reinstall`] [`shell-script`] [`vps`] [`windows`]  
...
- [teddysun/across](https://github.com/teddysun/across) ★5207 [`auto-transfer-backup`] [`backup`] [`bbr`] [`benchmark`] [`kms`] [`l2tp`] [`shell`] [`unixbench`]  
...
- [eooce/Sing-box](https://github.com/eooce/Sing-box) ★3577 [`argo`] [`hysteria2`] [`oneclick`] [`reality`] [`serv00`] [`sing-box`] [`tuic`] [`tunnel`] [`vmess-ws-tls`]  
...
- [gaoyifan/china-operator-ip](https://github.com/gaoyifan/china-operator-ip) ★3243 [`asn`] [`bgp`] [`china`] [`daily`] [`ip`] [`ipv6`] [`operator`]  
...
- [tom-snow/wechat-windows-versions](https://github.com/tom-snow/wechat-windows-versions) ★2609  
...
- [huan/docker-wechat](https://github.com/huan/docker-wechat) ★2324 [`docker`] [`wechat`]  
...
- [yhan219/navicat_reset_mac](https://github.com/yhan219/navicat_reset_mac) ★1765 [`navicat`] [`navicat-keygen`] [`navicat-reset`]  
...
- [userdocs/qbittorrent-nox-static](https://github.com/userdocs/qbittorrent-nox-static) ★1464 [`bash`] [`bash-script`] [`libtorrent`] [`qbittorrent-nox`] [`static`]  
...
- [brighill/registry-mirror](https://github.com/brighill/registry-mirror) ★137 [`docker-compose`] [`docker-mirror`] [`docker-registry`] [`registry-server`]  
...
- [imputnet/cobalt](https://github.com/imputnet/cobalt) ★37012 [`collaboration`] [`downloader`] [`instagram`] [`javascript`] [`music`] [`reddit`] [`social-media`] [`soundcloud`] [`svelte`] [`tiktok`] [`twitter`] [`typescript`] [`video`] [`vimeo`] [`vk`] [`webapp`] [`youtube`] [`youtube-downloader`]  
...
- [shadowsocks/ShadowsocksX-NG](https://github.com/shadowsocks/ShadowsocksX-NG) ★32843 [`kcptun`] [`macos`] [`shadowsocks`] [`shadowsocksx-ng`] [`swift`] [`v2ray-plugin`]  
...
- [Finb/Bark](https://github.com/Finb/Bark) ★6925 [`ios`] [`ios-app`] [`ios-swift`] [`mvvm`] [`mvvm-architecture`] [`push-notifications`] [`rxcocoa`] [`rxdatasources`] [`rxswift`]  
...
- [X1a0He/Adobe-Downloader](https://github.com/X1a0He/Adobe-Downloader) ★2424  
...
- [iptv-org/iptv](https://github.com/iptv-org/iptv) ★98074 [`iptv`] [`m3u`] [`playlist`] [`streams`] [`tv`]  
...
- [ant-design/ant-design](https://github.com/ant-design/ant-design) ★96468 [`ant-design`] [`antd`] [`design-systems`] [`react`] [`typescript`] [`ui-kit`] [`ui-library`]  
...
- [ChatGPTNextWeb/NextChat](https://github.com/ChatGPTNextWeb/NextChat) ★86238 [`calclaude`] [`chatgpt`] [`claude`] [`cross-platform`] [`desktop`] [`fe`] [`gemini`] [`gemini-pro`] [`gemini-server`] [`gemini-ultra`] [`gpt-4o`] [`groq`] [`nextjs`] [`ollama`] [`react`] [`tauri`] [`tauri-app`] [`vercel`] [`webui`]  
...
- [mermaid-js/mermaid](https://github.com/mermaid-js/mermaid) ★83756 [`diagrams`] [`diagrams-as-code`] [`documentation`] [`flowchart`] [`javascript`] [`mindmap`] [`typescript`] [`uml-diagrams`]  
...
- [immich-app/immich](https://github.com/immich-app/immich) ★82568 [`backup-tool`] [`flutter`] [`google-photos`] [`google-photos-alternative`] [`javascript`] [`mobile-app`] [`nestjs`] [`nodejs`] [`photo-gallery`] [`photos`] [`photos-management`] [`self-hosted`] [`svelte`] [`sveltekit`] [`typescript`] [`videos`]  
...
- [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) ★80572 [`gemini`] [`gemini-api`]  
...
- [clash-verge-rev/clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev) ★79542 [`clash`] [`clash-meta`] [`clash-verge`] [`linux`] [`mac`] [`mihomo`] [`tauri-app`] [`windows`]  
...
- [hoppscotch/hoppscotch](https://github.com/hoppscotch/hoppscotch) ★76389 [`api`] [`api-client`] [`api-rest`] [`api-testing`] [`developer-tools`] [`graphql`] [`http`] [`http-client`] [`pwa`] [`rest`] [`rest-api`] [`spa`] [`testing`] [`testing-tools`] [`tools`] [`vue`] [`vuejs`] [`websocket`]  
...
- [lobehub/lobe-chat](https://github.com/lobehub/lobe-chat) ★67209 [`agent`] [`ai`] [`artifacts`] [`chat`] [`chatgpt`] [`claude`] [`deepseek`] [`deepseek-r1`] [`function-calling`] [`gemini`] [`gpt`] [`knowledge-base`] [`mcp`] [`nextjs`] [`ollama`] [`openai`] [`rag`]  
...
- [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) ★65070 [`ai`] [`ai-agents`] [`ai-crawler`] [`ai-scraping`] [`ai-search`] [`crawler`] [`data-extraction`] [`html-to-markdown`] [`llm`] [`markdown`] [`scraper`] [`scraping`] [`web-crawler`] [`web-data`] [`web-data-extraction`] [`web-scraper`] [`web-scraping`] [`web-search`] [`webscraping`]  
...
- [nocodb/nocodb](https://github.com/nocodb/nocodb) ★58437 [`airtable`] [`airtable-alternative`] [`automatic-api`] [`hacktoberfest`] [`low-code`] [`no-code`] [`no-code-database`] [`no-code-platform`] [`postgresql`] [`rest-api`] [`restful-api`] [`spreadsheet`] [`sqlite`] [`swagger`]  
...
- [lyswhut/lx-music-desktop](https://github.com/lyswhut/lx-music-desktop) ★46834 [`electron`] [`javascript`] [`music-player`] [`vue`]  
...
- [slab/quill](https://github.com/slab/quill) ★46357 [`editor`] [`quill`] [`rich-text-editor`] [`wysiwyg`]  
...
- [RocketChat/Rocket.Chat](https://github.com/RocketChat/Rocket.Chat) ★43726 [`chat`] [`collaboration`] [`foss`] [`free`] [`hacktoberfest`] [`javascript`] [`meteor`] [`mit`] [`real-time`] [`slack`] [`webrtc`]  
...
- [DIYgod/RSSHub](https://github.com/DIYgod/RSSHub) ★39518 [`bilibili`] [`douban`] [`dribbble`] [`instagram`] [`lofter`] [`pixiv`] [`rss`] [`rsshub`] [`spotify`] [`telegram`] [`tiktok`] [`twitter`] [`v2ex`] [`wechat`] [`weibo`] [`ximalaya`] [`youtube`] [`zhihu`]  
...
- [RSSNext/Folo](https://github.com/RSSNext/Folo) ★35416 [`ai`] [`blockchain`] [`reader`] [`rss`] [`rss-reader`]  
...
- [umami-software/umami](https://github.com/umami-software/umami) ★31315 [`analytics`] [`charts`] [`google-analytics`] [`statistics`] [`web-analytics`]  
...
- [blakeblackshear/frigate](https://github.com/blakeblackshear/frigate) ★26619 [`ai`] [`camera`] [`google-coral`] [`home-assistant`] [`home-automation`] [`homeautomation`] [`mqtt`] [`nvr`] [`object-detection`] [`realtime`] [`rtsp`] [`tensorflow`]  
...
- [Molunerfinn/PicGo](https://github.com/Molunerfinn/PicGo) ★25792 [`aliyun-oss`] [`electron`] [`electron-app`] [`electron-vue`] [`github`] [`imgur`] [`imgur-uploader`] [`qiniu`] [`smms`] [`tencent-cos`] [`upyun`] [`vue`] [`weibo`]  
...
- [fingerprintjs/fingerprintjs](https://github.com/fingerprintjs/fingerprintjs) ★25745 [`audio-fingerprinting`] [`browser`] [`browser-fingerprint`] [`browser-fingerprinting`] [`detection`] [`fingerprint`] [`fingerprinting`] [`fingerprintjs`] [`fraud`] [`fraud-detection`] [`identification`] [`javascript`] [`visitor-identifier`]  
...
- [GoogleChromeLabs/squoosh](https://github.com/GoogleChromeLabs/squoosh) ★23949  
...
- [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ★23113  
...
- [maotoumao/MusicFree](https://github.com/maotoumao/MusicFree) ★21076 [`free`] [`music-player`] [`musicfree`] [`plugin`] [`react`] [`react-native`] [`typescript`]  
...
- [musistudio/claude-code-router](https://github.com/musistudio/claude-code-router) ★20285  
...
- [louislam/dockge](https://github.com/louislam/dockge) ★20030 [`docker`] [`docker-compose`] [`docker-deployment`] [`docker-stack`] [`docker-stack-deploy`] [`docker-ui`] [`responsive`] [`self-hosted`] [`selfhosted`] [`single-page-app`] [`socket-io`] [`webapp`] [`websocket`]  
...
- [whyour/qinglong](https://github.com/whyour/qinglong) ★18586 [`crontab`] [`docker`] [`javascript`] [`python`] [`shell`] [`task-manager`] [`typescript`]  
...
- [winfunc/opcode](https://github.com/winfunc/opcode) ★18427 [`anthropic`] [`anthropic-claude`] [`claude`] [`claude-4`] [`claude-4-opus`] [`claude-4-sonnet`] [`claude-ai`] [`claude-code`] [`claude-code-sdk`] [`cursor`] [`ide`] [`llm`] [`llm-code`] [`rust`] [`tauri`]  
...
- [wangeditor-team/wangEditor](https://github.com/wangeditor-team/wangEditor) ★18161 [`rich-text`] [`rich-text-html-editor`] [`typescript`] [`wangeditor`] [`wysiwyg`] [`wysiwyg-editor`]  
...
- [ag-grid/ag-grid](https://github.com/ag-grid/ag-grid) ★14638 [`angular`] [`angular-grid`] [`angular-table`] [`charting`] [`datagrid`] [`datatable`] [`excel`] [`filtering`] [`grid`] [`grouping`] [`javascript-table`] [`pagination`] [`pivoting`] [`react`] [`react-grid`] [`react-table`] [`sorting`] [`table`] [`vue-table`] [`vuejs`]  
...
- [vercel/vercel](https://github.com/vercel/vercel) ★14243 [`cli`] [`cloud`] [`command`] [`hosting`] [`jamstack`] [`ship`] [`vercel`]  
...
- [ourongxing/newsnow](https://github.com/ourongxing/newsnow) ★13461 [`elegant`] [`news`]  
...
- [ikatyang/emoji-cheat-sheet](https://github.com/ikatyang/emoji-cheat-sheet) ★13435 [`cheat-sheet`] [`emoji`] [`github`] [`markdown`]  
...
- [taye/interact.js](https://github.com/taye/interact.js) ★12821 [`drag-and-drop`] [`drop`] [`inertia`] [`javascript`] [`javascript-drag`] [`mobile`] [`modern-browsers`] [`multi-touch`] [`snap`] [`touch`] [`typescript`] [`vanilla`]  
...
- [plait-board/drawnix](https://github.com/plait-board/drawnix) ★12149 [`collaboration`] [`drawing`] [`flowchart`] [`localfirst`] [`mindmap`] [`productivity`] [`whiteboard`]  
...
- [ayangweb/BongoCat](https://github.com/ayangweb/BongoCat) ★11974 [`bongo-cat`] [`bongocat`] [`cross-platform`] [`desktop-app`] [`desktop-pet`] [`linux`] [`macos`] [`pet`] [`pet-project`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [dream-num/univer](https://github.com/dream-num/univer) ★11382 [`ai-excel`] [`ai-sheet`] [`ai-spreadsheet`] [`appscript`] [`collaboration`] [`data-table`] [`doc`] [`excel`] [`excel-mcp`] [`grid`] [`live-share`] [`ppt`] [`sdk`] [`sheet`] [`sheet-mcp`] [`spreadsheet`] [`spreadsheet-mcp`] [`univer-mcp`] [`word`] [`xlsx`]  
...
- [jackyzha0/quartz](https://github.com/jackyzha0/quartz) ★10380 [`digital-garden`] [`networked-thought`] [`obsidian`] [`obsidian-md`] [`quartz-ssg`] [`static-site-generator`]  
...
- [AIsouler/GKD_subscription](https://github.com/AIsouler/GKD_subscription) ★8465 [`gkd`] [`gkd-subscription`] [`typescript`]  
...
- [x-extends/vxe-table](https://github.com/x-extends/vxe-table) ★8382 [`cell`] [`checkbox`] [`editable`] [`form`] [`grid`] [`input`] [`modal`] [`pager`] [`radio`] [`select`] [`switch`] [`table`] [`toolbar`] [`vue`] [`vue-table`] [`vxe-grid`] [`vxe-table`] [`vxe-ui`]  
...
- [curlconverter/curlconverter](https://github.com/curlconverter/curlconverter) ★7987 [`curl`] [`tree-sitter`]  
...
- [sb2nov/mac-setup](https://github.com/sb2nov/mac-setup) ★7319 [`fresh-installs`] [`gitbook`] [`guide`] [`guidebook`] [`hacktoberfest`] [`install`] [`installation`] [`mac`] [`mac-osx`] [`macos`] [`setup`]  
...
- [purocean/yn](https://github.com/purocean/yn) ★6397 [`chatgpt`] [`deepseek`] [`drawio`] [`editor`] [`electron`] [`gemini`] [`koa2`] [`markdown`] [`markdown-editor`] [`markdown-it`] [`mermaid`] [`monaco-editor`] [`notebook`] [`openai`] [`plantuml`] [`reveal-js`] [`revealjs`] [`vscode`] [`vue`]  
...
- [EcoPasteHub/EcoPaste](https://github.com/EcoPasteHub/EcoPaste) ★6310 [`application`] [`clipboard`] [`clipboard-manager`] [`cross-platform`] [`desktop-app`] [`desktop-application`] [`linux`] [`macos`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [antvis/X6](https://github.com/antvis/X6) ★6254 [`antv`] [`dag`] [`diagram`] [`diagramming`] [`erd`] [`erdiagram`] [`flowchart`] [`graph`] [`graph-editor`] [`javascript`] [`javascript-diagramming-library`] [`svg`] [`typescript`] [`uml-diagram`]  
...
- [Termix-SSH/Termix](https://github.com/Termix-SSH/Termix) ★5966 [`docker`] [`file-management`] [`self-hosted`] [`ssh`] [`ssh-tunnel`] [`termix`]  
...
- [HuolalaTech/page-spy-web](https://github.com/HuolalaTech/page-spy-web) ★5479  
...
- [algolia/autocomplete](https://github.com/algolia/autocomplete) ★5176 [`accessible`] [`alfred`] [`algolia`] [`autocomplete`] [`combobox`] [`dropdown`] [`modal`] [`query`] [`search`] [`select`] [`spotlight`] [`suggestion`] [`typeahead`]  
...
- [galaxy-s10/billd-desk](https://github.com/galaxy-s10/billd-desk) ★4529 [`coturn`] [`electron`] [`flutter`] [`nodejs`] [`parsec`] [`remote-desktop`] [`rustdesk`] [`socket-io`] [`todesk`] [`typescript`] [`vue3`] [`webrtc`]  
...
- [meowtec/Imagine](https://github.com/meowtec/Imagine) ★4215 [`cross-platform`] [`desktop`] [`image-compression`] [`jpeg`] [`jpegmini`] [`linux-app`] [`macos`] [`pngquant`] [`save-for-web`] [`tinypng`] [`webp`]  
...
- [nwtgck/piping-server](https://github.com/nwtgck/piping-server) ★3108 [`data-transfer`] [`http`] [`nat-traversal`] [`stream`] [`transfer`] [`web`]  
...
- [pages-cms/pages-cms](https://github.com/pages-cms/pages-cms) ★3050 [`11ty`] [`astro`] [`cms`] [`docusaurus`] [`eleventy`] [`gatsby`] [`hugo`] [`jekyll`] [`nextjs`] [`ssg`] [`static-site`] [`static-site-generator`] [`vitepress`] [`vue`] [`vuejs`] [`vuejs3`] [`vuepress`]  
...
- [xjh22222228/nav](https://github.com/xjh22222228/nav) ★3030 [`ai-awesome`] [`angular`] [`nav`] [`navigation`] [`netlify`] [`nextjs`] [`ng-zorro-antd`] [`vercel`]  
...
- [LLOneBot/LLOneBot](https://github.com/LLOneBot/LLOneBot) ★2829 [`llob`] [`llonebot`] [`onebot`] [`onebot11`] [`qq`] [`qqbot`] [`satori`]  
...
- [pure-admin/pure-admin-thin](https://github.com/pure-admin/pure-admin-thin) ★2690 [`pure-admin-thin`] [`vue-pure-admin`]  
...
- [easychen/CookieCloud](https://github.com/easychen/CookieCloud) ★2662  
...
- [brookshi/Hitchhiker](https://github.com/brookshi/Hitchhiker) ★2209 [`api`] [`collaboration`] [`hitchhiker`] [`nodejs`] [`restful-api`] [`schedule`] [`stress-test`] [`test`] [`test-automation`] [`testing-tools`] [`typescript`]  
...
- [NetrisTV/ws-scrcpy](https://github.com/NetrisTV/ws-scrcpy) ★2150 [`android`] [`browser`] [`control`] [`javascript`] [`mirroring`] [`mobile`] [`phone`] [`remote`] [`remote-control`] [`scrcpy`] [`screen`] [`typescript`] [`websocket`]  
...
- [oleeskild/obsidian-digital-garden](https://github.com/oleeskild/obsidian-digital-garden) ★1928  
...
- [Adpro-Team/GKD_subscription](https://github.com/Adpro-Team/GKD_subscription) ★1682 [`gkd`] [`gkd-subscription`] [`nodejs`] [`subscription`] [`typescript`]  
...
- [pt-plugins/PT-depiler](https://github.com/pt-plugins/PT-depiler) ★1638 [`private-tracker`]  
...
- [ipid/unlock-music](https://github.com/ipid/unlock-music) ★1452  
...
- [yuudi/rclone-webui-angular](https://github.com/yuudi/rclone-webui-angular) ★345 [`rclone`] [`rclone-gui`]  
...
- [x-extends/vxe-pc-ui](https://github.com/x-extends/vxe-pc-ui) ★179 [`vxe-form-design`] [`vxe-print`] [`vxe-table`] [`vxe-ui`]  
...
- [abbodi1406/vcredist](https://github.com/abbodi1406/vcredist) ★7075  
...
- [VBA-tools/VBA-JSON](https://github.com/VBA-tools/VBA-JSON) ★2043  
...
- [vbenjs/vue-vben-admin](https://github.com/vbenjs/vue-vben-admin) ★30375 [`admin-template`] [`ant-design`] [`element-plus`] [`monorepo`] [`naive-ui`] [`shadcn-ui`] [`tsx`] [`typescript`] [`vben`] [`vite`] [`vite-template`] [`vue-router`] [`vue3`] [`vuex`]  
...
- [requarks/wiki](https://github.com/requarks/wiki) ★27203 [`cross-platform`] [`documentation`] [`git`] [`markdown`] [`nodejs`] [`open-source`] [`wiki`]  
...
- [Lissy93/dashy](https://github.com/Lissy93/dashy) ★22887 [`awesome`] [`dashboard`] [`docker`] [`hacktoberfest`] [`homelab`] [`homepage`] [`mit`] [`nodejs`] [`organization`] [`productivity`] [`pwa`] [`self-hosted`] [`startpage`] [`vue`]  
...
- [pure-admin/vue-pure-admin](https://github.com/pure-admin/vue-pure-admin) ★19085 [`admin`] [`element-plus`] [`esm`] [`pinia`] [`tailwindcss`] [`typescript`] [`vite`] [`vue3`]  
...
- [zyronon/douyin](https://github.com/zyronon/douyin) ★11161 [`douyin`] [`js`] [`tiktok`] [`vue`] [`vue3`]  
...
- [doocs/md](https://github.com/doocs/md) ★10875 [`ai-bot`] [`doocs`] [`editor`] [`llm`] [`markdown`] [`markdown-editor`] [`tailwindcss`] [`vite`] [`vue`] [`vue3`] [`wechat`] [`weixin`]  
...
- [jason5ng32/MyIP](https://github.com/jason5ng32/MyIP) ★9192 [`awesome`] [`censorship`] [`chatgpt`] [`dns`] [`ip`] [`ipinfo`] [`leaks`] [`myip`] [`network`] [`pingchecker`] [`proxy`] [`security`] [`security-tools`] [`speedtest`] [`vercel`] [`webrtc`] [`whatismyip`] [`whatismyipaddress`] [`whois`] [`whois-lookup`]  
...
- [luckjiawei/frpc-desktop](https://github.com/luckjiawei/frpc-desktop) ★6193 [`desktop`] [`electron`] [`frp`] [`frp-desktop`] [`frp-linux`] [`frp-macos`] [`frp-window`] [`frpc`] [`javascript`] [`tailwindcss`] [`typescript`] [`vite`] [`vue`]  
...
- [xugaoyi/vuepress-theme-vdoing](https://github.com/xugaoyi/vuepress-theme-vdoing) ★4852 [`actions`] [`blog`] [`blog-theme`] [`deploy`] [`javascript`] [`markdown`] [`theme`] [`vue`] [`vuepress`] [`vuepress-blog`] [`vuepress-plugin`] [`vuepress-theme`]  
  VuePress主题，提供简洁、美观且功能丰富的页面布局。支持多主题配置，包括博客、文档、知识库等。基于VuePress构建，使用Vue.js和JavaScript开发，包含自定义组件、插件和主题配置，可快速创建具有个性化风格的网站。
- [wechat-article/wechat-article-exporter](https://github.com/wechat-article/wechat-article-exporter) ★4635 [`download`] [`wechat`] [`wechat-article`] [`wechat-download`]  
...
- [hslr-s/sun-panel](https://github.com/hslr-s/sun-panel) ★4553 [`docker`] [`gin`] [`golang`] [`homelab`] [`homepage`] [`nas`] [`navigationpage`] [`raspberry-pi`] [`self-hosted`] [`startpage`] [`synology`] [`vue3`]  
...
- [palxiao/poster-design](https://github.com/palxiao/poster-design) ★4529 [`canvas`] [`design`] [`image`] [`moveable`] [`nodejs`] [`poster`] [`puppeteer`] [`vue3`]  
...
- [HuLaSpark/HuLa](https://github.com/HuLaSpark/HuLa) ★4284 [`chatbot`] [`cross-platform`] [`cross-platform-app`] [`macos`] [`mobile`] [`rust`] [`tauri`] [`tsx`] [`vue3`] [`webview`] [`windows`] [`windows-10`] [`windows-11`]  
...
- [MoeKoeMusic/MoeKoeMusic](https://github.com/MoeKoeMusic/MoeKoeMusic) ★3960 [`javascript`] [`kugou`] [`linux`] [`macos`] [`music`] [`vue3`] [`windows`]  
...
- [gzydong/LumenIM](https://github.com/gzydong/LumenIM) ★1512 [`golang`] [`im`] [`vue3`] [`websocket`]  
...
- [LOG1997/log-lottery](https://github.com/LOG1997/log-lottery) ★538 [`3d`] [`daisyui`] [`lottery`] [`lucky`] [`lucky-draw`] [`prizes`] [`raffle`] [`threejs`] [`vue3`] [`vue3-typescript`]  
