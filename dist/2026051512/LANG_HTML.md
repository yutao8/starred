...
- [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) ★122323 [`awesome-list`] [`free-for-developers`]  
...
- [vernesong/OpenClash](https://github.com/vernesong/OpenClash) ★25791 [`clash`] [`luci`] [`mihomo`] [`openclash`] [`openwrt`] [`shadowsocks`] [`snell`] [`v2ray`] [`vmess`]  
...
- [CaiJimmy/hugo-theme-stack](https://github.com/CaiJimmy/hugo-theme-stack) ★6376 [`bloggers`] [`hugo`] [`hugo-theme`] [`theme`]  
