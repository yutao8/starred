...
- [gojue/ecapture](https://github.com/gojue/ecapture) ★15278 [`android`] [`android-https-capture`] [`ebpf`] [`ebpf-go`] [`ebpf-tc`] [`ebpf-uprobe`] [`golang`] [`https`] [`linux`] [`network-capture`] [`security-audit`] [`ssl`] [`ssldump`] [`tcpdump`] [`tls`]  
...
- [wireshark/wireshark](https://github.com/wireshark/wireshark) ★9498 [`packet-capture`] [`stratoshark`] [`tshark`] [`wireshark`]  
...
- [TelegramMessenger/MTProxy](https://github.com/TelegramMessenger/MTProxy) ★6856  
...
- [RsyncProject/rsync](https://github.com/RsyncProject/rsync) ★4917  
