...
- [open-ani/animeko](https://github.com/open-ani/animeko) ★14556 [`android`] [`ani`] [`anime`] [`bangumi`] [`bittorrent`] [`bt`] [`compose`] [`compose-multiplatform`] [`danmaku`] [`ios`] [`jetpack-compose`] [`kotlin`] [`kotlin-multiplatform`] [`linux`] [`macos`] [`player`] [`torrent`] [`video`] [`windows`]  
...
- [zhanghai/MaterialFiles](https://github.com/zhanghai/MaterialFiles) ★7874 [`android`] [`android-application`] [`file-manager`] [`kotlin`] [`kotlin-android`] [`material-design`]  
...
- [NeoApplications/Neo-Backup](https://github.com/NeoApplications/Neo-Backup) ★3390 [`android`] [`backup-tool`] [`hacktoberfest`] [`kotlin`] [`root`]  
