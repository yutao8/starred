...
- [fatedier/frp](https://github.com/fatedier/frp) ★106531 [`expose`] [`firewall`] [`frp`] [`go`] [`http-proxy`] [`nat`] [`p2p`] [`proxy`] [`reverse-proxy`] [`tunnel`]  
...
- [syncthing/syncthing](https://github.com/syncthing/syncthing) ★84004 [`go`] [`p2p`] [`peer-to-peer`] [`synchronization`]  
...
- [junegunn/fzf](https://github.com/junegunn/fzf) ★80244 [`bash`] [`cli`] [`fish`] [`fzf`] [`go`] [`neovim`] [`tmux`] [`unix`] [`vim`] [`zsh`]  
...
- [usememos/memos](https://github.com/usememos/memos) ★59589 [`docker`] [`foss`] [`go`] [`markdown`] [`memo`] [`microblog`] [`note-taking`] [`notecard`] [`own-your-data`] [`react`] [`self-hosted`] [`social-network`] [`sqlite`]  
...
- [FiloSottile/mkcert](https://github.com/FiloSottile/mkcert) ★58909 [`certificates`] [`chrome`] [`firefox`] [`https`] [`ios`] [`linux`] [`local-development`] [`localhost`] [`macos`] [`root-ca`] [`tls`] [`windows`]  
...
- [go-gitea/gitea](https://github.com/go-gitea/gitea) ★55674 [`bitbucket`] [`cicd`] [`devops`] [`docker-registry-v2`] [`git`] [`git-gui`] [`git-lfs`] [`git-server`] [`gitea`] [`github`] [`github-actions`] [`gitlab`] [`go`] [`golang`] [`hacktoberfest`] [`maven-server`] [`npm-registry`] [`self-hosted`] [`typescript`] [`vue`]  
...
- [AlistGo/alist](https://github.com/AlistGo/alist) ★49468 [`file-server`] [`gin`] [`golang`] [`onedrive`] [`solidjs`] [`webdav`]  
...
- [coreybutler/nvm-windows](https://github.com/coreybutler/nvm-windows) ★46356 [`go`] [`management`] [`node`] [`node-version-manager`] [`nodejs`] [`nvm`] [`switch`] [`version`] [`version-manager`] [`versioning`] [`windows`]  
...
- [juanfont/headscale](https://github.com/juanfont/headscale) ★38359 [`tailscale`] [`tailscale-control-server`] [`tailscale-server`] [`wireguard`]  
...
- [schollz/croc](https://github.com/schollz/croc) ★34996 [`data-transfer`] [`file-sharing`] [`golang`] [`pake`] [`peer-to-peer`] [`tcp`] [`transfer`]  
...
- [filebrowser/filebrowser](https://github.com/filebrowser/filebrowser) ★34702 [`file-browser`] [`file-manager`] [`file-sharing`] [`go`] [`material-design`] [`self-hosted`] [`vue`]  
...
- [QuantumNous/new-api](https://github.com/QuantumNous/new-api) ★33321 [`ai-gateway`] [`claude`] [`deepseek`] [`gemini`] [`newapi`] [`openai`] [`rerank`]  
...
- [tailscale/tailscale](https://github.com/tailscale/tailscale) ★31555 [`2fa`] [`oauth`] [`sso`] [`tailscale`] [`vpn`] [`wireguard`]  
...
- [iawia002/lux](https://github.com/iawia002/lux) ★31346 [`bilibili`] [`crawler`] [`download`] [`downloader`] [`go`] [`golang`] [`iqiyi`] [`qq`] [`scraper`] [`tumblr`] [`video`] [`youku`] [`youtube`]  
...
- [binwiederhier/ntfy](https://github.com/binwiederhier/ntfy) ★30183 [`curl`] [`notifications`] [`ntfy`] [`ntfysh`] [`pubsub`] [`push-notifications`] [`rest-api`]  
...
- [cloudreve/cloudreve](https://github.com/cloudreve/cloudreve) ★27541 [`cloud`] [`cloud-storage`] [`cloudreve`] [`file`] [`file-manager`] [`file-sharing`] [`golang`]  
...
- [Wox-launcher/Wox](https://github.com/Wox-launcher/Wox) ★26774 [`alfred`] [`launcher`] [`launchy`] [`linux`] [`macos`] [`raycast`] [`spotlight`] [`windows`] [`wox`]  
...
- [XIU2/CloudflareSpeedTest](https://github.com/XIU2/CloudflareSpeedTest) ★26610 [`cdn`] [`cloudflare`] [`go`] [`golang`] [`speedtest`]  
...
- [containrrr/watchtower](https://github.com/containrrr/watchtower) ★24609 [`automation`] [`continuous-delivery`] [`devops`] [`docker`] [`hacktoberfest`] [`notifications`] [`receive-notifications`] [`registry`] [`update-checker`] [`watchtower`]  
...
- [GopeedLab/gopeed](https://github.com/GopeedLab/gopeed) ★24450 [`android`] [`bittorrent`] [`cross-platform`] [`debian`] [`downloader`] [`flutter`] [`golang`] [`http`] [`https`] [`ios`] [`macos`] [`magnet`] [`torrent`] [`ubuntu`] [`windows`]  
...
- [OpenListTeam/OpenList](https://github.com/OpenListTeam/OpenList) ★22489 [`alist`] [`aliyunpan`] [`baidupan`] [`openlist`]  
...
- [navidrome/navidrome](https://github.com/navidrome/navidrome) ★21059 [`airsonic`] [`madsonic`] [`media-server`] [`music`] [`music-server`] [`navidrome`] [`opensubsonic`] [`raspberry-pi`] [`self-hosted`] [`streamer`] [`streaming-api`] [`streaming-audio`] [`subsonic`] [`subsonic-server`]  
...
- [m1k1o/neko](https://github.com/m1k1o/neko) ★20932 [`docker`] [`golang`] [`media-streaming`] [`remote-control`] [`remote-desktop`] [`self-hosted`] [`virtual-browser`] [`vue`] [`webrtc`]  
...
- [apernet/hysteria](https://github.com/apernet/hysteria) ★20743 [`censorship-circumvention`] [`golang`] [`http-proxy`] [`hysteria`] [`proxy`] [`quic`] [`relay`] [`reliable-udp`] [`socks5`] [`tun`] [`vpn`]  
...
- [putyy/res-downloader](https://github.com/putyy/res-downloader) ★17471 [`douyin`] [`kuaishou`] [`res-downloader`] [`wechat`] [`wechat-video`] [`xiaohongshu`]  
...
- [slackhq/nebula](https://github.com/slackhq/nebula) ★17331  
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) ★14189 [`cloudflare`] [`cloudflare-tunnel`] [`reverse-proxy`] [`zero-trust-network-access`]  
...
- [shadow1ng/fscan](https://github.com/shadow1ng/fscan) ★13780 [`fscan`] [`scanner`] [`scanning`] [`sec`] [`security`] [`security-tools`]  
...
- [gokcehan/lf](https://github.com/gokcehan/lf) ★9270 [`file-manager`] [`terminal`]  
...
- [prometheus-community/windows_exporter](https://github.com/prometheus-community/windows_exporter) ★3542 [`prometheus`] [`prometheus-exporter`] [`windows`] [`wmi`]  
