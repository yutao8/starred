...
- [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) ★122300 [`awesome-list`] [`free-for-developers`]  
...
- [vernesong/OpenClash](https://github.com/vernesong/OpenClash) ★25783 [`clash`] [`luci`] [`mihomo`] [`openclash`] [`openwrt`] [`shadowsocks`] [`snell`] [`v2ray`] [`vmess`]  
...
- [vbskycn/iptv](https://github.com/vbskycn/iptv) ★6160  
...
- [TIM168/technical_books](https://github.com/TIM168/technical_books) ★3478 [`books`] [`go`] [`html`] [`http`] [`it`] [`java`] [`linux`] [`php`] [`python`] [`technical`] [`technical-books`]  
...
- [pdmaker/watermark-master](https://github.com/pdmaker/watermark-master) ★363 [`watermark`] [`watermark-adder`]  
