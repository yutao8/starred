...
- [ventoy/Ventoy](https://github.com/ventoy/Ventoy) ★76237 [`arm64`] [`auto-install`] [`bootable-usb`] [`bsd`] [`chromeos`] [`iso-files`] [`legacy`] [`linux`] [`multiboot`] [`persistence`] [`secure-boot`] [`uefi`] [`unattended`] [`unix`] [`usb`] [`windows`] [`x86`] [`x86-64`]  
...
- [mpv-player/mpv](https://github.com/mpv-player/mpv) ★35010 [`audio`] [`c`] [`ffmpeg`] [`mplayer`] [`mpv`] [`multimedia`] [`video`]  
...
- [jqlang/jq](https://github.com/jqlang/jq) ★34581 [`jq`]  
...
- [valinet/ExplorerPatcher](https://github.com/valinet/ExplorerPatcher) ★32335  
...
- [kingToolbox/WindTerm](https://github.com/kingToolbox/WindTerm) ★30727 [`bash`] [`client`] [`cmd`] [`linux`] [`mac`] [`powershell`] [`serial`] [`sftp`] [`shell`] [`ssh`] [`telnet`] [`terminal`] [`tmux`] [`windows`] [`wsl`] [`x11`] [`xmodem`] [`xterm`] [`ymodem`] [`zmodem`]  
...
- [coturn/coturn](https://github.com/coturn/coturn) ★13923 [`networking`] [`server`] [`turn`]  
...
- [wireshark/wireshark](https://github.com/wireshark/wireshark) ★9269 [`packet-capture`] [`stratoshark`] [`tshark`] [`wireshark`]  
...
- [winfsp/winfsp](https://github.com/winfsp/winfsp) ★8530 [`driver`] [`filesystem`] [`fuse`] [`gplv3`] [`kernel`] [`windows`] [`windows-kernel`]  
...
- [TelegramMessenger/MTProxy](https://github.com/TelegramMessenger/MTProxy) ★6737  
...
- [RsyncProject/rsync](https://github.com/RsyncProject/rsync) ★4416  
