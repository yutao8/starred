...
- [XIU2/TrackersListCollection](https://github.com/XIU2/TrackersListCollection) ★29528 [`aria2`] [`aria2-format-tracker`] [`bittorrent`] [`bittorrent-trackers`] [`qbittorrent`] [`torrent`] [`torrent-tracker`] [`tracker`] [`trackers`] [`trackerslist`] [`utorrent`]  
...
- [qianguyihao/Web](https://github.com/qianguyihao/Web) ★28032 [`css`] [`front-end`] [`html`] [`javascript`]  
...
- [leiurayer/downkyi](https://github.com/leiurayer/downkyi) ★23710  
...
- [zijie0/HumanSystemOptimization](https://github.com/zijie0/HumanSystemOptimization) ★20645  
...
- [AZeC4/TelegramGroup](https://github.com/AZeC4/TelegramGroup) ★18895 [`telegram`] [`telegram-api`] [`telegram-bot`] [`telegram-bot-api`] [`telegram-bots`] [`telegram-channel`] [`telegramgroups`]  
...
- [sindresorhus/quick-look-plugins](https://github.com/sindresorhus/quick-look-plugins) ★18418  
...
- [Johnshall/Shadowrocket-ADBlock-Rules-Forever](https://github.com/Johnshall/Shadowrocket-ADBlock-Rules-Forever) ★17579 [`adblock`] [`gfw`] [`proxy`] [`shadowrocket`] [`v2ray`]  
...
- [clearw5/Auto.js](https://github.com/clearw5/Auto.js) ★12822 [`android`] [`autojs`] [`automation`] [`javascript`] [`javascript-ide`] [`nodejs`] [`tasker`] [`uiautomator`] [`workflow`]  
...
- [AUK9527/Are-u-ok](https://github.com/AUK9527/Are-u-ok) ★12104  
...
- [pikvm/pikvm](https://github.com/pikvm/pikvm) ★9406 [`atx`] [`hardware`] [`hdmi`] [`ip-kvm`] [`ipkvm`] [`ipmi`] [`kvm`] [`mass-storage-device`] [`pi-kvm`] [`pikvm`] [`raspberry-pi`] [`raspberrypi`] [`vga`] [`video-capture-device`] [`vnc`]  
...
- [jackhawks/rectg](https://github.com/jackhawks/rectg) ★8140 [`rectg`] [`telegram`] [`telegram-bot`] [`telegram-channel`] [`telegram-group`]  
...
- [wuxingsanren/wildcat-vip-account](https://github.com/wuxingsanren/wildcat-vip-account) ★7848  
...
- [dongyubin/DockerHub](https://github.com/dongyubin/DockerHub) ★5979 [`cloudflare`] [`docker`] [`docker-image`] [`docker-registry`] [`dockerhub`] [`proxy`]  
...
- [reqable/reqable-app](https://github.com/reqable/reqable-app) ★5376 [`android-app`] [`capture`] [`debugging-tool`] [`desktop-app`] [`flutter`] [`http`] [`http2`] [`http3`] [`https`] [`ios-app`] [`quic`] [`rest-api`]  
...
- [ACL4SSR/ACL4SSR](https://github.com/ACL4SSR/ACL4SSR) ★5239 [`acl`] [`acl4ssr`] [`clash`] [`gfwlist`]  
...
- [awesome-vpn/awesome-vpn](https://github.com/awesome-vpn/awesome-vpn) ★4560 [`clash`] [`fanqiang`] [`free`] [`geopolitics`] [`gfw`] [`great-firewall`] [`shadowsocks`] [`shadowsocksr`] [`ss`] [`trojan`] [`v2ray`] [`vless`] [`vmess`] [`vpn-server`] [`xray`]  
...
- [suxuang/myIPTV](https://github.com/suxuang/myIPTV) ★4119  
...
- [AttemptD/AfuseKt-release](https://github.com/AttemptD/AfuseKt-release) ★3902  
...
- [Kimentanm/aptv](https://github.com/Kimentanm/aptv) ★2487  
...
- [tech-shrimp/me](https://github.com/tech-shrimp/me) ★784  
...
- [huang770101/my-iptv](https://github.com/huang770101/my-iptv) ★71  
