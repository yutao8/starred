...
- [Genymobile/scrcpy](https://github.com/Genymobile/scrcpy) ★135496 [`android`] [`c`] [`ffmpeg`] [`libav`] [`mirroring`] [`recording`] [`screen`] [`sdl2`]  
...
- [ventoy/Ventoy](https://github.com/ventoy/Ventoy) ★74423 [`arm64`] [`auto-install`] [`bootable-usb`] [`bsd`] [`chromeos`] [`iso-files`] [`legacy`] [`linux`] [`multiboot`] [`persistence`] [`secure-boot`] [`uefi`] [`unattended`] [`unix`] [`usb`] [`windows`] [`x86`] [`x86-64`]  
...
- [mpv-player/mpv](https://github.com/mpv-player/mpv) ★33991 [`audio`] [`c`] [`ffmpeg`] [`mplayer`] [`mpv`] [`multimedia`] [`video`]  
...
- [valinet/ExplorerPatcher](https://github.com/valinet/ExplorerPatcher) ★31502  
...
- [coolsnowwolf/lede](https://github.com/coolsnowwolf/lede) ★31311 [`lede`] [`lua`] [`openwrt-feed`] [`openwrt-package`] [`openwrt-zh-cn`]  
...
- [kingToolbox/WindTerm](https://github.com/kingToolbox/WindTerm) ★29737 [`bash`] [`client`] [`cmd`] [`linux`] [`mac`] [`powershell`] [`serial`] [`sftp`] [`shell`] [`ssh`] [`telnet`] [`terminal`] [`tmux`] [`windows`] [`wsl`] [`x11`] [`xmodem`] [`xterm`] [`ymodem`] [`zmodem`]  
...
- [facebook/zstd](https://github.com/facebook/zstd) ★26594  
...
- [jarun/nnn](https://github.com/jarun/nnn) ★21226 [`android`] [`batch-rename`] [`c`] [`cli`] [`command-line`] [`developer-tools`] [`disk-usage`] [`file-manager`] [`file-preview`] [`file-search`] [`filesystem`] [`launcher`] [`multi-platform`] [`ncurses`] [`productivity`] [`raspberry-pi`] [`terminal`] [`tui`] [`vim`] [`wsl`]  
...
- [gojue/ecapture](https://github.com/gojue/ecapture) ★14996 [`android`] [`android-https-capture`] [`ebpf`] [`ebpf-go`] [`ebpf-tc`] [`ebpf-uprobe`] [`golang`] [`https`] [`linux`] [`network-capture`] [`security-audit`] [`ssl`] [`ssldump`] [`tcpdump`] [`tls`]  
...
- [coturn/coturn](https://github.com/coturn/coturn) ★13582 [`networking`] [`server`] [`turn`]  
...
- [vanhauser-thc/thc-hydra](https://github.com/vanhauser-thc/thc-hydra) ★11651 [`brute-force`] [`brute-force-attacks`] [`brute-force-passwords`] [`bruteforce`] [`bruteforce-attacks`] [`bruteforcer`] [`bruteforcing`] [`hydra`] [`network-security`] [`password-cracker`] [`password-cracking`] [`penetration-testing`] [`pentest`] [`pentest-tool`] [`pentesting`] [`thc`]  
...
- [pymumu/smartdns](https://github.com/pymumu/smartdns) ★10541 [`c`] [`dns`] [`dns-over-https`] [`dns-over-tls`] [`dns-server`] [`dns64`] [`doh`] [`doh3`] [`doq`] [`dot`] [`nftables`] [`nftables-sets`] [`openwrt`] [`openwrt-package`] [`smartdns`] [`stubby`]  
...
- [wireshark/wireshark](https://github.com/wireshark/wireshark) ★8994 [`packet-capture`] [`stratoshark`] [`tshark`] [`wireshark`]  
...
- [esnet/iperf](https://github.com/esnet/iperf) ★8260 [`iperf3`]  
...
- [pawelsalawa/sqlitestudio](https://github.com/pawelsalawa/sqlitestudio) ★6416 [`cpp`] [`database`] [`database-management`] [`qt`] [`qt5`] [`sqlcipher`] [`sqlite`] [`sqlite3-database`] [`wxsqlite3`]  
...
- [sabrogden/Ditto](https://github.com/sabrogden/Ditto) ★5943 [`clipboard`] [`clipboard-manager`]  
...
- [TelegramMessenger/MTProxy](https://github.com/TelegramMessenger/MTProxy) ★5735  
...
- [3proxy/3proxy](https://github.com/3proxy/3proxy) ★4914 [`accounting`] [`c`] [`https-proxy`] [`ipv6`] [`network-management`] [`network-security`] [`portmap`] [`proxy`] [`proxy-server`] [`sni`] [`socks`] [`socks-proxy`] [`socks-server`] [`socks5`] [`socks5-proxy`] [`socks5-server`] [`stunnel`] [`tls-proxy`] [`traffic-shaping`]  
...
- [OpenPrinting/cups](https://github.com/OpenPrinting/cups) ★1525 [`bsd`] [`ipp`] [`linux`] [`printing`]  
