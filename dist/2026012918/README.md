...
- **编程语言种类：** 56
- **仓库总数：** 1885
- **最后更新时间：** 2026-01-29 18:00:28

[**→ 查看所有仓库**](dist/2026012918/ALL.md)
...
- [gurecn/YuyanIme](https://github.com/gurecn/YuyanIme) ★3053 [`double-pinyin`] [`ime`] [`input-method`] [`keyboard`] [`pinyin`] [`qwerty`] [`rime`] [`t9`]  
...
- [fcitx5-android/fcitx5-android](https://github.com/fcitx5-android/fcitx5-android) ★4802 [`android`] [`android-ime`] [`android-keyboard`] [`fcitx`] [`fcitx5`] [`ime`] [`input-method`] [`keyboard`]  
...
- [gaboolic/rime-frost](https://github.com/gaboolic/rime-frost) ★2975  
...
- [NationalSecurityAgency/ghidra](https://github.com/NationalSecurityAgency/ghidra) ★63904 [`disassembler`] [`reverse-engineering`] [`software-analysis`]  
...
- [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) ★164128 [`activator`] [`hwid`] [`kms`] [`kms38`] [`massgrave`] [`massgravel`] [`microsoft`] [`microsoft365`] [`office`] [`office365`] [`ohook`] [`powershell`] [`tsforge`] [`windows`] [`windows-10`] [`windows-11`]  
...
- [Atlas-OS/Atlas](https://github.com/Atlas-OS/Atlas) ★19478 [`ame-wizard`] [`atlas`] [`atlasos`] [`debloat`] [`fps`] [`gaming`] [`latency`] [`open-source`] [`opensource`] [`performance`] [`privacy`] [`security`] [`tweaks`] [`windows`]  
...
- [FongMi/Release](https://github.com/FongMi/Release) ★5388  
...
- [Genymobile/scrcpy](https://github.com/Genymobile/scrcpy) ★134877 [`android`] [`c`] [`ffmpeg`] [`libav`] [`mirroring`] [`recording`] [`screen`] [`sdl2`]  
...
- [ventoy/Ventoy](https://github.com/ventoy/Ventoy) ★74134 [`arm64`] [`auto-install`] [`bootable-usb`] [`bsd`] [`chromeos`] [`iso-files`] [`legacy`] [`linux`] [`multiboot`] [`persistence`] [`secure-boot`] [`uefi`] [`unattended`] [`unix`] [`usb`] [`windows`] [`x86`] [`x86-64`]  
...
- [mpv-player/mpv](https://github.com/mpv-player/mpv) ★33793 [`audio`] [`c`] [`ffmpeg`] [`mplayer`] [`mpv`] [`multimedia`] [`video`]  
...
- [jqlang/jq](https://github.com/jqlang/jq) ★33432 [`jq`]  
...
- [valinet/ExplorerPatcher](https://github.com/valinet/ExplorerPatcher) ★31344  
...
- [coolsnowwolf/lede](https://github.com/coolsnowwolf/lede) ★31283 [`lede`] [`lua`] [`openwrt-feed`] [`openwrt-package`] [`openwrt-zh-cn`]  
...
- [kingToolbox/WindTerm](https://github.com/kingToolbox/WindTerm) ★29571 [`bash`] [`client`] [`cmd`] [`linux`] [`mac`] [`powershell`] [`serial`] [`sftp`] [`shell`] [`ssh`] [`telnet`] [`terminal`] [`tmux`] [`windows`] [`wsl`] [`x11`] [`xmodem`] [`xterm`] [`ymodem`] [`zmodem`]  
...
[查看更多 C 仓库 →](dist/2026012918/LANG_C.md)

## C#

- [microsoft/PowerToys](https://github.com/microsoft/PowerToys) ★128539 [`color-picker`] [`command-palette`] [`desktop`] [`fancyzones`] [`keyboard-manager`] [`microsoft-powertoys`] [`powerrename`] [`powertoys`] [`windows`] [`windows-10`] [`windows-11`]  
...
- [2dust/v2rayN](https://github.com/2dust/v2rayN) ★95687 [`proxy`] [`shadowsocks`] [`socks5`] [`trojan`] [`v2fly`] [`v2ray`] [`vless`] [`vmess`] [`windows`] [`xray`] [`xtls`]  
...
- [PowerShell/PowerShell](https://github.com/PowerShell/PowerShell) ★51295 [`command-line`] [`hacktoberfest`] [`linux`] [`macos`] [`netcore`] [`powershell`] [`shell`] [`windows`]  
  这是一个用于PowerShell的项目，具体功能不明确。  需要更多信息才能生成合适的项目描述。 请提供GitHub项目链接。
- [huiyadanli/RevokeMsgPatcher](https://github.com/huiyadanli/RevokeMsgPatcher) ★36468 [`hex-editor`] [`patch`] [`pc`] [`qq`] [`revoke`] [`revokemsg`] [`tim`] [`tool`] [`wechat`] [`windows`]  
...
- [AvaloniaUI/Avalonia](https://github.com/AvaloniaUI/Avalonia) ★29921 [`android`] [`app-framework`] [`avalonia`] [`avaloniaui`] [`browser`] [`c-sharp`] [`cross-platform`] [`csharp`] [`desktop`] [`dotnet`] [`gui`] [`ios`] [`linux`] [`macos`] [`mobile`] [`mvvm`] [`wasm`] [`windows`] [`xamarin`] [`xaml`]  
...
- [rocksdanister/lively](https://github.com/rocksdanister/lively) ★18077 [`csharp`] [`desktop`] [`desktop-wallpaper`] [`dynamic-desktop`] [`dynamic-wallpaper`] [`fluent-design`] [`live-wallpaper`] [`screensavers`] [`wallpaper`] [`wallpaper-app`] [`wallpaper-changer`] [`wallpaper-engine`] [`wallpaperengine`] [`wallpapers`] [`widgets`] [`windows-10`] [`windows-11`] [`windows-app`] [`winui`] [`winui3`]  
...
- [bitwarden/server](https://github.com/bitwarden/server) ★17957 [`api`] [`aspnet`] [`aspnetcore`] [`bitwarden`] [`csharp`] [`docker`] [`dotnet`] [`dotnet-core`] [`signalr`] [`sql`] [`sql-server`]  
...
[查看更多 C# 仓库 →](dist/2026012918/LANG_C_.md)

## C++

- [electron/electron](https://github.com/electron/electron) ★119931 [`c-plus-plus`] [`chrome`] [`css`] [`electron`] [`html`] [`javascript`] [`nodejs`] [`v8`] [`works-with-codespaces`]  
...
- [microsoft/terminal](https://github.com/microsoft/terminal) ★101575 [`cmd`] [`command-line`] [`console`] [`contributions-welcome`] [`good-first-issue`] [`hacktoberfest`] [`terminal`] [`windows`] [`windows-console`] [`windows-terminal`] [`wsl`]  
...
- [tesseract-ocr/tesseract](https://github.com/tesseract-ocr/tesseract) ★72126 [`hacktoberfest`] [`lstm`] [`machine-learning`] [`ocr`] [`ocr-engine`] [`tesseract`] [`tesseract-ocr`]  
...
- [aria2/aria2](https://github.com/aria2/aria2) ★39853 [`bittorrent`] [`cpp11`] [`download`] [`ftp`] [`http`] [`metalink`] [`rpc`] [`sftp`]  
...
- [qbittorrent/qBittorrent](https://github.com/qbittorrent/qBittorrent) ★35232 [`bittorrent`] [`bittorrent-client`] [`c-plus-plus`] [`crossplatform`] [`torrent`] [`torrent-client`]  
...
- [LizardByte/Sunshine](https://github.com/LizardByte/Sunshine) ★33997 [`cpp`] [`docker`] [`flathub-pkg`] [`game-stream`] [`game-streaming`] [`game-streaming-server`] [`geforce-experience`] [`homebrew-pkg`] [`maintainer-wanted`] [`moonlight`] [`pacman-pkg`] [`python`] [`remote-desktop`] [`replicator-custom-issues`] [`replicator-release-notifications`] [`rtd`] [`winget-pkg`]  
...
- [microsoft/WSL](https://github.com/microsoft/WSL) ★30969  
  在 Windows 10/11 上运行完整 Linux 用户空间的子系统，提供与原生 Linux 几乎相同的文件系统、网络、进程与信号模型，实现 Bash、ssh、git、docker 等常用工具的原生体验。核心采用轻量化的 lxcore 内核与 Pico 进程模型，通过 Hyper‑V‑based 实现与 Windows 内核的高效交互，支持多发行版（Ubuntu、Debian、Alpine 等）以 tar 包形式快速导入。系统管理通过 wsl.exe 命令行界面完成，支持文件系统互挂、端口转发、跨平台调试以及 Win32 与 Linux 应用的直接互操作，实质上是基于 C/C++ 与 Windows 内核组件的兼容层，面向开发者、运维与学习者提供无缝的跨平台工作流。
- [c0re100/qBittorrent-Enhanced-Edition](https://github.com/c0re100/qBittorrent-Enhanced-Edition) ★24919 [`bittorrent`] [`bittorrent-client`]  
...
[查看更多 C++ 仓库 →](dist/2026012918/LANG_C__.md)
...
- [microsoft/vcpkg](https://github.com/microsoft/vcpkg) ★26541 [`c`] [`cmake`] [`cplusplus`] [`cpp`] [`libraries`] [`package-manager`] [`packages`] [`vcpkg`] [`visual-studio`] [`windows`]  
...
[查看更多 CSS 仓库 →](dist/2026012918/LANG_CSS.md)
...
- [AppFlowy-IO/AppFlowy](https://github.com/AppFlowy-IO/AppFlowy) ★67813 [`blog`] [`confluence-alternative`] [`content-management`] [`content-services`] [`documentation`] [`flutter`] [`note-taking`] [`notion-alternative`] [`project-management`] [`task-management`] [`team-collaboration`] [`wiki`]  
...
- [wanghongenpin/proxypin](https://github.com/wanghongenpin/proxypin) ★11491 [`capture-traffic`] [`charles`] [`fiddler`] [`proxy`] [`proxypin`] [`zhuabao`]  
...
[查看更多 Dart 仓库 →](dist/2026012918/LANG_Dart.md)

## Dockerfile

- [Anduin2017/HowToCook](https://github.com/Anduin2017/HowToCook) ★97507 [`chinese`] [`cookbook`] [`cooking`] [`dishes`] [`recipes`]  
...
- [jaywcjlove/reference](https://github.com/jaywcjlove/reference) ★14921 [`cheatsheet`] [`docker`] [`javascript`] [`npm`] [`npm-package`] [`react`] [`reactjs`] [`references`] [`semver`] [`toml`] [`typescript`] [`vue3`] [`vuejs`]  
...
- [Fechin/reference](https://github.com/Fechin/reference) ★9959 [`awk`] [`bash`] [`chatgpt`] [`cheatsheet`] [`cheatsheets`] [`css`] [`golang`] [`grep`] [`markdown`] [`python`] [`reference`] [`sed`] [`snippets`] [`vim`]  
...
- [Richasy/Bili.Copilot](https://github.com/Richasy/Bili.Copilot) ★5041 [`bilibili`] [`windows-app-sdk`] [`winui3`]  
...
- [fatedier/frp](https://github.com/fatedier/frp) ★103977 [`expose`] [`firewall`] [`frp`] [`go`] [`http-proxy`] [`nat`] [`p2p`] [`proxy`] [`reverse-proxy`] [`tunnel`]  
...
- [syncthing/syncthing](https://github.com/syncthing/syncthing) ★79440 [`go`] [`p2p`] [`peer-to-peer`] [`synchronization`]  
...
- [junegunn/fzf](https://github.com/junegunn/fzf) ★77349 [`bash`] [`cli`] [`fish`] [`fzf`] [`go`] [`neovim`] [`tmux`] [`unix`] [`vim`] [`zsh`]  
...
- [minio/minio](https://github.com/minio/minio) ★59971 [`amazon-s3`] [`cloud`] [`cloudnative`] [`cloudstorage`] [`go`] [`k8s`] [`kubernetes`] [`multi-cloud`] [`multi-cloud-kubernetes`] [`objectstorage`] [`s3`] [`storage`]  
...
- [FiloSottile/mkcert](https://github.com/FiloSottile/mkcert) ★57890 [`certificates`] [`chrome`] [`firefox`] [`https`] [`ios`] [`linux`] [`local-development`] [`localhost`] [`macos`] [`root-ca`] [`tls`] [`windows`]  
...
- [usememos/memos](https://github.com/usememos/memos) ★56106 [`docker`] [`foss`] [`go`] [`markdown`] [`memo`] [`microblog`] [`note-taking`] [`notecard`] [`react`] [`self-hosted`] [`social-network`] [`sqlite`]  
...
- [rclone/rclone](https://github.com/rclone/rclone) ★55181 [`azure-blob`] [`azure-blob-storage`] [`azure-files`] [`backblaze-b2`] [`cloud-storage`] [`dropbox`] [`encryption`] [`ftp`] [`fuse-filesystem`] [`go`] [`golang`] [`google-cloud-storage`] [`google-drive`] [`onedrive`] [`openstack-swift`] [`rclone`] [`s3`] [`sftp`] [`sync`] [`webdav`]  
...
- [go-gitea/gitea](https://github.com/go-gitea/gitea) ★53443 [`bitbucket`] [`cicd`] [`devops`] [`docker-registry-v2`] [`git`] [`git-gui`] [`git-server`] [`gitea`] [`github`] [`github-actions`] [`gitlab`] [`go`] [`golang`] [`hacktoberfest`] [`maven-server`] [`npm-registry`] [`vue`]  
...
- [AlistGo/alist](https://github.com/AlistGo/alist) ★48927 [`file-server`] [`gin`] [`golang`] [`onedrive`] [`solidjs`] [`webdav`]  
...
[查看更多 Go 仓库 →](dist/2026012918/LANG_Go.md)

## Haskell

- [jgm/pandoc](https://github.com/jgm/pandoc) ★41776 [`commonmark`] [`converter`] [`document`] [`haskell`] [`markdown`] [`markup`] [`pandoc`] [`presentation`] [`publishing`]  
...
- [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) ★117623 [`awesome-list`] [`free-for-developers`]  
...
- [vernesong/OpenClash](https://github.com/vernesong/OpenClash) ★24046 [`clash`] [`luci`] [`mihomo`] [`openclash`] [`openwrt`] [`shadowsocks`] [`snell`] [`v2ray`] [`vmess`]  
...
- [webmin/webmin](https://github.com/webmin/webmin) ★5548  
...
- [vbskycn/iptv](https://github.com/vbskycn/iptv) ★5326  
...
[查看更多 HTML 仓库 →](dist/2026012918/LANG_HTML.md)

## Java

- [krahets/hello-algo](https://github.com/krahets/hello-algo) ★121925 [`algo`] [`algorithm`] [`algorithms`] [`book`] [`data-structure`] [`data-structures`] [`data-structures-and-algorithms`] [`dsa`] [`education`] [`leetcode`] [`programming`]  
...
- [NationalSecurityAgency/ghidra](https://github.com/NationalSecurityAgency/ghidra) ★63904 [`disassembler`] [`reverse-engineering`] [`software-analysis`]  
  Ghidra 是 NSA 开源的逆向分析平台，提供二进制导入、函数识别、交叉引用、数据流分析和高级反编译等完整工作流。核心采用 Java 实现跨平台 UI（基于 SWT），配合 C++ 编写的高性能 decompiler，支持 x86、ARM、MIPS 等百余种处理器架构。项目结构划分为分析引擎、插件框架和脚本环境，用户可使用 Python、Java 或 Jython 编写自定义插件，快速扩展功能。通过统一的项目数据库管理文件、符号和分析结果，实现协同审计和批量处理，适用于漏洞研究、恶意软件检测和软件兼容性验证等场景。
- [termux/termux-app](https://github.com/termux/termux-app) ★49356 [`android`] [`hacktoberfest`] [`linux`] [`terminal`] [`termux`]  
...
- [dbeaver/dbeaver](https://github.com/dbeaver/dbeaver) ★48454 [`ai`] [`copilot`] [`database`] [`db2`] [`dbeaver`] [`erd`] [`gui`] [`java`] [`jdbc`] [`mysql`] [`nosql`] [`openai`] [`oracle`] [`postgresql`] [`redshift`] [`sql`] [`sqlite`] [`sqlserver`]  
...
- [skylot/jadx](https://github.com/skylot/jadx) ★47068 [`android`] [`decompiler`] [`dex`] [`java`]  
...
- [DrKLO/Telegram](https://github.com/DrKLO/Telegram) ★28387 [`telegram`]  
...
[查看更多 Java 仓库 →](dist/2026012918/LANG_Java.md)
...
[查看更多 JavaScript 仓库 →](dist/2026012918/LANG_JavaScript.md)
...
- [2dust/v2rayNG](https://github.com/2dust/v2rayNG) ★50245 [`android`] [`proxy`] [`shadowsocks`] [`socks5`] [`trojan`] [`v2fly`] [`v2ray`] [`vless`] [`vmess`] [`vpn`] [`xray`] [`xtls`]  
...
- [bannedbook/fanqiang](https://github.com/bannedbook/fanqiang) ★42052 [`brook`] [`daze`] [`fanqiang`] [`goflyway`] [`lightsocks`] [`proxy`] [`psiphon`] [`shadowsocks`] [`ssr`] [`trojan`] [`v2ray`]  
  这是一个用于科学上网的翻墙工具，提供多种连接方式，支持多种操作系统。它使用Go语言开发，核心模块包括代理服务器和连接管理，并整合了多种开源库。该项目旨在为用户提供快速、稳定、便捷的网络访问方式，绕过地区限制。
- [gkd-kit/gkd](https://github.com/gkd-kit/gkd) ★35498 [`accessibility`] [`android`] [`auto`] [`click`] [`compose`] [`jetpack-compose`] [`kotlin`] [`kotlin-js`] [`kotlin-multiplatform`] [`webassembly`]  
...
- [MetaCubeX/ClashMetaForAndroid](https://github.com/MetaCubeX/ClashMetaForAndroid) ★33290  
...
- [pppscn/SmsForwarder](https://github.com/pppscn/SmsForwarder) ★24331 [`android`] [`api`] [`app`] [`bark`] [`call`] [`chatgpt`] [`dingding`] [`forward`] [`mqtt`] [`pushdear`] [`pushplus`] [`serverchan`] [`sms`] [`smtp`] [`telegram`] [`webhook`] [`wechatapp`]  
...
- [RikkaApps/Shizuku](https://github.com/RikkaApps/Shizuku) ★21248  
...
- [MatsuriDayo/NekoBoxForAndroid](https://github.com/MatsuriDayo/NekoBoxForAndroid) ★18419 [`android`] [`gfw`] [`proxy`] [`shadowsocks`] [`sing-box`] [`trojan`] [`vmess`] [`vpn`]  
...
- [mihonapp/mihon](https://github.com/mihonapp/mihon) ★18273 [`android`] [`kotlin`] [`manga`] [`manga-downloader`] [`manga-reader`] [`mangadownloader`] [`mangareader`] [`tachiyomi`] [`tachiyomi-alternative`]  
...
[查看更多 Kotlin 仓库 →](dist/2026012918/LANG_Kotlin.md)
...
- [Kong/kong](https://github.com/Kong/kong) ★42620 [`ai`] [`ai-gateway`] [`api-gateway`] [`api-management`] [`apis`] [`artificial-intelligence`] [`cloud-native`] [`devops`] [`kubernetes`] [`kubernetes-ingress`] [`kubernetes-ingress-controller`] [`llm-gateway`] [`llm-ops`] [`mcp`] [`mcp-gateway`] [`microservice`] [`microservices`] [`openai-proxy`] [`reverse-proxy`] [`serverless`]  
...
- [iDvel/rime-ice](https://github.com/iDvel/rime-ice) ★15418 [`rime`] [`rime-config`] [`rime-custom`] [`rime-schema`] [`rime-squirrel`] [`rime-weasel`]  
...
- [gaboolic/rime-frost](https://github.com/gaboolic/rime-frost) ★2975  
  Rime‑Frost 为 Rime 输入法提供的全功能方案，实现高效中文输入与简洁键位布局。核心采用 schema.yml 定义词库结构，配合 yaml 格式词表、Lua 过滤脚本，实现双拼、动态候选、智能纠错、emoji 与常用短语联想。兼容 Windows Weasel、macOS Squirrel、Linux fcitx‑rime，支持自定义 short‑code 扩展。技术上使用 Rust 编写的 rime‑engine 进行实时解析，Python 脚本负责词频统计与词表自动更新，模块划分为 MainSchema、Recognizer、Engine、Filter，确保方案可维护、可拓展，适合日常打字与专业写作。
- [zhihulite/Hydrogen](https://github.com/zhihulite/Hydrogen) ★1502  
...
- [twbs/bootstrap](https://github.com/twbs/bootstrap) ★173961 [`bootstrap`] [`css`] [`css-framework`] [`html`] [`javascript`] [`sass`] [`scss`]  
...
- [frida/frida](https://github.com/frida/frida) ★19585 [`frida`] [`instrumentation`] [`vala`]  
...
- [996icu/996.ICU](https://github.com/996icu/996.ICU) ★275366  
  该项目是一个关于中国程序员工作强度和压力的匿名吐槽平台。用户可以通过匿名发表帖子，分享工作经历和感受。平台使用简单的文本格式，并支持搜索和过滤功能。该项目主要使用PHP语言开发，并使用数据库存储用户数据和帖子信息。
- [awesome-selfhosted/awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ★270592 [`awesome`] [`awesome-list`] [`cloud`] [`free-software`] [`hosting`] [`privacy`] [`self-hosted`] [`selfhosted`]  
...
- [deepseek-ai/DeepSeek-R1](https://github.com/deepseek-ai/DeepSeek-R1) ★91798  
...
- [ruanyf/weekly](https://github.com/ruanyf/weekly) ★83286  
...
- [justjavac/awesome-wechat-weapp](https://github.com/justjavac/awesome-wechat-weapp) ★50400 [`demo`] [`minapp`] [`miniprogram`] [`weapp-demo`] [`wechat`] [`wechat-weapp`] [`wepy`] [`wxapp`] [`wxml`]  
...
- [LC044/WeChatMsg](https://github.com/LC044/WeChatMsg) ★40492 [`chatgpt`] [`llms`] [`pyqt`] [`wechat`]  
...
[查看更多 NaN 仓库 →](dist/2026012918/LANG_NaN.md)
...
[查看更多 Objective-C 仓库 →](dist/2026012918/LANG_Objective-C.md)
...
- [nextcloud/server](https://github.com/nextcloud/server) ★33927 [`cloud`] [`collaboration`] [`decentralized`] [`design`] [`distributed`] [`enterprise`] [`federation`] [`file-sharing`] [`free-software`] [`hacktoberfest`] [`javascript`] [`nextcloud`] [`open-source`] [`opensource`] [`owncloud`] [`php`] [`self-hosting`] [`sharing`] [`usability`] [`ux`]  
...
[查看更多 PHP 仓库 →](dist/2026012918/LANG_PHP.md)
...
- [ScoopInstaller/Scoop](https://github.com/ScoopInstaller/Scoop) ★23532 [`installer`] [`powershell`] [`scoop`] [`windows`]  
...
- [public-apis/public-apis](https://github.com/public-apis/public-apis) ★394131 [`api`] [`apis`] [`dataset`] [`development`] [`free`] [`list`] [`lists`] [`open-source`] [`public`] [`public-api`] [`public-apis`] [`resources`] [`software`]  
...
- [EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books) ★381334 [`books`] [`education`] [`hacktoberfest`] [`list`] [`resource`]  
...
- [521xueweihan/HelloGitHub](https://github.com/521xueweihan/HelloGitHub) ★141581 [`awesome`] [`github`] [`hellogithub`] [`python`]  
...
- [ytdl-org/youtube-dl](https://github.com/ytdl-org/youtube-dl) ★139607  
...
- [deepseek-ai/DeepSeek-V3](https://github.com/deepseek-ai/DeepSeek-V3) ★101374  
...
- [nvbn/thefuck](https://github.com/nvbn/thefuck) ★95338 [`python`] [`shell`]  
...
- [home-assistant/core](https://github.com/home-assistant/core) ★84450 [`asyncio`] [`hacktoberfest`] [`home-automation`] [`internet-of-things`] [`iot`] [`mqtt`] [`python`] [`raspberry-pi`]  
...
- [fighting41love/funNLP](https://github.com/fighting41love/funNLP) ★78728  
...
- [sherlock-project/sherlock](https://github.com/sherlock-project/sherlock) ★72254 [`cli`] [`cti`] [`cybersecurity`] [`forensics`] [`hacktoberfest`] [`information-gathering`] [`infosec`] [`linux`] [`osint`] [`pentesting`] [`python`] [`python3`] [`reconnaissance`] [`redteam`] [`sherlock`] [`tools`]  
...
[查看更多 Python 仓库 →](dist/2026012918/LANG_Python.md)
...
- [TapXWorld/ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook) ★64602  
...
- [discourse/discourse](https://github.com/discourse/discourse) ★46156 [`discourse`] [`ember`] [`forum`] [`javascript`] [`postgresql`] [`rails`] [`ruby`]  
...
- [rustdesk/rustdesk](https://github.com/rustdesk/rustdesk) ★106530 [`android`] [`anydesk`] [`dart`] [`flatpak`] [`flutter`] [`flutter-apps`] [`ios`] [`linux`] [`macos`] [`p2p`] [`rdp`] [`remote-control`] [`remote-desktop`] [`rust`] [`rust-lang`] [`teamviewer`] [`vnc`] [`wayland`] [`windows`]  
...
- [zed-industries/zed](https://github.com/zed-industries/zed) ★74268 [`gpui`] [`rust-lang`] [`text-editor`] [`zed`]  
...
- [topjohnwu/Magisk](https://github.com/topjohnwu/Magisk) ★58403  
...
- [dani-garcia/vaultwarden](https://github.com/dani-garcia/vaultwarden) ★54205 [`bitwarden`] [`bitwarden-rs`] [`docker`] [`rocket`] [`rust`] [`vaultwarden`]  
...
- [starship/starship](https://github.com/starship/starship) ★53783 [`bash`] [`fish`] [`fish-prompt`] [`fish-theme`] [`oh-my-zsh`] [`powershell`] [`rust`] [`shell-prompt`] [`starship`] [`zsh`] [`zsh-prompt`] [`zsh-theme`]  
...
- [tw93/Pake](https://github.com/tw93/Pake) ★45463 [`chatgpt`] [`claude`] [`desktop`] [`gemini`] [`hight-performance`] [`linux`] [`macos`] [`no-electron`] [`package`] [`rust`] [`tauri`] [`windows`] [`youtube`]  
...
- [fish-shell/fish-shell](https://github.com/fish-shell/fish-shell) ★32184 [`fish`] [`rust`] [`shell`] [`terminal`]  
...
- [lbjlaq/Antigravity-Manager](https://github.com/lbjlaq/Antigravity-Manager) ★19229 [`account-manager`] [`antigravity`]  
...
- [lsd-rs/lsd](https://github.com/lsd-rs/lsd) ★15378 [`color`] [`hacktoberfest`] [`icons`] [`ls`] [`nerd-fonts`] [`rust`]  
...
[查看更多 Rust 仓库 →](dist/2026012918/LANG_Rust.md)
...
- [ohmyzsh/ohmyzsh](https://github.com/ohmyzsh/ohmyzsh) ★184305 [`cli`] [`cli-app`] [`oh-my-zsh`] [`oh-my-zsh-plugin`] [`oh-my-zsh-theme`] [`ohmyzsh`] [`plugin-framework`] [`plugins`] [`productivity`] [`shell`] [`terminal`] [`theme`] [`themes`] [`zsh`] [`zsh-configuration`]  
...
- [dockur/windows](https://github.com/dockur/windows) ★49722 [`docker`] [`docker-container`] [`virtualization`] [`windows`] [`windows-virtual-desktop`] [`windows-virtual-machine`] [`windows-virtual-machines`] [`windows-vm`]  
...
- [acmesh-official/acme.sh](https://github.com/acmesh-official/acme.sh) ★45521 [`acme`] [`acme-challenge`] [`acme-protocol`] [`acme-v2`] [`ash`] [`bash`] [`buypass`] [`certbot`] [`lets-encrypt`] [`posix`] [`posix-sh`] [`shell`] [`ssl`] [`ssl-certificate`] [`ssl-certificates`] [`tls`] [`tls-certificate`] [`zerossl`]  
...
- [pyenv/pyenv](https://github.com/pyenv/pyenv) ★44172 [`python`] [`shell`]  
...
- [zsh-users/zsh-autosuggestions](https://github.com/zsh-users/zsh-autosuggestions) ★34698 [`autocomplete`] [`autosuggest`] [`fish`] [`shell`] [`zsh`] [`zsh-autosuggestions`]  
...
- [233boy/v2ray](https://github.com/233boy/v2ray) ★28018 [`shell-script`] [`v2ray`] [`vmess`]  
  这是一个基于Go语言开发的V2Ray代理服务器。它提供快速、稳定的代理连接，支持多种协议和配置。项目包含了核心代理服务以及客户端配置文件生成工具，用户可以方便地配置和管理V2Ray连接。代码结构清晰，易于维护和扩展。
- [hwdsl2/setup-ipsec-vpn](https://github.com/hwdsl2/setup-ipsec-vpn) ★27318 [`cisco-ipsec`] [`docker`] [`encryption`] [`ikev2`] [`ipsec`] [`l2tp`] [`libreswan`] [`linux`] [`network`] [`raspberry-pi`] [`security`] [`vpn`] [`vpn-client`] [`vpn-server`]  
...
- [yuaotian/go-cursor-help](https://github.com/yuaotian/go-cursor-help) ★25833 [`cursor`] [`error`]  
...
[查看更多 Shell 仓库 →](dist/2026012918/LANG_Shell.md)

## Svelte

- [imputnet/cobalt](https://github.com/imputnet/cobalt) ★38320 [`collaboration`] [`downloader`] [`instagram`] [`javascript`] [`music`] [`reddit`] [`social-media`] [`soundcloud`] [`svelte`] [`tiktok`] [`twitter`] [`typescript`] [`video`] [`vimeo`] [`vk`] [`webapp`] [`youtube`] [`youtube-downloader`]  
...
- [iptv-org/iptv](https://github.com/iptv-org/iptv) ★110687 [`iptv`] [`m3u`] [`playlist`] [`streams`] [`tv`]  
...
- [ant-design/ant-design](https://github.com/ant-design/ant-design) ★97373 [`ant-design`] [`antd`] [`design-systems`] [`react`] [`typescript`] [`ui-kit`] [`ui-library`]  
...
- [clash-verge-rev/clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev) ★94809 [`clash`] [`clash-meta`] [`clash-verge`] [`linux`] [`mac`] [`mihomo`] [`tauri-app`] [`windows`]  
...
- [tailwindlabs/tailwindcss](https://github.com/tailwindlabs/tailwindcss) ★93228 [`css`] [`css-framework`] [`functional-css`] [`postcss`] [`responsive`] [`tailwindcss`] [`utility-classes`]  
...
- [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) ★92923 [`ai`] [`ai-agents`] [`cli`] [`gemini`] [`gemini-api`] [`mcp-client`] [`mcp-server`]  
...
- [immich-app/immich](https://github.com/immich-app/immich) ★90837 [`backup-tool`] [`flutter`] [`google-photos`] [`google-photos-alternative`] [`javascript`] [`mobile-app`] [`nestjs`] [`nodejs`] [`photo-gallery`] [`photos`] [`photos-management`] [`self-hosted`] [`svelte`] [`sveltekit`] [`typescript`] [`videos`]  
...
- [mermaid-js/mermaid](https://github.com/mermaid-js/mermaid) ★85658 [`diagrams`] [`diagrams-as-code`] [`documentation`] [`flowchart`] [`javascript`] [`mindmap`] [`typescript`] [`uml-diagrams`]  
...
- [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) ★78115 [`ai`] [`ai-agents`] [`ai-crawler`] [`ai-scraping`] [`ai-search`] [`crawler`] [`data-extraction`] [`html-to-markdown`] [`llm`] [`markdown`] [`scraper`] [`scraping`] [`web-crawler`] [`web-data`] [`web-data-extraction`] [`web-scraper`] [`web-scraping`] [`web-search`] [`webscraping`]  
...
- [hoppscotch/hoppscotch](https://github.com/hoppscotch/hoppscotch) ★77706 [`api`] [`api-client`] [`api-rest`] [`api-testing`] [`developer-tools`] [`graphql`] [`http`] [`http-client`] [`pwa`] [`rest`] [`rest-api`] [`spa`] [`testing`] [`testing-tools`] [`tools`] [`vue`] [`vuejs`] [`websocket`]  
...
[查看更多 TypeScript 仓库 →](dist/2026012918/LANG_TypeScript.md)

## VBScript

- [abbodi1406/vcredist](https://github.com/abbodi1406/vcredist) ★7301  
...
- [CorentinTh/it-tools](https://github.com/CorentinTh/it-tools) ★36757 [`converter`] [`developer-productivity`] [`developer-tools`] [`frontend`] [`javascript`] [`productivity`] [`tool`] [`tools`] [`typescript`] [`vuejs`] [`website`]  
...
- [vbenjs/vue-vben-admin](https://github.com/vbenjs/vue-vben-admin) ★31409 [`admin-template`] [`ant-design`] [`element-plus`] [`monorepo`] [`naive-ui`] [`shadcn-ui`] [`tsx`] [`typescript`] [`vben`] [`vite`] [`vite-template`] [`vue-router`] [`vue3`] [`vuex`]  
...
- [requarks/wiki](https://github.com/requarks/wiki) ★27772 [`cross-platform`] [`documentation`] [`git`] [`markdown`] [`nodejs`] [`open-source`] [`wiki`]  
...
- [Lissy93/dashy](https://github.com/Lissy93/dashy) ★23837 [`awesome`] [`dashboard`] [`docker`] [`hacktoberfest`] [`homelab`] [`homepage`] [`mit`] [`nodejs`] [`organization`] [`productivity`] [`pwa`] [`self-hosted`] [`startpage`] [`vue`]  
...
- [pure-admin/vue-pure-admin](https://github.com/pure-admin/vue-pure-admin) ★19690 [`admin`] [`element-plus`] [`esm`] [`pinia`] [`tailwindcss`] [`typescript`] [`vite`] [`vue3`]  
...
[查看更多 Vue 仓库 →](dist/2026012918/LANG_Vue.md)
