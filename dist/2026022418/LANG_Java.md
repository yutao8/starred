...
- [justauth/JustAuth](https://github.com/justauth/JustAuth) ★17395 [`googlelogin`] [`justauth`] [`oauth2`] [`qqlogin`] [`weixinlogin`]  
...
- [android-hacker/VirtualXposed](https://github.com/android-hacker/VirtualXposed) ★15961 [`android`] [`aop`] [`hook`] [`non-root`] [`xposed`]  
...
- [theonedev/onedev](https://github.com/theonedev/onedev) ★14715 [`ci-cd`] [`devops`] [`git`] [`kanban`] [`packages`] [`self-hosted`]  
...
- [microg/GmsCore](https://github.com/microg/GmsCore) ★12349 [`android`] [`auth`] [`cloud-messaging`] [`firebase`] [`geolocation`] [`google`] [`google-cloud-messaging`] [`java`] [`kotlin`] [`kotlin-android`] [`maps`] [`microg`] [`mobile`] [`push-notifications`]  
...
- [wildfirechat/im-server](https://github.com/wildfirechat/im-server) ★8443 [`im`] [`voip`]  
...
- [FongMi/TV](https://github.com/FongMi/TV) ★7421 [`catvod`] [`leanback`] [`media3`]  
...
- [648540858/wvp-GB28181-pro](https://github.com/648540858/wvp-GB28181-pro) ★6660 [`1078`] [`28181`] [`28181web`] [`808`] [`gb28181`] [`gb28181server`] [`wvp`]  
...
- [meefik/linuxdeploy](https://github.com/meefik/linuxdeploy) ★5759 [`android`] [`chroot`] [`containers`] [`deployment`] [`linux`]  
...
- [SuperMonster003/AutoJs6](https://github.com/SuperMonster003/AutoJs6) ★5362 [`android`] [`autojs`] [`autojs6`] [`automated-tool`] [`automation`] [`javascript`]  
...
- [pqpo/SmartCropper](https://github.com/pqpo/SmartCropper) ★4122 [`detection`] [`hed-net`] [`image`] [`image-cropper`] [`opencv`] [`pytorch`] [`smartcropper`] [`tensorflow`]  
  Smart
- [emanuele-f/PCAPdroid](https://github.com/emanuele-f/PCAPdroid) ★3728 [`android`] [`capture-traffic`] [`decryption`] [`firewall`] [`network-analysis`] [`no-root`] [`pcap`] [`pcap-files`] [`sniffer`] [`sniffing`] [`traffic-monitor`] [`wireshark`]  
...
- [termux/termux-tasker](https://github.com/termux/termux-tasker) ★1407 [`android`] [`termux`]  
...
- [aizuda/snail-job](https://github.com/aizuda/snail-job) ★766 [`mybatis-plus`] [`retry`] [`scheduler`]  
