...
- [open-ani/animeko](https://github.com/open-ani/animeko) ★13520 [`android`] [`ani`] [`anime`] [`bangumi`] [`bittorrent`] [`bt`] [`compose`] [`compose-multiplatform`] [`danmaku`] [`ios`] [`jetpack-compose`] [`kotlin`] [`kotlin-multiplatform`] [`linux`] [`macos`] [`player`] [`torrent`] [`video`] [`windows`]  
...
- [ankidroid/Anki-Android](https://github.com/ankidroid/Anki-Android) ★10347 [`android`] [`anki`] [`ankidroid`] [`education`] [`flashcards`] [`kotlin`] [`learning`] [`srs`]  
...
- [bitwarden/android](https://github.com/bitwarden/android) ★8135 [`android`] [`bitwarden`] [`compose`] [`jetpack`] [`kotlin`]  
...
- [ReadYouApp/ReadYou](https://github.com/ReadYouApp/ReadYou) ★6626 [`android`] [`compose`] [`f-droid`] [`kotlin`] [`material-design`] [`material-design-3`] [`material-ui`] [`material-you`] [`rss-reader`]  
...
- [aaa1115910/bv](https://github.com/aaa1115910/bv) ★3519  
...
- [tailscale/tailscale-android](https://github.com/tailscale/tailscale-android) ★1643 [`android`] [`chromeos`] [`tailscale`] [`vpn`] [`vpn-client`] [`wireguard`]  
...
- [mudkipme/MoeMemosAndroid](https://github.com/mudkipme/MoeMemosAndroid) ★915 [`android-application`] [`f-droid`] [`fdroid`] [`jetpack-compose`] [`kotlin-android`] [`memo`] [`note-taking`] [`self-hosted`]  
