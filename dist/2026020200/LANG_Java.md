...
- [krahets/hello-algo](https://github.com/krahets/hello-algo) ★122043 [`algo`] [`algorithm`] [`algorithms`] [`book`] [`data-structure`] [`data-structures`] [`data-structures-and-algorithms`] [`dsa`] [`education`] [`leetcode`] [`programming`]  
...
- [NationalSecurityAgency/ghidra](https://github.com/NationalSecurityAgency/ghidra) ★63980 [`disassembler`] [`reverse-engineering`] [`software-analysis`]  
...
- [skylot/jadx](https://github.com/skylot/jadx) ★47104 [`android`] [`decompiler`] [`dex`] [`java`]  
...
- [DrKLO/Telegram](https://github.com/DrKLO/Telegram) ★28400 [`telegram`]  
...
- [theonedev/onedev](https://github.com/theonedev/onedev) ★14660 [`ci-cd`] [`devops`] [`git`] [`kanban`] [`packages`] [`self-hosted`]  
...
- [zfile-dev/zfile](https://github.com/zfile-dev/zfile) ★10646 [`clouddisk`] [`h2`] [`h5ai`] [`mysql`] [`spring-boot`] [`vue`]  
...
- [wildfirechat/im-server](https://github.com/wildfirechat/im-server) ★8434 [`im`] [`voip`]  
...
- [qaiu/netdisk-fast-download](https://github.com/qaiu/netdisk-fast-download) ★2559 [`api`] [`download`] [`drive`] [`file-server`] [`ilanzou`] [`java`] [`netdisk-fast-download`] [`onedrive`] [`parser`] [`share`] [`vertx`] [`webserver`] [`yunpan`]  
