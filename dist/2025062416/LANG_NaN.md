...
- [awesome-selfhosted/awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ★233558 [`awesome`] [`awesome-list`] [`cloud`] [`free-software`] [`hosting`] [`privacy`] [`self-hosted`] [`selfhosted`]  
  这是一个收集各种可自托管软件的资源列表。涵盖了从博客和论坛到视频会议和VPN等各种应用。列表按类别组织，便于用户快速找到所需的自托管工具。该项目使用纯文本格式维护，便于轻松更新和浏览。
- [justjavac/free-programming-books-zh_CN](https://github.com/justjavac/free-programming-books-zh_CN) ★114394 [`android`] [`angular`] [`books`] [`free`] [`ios`] [`javascript`] [`kotlin`] [`pdf`] [`programming`] [`python`] [`react`] [`react-native`] [`swift`] [`vue`]  
...
- [deepseek-ai/DeepSeek-R1](https://github.com/deepseek-ai/DeepSeek-R1) ★90248  
...
- [ruanyf/weekly](https://github.com/ruanyf/weekly) ★69296  
...
- [qianguyihao/Web](https://github.com/qianguyihao/Web) ★27581 [`css`] [`front-end`] [`html`] [`javascript`]  
...
- [zijie0/HumanSystemOptimization](https://github.com/zijie0/HumanSystemOptimization) ★18732  
...
- [dongyubin/DockerHub](https://github.com/dongyubin/DockerHub) ★4361 [`cloudflare`] [`docker`] [`docker-image`] [`docker-registry`] [`dockerhub`] [`proxy`]  
...
- [hujingguang/ChinaIPTV](https://github.com/hujingguang/ChinaIPTV) ★1330  
...
- [ihmily/ip-info-api](https://github.com/ihmily/ip-info-api) ★1173 [`ip`] [`ip-geolocation`] [`ipaddress-tracker`] [`ipapi`] [`ipinfo`]  
...
- [submato/xhscrawl](https://github.com/submato/xhscrawl) ★979  
...
- [fancyapps/ui](https://github.com/fancyapps/ui) ★934 [`carousel`] [`fancybox`] [`gallery`] [`javascript`] [`lightbox`] [`panzoom`]  
...
- [jk2024988/TV2024](https://github.com/jk2024988/TV2024) ★893  
...
- [nauxliu/Dash-docsets-CN](https://github.com/nauxliu/Dash-docsets-CN) ★295 [`dash`] [`docset`] [`docset-cn`]  
  该项目提供一份中文版的Dash文档集，方便用户快速浏览和学习Dash框架。它包含了Dash核心组件、函数、方法等的详细说明和示例，并以清晰易懂的中文进行解释。项目使用Python和Dash库构建，并利用Markdown语言组织文档内容，通过Dash的交互式界面呈现，方便用户查阅和学习。  该文档集旨在帮助开发者更好地理解和应用Dash框架，提高开发效率。
...
- [hououinkami/AppleTV](https://github.com/hououinkami/AppleTV) ★281  
...
- [VeniZ/ShadowsocksX-NG-R8-Bakup](https://github.com/VeniZ/ShadowsocksX-NG-R8-Bakup) ★136  
  这是一个ShadowsocksX-NG-R8的备份项目，提供该VPN客户端的离线安装包。  项目使用Go语言构建，并包含了构建离线安装包的脚本。  用户可以下载预先构建好的安装包，方便在没有网络连接的环境下安装ShadowsocksX-NG-R8。  该项目旨在简化离线环境下的VPN客户端安装过程。
...
- [zxyyang/BaiduDisk-Qr-Login-Tenant-2.0](https://github.com/zxyyang/BaiduDisk-Qr-Login-Tenant-2.0) ★64  
...
- [zogodo/typora-0.11.18](https://github.com/zogodo/typora-0.11.18) ★36  
  Typora 是一款轻量级 Markdown 编辑器，该项目提供了一个版本为 0.11.18 的 Typora 二进制文件。该版本包含 Typora 的核心功能，允许用户使用 Markdown 语法撰写并编辑文档。它使用 C++ 作为主要开发语言，并可能整合了其他库来实现渲染、编辑和界面功能。
...
- [CaledoniaProject/php-decoder](https://github.com/CaledoniaProject/php-decoder) ★28  
  这是一个PHP代码解码器项目。它使用PHP语言，通过正则表达式匹配和字符串操作，解析并解码各种PHP代码片段。项目核心功能是将加密或混淆的PHP代码还原成可读的原始形式。解码过程主要依赖于对PHP语法和编码模式的理解，并通过算法识别和替换混淆元素。该项目可用于安全审计、代码分析和逆向工程等场景。
