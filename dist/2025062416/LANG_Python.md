...
- [EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books) ★360172 [`books`] [`education`] [`hacktoberfest`] [`list`] [`resource`]  
...
- [public-apis/public-apis](https://github.com/public-apis/public-apis) ★352527 [`api`] [`apis`] [`dataset`] [`development`] [`free`] [`list`] [`lists`] [`open-source`] [`public`] [`public-api`] [`public-apis`] [`resources`] [`software`]  
...
- [ytdl-org/youtube-dl](https://github.com/ytdl-org/youtube-dl) ★136203  
...
- [deepseek-ai/DeepSeek-V3](https://github.com/deepseek-ai/DeepSeek-V3) ★97808  
...
- [home-assistant/core](https://github.com/home-assistant/core) ★79774 [`asyncio`] [`hacktoberfest`] [`home-automation`] [`internet-of-things`] [`iot`] [`mqtt`] [`python`] [`raspberry-pi`]  
...
- [fighting41love/funNLP](https://github.com/fighting41love/funNLP) ★74298  
...
- [sherlock-project/sherlock](https://github.com/sherlock-project/sherlock) ★66245 [`cli`] [`cti`] [`cybersecurity`] [`forensics`] [`hacktoberfest`] [`information-gathering`] [`infosec`] [`linux`] [`osint`] [`pentesting`] [`python`] [`python3`] [`reconnaissance`] [`redteam`] [`sherlock`] [`tools`]  
...
- [scrapy/scrapy](https://github.com/scrapy/scrapy) ★57240 [`crawler`] [`crawling`] [`framework`] [`hacktoberfest`] [`python`] [`scraping`] [`web-scraping`] [`web-scraping-python`]  
...
- [zhayujie/chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat) ★37848 [`ai`] [`ai-agent`] [`chatgpt`] [`claude-4`] [`deepseek`] [`dingtalk`] [`feishu-bot`] [`gemini`] [`gpt-4`] [`kimi`] [`linkai`] [`llm`] [`mcp`] [`multi-agent`] [`openai`] [`python3`] [`qwen`] [`rag`] [`wechat`] [`wechat-bot`]  
...
- [yeongpin/cursor-free-vip](https://github.com/yeongpin/cursor-free-vip) ★30868 [`automation`] [`cursor`] [`cursor-ai`] [`cursor-ide`] [`cursorai`] [`cursors`] [`free`] [`freetrial`] [`pro`]  
...
- [littlecodersh/ItChat](https://github.com/littlecodersh/ItChat) ★26239 [`api`] [`itchat`] [`robot`] [`wechat`]  
  这是一个基于itchat库的微信机器人项目，用于自动回复消息、发送消息、群管理等功能。它使用Python语言开发，基于itchat库封装，并提供了一些常用的机器人功能，例如自动回复、群消息转发、好友管理等。项目代码结构清晰，易于理解和扩展。
- [521xueweihan/GitHub520](https://github.com/521xueweihan/GitHub520) ★26043 [`dns`] [`github`] [`hosts`]  
...
- [jhao104/proxy_pool](https://github.com/jhao104/proxy_pool) ★22505 [`crawler`] [`http`] [`proxy`] [`redis`] [`spider`]  
...
- [Delgan/loguru](https://github.com/Delgan/loguru) ★21973 [`log`] [`logger`] [`logging`] [`python`]  
...
- [LiLittleCat/awesome-free-chatgpt](https://github.com/LiLittleCat/awesome-free-chatgpt) ★20073 [`awesome`] [`awesome-list`] [`chat`] [`chatgpt`] [`free`] [`freechatgpt`]  
  这是一个收集免费 ChatGPT 替代方案的资源库。涵盖各种类型的免费或开源聊天机器人，包括代码生成、文本摘要、翻译等功能。该资源库主要使用 Markdown 格式组织，方便用户快速筛选和了解不同工具的特点。
- [bee-san/Ciphey](https://github.com/bee-san/Ciphey) ★19577 [`artificial-intelligence`] [`cipher`] [`cpp`] [`cryptography`] [`ctf`] [`ctf-tools`] [`cyberchef-magic`] [`decryption`] [`deep-neural-network`] [`encodings`] [`encryptions`] [`hacking`] [`hacktoberfest`] [`hashes`] [`natural-language-processing`] [`pentesting`] [`python`]  
...
- [Guovin/iptv-api](https://github.com/Guovin/iptv-api) ★16228 [`amd64`] [`api`] [`arm64`] [`armv7`] [`auto`] [`diy`] [`docker`] [`epg`] [`ipdb`] [`iptv`] [`ipv4`] [`ipv6`] [`m3u`] [`m3u8`] [`rtmp`] [`tv`] [`tvbox`] [`workflow`]  
...
- [xming521/WeClone](https://github.com/xming521/WeClone) ★14302 [`llm`] [`qwen`]  
...
- [RockChinQ/LangBot](https://github.com/RockChinQ/LangBot) ★12172 [`agent`] [`ai`] [`bot`] [`chatgpt`] [`deepseek`] [`dify`] [`dingtalk`] [`discord`] [`feishu`] [`langbot`] [`lark`] [`llm`] [`n8n`] [`ollama`] [`openai`] [`plugins`] [`qq`] [`rag`] [`telegram`] [`wechat`]  
...
- [JoeanAmier/TikTokDownloader](https://github.com/JoeanAmier/TikTokDownloader) ★10640 [`abogus`] [`api`] [`csv`] [`docker`] [`douyin`] [`downloader`] [`ffmpeg`] [`httpx`] [`linux`] [`macos`] [`mstoken`] [`pyinstaller`] [`python`] [`rich`] [`server`] [`sqlite`] [`tiktok`] [`ttwid`] [`windows`] [`xlsx`]  
...
- [hunshcn/gh-proxy](https://github.com/hunshcn/gh-proxy) ★8100  
...
- [shidahuilang/shuyuan](https://github.com/shidahuilang/shuyuan) ★7817 [`aiyueshuxiang`] [`ipa`] [`iptv`] [`reader`] [`shuyuan`] [`trollstore`] [`tts`] [`xiangsegige`] [`yuanyuedu`] [`yuedu`]  
...
- [chyroc/WechatSogou](https://github.com/chyroc/WechatSogou) ★6087 [`crawler`] [`pypi`] [`python`] [`scrapy`] [`sogou`] [`wechat`]  
  这是一个用于爬取微信公众号文章和搜狗搜索结果的Python项目。它利用`requests`库进行网络请求，`BeautifulSoup`库进行HTML解析，并使用多线程提高爬取效率。项目提供灵活的配置选项，允许用户自定义爬取目标、页数和保存路径。  核心功能包括：指定公众号爬取文章、搜狗搜索结果爬取，并支持保存为Markdown格式。 项目主要使用Python语言开发，并依赖于`requests`, `BeautifulSoup4`, `threading`等库。
- [Python3WebSpider/ProxyPool](https://github.com/Python3WebSpider/ProxyPool) ★6019 [`flask`] [`http`] [`proxy`] [`proxypool`] [`redis`] [`webspider`]  
...
- [davidteather/TikTok-Api](https://github.com/davidteather/TikTok-Api) ★5518 [`api`] [`download-tiktoks`] [`hacktoberfest`] [`python`] [`tik`] [`tiktok`] [`tiktok-api`] [`tiktok-automation`] [`tiktok-compilations`] [`tiktok-downloader`] [`tiktok-python`] [`tiktok-scraper`] [`tiktok-signature`] [`tiktok-trending-page`] [`tiktokapi`] [`tok`] [`trending`]  
...
- [Baiyuetribe/kamiFaka](https://github.com/Baiyuetribe/kamiFaka) ★2148 [`faka`] [`flask`] [`heroku`] [`jwt-authentication`] [`mysql`] [`pwd`] [`smtp`] [`stisla`] [`ui-stisla`] [`vue3`] [`vuejs`]  
...
- [observerss/textfilter](https://github.com/observerss/textfilter) ★2080  
...
- [mofeng-git/One-KVM](https://github.com/mofeng-git/One-KVM) ★1490  
...
- [yanchunhuo/AutomationTest](https://github.com/yanchunhuo/AutomationTest) ★989 [`appium`] [`automated-testing`] [`autotesting`] [`dubbo`] [`selenium`]  
...
- [ZSAIm/iqiyi-parser](https://github.com/ZSAIm/iqiyi-parser) ★959  
  该项目是一个用于解析爱奇艺视频数据的Python脚本。它主要用于提取视频链接、标题、封面图片等信息。  脚本使用正则表达式和Beautiful Soup库解析HTML页面，并使用`requests`库进行HTTP请求。  输出结果为结构化的JSON格式，方便后续数据处理和分析。  该工具适用于需要从爱奇艺批量获取视频元数据的场景。
...
- [y9nhjy/Proxifier-Keygen](https://github.com/y9nhjy/Proxifier-Keygen) ★891  
...
- [LogicJake/WebMonitor](https://github.com/LogicJake/WebMonitor) ★876 [`monitor`] [`rss`] [`web-monitor`]  
...
- [iawia002/Lulu](https://github.com/iawia002/Lulu) ★812 [`crawler`] [`crawling`] [`downloader`] [`python`] [`python3`] [`scraper`] [`scraping`] [`video`]  
...
- [thedemons/opentele](https://github.com/thedemons/opentele) ★381 [`opentele`] [`python`] [`python3`] [`tdata`] [`tdesktop`] [`telegram`] [`telegram-api`] [`telegram-api-bot`] [`telegram-bot`] [`telegram-desktop`] [`telegram-userbot`] [`telegramapi`] [`telegrambot`] [`telethon`]  
...
- [jhao104/SSDBAdmin](https://github.com/jhao104/SSDBAdmin) ★352 [`flask`] [`gui`] [`ssdb`] [`ssdbadmin`] [`webgui`]  
  SSDBAdmin 是一个用于管理 SSDB 数据库的工具。它提供图形化界面，方便用户执行各种操作，例如创建、删除、修改数据库，以及查看数据等。该工具使用 Python 和 Tkinter 构建，并利用 SSDB 客户端库进行数据交互。  通过直观的界面，用户可以轻松地管理和维护 SSDB 数据库，提高工作效率。
...
- [expzhizhuo/WechatBot](https://github.com/expzhizhuo/WechatBot) ★232  
...
- [selfboot/html2Dash](https://github.com/selfboot/html2Dash) ★209  
  这是一个将HTML转换为Dash应用程序的工具。它允许用户将现有的HTML网页轻松转换为可交互的Dash应用，保留原网页的结构和样式。主要使用Python语言，基于Dash框架，通过解析HTML结构并将其转换为Dash组件实现。该工具简化了将静态网页转换为动态交互应用的过程，并支持自定义样式和功能扩展。
- [TianmuTNT/iptv](https://github.com/TianmuTNT/iptv) ★199 [`auto-update`] [`cctv`] [`iptv`] [`iptv-m3u`] [`iptv-txt`] [`python`]  
...
- [Gentlesprite/Telegram_Restricted_Media_Downloader](https://github.com/Gentlesprite/Telegram_Restricted_Media_Downloader) ★133 [`download`] [`linux`] [`pyrogram`] [`python`] [`restricted`] [`rich`] [`telegram`] [`tools`] [`windows`]  
...
- [geekgao/BankCards](https://github.com/geekgao/BankCards) ★81 [`creditcard`] [`python`]  
  这是一个用于生成银行卡号、CVV和有效期等信息的工具。它使用随机数生成器模拟银行卡信息，并根据不同类型的银行卡生成对应的格式。主要使用Python语言和随机数库，并包含了数据验证模块以确保生成的卡号符合一定的格式要求。该工具旨在用于测试和演示场景，不应用于任何实际的银行卡操作。
