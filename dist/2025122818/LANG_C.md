...
- [facebook/zstd](https://github.com/facebook/zstd) ★26297  
...
- [jarun/nnn](https://github.com/jarun/nnn) ★21007 [`android`] [`batch-rename`] [`c`] [`cli`] [`command-line`] [`developer-tools`] [`disk-usage`] [`file-manager`] [`file-preview`] [`file-search`] [`filesystem`] [`launcher`] [`multi-platform`] [`ncurses`] [`productivity`] [`raspberry-pi`] [`terminal`] [`tui`] [`vim`] [`wsl`]  
...
- [esnet/iperf](https://github.com/esnet/iperf) ★8141 [`iperf3`]  
...
- [akopytov/sysbench](https://github.com/akopytov/sysbench) ★6637 [`benchmark`] [`console`] [`freebsd`] [`linux`] [`lua`] [`luajit`] [`macos`] [`micro-benchmarks`] [`mysql`] [`oltp`] [`postgresql`] [`sysbench`]  
...
- [sabrogden/Ditto](https://github.com/sabrogden/Ditto) ★5654 [`clipboard`] [`clipboard-manager`]  
