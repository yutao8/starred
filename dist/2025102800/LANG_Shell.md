...
- [ohmyzsh/ohmyzsh](https://github.com/ohmyzsh/ohmyzsh) ★182308 [`cli`] [`cli-app`] [`oh-my-zsh`] [`oh-my-zsh-plugin`] [`oh-my-zsh-theme`] [`ohmyzsh`] [`plugin-framework`] [`plugins`] [`productivity`] [`shell`] [`terminal`] [`theme`] [`themes`] [`zsh`] [`zsh-configuration`]  
...
- [dockur/windows](https://github.com/dockur/windows) ★47986 [`docker`] [`docker-container`] [`virtualization`] [`windows`] [`windows-virtual-desktop`] [`windows-virtual-machine`] [`windows-virtual-machines`] [`windows-vm`]  
...
- [acmesh-official/acme.sh](https://github.com/acmesh-official/acme.sh) ★44343 [`acme`] [`acme-client`] [`acme-protocol`] [`ash`] [`bash`] [`buypass`] [`certbot`] [`letsencrypt`] [`posix`] [`posix-sh`] [`shell`] [`zerossl`]  
...
- [233boy/v2ray](https://github.com/233boy/v2ray) ★27215 [`shell-script`] [`v2ray`] [`vmess`]  
...
- [yuaotian/go-cursor-help](https://github.com/yuaotian/go-cursor-help) ★24899 [`cursor`] [`error`]  
...
- [lxgw/LxgwWenKai](https://github.com/lxgw/LxgwWenKai) ★21954 [`cjk`] [`font`] [`typeface`]  
...
- [mack-a/v2ray-agent](https://github.com/mack-a/v2ray-agent) ★17482 [`cloudflare`] [`grpc-cloudflare`] [`httpupgrade`] [`hysteria2`] [`nginx`] [`reality`] [`reality-grpc`] [`shell`] [`sing-box`] [`trojan`] [`trojan-grpc`] [`tuic-v5`] [`v2ray`] [`vless`] [`vmess`] [`websockettlscdn-cloudflare-ip`] [`xray`] [`xray-core`] [`xray-install`] [`xtls-rprx-vision`]  
...
- [unixorn/awesome-zsh-plugins](https://github.com/unixorn/awesome-zsh-plugins) ★16959 [`awesome`] [`awesome-list`] [`collection`] [`hacktoberfest`] [`list`] [`oh-my-zsh`] [`zgenom`] [`zsh-completions`] [`zsh-configuration`] [`zsh-framework`] [`zsh-plugin`] [`zsh-prompt`] [`zsh-theme`]  
...
- [hq450/fancyss](https://github.com/hq450/fancyss) ★13082 [`arm`] [`koolgame`] [`merlin`] [`naiveproxy`] [`shadowsocks`] [`shadowsocks-rust`] [`ss`] [`ssr`] [`trojan`] [`v2ray`] [`x64`] [`xray`]  
...
- [DaoCloud/public-image-mirror](https://github.com/DaoCloud/public-image-mirror) ★11961 [`mirror`] [`speedup`]  
...
- [YanG-1989/m3u](https://github.com/YanG-1989/m3u) ★10441  
...
- [angristan/wireguard-install](https://github.com/angristan/wireguard-install) ★10023 [`linux`] [`nat`] [`privacy`] [`vpn`] [`wireguard`]  
...
- [Gogh-Co/Gogh](https://github.com/Gogh-Co/Gogh) ★9924 [`bash`] [`color-scheme`] [`gnome-terminal`] [`iterm2`] [`linux`] [`mint`] [`pantheon-terminal`] [`shell`] [`terminal`]  
...
- [bin456789/reinstall](https://github.com/bin456789/reinstall) ★8374 [`alpine`] [`alpine-linux`] [`boot`] [`distro`] [`grub`] [`installer`] [`iso`] [`linux`] [`linux-distribution`] [`liveos`] [`netboot`] [`netinst`] [`netinstall`] [`operating-systems`] [`os`] [`reinstall`] [`shell-script`] [`vps`] [`windows`]  
...
- [spiritLHLS/ecs](https://github.com/spiritLHLS/ecs) ★5903 [`almalinux`] [`arch`] [`astralinux`] [`bench-script`] [`benchmark`] [`cdn`] [`centos`] [`checker`] [`debian`] [`fedora`] [`goecs`] [`ipv6`] [`lemonbench`] [`openai`] [`oracle-linux`] [`rockylinux`] [`speedtest`] [`sysbench`] [`ubuntu`] [`vps`]  
...
- [xubiaolin/docker-zerotier-planet](https://github.com/xubiaolin/docker-zerotier-planet) ★3655 [`dockerfile`] [`planet`] [`self-host-zerotier`] [`self-hosted`] [`zerotier`] [`zerotier-network`]  
...
- [eooce/Sing-box](https://github.com/eooce/Sing-box) ★3576 [`argo`] [`hysteria2`] [`oneclick`] [`reality`] [`serv00`] [`sing-box`] [`tuic`] [`tunnel`] [`vmess-ws-tls`]  
...
- [Aurora-Admin-Panel/deploy](https://github.com/Aurora-Admin-Panel/deploy) ★1919 [`admin-panel`] [`gost`] [`iptables`] [`port-forwarding`]  
