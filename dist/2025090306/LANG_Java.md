...
- [justauth/JustAuth](https://github.com/justauth/JustAuth) ★17165 [`googlelogin`] [`justauth`] [`oauth2`] [`qqlogin`] [`weixinlogin`]  
...
- [microg/GmsCore](https://github.com/microg/GmsCore) ★10798 [`android`] [`auth`] [`cloud-messaging`] [`firebase`] [`geolocation`] [`google`] [`google-cloud-messaging`] [`java`] [`kotlin`] [`kotlin-android`] [`maps`] [`microg`] [`mobile`] [`push-notifications`]  
...
- [FongMi/TV](https://github.com/FongMi/TV) ★6446 [`catvod`] [`danmaku`] [`leanback`] [`media3`] [`p2p`] [`thunder`] [`tvbus`]  
...
- [201206030/novel](https://github.com/201206030/novel) ★5435 [`book`] [`cms`] [`mybatis`] [`novel`] [`read`] [`springboot`]  
