...
- [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) ★120486 [`awesome-list`] [`free-for-developers`]  
...
- [vernesong/OpenClash](https://github.com/vernesong/OpenClash) ★25054 [`clash`] [`luci`] [`mihomo`] [`openclash`] [`openwrt`] [`shadowsocks`] [`snell`] [`v2ray`] [`vmess`]  
...
- [vbskycn/iptv](https://github.com/vbskycn/iptv) ★5879  
...
- [aoaostar/legado](https://github.com/aoaostar/legado) ★4908 [`legado`] [`legado3`]  
...
- [yutao8/starred](https://github.com/yutao8/starred) ★154 [`api`] [`crawler`] [`github`] [`gpt`] [`iptv`] [`php`] [`python`] [`script`] [`sdk`] [`shell`] [`spider`] [`star`]  
