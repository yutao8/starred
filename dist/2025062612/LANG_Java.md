...
- [Stirling-Tools/Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF) ★62609 [`docker`] [`java`] [`pdf`] [`pdf-converter`] [`pdf-editor`] [`pdf-manipulation`] [`pdf-merger`] [`pdf-ocr`] [`pdf-tools`] [`pdf-web-apps`] [`pdfmerger`]  
...
- [skylot/jadx](https://github.com/skylot/jadx) ★44441 [`android`] [`decompiler`] [`dex`] [`java`]  
...
- [termux/termux-app](https://github.com/termux/termux-app) ★42644 [`android`] [`hacktoberfest`] [`linux`] [`terminal`] [`termux`]  
...
- [halo-dev/halo](https://github.com/halo-dev/halo) ★35928 [`blog`] [`blog-engine`] [`cms`] [`content-management-system`] [`halo`] [`halocms`]  
...
- [DrKLO/Telegram](https://github.com/DrKLO/Telegram) ★26774 [`telegram`]  
...
- [android-hacker/VirtualXposed](https://github.com/android-hacker/VirtualXposed) ★15728 [`android`] [`aop`] [`hook`] [`non-root`] [`xposed`]  
...
- [theonedev/onedev](https://github.com/theonedev/onedev) ★14072 [`ci-cd`] [`devops`] [`git`] [`kanban`] [`packages`] [`self-hosted`]  
...
- [zfile-dev/zfile](https://github.com/zfile-dev/zfile) ★10228 [`clouddisk`] [`h2`] [`h5ai`] [`mysql`] [`spring-boot`] [`vue`]  
...
- [microg/GmsCore](https://github.com/microg/GmsCore) ★10157 [`android`] [`auth`] [`cloud-messaging`] [`firebase`] [`geolocation`] [`google`] [`google-cloud-messaging`] [`java`] [`kotlin`] [`kotlin-android`] [`maps`] [`microg`] [`mobile`] [`push-notifications`]  
...
- [crossoverJie/cim](https://github.com/crossoverJie/cim) ★9416 [`heartbeat`] [`im`] [`netty`] [`tcp`]  
...
- [jeecgboot/jimureport](https://github.com/jeecgboot/jimureport) ★7243 [`bi`] [`bigscreen`] [`birt`] [`data-analysis`] [`data-visualization`] [`dataease`] [`datav`] [`echart`] [`echarts`] [`finereport`] [`highcharts`] [`ireport`] [`jasperreport`] [`jfreechart`] [`metabase`] [`print`] [`redash`] [`report`] [`superset`] [`tableau`]  
...
- [FongMi/TV](https://github.com/FongMi/TV) ★6142 [`catvod`] [`danmaku`] [`leanback`] [`media3`] [`p2p`] [`thunder`] [`tvbus`]  
...
- [meefik/linuxdeploy](https://github.com/meefik/linuxdeploy) ★5534 [`android`] [`chroot`] [`containers`] [`deployment`] [`linux`]  
...
- [Fuzion24/JustTrustMe](https://github.com/Fuzion24/JustTrustMe) ★5065  
...
- [pqpo/SmartCropper](https://github.com/pqpo/SmartCropper) ★4070 [`detection`] [`hed-net`] [`image`] [`image-cropper`] [`opencv`] [`pytorch`] [`smartcropper`] [`tensorflow`]  
  Smart
- [syncthing/syncthing-android](https://github.com/syncthing/syncthing-android) ★3902 [`android`] [`java`] [`p2p`] [`peer-to-peer`] [`synchronization`]  
...
- [niumoo/bing-wallpaper](https://github.com/niumoo/bing-wallpaper) ★2447 [`bing`] [`bing-image`] [`bing-wallpaper`] [`wallpaper`]  
...
- [kaaass/ZerotierFix](https://github.com/kaaass/ZerotierFix) ★2038 [`android`] [`android-app`] [`zerotier`] [`zerotier-one`]  
...
- [qaiu/netdisk-fast-download](https://github.com/qaiu/netdisk-fast-download) ★1929 [`api`] [`download`] [`drive`] [`file-server`] [`ilanzou`] [`java`] [`lanzouyun`] [`onedrive`] [`pandownload`] [`parser`] [`share`] [`vertx`] [`webserver`]  
...
- [CYRUS-STUDIO/ApkToolPlus](https://github.com/CYRUS-STUDIO/ApkToolPlus) ★1336 [`apk-decompiler`] [`apk-protection`] [`apk-signature-protection`] [`apktool`]  
...
- [no1xuan/HivisionIDPhotos-wechat-weapp](https://github.com/no1xuan/HivisionIDPhotos-wechat-weapp) ★397  
