...
- [coturn/coturn](https://github.com/coturn/coturn) ★12887 [`networking`] [`server`] [`turn`]  
...
- [zerotier/ZeroTierOne](https://github.com/zerotier/ZeroTierOne) ★15823 [`decentralization`] [`networking`] [`peer-to-peer`] [`sd-wan`] [`sdn`] [`virtual-network`] [`vpn`]  
...
- [xfangfang/wiliwili](https://github.com/xfangfang/wiliwili) ★4439 [`bilibili`] [`mpv`] [`nanovg`] [`nintendo-switch`] [`nintendo-switch-homebrew`] [`opencc`] [`opengl`] [`ps4`] [`psv`] [`xbox`]  
...
- [qiin2333/Sunshine-Foundation](https://github.com/qiin2333/Sunshine-Foundation) ★2816 [`cloudgaming`] [`game-streaming`] [`moonlight`] [`remote-desktop`] [`stream`] [`sunshine`]  
...
- [microg/GmsCore](https://github.com/microg/GmsCore) ★10790 [`android`] [`auth`] [`cloud-messaging`] [`firebase`] [`geolocation`] [`google`] [`google-cloud-messaging`] [`java`] [`kotlin`] [`kotlin-android`] [`maps`] [`microg`] [`mobile`] [`push-notifications`]  
...
- [SuperMonster003/AutoJs6](https://github.com/SuperMonster003/AutoJs6) ★4528 [`android`] [`autojs`] [`autojs6`] [`automated-tool`] [`automation`] [`javascript`]  
...
- [ziadoz/awesome-php](https://github.com/ziadoz/awesome-php) ★31857 [`awesome`] [`awesome-lists`] [`php`] [`php-applications`] [`php-framework`] [`php-installation`] [`php-library`]  
...
- [XIU2/TrackersListCollection](https://github.com/XIU2/TrackersListCollection) ★29182 [`aria2`] [`aria2-format-tracker`] [`bittorrent`] [`bittorrent-trackers`] [`qbittorrent`] [`torrent`] [`torrent-tracker`] [`tracker`] [`trackers`] [`trackerslist`] [`utorrent`]  
...
- [AZeC4/TelegramGroup](https://github.com/AZeC4/TelegramGroup) ★18597 [`telegram`] [`telegram-api`] [`telegram-bot`] [`telegram-bot-api`] [`telegram-bots`] [`telegram-channel`] [`telegramgroups`]  
...
- [Johnshall/Shadowrocket-ADBlock-Rules-Forever](https://github.com/Johnshall/Shadowrocket-ADBlock-Rules-Forever) ★16802 [`adblock`] [`gfw`] [`proxy`] [`shadowrocket`] [`v2ray`]  
...
- [AUK9527/Are-u-ok](https://github.com/AUK9527/Are-u-ok) ★11762  
...
- [ripperhe/Bob](https://github.com/ripperhe/Bob) ★9414 [`bobapp`] [`chatgpt`] [`deepseek`] [`doubao`] [`ernie`] [`gemini`] [`groq`] [`hunyuan`] [`kimi`] [`macos`] [`ocr`] [`openai`] [`qwen`] [`translate`] [`translation`] [`translator`] [`zhipuai`]  
...
- [dongyubin/DockerHub](https://github.com/dongyubin/DockerHub) ★5482 [`cloudflare`] [`docker`] [`docker-image`] [`docker-registry`] [`dockerhub`] [`proxy`]  
...
- [suxuang/myIPTV](https://github.com/suxuang/myIPTV) ★3357  
...
- [sahibjotsaggu/San-Francisco-Pro-Fonts](https://github.com/sahibjotsaggu/San-Francisco-Pro-Fonts) ★1836 [`fonts`]  
...
- [FreshRSS/FreshRSS](https://github.com/FreshRSS/FreshRSS) ★12336 [`feed`] [`freshrss`] [`news-aggregator`] [`php`] [`rss`] [`rss-aggregator`] [`rss-reader`] [`self-hosted`] [`websub`]  
...
- [YOURLS/YOURLS](https://github.com/YOURLS/YOURLS) ★11516 [`bitly`] [`hacktoberfest`] [`php`] [`short-url`] [`shorten-urls`] [`shortener`] [`url-shortener`] [`url-shortner`] [`yourls`]  
...
- [z-song/laravel-admin](https://github.com/z-song/laravel-admin) ★11178 [`laravel-admin`] [`model-form`] [`model-grid`] [`model-show`] [`model-tree`]  
  Laravel
- [assimon/dujiaoka](https://github.com/assimon/dujiaoka) ★11016 [`dujiaofaka`] [`dujiaoka`] [`faka`]  
...
- [Hanson/vbot](https://github.com/Hanson/vbot) ★4310 [`php`] [`robot`] [`wechat`] [`weixin`]  
...
- [Bubka/2FAuth](https://github.com/Bubka/2FAuth) ★3338 [`2fa`] [`2factor`] [`hotp`] [`otp`] [`qrcode`] [`self-hosted`] [`totp`] [`two-factor`] [`two-factor-authentication`] [`webapp`]  
...
- [aazooo/zjmf](https://github.com/aazooo/zjmf) ★511  
...
- [rustdesk/rustdesk-server](https://github.com/rustdesk/rustdesk-server) ★8450 [`remote-access`] [`remote-control`] [`remote-desktop`] [`tauri`]  
...
- [nocodb/nocodb](https://github.com/nocodb/nocodb) ★56716 [`airtable`] [`airtable-alternative`] [`automatic-api`] [`hacktoberfest`] [`low-code`] [`no-code`] [`no-code-database`] [`no-code-platform`] [`postgresql`] [`rest-api`] [`restful-api`] [`spreadsheet`] [`sqlite`] [`swagger`]  
...
- [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) ★54027 [`ai`] [`ai-scraping`] [`crawler`] [`data`] [`html-to-markdown`] [`llm`] [`markdown`] [`rag`] [`scraper`] [`scraping`] [`web-crawler`] [`webscraping`]  
...
- [DIYgod/RSSHub](https://github.com/DIYgod/RSSHub) ★38549 [`bilibili`] [`douban`] [`dribbble`] [`instagram`] [`lofter`] [`pixiv`] [`rss`] [`rsshub`] [`spotify`] [`telegram`] [`tiktok`] [`twitter`] [`v2ex`] [`wechat`] [`weibo`] [`ximalaya`] [`youtube`] [`zhihu`]  
...
- [RSSNext/Folo](https://github.com/RSSNext/Folo) ★33305 [`ai`] [`blockchain`] [`reader`] [`rss`] [`rss-reader`]  
...
- [umami-software/umami](https://github.com/umami-software/umami) ★30511 [`analytics`] [`charts`] [`google-analytics`] [`statistics`] [`web-analytics`]  
...
- [blakeblackshear/frigate](https://github.com/blakeblackshear/frigate) ★25655 [`ai`] [`camera`] [`google-coral`] [`home-assistant`] [`home-automation`] [`homeautomation`] [`mqtt`] [`nvr`] [`object-detection`] [`realtime`] [`rtsp`] [`tensorflow`]  
...
- [fingerprintjs/fingerprintjs](https://github.com/fingerprintjs/fingerprintjs) ★25384 [`audio-fingerprinting`] [`browser`] [`browser-fingerprint`] [`browser-fingerprinting`] [`detection`] [`fingerprint`] [`fingerprinting`] [`fingerprintjs`] [`fraud`] [`fraud-detection`] [`identification`] [`javascript`] [`visitor-identifier`]  
...
- [GoogleChromeLabs/squoosh](https://github.com/GoogleChromeLabs/squoosh) ★23639  
...
- [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ★22321  
...
- [wechaty/wechaty](https://github.com/wechaty/wechaty) ★21880 [`bot`] [`chatbot`] [`conversational-ai`] [`framework`] [`qq`] [`robotics`] [`wechat`] [`wechaty`] [`whatsapp`]  
...
- [maotoumao/MusicFree](https://github.com/maotoumao/MusicFree) ★20079 [`free`] [`music-player`] [`musicfree`] [`plugin`] [`react`] [`react-native`] [`typescript`]  
...
- [louislam/dockge](https://github.com/louislam/dockge) ★19362 [`docker`] [`docker-compose`] [`docker-deployment`] [`docker-stack`] [`docker-stack-deploy`] [`docker-ui`] [`responsive`] [`self-hosted`] [`selfhosted`] [`single-page-app`] [`socket-io`] [`webapp`] [`websocket`]  
...
- [wangeditor-team/wangEditor](https://github.com/wangeditor-team/wangEditor) ★18083 [`rich-text`] [`rich-text-html-editor`] [`typescript`] [`wangeditor`] [`wysiwyg`] [`wysiwyg-editor`]  
...
- [musistudio/claude-code-router](https://github.com/musistudio/claude-code-router) ★16234  
...
- [getAsterisk/opcode](https://github.com/getAsterisk/opcode) ★15225 [`anthropic`] [`anthropic-claude`] [`claude`] [`claude-4`] [`claude-4-opus`] [`claude-4-sonnet`] [`claude-ai`] [`claude-code`] [`claude-code-sdk`] [`cursor`] [`ide`] [`llm`] [`llm-code`] [`rust`] [`tauri`]  
...
- [vercel/vercel](https://github.com/vercel/vercel) ★14016 [`cli`] [`cloud`] [`command`] [`hosting`] [`jamstack`] [`ship`] [`vercel`]  
...
- [dexie/Dexie.js](https://github.com/dexie/Dexie.js) ★13460 [`database`] [`indexeddb`] [`javascript`] [`offline`] [`offline-storage`] [`storage`]  
...
- [ourongxing/newsnow](https://github.com/ourongxing/newsnow) ★12795 [`elegant`] [`news`]  
...
- [dream-num/univer](https://github.com/dream-num/univer) ★10864 [`appscript`] [`collaboration`] [`data-table`] [`doc`] [`document`] [`excel`] [`grid`] [`live-share`] [`office`] [`powerpoint`] [`ppt`] [`productivity`] [`sdk`] [`sheet`] [`slide`] [`spreadsheet`] [`univer-mcp`] [`word`] [`xlsx`]  
  这是一个用于生成各种类型的数字序列的工具。它支持算术、几何、斐波那契、卢卡斯等多种序列类型，并允许用户自定义序列规则。该工具使用Python语言开发，基于NumPy库进行数值计算，并提供简洁的API接口，方便用户快速生成所需序列。
- [giscus/giscus](https://github.com/giscus/giscus) ★10400 [`blog`] [`comment-system`] [`comments`] [`comments-widget`] [`giscus`] [`github`] [`github-discussions`] [`hacktoberfest`] [`javascript`] [`nextjs`] [`react`] [`reactjs`] [`utterances`] [`widget`]  
...
- [jackyzha0/quartz](https://github.com/jackyzha0/quartz) ★9926 [`digital-garden`] [`networked-thought`] [`obsidian`] [`obsidian-md`] [`quartz-ssg`] [`static-site-generator`]  
...
- [ayangweb/BongoCat](https://github.com/ayangweb/BongoCat) ★9855 [`bongo-cat`] [`bongocat`] [`cross-platform`] [`desktop-app`] [`desktop-pet`] [`linux`] [`macos`] [`pet`] [`pet-project`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [AIsouler/GKD_subscription](https://github.com/AIsouler/GKD_subscription) ★7510 [`gkd`] [`gkd-subscription`] [`typescript`]  
...
- [EcoPasteHub/EcoPaste](https://github.com/EcoPasteHub/EcoPaste) ★6000 [`application`] [`clipboard`] [`clipboard-manager`] [`cross-platform`] [`desktop-app`] [`desktop-application`] [`linux`] [`macos`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [remotely-save/remotely-save](https://github.com/remotely-save/remotely-save) ★5981  
...
- [oleeskild/obsidian-digital-garden](https://github.com/oleeskild/obsidian-digital-garden) ★1862  
...
- [pt-plugins/PT-depiler](https://github.com/pt-plugins/PT-depiler) ★1309 [`private-tracker`]  
...
- [jason5ng32/MyIP](https://github.com/jason5ng32/MyIP) ★8941 [`awesome`] [`censorship`] [`chatgpt`] [`dns`] [`ip`] [`ipinfo`] [`leaks`] [`myip`] [`network`] [`pingchecker`] [`proxy`] [`security`] [`security-tools`] [`speedtest`] [`vercel`] [`webrtc`] [`whatismyip`] [`whatismyipaddress`] [`whois`] [`whois-lookup`]  
...
- [palxiao/poster-design](https://github.com/palxiao/poster-design) ★4473 [`canvas`] [`design`] [`image`] [`moveable`] [`nodejs`] [`poster`] [`puppeteer`] [`vue3`]  
...
- [hslr-s/sun-panel](https://github.com/hslr-s/sun-panel) ★4366 [`docker`] [`gin`] [`golang`] [`homelab`] [`homepage`] [`nas`] [`navigationpage`] [`raspberry-pi`] [`self-hosted`] [`startpage`] [`synology`] [`vue3`]  
...
- [wechat-article/wechat-article-exporter](https://github.com/wechat-article/wechat-article-exporter) ★4363 [`download`] [`wechat`] [`wechat-article`] [`wechat-download`]  
...
- [HuLaSpark/HuLa](https://github.com/HuLaSpark/HuLa) ★3630 [`chatbot`] [`macos`] [`rust`] [`tauri`] [`tsx`] [`vue3`] [`webview`] [`windows`] [`windows-10`] [`windows-11`]  
