...
- [open-ani/animeko](https://github.com/open-ani/animeko) ★14386 [`android`] [`ani`] [`anime`] [`bangumi`] [`bittorrent`] [`bt`] [`compose`] [`compose-multiplatform`] [`danmaku`] [`ios`] [`jetpack-compose`] [`kotlin`] [`kotlin-multiplatform`] [`linux`] [`macos`] [`player`] [`torrent`] [`video`] [`windows`]  
...
- [ankidroid/Anki-Android](https://github.com/ankidroid/Anki-Android) ★10560 [`android`] [`anki`] [`ankidroid`] [`education`] [`flashcards`] [`kotlin`] [`learning`] [`srs`]  
...
- [bitwarden/android](https://github.com/bitwarden/android) ★8283 [`android`] [`bitwarden`] [`compose`] [`jetpack`] [`kotlin`]  
...
- [osfans/trime](https://github.com/osfans/trime) ★3995 [`android`] [`chinese`] [`ime`] [`jni`] [`opencc`] [`rime`]  
...
- [aaa1115910/bv](https://github.com/aaa1115910/bv) ★3661  
  这是一个基于Python和Flask框架的简单博客系统。用户可以通过注册登录访问，创建、编辑和删除文章。系统使用MySQL数据库存储文章和用户信息，并提供基本的评论功能。项目旨在提供一个易于上手的博客平台，方便个人或组织分享内容。
- [NeoApplications/Neo-Backup](https://github.com/NeoApplications/Neo-Backup) ★3386 [`android`] [`backup-tool`] [`hacktoberfest`] [`kotlin`] [`root`]  
...
- [gallonyin/worktool](https://github.com/gallonyin/worktool) ★2952  
...
- [KDE/kdeconnect-android](https://github.com/KDE/kdeconnect-android) ★1263  
...
- [rcmiku/Payload-Dumper-Compose](https://github.com/rcmiku/Payload-Dumper-Compose) ★764  
