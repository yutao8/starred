...
- [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) ★116076 [`awesome-list`] [`free-for-developers`]  
...
- [vernesong/OpenClash](https://github.com/vernesong/OpenClash) ★22980 [`clash`] [`luci`] [`mihomo`] [`openclash`] [`openwrt`] [`shadowsocks`] [`snell`] [`v2ray`] [`vmess`]  
...
- [Lerist/FakeLocation](https://github.com/Lerist/FakeLocation) ★6672  
...
- [vbskycn/iptv](https://github.com/vbskycn/iptv) ★4989  
...
- [aoaostar/legado](https://github.com/aoaostar/legado) ★4337 [`legado`] [`legado3`]  
...
- [xinglie/report-designer](https://github.com/xinglie/report-designer) ★1203 [`cloud-print`] [`data-analysis`] [`data-visualization`] [`editor`] [`h5-creator`] [`h5-editor`] [`h5-maker`] [`iot-demo`] [`layouts-and-renderings`] [`online-design`] [`online-printing`] [`printer`] [`snapshot`] [`visiual-editor`] [`xinglie`]  
