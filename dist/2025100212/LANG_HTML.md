...
- [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) ★112939 [`awesome-list`] [`free-for-developers`]  
...
- [vernesong/OpenClash](https://github.com/vernesong/OpenClash) ★22042 [`clash`] [`luci`] [`mihomo`] [`openclash`] [`openwrt`] [`shadowsocks`] [`snell`] [`v2ray`] [`vmess`]  
...
- [xfirefly/Airplay-SDK](https://github.com/xfirefly/Airplay-SDK) ★3818 [`airplay`] [`airplay-receiver`] [`android`] [`dlna`] [`windows`]  
