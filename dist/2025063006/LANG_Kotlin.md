...
- [topjohnwu/Magisk](https://github.com/topjohnwu/Magisk) ★53982  
...
- [2dust/v2rayNG](https://github.com/2dust/v2rayNG) ★42142 [`android`] [`proxy`] [`shadowsocks`] [`socks5`] [`trojan`] [`v2fly`] [`v2ray`] [`vless`] [`vmess`] [`vpn`] [`xray`] [`xtls`]  
...
- [gkd-kit/gkd](https://github.com/gkd-kit/gkd) ★29172 [`accessibility`] [`android`] [`auto`] [`click`] [`compose`] [`jetpack-compose`] [`kotlin`] [`kotlin-js`] [`kotlin-multiplatform`] [`webassembly`]  
...
- [pppscn/SmsForwarder](https://github.com/pppscn/SmsForwarder) ★21661 [`android`] [`api`] [`app`] [`bark`] [`call`] [`chatgpt`] [`dingding`] [`forward`] [`mqtt`] [`pushdear`] [`pushplus`] [`serverchan`] [`sms`] [`smtp`] [`telegram`] [`webhook`] [`wechatapp`]  
...
- [RikkaApps/Shizuku](https://github.com/RikkaApps/Shizuku) ★15268  
...
- [tiann/KernelSU](https://github.com/tiann/KernelSU) ★12846 [`android`] [`kernel`] [`kernelsu`] [`root`] [`su`]  
...
- [bitwarden/android](https://github.com/bitwarden/android) ★7492 [`android`] [`bitwarden`] [`compose`] [`jetpack`] [`kotlin`]  
