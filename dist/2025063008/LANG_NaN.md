...
- [996icu/996.ICU](https://github.com/996icu/996.ICU) ★273291  
  这是一个关于中国程序员工作时间过长的匿名吐槽平台。用户可以通过该平台匿名分享工作经历，表达对996工作制的看法。该平台使用简单的网页前端技术，并使用数据库存储用户提交的信息。平台旨在为程序员提供一个表达诉求和互相支持的渠道，并促进对该问题的讨论。
- [awesome-selfhosted/awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ★234341 [`awesome`] [`awesome-list`] [`cloud`] [`free-software`] [`hosting`] [`privacy`] [`self-hosted`] [`selfhosted`]  
...
- [justjavac/free-programming-books-zh_CN](https://github.com/justjavac/free-programming-books-zh_CN) ★114462 [`android`] [`angular`] [`books`] [`free`] [`ios`] [`javascript`] [`kotlin`] [`pdf`] [`programming`] [`python`] [`react`] [`react-native`] [`swift`] [`vue`]  
  这是一个中文版的免费编程书籍列表项目。它收集了大量的免费编程书籍，并按语言、类别、难度等进行分类。用户可以通过搜索和筛选功能轻松找到所需资源。项目使用Python和Scrapy框架爬取书籍信息，并使用数据库存储和管理数据。  关键模块包括网页抓取、数据清洗、分类标签生成和网站展示。该项目旨在为学习编程的开发者提供便捷的资源查找途径。
...
- [ruanyf/weekly](https://github.com/ruanyf/weekly) ★69832  
...
- [justjavac/awesome-wechat-weapp](https://github.com/justjavac/awesome-wechat-weapp) ★47867 [`demo`] [`minapp`] [`miniprogram`] [`weapp-demo`] [`wechat`] [`wechat-weapp`] [`wepy`] [`wxapp`] [`wxml`]  
  这是一个微信小程序开发的优秀资源列表。它汇集了各种实用的工具、库、框架和示例，涵盖小程序开发的方方面面，例如组件库、UI框架、调试工具等。该列表由markdown格式的链接和描述组成，方便开发者快速找到所需资源，提高开发效率。
- [ziishaned/learn-regex](https://github.com/ziishaned/learn-regex) ★46031 [`learn-regex`] [`regex`] [`regular-expression`]  
  这是一个用于学习正则表达式的交互式网页应用。用户可以通过输入文本和正则表达式，实时查看匹配结果。项目使用 JavaScript 和 HTML/CSS 构建，并利用正则表达式引擎进行匹配。它提供逐步匹配演示，方便用户理解正则表达式的工作原理。  用户友好界面，涵盖各种正则表达式语法，适合初学者和进阶用户。
...
- [ziadoz/awesome-php](https://github.com/ziadoz/awesome-php) ★31693 [`awesome`] [`awesome-lists`] [`php`] [`php-applications`] [`php-framework`] [`php-installation`] [`php-library`]  
  这是一个PHP资源列表，涵盖了各种主题，例如框架、库、工具、教程和最佳实践等。该列表使用纯文本格式，方便浏览和搜索。项目主要由GitHub仓库中的README文件构成，以链接形式组织不同资源，并对每个资源进行简要描述。
- [Binaryify/NeteaseCloudMusicApi](https://github.com/Binaryify/NeteaseCloudMusicApi) ★30322 [`api`] [`apis`] [`cloudmusic`] [`javascript`] [`neteasecloud`] [`nodejs`]  
  这是一个Python项目，用于访问网易云音乐API。它提供了一个简洁易用的接口，方便开发者获取音乐信息、用户数据等。项目使用Python语言和requests库进行网络请求，并使用字典结构存储和访问数据。  核心功能包括获取歌曲信息、用户歌单、评论等，支持多种API调用。  代码结构清晰，易于理解和维护。
...
- [geekcompany/ResumeSample](https://github.com/geekcompany/ResumeSample) ★27723  
  这是一个简历模板项目，提供多种风格的简历示例，方便用户快速创建专业、吸引眼球的简历。使用HTML、CSS和JavaScript构建，包含可定制的布局和样式，支持多种设备响应。项目包含不同行业、不同经验水平的简历模板，并提供可编辑的示例代码，方便用户修改和调整。
...
- [gfwlist/gfwlist](https://github.com/gfwlist/gfwlist) ★24222 [`anticensorship`] [`censorship`] [`censorship-circumvention`] [`china`] [`gfw`]  
  这是一个用于屏蔽中国大陆网络审查的工具，包含一个不断更新的域名和IP地址列表。该列表可用于各种代理软件或浏览器插件，以阻止访问受限制的网站和服务。项目使用纯文本格式维护列表，并提供脚本和工具方便用户更新和使用。
- [judasn/IntelliJ-IDEA-Tutorial](https://github.com/judasn/IntelliJ-IDEA-Tutorial) ★22076 [`android-studio`] [`clion`] [`datagrip`] [`gogland`] [`intellij`] [`intellij-idea`] [`java`] [`jetbrains`] [`phpstorm`] [`pycharm`] [`rubymine`] [`tutorial`] [`webstorm`]  
  这是一个用于IntelliJ IDEA的教程项目。它提供了一系列逐步的教程，涵盖了IntelliJ IDEA的各种功能，例如创建项目、配置运行环境、使用各种插件和工具等。教程以清晰的步骤和示例代码为主，帮助用户快速上手IntelliJ IDEA。项目使用Markdown编写教程内容，并包含示例代码，方便用户学习和实践。
- [yanue/V2rayU](https://github.com/yanue/V2rayU) ★19422 [`mac-v2ray`] [`v2ray`] [`v2ray-core`] [`v2ray-gui`] [`v2ray-mac`] [`v2ray-shadowsocks`] [`v2rayu`] [`vmess`]  
  V2RayU 是一个基于 V2Ray 的轻量级客户端，提供便捷的代理配置和连接管理。它使用 Go 语言开发，并基于 GUI 框架构建，提供直观的图形化界面，方便用户快速设置和管理 V2Ray 连接。  该项目支持多种协议和配置选项，允许用户根据需求自定义连接参数。  核心功能包括连接管理、日志记录和配置导入导出等。
- [zijie0/HumanSystemOptimization](https://github.com/zijie0/HumanSystemOptimization) ★18971  
...
- [sindresorhus/quick-look-plugins](https://github.com/sindresorhus/quick-look-plugins) ★18314  
  该项目提供快速预览插件，用于为macOS上的Quick Look功能添加自定义预览。用户可以创建自定义插件，扩展Quick Look以支持新的文件类型或格式。插件使用JavaScript编写，并利用Node.js和Quick Look API。插件通过预定义的API接口与系统交互，从而实现对不同文件类型的预览。
...
- [hzlzh/Best-App](https://github.com/hzlzh/Best-App) ★17434 [`app`] [`mac`] [`macos`]  
  这是一个用于快速构建Android应用的模板项目。它包含了常用的组件，例如登录、注册、用户管理等，并使用Kotlin语言和Jetpack Compose框架构建。项目旨在提供一个高效的开发起点，帮助开发者快速搭建应用原型和功能模块。  通过预设的架构和组件，开发者可以专注于业务逻辑的实现，提高开发效率。
- [xiaye13579/BBLL](https://github.com/xiaye13579/BBLL) ★16411 [`android`] [`apk`] [`bilibili`] [`bilibili-client`] [`bilibili-tv`] [`tv`]  
...
- [521xueweihan/git-tips](https://github.com/521xueweihan/git-tips) ★15757 [`cheatsheet`] [`git`] [`github`]  
  这是一个Git实用技巧合集，涵盖了常用的Git命令、分支管理策略、代码冲突解决以及版本控制最佳实践。项目使用Markdown编写，清晰地展示了各种技巧的步骤和示例代码，并提供了一些实际场景下的应用案例。通过学习这些技巧，开发者可以更高效地使用Git进行版本控制，提升开发效率。
- [sparanoid/chinese-copywriting-guidelines](https://github.com/sparanoid/chinese-copywriting-guidelines) ★14826 [`chinese`] [`chinese-simplified`] [`chinese-traditional`] [`copywriting`] [`css`] [`documentation`] [`guideline`] [`leancloud`] [`markdown`]  
  这是一个中文文案创作指南，涵盖了标题、描述、产品文案、广告文案等多个方面。指南以易于理解的语言和实际案例，指导用户提升文案质量。该项目使用 Markdown 格式，包含清晰的目录结构，便于用户查找和学习。
...
- [zenorocha/alfred-workflows](https://github.com/zenorocha/alfred-workflows) ★12310  
  该项目提供Alfred工作流，用于简化macOS上的各种任务。它包含多个预构建工作流，例如文件管理、网络工具、代码片段生成和系统工具调用。工作流使用Alfred内置的脚本语言和API，并通过自动化任务提高用户效率。  项目使用JavaScript和Python等语言，并结合Alfred的工作流引擎实现功能。
- [mzlogin/awesome-adb](https://github.com/mzlogin/awesome-adb) ★11769 [`android`] [`android-adb`] [`android-debug-bridge`]  
  这是一个收集了各种Android Debug Bridge (ADB) 工具和资源的列表。涵盖了ADB 的常用命令、高级技巧、以及各种辅助工具和脚本。项目使用纯文本格式维护，方便查找和使用。  主要内容包括 ADB 命令详解、自动化脚本示例、以及与不同 Android 版本相关的兼容性信息。
...
- [paperwork/paperwork](https://github.com/paperwork/paperwork) ★7826  
  这是一个用于创建和管理个人和团队任务的Web应用程序。它使用React.js构建，并利用Redux进行状态管理。用户可以创建任务、设置截止日期、分配给团队成员、添加备注和标记任务状态。该应用提供清晰的界面，方便用户跟踪任务进度和完成情况，并支持用户自定义任务模板和权限控制。
- [shadowsocksrr/shadowsocksr-android](https://github.com/shadowsocksrr/shadowsocksr-android) ★7681  
  这是一个Android平台的ShadowsocksR客户端，允许用户通过ShadowsocksR协议连接VPN服务器，实现网络访问代理。该应用使用Java语言开发，并基于Android平台的网络库进行连接和传输，支持自定义配置，包括服务器地址、端口、加密算法等。用户可以通过该应用轻松地配置和管理ShadowsocksR连接，以访问受限的网络资源。
...
- [qingshuisiyuan/electron-ssr-backup](https://github.com/qingshuisiyuan/electron-ssr-backup) ★5844 [`electron-ssr`] [`linux-ssr`] [`shadowsocksr`] [`ssr`]  
  这是一个使用Electron构建的SSR备份工具。它允许用户通过图形界面选择要备份的服务器，并配置备份策略（例如定时备份、增量备份）。该工具使用Node.js和Express.js作为后端，并利用`node-fetch`库进行网络请求，实现与服务器的交互。Electron提供了跨平台的桌面应用体验，方便用户使用。核心功能包括：服务器连接管理、备份任务调度、备份文件管理和日志记录。
...
- [justinwalsh/daux.io](https://github.com/justinwalsh/daux.io) ★4523  
  daux.io是一个用于构建和部署数据驱动的Web应用程序的框架。它使用Python和Flask构建，并提供了一个易于使用的API来管理数据、用户和应用程序逻辑。核心功能包括用户认证、数据存储和API构建，旨在简化数据密集型Web应用的开发流程。该框架使用了SQLAlchemy进行数据库交互，并支持多种数据存储格式，例如JSON和CSV。
- [qwerty472123/wxappUnpacker](https://github.com/qwerty472123/wxappUnpacker) ★4523  
  该项目是一个微信小程序反编译工具，用于提取小程序代码和资源文件。它使用逆向工程技术，通过分析小程序代码包，提取出 JavaScript 代码、WXML 模板和 WXSS 样式表等资源。项目主要使用 Python 语言和一些辅助库，例如 `wxapp-unpacking` 模块，并结合正则表达式和字符串匹配算法完成代码提取和资源分离。该工具旨在帮助开发者分析和理解微信小程序的代码结构，并可用于小程序二次开发或代码审计等用途。
...
- [shadowsocksr-backup/shadowsocksr-android](https://github.com/shadowsocksr-backup/shadowsocksr-android) ★3463  
  这是一个Android平台的ShadowsocksR客户端备份工具。它允许用户备份和恢复ShadowsocksR客户端的配置，包括服务器地址、端口、用户名和密码等信息。该工具使用Kotlin语言开发，并基于Android Studio框架。核心功能包括：配置备份、配置恢复、配置导入和导出，以及本地配置管理。  通过简单的界面操作，用户可以轻松地管理和备份ShadowsocksR的VPN连接配置，方便在不同设备间迁移或恢复配置。
...
- [Jermic/Android-Crack-Tool](https://github.com/Jermic/Android-Crack-Tool) ★2944 [`android`] [`android-crack`] [`apk`] [`apktool`] [`axml`] [`crack`] [`decompile`] [`dex`] [`mac`] [`osx`] [`smali`]  
  该项目是一个Android平台的破解工具，旨在绕过应用的保护机制。它利用逆向工程技术分析应用的代码和资源，并通过修改或注入代码来实现功能破解。主要使用Java语言和Android SDK开发，并结合了反编译工具和动态分析技术。该工具的目标是为开发者提供一种分析和修改Android应用的方法，但请谨慎使用，并遵守相关法律法规。  请勿用于非法用途。
...
- [PizzaLiu/PHP-FIG](https://github.com/PizzaLiu/PHP-FIG) ★1411  
  这是一个PHP框架，用于简化和标准化PHP项目的构建。它提供了一套通用的组件，例如依赖注入、日志记录和配置管理。该框架使用PHP语言编写，并基于PSR标准。核心功能包括自动加载、依赖注入容器和配置管理，旨在提高代码的可维护性和可测试性。
...
- [Damao/Intellij-IDEA-F2E](https://github.com/Damao/Intellij-IDEA-F2E) ★1368  
  该项目为IntelliJ IDEA提供前端开发辅助功能，基于插件机制。它简化了前端开发流程，提供代码格式化、代码提示、单元测试等功能。项目使用Java语言和IntelliJ IDEA插件开发框架实现，核心模块包括代码分析、代码生成和调试支持。插件可有效提高前端开发效率，并支持常见的前端框架。
...
- [tvvocold/free-for-dev-zh](https://github.com/tvvocold/free-for-dev-zh) ★1240  
  这是一个中文版的开源免费软件资源列表。它涵盖了各种软件类别，包括开发工具、设计工具、办公软件等，方便开发者和学生获取免费软件。项目使用Python和Beautiful Soup库爬取数据，并以Markdown格式组织，最终生成HTML页面。该项目旨在为用户提供一个便捷的免费软件搜索平台，节省用户查找时间。
...
- [yuanxin69/m3u](https://github.com/yuanxin69/m3u) ★597  
  这是一个用于生成和管理M3U播放列表的工具。它支持从各种来源（如URL、本地文件）导入视频，并根据配置生成包含指定视频的M3U播放列表。用户可以通过命令行界面轻松操作，指定视频路径、输出文件名等参数。该工具使用Python编写，利用`argparse`模块进行命令行参数解析，并使用`os`模块进行文件操作。
...
- [SnoW-Wei/Dash-dcsets-CN](https://github.com/SnoW-Wei/Dash-dcsets-CN) ★361  
  这是一个用于生成Dash应用的中国大陆地区数据集的工具。它利用Python和Pandas库，从多个数据源（如国家统计局、Wind等）爬取并整合数据，并将其转换为Dash可视化应用所需的格式。该工具简化了数据准备和可视化流程，方便用户快速构建基于Dash的中国大陆地区数据分析应用。核心功能包括数据爬取、清洗、转换和Dash应用生成。
...
- [nauxliu/Dash-docsets-CN](https://github.com/nauxliu/Dash-docsets-CN) ★295 [`dash`] [`docset`] [`docset-cn`]  
  该项目提供一份中文版的Dash文档集，方便用户快速查阅和学习Dash框架。它收集了Dash官方文档和常用扩展库的中文翻译和解释，涵盖了Dash的基本组件、交互式图表、数据可视化等关键功能。项目使用Python和Dash库进行开发，并通过Markdown文档和示例代码结合的方式呈现，便于理解和实践。  该文档集旨在帮助开发者更轻松地上手Dash框架，提高开发效率。
...
- [VeniZ/ShadowsocksX-NG-R8-Bakup](https://github.com/VeniZ/ShadowsocksX-NG-R8-Bakup) ★136  
  这是一个 ShadowsocksX-NG-R8 的备份项目，提供该软件的离线安装包。  它使用 Go 语言构建，主要包含软件的编译产物和配置文件模板，方便用户在无法访问网络或需要离线安装时使用。  该项目旨在提供 ShadowsocksX-NG-R8 的离线安装包，以确保用户能够在需要时快速部署和使用该软件。
...
- [zogodo/typora-0.11.18](https://github.com/zogodo/typora-0.11.18) ★37  
  Typora 是一个功能强大的 Markdown 编辑器，此项目为 Typora 的 0.11.18 版本。该版本包含了 Typora 的核心功能，例如 Markdown 编辑、预览、导出等。它使用原生 C++ 编写，并结合了 Qt 框架，以提供跨平台的图形用户界面。该版本专注于稳定性和可靠性改进，并修复了已知的 bug。
...
- [CaledoniaProject/php-decoder](https://github.com/CaledoniaProject/php-decoder) ★28  
  这是一个PHP代码解码器项目，旨在将加密或混淆的PHP代码还原为可读的原始代码。它使用正则表达式匹配和替换技术，识别并还原常见的混淆技巧，如字符串替换、变量重命名和函数调用修改等。项目主要使用PHP语言开发，并包含一个核心解码模块，以及针对不同混淆策略的规则集。该项目能够有效地帮助开发者理解和调试经过混淆的PHP代码，提高代码可维护性和安全性。
