...
- [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) ★63171 [`ai`] [`ai-agents`] [`ai-crawler`] [`ai-scraping`] [`ai-search`] [`crawler`] [`data-extraction`] [`html-to-markdown`] [`llm`] [`markdown`] [`scraper`] [`scraping`] [`web-crawler`] [`web-data`] [`web-data-extraction`] [`web-scraper`] [`web-scraping`] [`web-search`] [`webscraping`]  
...
- [nocodb/nocodb](https://github.com/nocodb/nocodb) ★58213 [`airtable`] [`airtable-alternative`] [`automatic-api`] [`hacktoberfest`] [`low-code`] [`no-code`] [`no-code-database`] [`no-code-platform`] [`postgresql`] [`rest-api`] [`restful-api`] [`spreadsheet`] [`sqlite`] [`swagger`]  
...
- [lyswhut/lx-music-desktop](https://github.com/lyswhut/lx-music-desktop) ★46667 [`electron`] [`javascript`] [`music-player`] [`vue`]  
...
- [slab/quill](https://github.com/slab/quill) ★46287 [`editor`] [`quill`] [`rich-text-editor`] [`wysiwyg`]  
...
- [RocketChat/Rocket.Chat](https://github.com/RocketChat/Rocket.Chat) ★43633 [`chat`] [`collaboration`] [`foss`] [`free`] [`hacktoberfest`] [`javascript`] [`meteor`] [`mit`] [`real-time`] [`slack`] [`webrtc`]  
...
- [DIYgod/RSSHub](https://github.com/DIYgod/RSSHub) ★39304 [`bilibili`] [`douban`] [`dribbble`] [`instagram`] [`lofter`] [`pixiv`] [`rss`] [`rsshub`] [`spotify`] [`telegram`] [`tiktok`] [`twitter`] [`v2ex`] [`wechat`] [`weibo`] [`ximalaya`] [`youtube`] [`zhihu`]  
...
- [RSSNext/Folo](https://github.com/RSSNext/Folo) ★35041 [`ai`] [`blockchain`] [`reader`] [`rss`] [`rss-reader`]  
...
- [niklasvh/html2canvas](https://github.com/niklasvh/html2canvas) ★31593 [`dom`] [`javascript`] [`screenshot`]  
...
- [umami-software/umami](https://github.com/umami-software/umami) ★31115 [`analytics`] [`charts`] [`google-analytics`] [`statistics`] [`web-analytics`]  
...
- [blakeblackshear/frigate](https://github.com/blakeblackshear/frigate) ★26412 [`ai`] [`camera`] [`google-coral`] [`home-assistant`] [`home-automation`] [`homeautomation`] [`mqtt`] [`nvr`] [`object-detection`] [`realtime`] [`rtsp`] [`tensorflow`]  
...
- [oldj/SwitchHosts](https://github.com/oldj/SwitchHosts) ★25762 [`electron`] [`hosts`] [`hostseditor`] [`hostsfile`] [`switch-hosts`] [`switchhosts`]  
...
- [fingerprintjs/fingerprintjs](https://github.com/fingerprintjs/fingerprintjs) ★25658 [`audio-fingerprinting`] [`browser`] [`browser-fingerprint`] [`browser-fingerprinting`] [`detection`] [`fingerprint`] [`fingerprinting`] [`fingerprintjs`] [`fraud`] [`fraud-detection`] [`identification`] [`javascript`] [`visitor-identifier`]  
...
- [GoogleChromeLabs/squoosh](https://github.com/GoogleChromeLabs/squoosh) ★23886  
...
- [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ★22884  
...
- [wechaty/wechaty](https://github.com/wechaty/wechaty) ★22022 [`bot`] [`chatbot`] [`conversational-ai`] [`framework`] [`qq`] [`robotics`] [`wechat`] [`wechaty`] [`whatsapp`]  
...
- [maotoumao/MusicFree](https://github.com/maotoumao/MusicFree) ★20866 [`free`] [`music-player`] [`musicfree`] [`plugin`] [`react`] [`react-native`] [`typescript`]  
...
- [louislam/dockge](https://github.com/louislam/dockge) ★19872 [`docker`] [`docker-compose`] [`docker-deployment`] [`docker-stack`] [`docker-stack-deploy`] [`docker-ui`] [`responsive`] [`self-hosted`] [`selfhosted`] [`single-page-app`] [`socket-io`] [`webapp`] [`websocket`]  
...
- [musistudio/claude-code-router](https://github.com/musistudio/claude-code-router) ★19578  
...
- [baidu/amis](https://github.com/baidu/amis) ★18602 [`admin`] [`frontend`] [`frontend-framework`] [`json`] [`low-code`] [`low-code-development-platform`] [`lowcode`] [`no-code`]  
...
- [winfunc/opcode](https://github.com/winfunc/opcode) ★18231 [`anthropic`] [`anthropic-claude`] [`claude`] [`claude-4`] [`claude-4-opus`] [`claude-4-sonnet`] [`claude-ai`] [`claude-code`] [`claude-code-sdk`] [`cursor`] [`ide`] [`llm`] [`llm-code`] [`rust`] [`tauri`]  
...
- [ag-grid/ag-grid](https://github.com/ag-grid/ag-grid) ★14587 [`angular`] [`angular-grid`] [`angular-table`] [`charting`] [`datagrid`] [`datatable`] [`excel`] [`filtering`] [`grid`] [`grouping`] [`javascript-table`] [`pagination`] [`pivoting`] [`react`] [`react-grid`] [`react-table`] [`sorting`] [`table`] [`vue-table`] [`vuejs`]  
...
- [vercel/vercel](https://github.com/vercel/vercel) ★14197 [`cli`] [`cloud`] [`command`] [`hosting`] [`jamstack`] [`ship`] [`vercel`]  
...
- [ikatyang/emoji-cheat-sheet](https://github.com/ikatyang/emoji-cheat-sheet) ★13398 [`cheat-sheet`] [`emoji`] [`github`] [`markdown`]  
...
- [ourongxing/newsnow](https://github.com/ourongxing/newsnow) ★13295 [`elegant`] [`news`]  
...
- [taye/interact.js](https://github.com/taye/interact.js) ★12811 [`drag-and-drop`] [`drop`] [`inertia`] [`javascript`] [`javascript-drag`] [`mobile`] [`modern-browsers`] [`multi-touch`] [`snap`] [`touch`] [`typescript`] [`vanilla`]  
...
- [plait-board/drawnix](https://github.com/plait-board/drawnix) ★12001 [`collaboration`] [`drawing`] [`flowchart`] [`localfirst`] [`mindmap`] [`productivity`] [`whiteboard`]  
...
- [dream-num/univer](https://github.com/dream-num/univer) ★11317 [`ai-excel`] [`ai-sheet`] [`ai-spreadsheet`] [`appscript`] [`collaboration`] [`data-table`] [`doc`] [`excel`] [`excel-mcp`] [`grid`] [`live-share`] [`ppt`] [`sdk`] [`sheet`] [`sheet-mcp`] [`spreadsheet`] [`spreadsheet-mcp`] [`univer-mcp`] [`word`] [`xlsx`]  
  这是一个用于生成各种类型的数字序列的工具。它支持算术、几何、斐波那契、卢卡斯等多种序列类型，并允许用户自定义序列规则。该工具使用Python语言开发，基于NumPy库进行数值计算，并提供简洁的API接口，方便用户快速生成所需序列。
- [ayangweb/BongoCat](https://github.com/ayangweb/BongoCat) ★11119 [`bongo-cat`] [`bongocat`] [`cross-platform`] [`desktop-app`] [`desktop-pet`] [`linux`] [`macos`] [`pet`] [`pet-project`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [giscus/giscus](https://github.com/giscus/giscus) ★10640 [`blog`] [`comment-system`] [`comments`] [`comments-widget`] [`giscus`] [`github`] [`github-discussions`] [`hacktoberfest`] [`javascript`] [`nextjs`] [`react`] [`reactjs`] [`utterances`] [`widget`]  
...
- [gridstack/gridstack.js](https://github.com/gridstack/gridstack.js) ★8425 [`angular`] [`dashboard`] [`grid`] [`gridster`] [`javascript`] [`react`] [`typescript`] [`vue`] [`widget`]  
...
- [AIsouler/GKD_subscription](https://github.com/AIsouler/GKD_subscription) ★8165 [`gkd`] [`gkd-subscription`] [`typescript`]  
...
- [yinxin630/fiora](https://github.com/yinxin630/fiora) ★7054 [`chat`] [`chatroom`] [`fiora`] [`mongodb`] [`react`] [`socket`]  
...
- [galaxy-s10/billd-desk](https://github.com/galaxy-s10/billd-desk) ★4471 [`coturn`] [`electron`] [`flutter`] [`nodejs`] [`parsec`] [`remote-desktop`] [`rustdesk`] [`socket-io`] [`todesk`] [`typescript`] [`vue3`] [`webrtc`]  
...
- [xpf0000/FlyEnv](https://github.com/xpf0000/FlyEnv) ★2107 [`development-environment`] [`electron`] [`laravel`] [`laravel-herd`] [`local-dns-server`] [`local-web-server`] [`mamp`] [`mamp-pro`] [`php`] [`php-environment`] [`php-obfuscator`] [`phpstudy`] [`web-ide`] [`wordpress`] [`xampp`]  
...
- [baiy/Ctool](https://github.com/baiy/Ctool) ★1902 [`chrome-extension`] [`crx`] [`developer-tools`] [`development`] [`electron-app`] [`firefox-extension`] [`qrcode`]  
...
- [pt-plugins/PT-depiler](https://github.com/pt-plugins/PT-depiler) ★1587 [`private-tracker`]  
