...
- [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) ★155124 [`activator`] [`hwid`] [`kms`] [`kms38`] [`massgrave`] [`massgravel`] [`microsoft`] [`microsoft365`] [`office`] [`office365`] [`ohook`] [`powershell`] [`tsforge`] [`windows`] [`windows-10`] [`windows-11`]  
...
- [Atlas-OS/Atlas](https://github.com/Atlas-OS/Atlas) ★18439 [`ame-wizard`] [`atlas`] [`atlasos`] [`debloat`] [`fps`] [`gaming`] [`latency`] [`open-source`] [`opensource`] [`performance`] [`privacy`] [`security`] [`tweaks`] [`windows`]  
...
- [FongMi/Release](https://github.com/FongMi/Release) ★4991  
...
- [Genymobile/scrcpy](https://github.com/Genymobile/scrcpy) ★130750 [`android`] [`c`] [`ffmpeg`] [`libav`] [`mirroring`] [`recording`] [`screen`] [`sdl2`]  
...
- [ventoy/Ventoy](https://github.com/ventoy/Ventoy) ★72187 [`auto-install`] [`bootable-usb`] [`bsd`] [`chromeos`] [`iso-files`] [`legacy`] [`linux`] [`multiboot`] [`persistence`] [`secure-boot`] [`uefi`] [`unattended`] [`unix`] [`usb`] [`windows`]  
...
- [coolsnowwolf/lede](https://github.com/coolsnowwolf/lede) ★31067 [`lede`] [`lua`] [`openwrt-feed`] [`openwrt-package`] [`openwrt-zh-cn`]  
...
- [valinet/ExplorerPatcher](https://github.com/valinet/ExplorerPatcher) ★29905  
...
- [openssl/openssl](https://github.com/openssl/openssl) ★28959 [`cryptography`] [`decryption`] [`encryption`] [`openssl`] [`ssl`] [`tls`]  
...
- [kingToolbox/WindTerm](https://github.com/kingToolbox/WindTerm) ★28573 [`bash`] [`client`] [`cmd`] [`linux`] [`mac`] [`powershell`] [`serial`] [`sftp`] [`shell`] [`ssh`] [`telnet`] [`terminal`] [`tmux`] [`windows`] [`wsl`] [`x11`] [`xmodem`] [`xterm`] [`ymodem`] [`zmodem`]  
...
- [gojue/ecapture](https://github.com/gojue/ecapture) ★14750 [`android`] [`android-https-capture`] [`ebpf`] [`ebpf-go`] [`ebpf-tc`] [`ebpf-uprobe`] [`golang`] [`https`] [`linux`] [`network-capture`] [`security-audit`] [`ssl`] [`ssldump`] [`tcpdump`] [`tls`]  
...
- [SoftEtherVPN/SoftEtherVPN](https://github.com/SoftEtherVPN/SoftEtherVPN) ★12715 [`etherip`] [`ike`] [`ipsec`] [`l2tp`] [`l2tpv3`] [`openvpn`] [`softether-vpn`] [`softethervpn`] [`ssl-vpn`] [`sstp`] [`tls`] [`vpn`] [`vpn-protocols`] [`vpn-server`] [`vpn-tunnel`] [`wfh`] [`wireguard`] [`work-from-home`]  
...
- [vanhauser-thc/thc-hydra](https://github.com/vanhauser-thc/thc-hydra) ★11119 [`brute-force`] [`brute-force-attacks`] [`brute-force-passwords`] [`bruteforce`] [`bruteforce-attacks`] [`bruteforcer`] [`bruteforcing`] [`hydra`] [`network-security`] [`password-cracker`] [`password-cracking`] [`penetration-testing`] [`pentest`] [`pentest-tool`] [`pentesting`] [`thc`]  
...
- [rofl0r/proxychains-ng](https://github.com/rofl0r/proxychains-ng) ★10338 [`hack`] [`hook`] [`http`] [`preload`] [`proxy`] [`proxychains`] [`socks`]  
...
- [pymumu/smartdns](https://github.com/pymumu/smartdns) ★10123 [`c`] [`dns`] [`dns-over-https`] [`dns-over-tls`] [`dns-server`] [`dns64`] [`doh`] [`doh3`] [`doq`] [`dot`] [`nftables`] [`nftables-sets`] [`openwrt`] [`openwrt-package`] [`smartdns`] [`stubby`]  
...
- [istoreos/istoreos](https://github.com/istoreos/istoreos) ★6854 [`istore`] [`istoreos`] [`koolcenter`] [`linkease`] [`nas`] [`openwrt`] [`router`]  
...
- [akopytov/sysbench](https://github.com/akopytov/sysbench) ★6549 [`benchmark`] [`console`] [`freebsd`] [`linux`] [`lua`] [`luajit`] [`macos`] [`micro-benchmarks`] [`mysql`] [`oltp`] [`postgresql`] [`sysbench`]  
...
- [tinyproxy/tinyproxy](https://github.com/tinyproxy/tinyproxy) ★5510  
...
- [3proxy/3proxy](https://github.com/3proxy/3proxy) ★4683 [`accounting`] [`c`] [`https-proxy`] [`ipv6`] [`network-management`] [`network-security`] [`portmap`] [`proxy`] [`proxy-server`] [`sni`] [`socks`] [`socks-proxy`] [`socks-server`] [`socks5`] [`socks5-proxy`] [`socks5-server`] [`stunnel`] [`tls-proxy`] [`traffic-shaping`]  
...
- [microsoft/PowerToys](https://github.com/microsoft/PowerToys) ★125495 [`color-picker`] [`command-palette`] [`desktop`] [`fancyzones`] [`keyboard-manager`] [`microsoft-powertoys`] [`powerrename`] [`powertoys`] [`windows`] [`windows-10`] [`windows-11`]  
...
- [2dust/v2rayN](https://github.com/2dust/v2rayN) ★89539 [`proxy`] [`shadowsocks`] [`socks5`] [`trojan`] [`v2fly`] [`v2ray`] [`vless`] [`vmess`] [`windows`] [`xray`] [`xtls`]  
...
- [huiyadanli/RevokeMsgPatcher](https://github.com/huiyadanli/RevokeMsgPatcher) ★35119 [`hex-editor`] [`patch`] [`pc`] [`qq`] [`revoke`] [`revokemsg`] [`tim`] [`tool`] [`wechat`] [`windows`]  
...
- [AvaloniaUI/Avalonia](https://github.com/AvaloniaUI/Avalonia) ★29134 [`android`] [`app-framework`] [`avalonia`] [`avaloniaui`] [`browser`] [`c-sharp`] [`cross-platform`] [`csharp`] [`desktop`] [`dotnet`] [`gui`] [`ios`] [`linux`] [`macos`] [`mobile`] [`mvvm`] [`wasm`] [`windows`] [`xamarin`] [`xaml`]  
...
- [rocksdanister/lively](https://github.com/rocksdanister/lively) ★17518 [`csharp`] [`desktop`] [`desktop-wallpaper`] [`dynamic-desktop`] [`dynamic-wallpaper`] [`fluent-design`] [`live-wallpaper`] [`screensavers`] [`wallpaper`] [`wallpaper-app`] [`wallpaper-changer`] [`wallpaper-engine`] [`wallpaperengine`] [`wallpapers`] [`widgets`] [`windows-10`] [`windows-11`] [`windows-app`] [`winui`] [`winui3`]  
...
- [d2phap/ImageGlass](https://github.com/d2phap/ImageGlass) ★11514 [`avif`] [`csharp`] [`direct2d`] [`dotnet`] [`heic`] [`heif`] [`image-viewer`] [`imageglass`] [`jpeg-xl`] [`jxl`] [`photo-viewer`] [`picture-gallery`] [`picture-viewer`] [`raw`] [`raw-image`] [`svg`] [`svg-viewer`] [`winforms`]  
...
- [OdysseusYuan/LKY_OfficeTools](https://github.com/OdysseusYuan/LKY_OfficeTools) ★10871 [`access`] [`email`] [`excel`] [`kms`] [`lync`] [`microsoft`] [`msoffice`] [`office`] [`office-free`] [`office365`] [`onedrive`] [`onenote`] [`outlook`] [`ppt`] [`project`] [`publisher`] [`skype`] [`teams`] [`visio`] [`word`]  
...
- [studyzy/imewlconverter](https://github.com/studyzy/imewlconverter) ★9271 [`c-sharp`] [`chinese-characters`] [`converter`] [`dotnet`] [`dotnet-core`] [`ime`]  
...
- [nilaoda/N_m3u8DL-RE](https://github.com/nilaoda/N_m3u8DL-RE) ★6699 [`dash`] [`ffmpeg`] [`hls`] [`ism`] [`live`] [`m3u8`] [`m3u8-downloader`] [`mpd`] [`recorder`]  
...
- [BililiveRecorder/BililiveRecorder](https://github.com/BililiveRecorder/BililiveRecorder) ★4397 [`bilibili`] [`bilibili-live`] [`dotnet-core`] [`flv`] [`stream`] [`wpf`]  
...
- [TheJoeFin/Text-Grab](https://github.com/TheJoeFin/Text-Grab) ★4231 [`dotnet`] [`msix`] [`ocr`] [`window-10`] [`windows`] [`windows-11`] [`wpf`]  
...
- [Jeric-X/SyncClipboard](https://github.com/Jeric-X/SyncClipboard) ★3607  
...
- [SuperStudio/SuperCom](https://github.com/SuperStudio/SuperCom) ★1134  
...
- [microsoft/vcpkg](https://github.com/microsoft/vcpkg) ★26020 [`c`] [`cmake`] [`cplusplus`] [`cpp`] [`libraries`] [`package-manager`] [`packages`] [`vcpkg`] [`visual-studio`] [`windows`]  
...
- [zero-peak/ZeroOmega](https://github.com/zero-peak/ZeroOmega) ★6445 [`proxy`] [`switchyomega`] [`zeroomega`]  
...
- [Anduin2017/HowToCook](https://github.com/Anduin2017/HowToCook) ★95612 [`chinese`] [`cookbook`] [`cooking`] [`dishes`] [`recipes`]  
...
- [jaywcjlove/reference](https://github.com/jaywcjlove/reference) ★14597 [`cheatsheet`] [`docker`] [`javascript`] [`npm`] [`npm-package`] [`react`] [`reactjs`] [`references`] [`semver`] [`toml`] [`typescript`] [`vue3`] [`vuejs`]  
...
- [fatedier/frp](https://github.com/fatedier/frp) ★100382 [`expose`] [`firewall`] [`frp`] [`go`] [`http-proxy`] [`nat`] [`p2p`] [`proxy`] [`reverse-proxy`] [`tunnel`]  
...
- [syncthing/syncthing](https://github.com/syncthing/syncthing) ★77390 [`go`] [`p2p`] [`peer-to-peer`] [`synchronization`]  
...
- [junegunn/fzf](https://github.com/junegunn/fzf) ★74930 [`bash`] [`cli`] [`fish`] [`fzf`] [`go`] [`neovim`] [`tmux`] [`unix`] [`vim`] [`zsh`]  
...
- [minio/minio](https://github.com/minio/minio) ★57905 [`amazon-s3`] [`cloud`] [`cloudnative`] [`cloudstorage`] [`go`] [`k8s`] [`kubernetes`] [`multi-cloud`] [`multi-cloud-kubernetes`] [`objectstorage`] [`s3`] [`storage`]  
...
- [rclone/rclone](https://github.com/rclone/rclone) ★53381 [`azure-blob`] [`azure-blob-storage`] [`azure-files`] [`backblaze-b2`] [`cloud-storage`] [`dropbox`] [`encryption`] [`ftp`] [`fuse-filesystem`] [`go`] [`golang`] [`google-cloud-storage`] [`google-drive`] [`onedrive`] [`openstack-swift`] [`rclone`] [`s3`] [`sftp`] [`sync`] [`webdav`]  
...
- [go-gitea/gitea](https://github.com/go-gitea/gitea) ★51858 [`bitbucket`] [`cicd`] [`devops`] [`docker-registry-v2`] [`git`] [`git-gui`] [`git-server`] [`gitea`] [`github`] [`github-actions`] [`gitlab`] [`go`] [`golang`] [`hacktoberfest`] [`maven-server`] [`npm-registry`] [`vue`]  
...
- [AlistGo/alist](https://github.com/AlistGo/alist) ★48494 [`file-server`] [`gin`] [`golang`] [`onedrive`] [`solidjs`] [`webdav`]  
...
- [v2ray/v2ray-core](https://github.com/v2ray/v2ray-core) ★46655 [`golang`] [`http-proxy`] [`proxy`] [`shadowsocks`] [`socks`] [`socks5`] [`v2ray`] [`vmess`]  
...
- [usememos/memos](https://github.com/usememos/memos) ★45776 [`docker`] [`foss`] [`go`] [`markdown`] [`memo`] [`microblog`] [`note-taking`] [`notecard`] [`react`] [`self-hosted`] [`social-network`] [`sqlite`]  
...
- [coreybutler/nvm-windows](https://github.com/coreybutler/nvm-windows) ★43554 [`go`] [`management`] [`node`] [`node-version-manager`] [`nodejs`] [`nvm`] [`switch`] [`version`] [`version-manager`] [`versioning`] [`windows`]  
...
- [ehang-io/nps](https://github.com/ehang-io/nps) ★33600 [`dns`] [`firewall`] [`go`] [`gzip`] [`http`] [`https`] [`nat`] [`nps`] [`snnapy`] [`socks`] [`socks5`] [`ssh`] [`tcp`] [`tunnel`] [`udp`]  
...
- [juanfont/headscale](https://github.com/juanfont/headscale) ★32557 [`tailscale`] [`tailscale-control-server`] [`tailscale-server`] [`wireguard`]  
...
- [schollz/croc](https://github.com/schollz/croc) ★31910 [`data-transfer`] [`file-sharing`] [`golang`] [`pake`] [`peer-to-peer`] [`tcp`] [`transfer`]  
...
- [filebrowser/filebrowser](https://github.com/filebrowser/filebrowser) ★31861 [`file-browser`] [`file-manager`] [`file-sharing`] [`go`] [`material-design`] [`self-hosted`] [`vue`]  
  这是一个用于浏览和管理文件的Web应用程序。它使用Python和Flask框架构建，提供文件上传、下载、删除、重命名等基本操作。用户可以通过Web界面直观地查看和操作文件，支持多种文件类型。项目包含用户认证模块，确保文件访问权限安全。
- [iawia002/lux](https://github.com/iawia002/lux) ★30591 [`bilibili`] [`crawler`] [`download`] [`downloader`] [`go`] [`golang`] [`iqiyi`] [`qq`] [`scraper`] [`tumblr`] [`video`] [`youku`] [`youtube`]  
...
- [binwiederhier/ntfy](https://github.com/binwiederhier/ntfy) ★27152 [`curl`] [`notifications`] [`ntfy`] [`ntfysh`] [`pubsub`] [`push-notifications`] [`rest-api`]  
...
- [tailscale/tailscale](https://github.com/tailscale/tailscale) ★25804 [`2fa`] [`oauth`] [`sso`] [`tailscale`] [`vpn`] [`wireguard`]  
...
- [cloudreve/cloudreve](https://github.com/cloudreve/cloudreve) ★25393 [`cloud`] [`cloud-storage`] [`cloudreve`] [`file`] [`file-manager`] [`file-sharing`] [`golang`]  
...
- [containrrr/watchtower](https://github.com/containrrr/watchtower) ★24040 [`automation`] [`continuous-delivery`] [`devops`] [`docker`] [`hacktoberfest`] [`notifications`] [`receive-notifications`] [`registry`] [`update-checker`] [`watchtower`]  
...
- [XIU2/CloudflareSpeedTest](https://github.com/XIU2/CloudflareSpeedTest) ★23317 [`cdn`] [`cloudflare`] [`go`] [`golang`] [`speedtest`]  
...
- [chaitin/SafeLine](https://github.com/chaitin/SafeLine) ★19075 [`api-gateway`] [`application-security`] [`appsec`] [`blueteam`] [`bruteforce`] [`captcha`] [`cve`] [`cybersecurity`] [`firewall`] [`hackers`] [`http-flood`] [`security`] [`self-hosted`] [`sql-injection`] [`vulnerability`] [`waf`] [`web-application-firewall`] [`web-security`] [`websecurity`] [`xss`]  
...
- [apernet/hysteria](https://github.com/apernet/hysteria) ★17664 [`censorship-circumvention`] [`golang`] [`http-proxy`] [`hysteria`] [`proxy`] [`quic`] [`relay`] [`reliable-udp`] [`socks5`] [`tun`] [`vpn`]  
...
- [OpenListTeam/OpenList](https://github.com/OpenListTeam/OpenList) ★17556 [`alist`] [`aliyunpan`] [`baidupan`] [`openlist`]  
...
- [ginuerzh/gost](https://github.com/ginuerzh/gost) ★17245 [`dns`] [`go`] [`golang`] [`http2`] [`kcp`] [`obfs4`] [`quic`] [`shadowsocks`] [`sni`] [`socks5`] [`ssh`] [`tls`] [`tunnel`] [`tuntap`] [`udp`]  
...
- [ory/hydra](https://github.com/ory/hydra) ★16647 [`authorization`] [`cloud`] [`docker`] [`federation`] [`hacktoberfest`] [`hydra`] [`identity`] [`oauth`] [`oauth-provider`] [`oauth2`] [`oauth2-provider`] [`oauth2-server`] [`oidc`] [`openid`] [`openid-connect`] [`openid-connect-provider`] [`openid-provider`] [`security`] [`server`] [`sso`]  
...
- [jeessy2/ddns-go](https://github.com/jeessy2/ddns-go) ★15579 [`alidns`] [`baiduyun`] [`cloudflare`] [`ddns`] [`ddns-go`] [`dnspod`] [`godaddy-ddns`] [`google-domains`] [`porkbun`]  
...
- [gotify/server](https://github.com/gotify/server) ★14004 [`api`] [`cloud`] [`free-software`] [`golang`] [`gotify`] [`hosting`] [`javascript`] [`notifications`] [`privacy`] [`react`] [`self-hosted`] [`self-hosting`] [`selfhosted`]  
...
- [shadow1ng/fscan](https://github.com/shadow1ng/fscan) ★12910  
...
- [tinode/chat](https://github.com/tinode/chat) ★12882 [`chat`] [`chat-application`] [`chatapp`] [`chatbots`] [`chatserver`] [`collaboration`] [`go`] [`golang`] [`instant-messaging`] [`messaging`] [`messaging-api`] [`messenger`] [`telegram`] [`video-call`] [`video-chat`] [`video-conferencing`] [`webchat-server`] [`webrtc`] [`whatsapp`] [`xmpp`]  
  这是一个开源的即时通讯平台，基于WebSockets协议，提供可靠的实时消息传递。它使用Go语言开发，采用模块化设计，包含服务器端和客户端库，支持多种平台和设备。该平台易于扩展和定制，适合构建各种需要实时通信的应用，例如聊天室、协作工具等。
- [casdoor/casdoor](https://github.com/casdoor/casdoor) ★12534 [`auth`] [`authentication`] [`authn`] [`casbin`] [`casdoor`] [`faceid`] [`iam`] [`kerberos`] [`ldap`] [`mfa`] [`oauth`] [`oidc`] [`payment-gateway`] [`radius`] [`saml`] [`scim`] [`single-sign-on`] [`sso`] [`totp`] [`webauthn`]  
...
- [fullstorydev/grpcurl](https://github.com/fullstorydev/grpcurl) ★12195 [`golang`] [`grpc`] [`protobuf`]  
...
- [putyy/res-downloader](https://github.com/putyy/res-downloader) ★11463 [`douyin`] [`kuaishou`] [`res-downloader`] [`wechat`] [`wechat-video`] [`xiaohongshu`]  
...
- [0xJacky/nginx-ui](https://github.com/0xJacky/nginx-ui) ★9815 [`chatgpt-app`] [`code-completion`] [`copilot`] [`cron`] [`deepseek-r1`] [`docker`] [`go`] [`letsencrypt`] [`linux`] [`macos`] [`mcp`] [`mcp-server`] [`nginx`] [`self-hosted`] [`vue`] [`webui`] [`windows`]  
...
- [gokcehan/lf](https://github.com/gokcehan/lf) ★8717 [`file-manager`] [`terminal`]  
...
- [ViRb3/wgcf](https://github.com/ViRb3/wgcf) ★7261 [`client`] [`cloudflare`] [`plus`] [`security`] [`vpn`] [`warp`] [`wireguard`]  
...
- [nxtrace/NTrace-core](https://github.com/nxtrace/NTrace-core) ★7148 [`api`] [`as-path`] [`asn-lookup`] [`geoip`] [`geolocation`] [`ip-lookup`] [`network-analysis`] [`next-trace`] [`nexttrace`] [`traceroute`] [`utility`]  
...
- [Hackl0us/GeoIP2-CN](https://github.com/Hackl0us/GeoIP2-CN) ★7147 [`clash`] [`geoip`] [`geoip2`] [`proxy`] [`quantumultx`] [`shadowrocket`] [`shadowsocks`] [`surge`]  
...
- [gdy666/lucky](https://github.com/gdy666/lucky) ★6737 [`acme`] [`aliyunpan`] [`cron`] [`ddns`] [`dynadot`] [`filebrowser`] [`ftp`] [`ipv6`] [`socat`] [`stun`] [`vercel`] [`volcengine`] [`webdav`] [`wol`]  
...
- [iyear/tdl](https://github.com/iyear/tdl) ★5995 [`bash`] [`download`] [`downloader`] [`telegram`] [`telegram-api`] [`telegram-bot`] [`telegram-bots`] [`telegram-channel`] [`telegram-userbot`]  
...
- [git-jiadong/wechatDataBackup](https://github.com/git-jiadong/wechatDataBackup) ★5927 [`wechat`] [`wechat-app`] [`wechat-bot`]  
...
- [ngoduykhanh/wireguard-ui](https://github.com/ngoduykhanh/wireguard-ui) ★4920 [`wireguard`] [`wireguard-admin`] [`wireguard-config-gen`] [`wireguard-go`] [`wireguard-ui`] [`wireguard-vpn`] [`wireguard-web`]  
...
- [qjfoidnh/BaiduPCS-Go](https://github.com/qjfoidnh/BaiduPCS-Go) ★4127 [`baidupcs`]  
...
- [sjqzhang/go-fastdfs](https://github.com/sjqzhang/go-fastdfs) ★4102 [`breakpoint-resume`] [`cloud-storage`] [`cloudnative`] [`distributed-file-storage`] [`distributed-file-system`] [`fastdfs`] [`file-system`] [`fileserver`] [`filesystem`] [`go`] [`go-fastdfs`] [`godfs`] [`object-storage-service`] [`oss`] [`rsync`] [`small-file-merge`] [`storage`] [`storage-servers`] [`sync`] [`tus`]  
...
- [prometheus-community/windows_exporter](https://github.com/prometheus-community/windows_exporter) ★3356 [`prometheus`] [`prometheus-exporter`] [`windows`] [`wmi`]  
...
- [jgm/pandoc](https://github.com/jgm/pandoc) ★40070 [`commonmark`] [`converter`] [`document`] [`haskell`] [`markdown`] [`markup`] [`pandoc`] [`presentation`] [`publishing`]  
...
- [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) ★114676 [`awesome-list`] [`free-for-developers`]  
...
- [vernesong/OpenClash](https://github.com/vernesong/OpenClash) ★22557 [`clash`] [`luci`] [`mihomo`] [`openclash`] [`openwrt`] [`shadowsocks`] [`snell`] [`v2ray`] [`vmess`]  
...
- [vbskycn/iptv](https://github.com/vbskycn/iptv) ★4827  
...
- [cf-pages/Telegraph-Image](https://github.com/cf-pages/Telegraph-Image) ★4239 [`cloudflare`] [`cloudflare-pages`] [`flickr`] [`image`] [`image-host`] [`image-hosting`] [`image-sharing`] [`imgur`] [`serverless`] [`telegraph`] [`upload-images`]  
...
- [hookmaster/frida-all-in-one](https://github.com/hookmaster/frida-all-in-one) ★3103 [`android`] [`awesome`] [`dynamic`] [`frida`] [`instructions`] [`ios`] [`linux`] [`macos`] [`windows`]  
...
- [Stirling-Tools/Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF) ★69549 [`docker`] [`hacktoberfest`] [`java`] [`pdf`] [`pdf-converter`] [`pdf-editor`] [`pdf-manipulation`] [`pdf-merger`] [`pdf-ocr`] [`pdf-tools`] [`pdf-web-apps`] [`pdfmerger`]  
...
- [termux/termux-app](https://github.com/termux/termux-app) ★46629 [`android`] [`hacktoberfest`] [`linux`] [`terminal`] [`termux`]  
...
- [dbeaver/dbeaver](https://github.com/dbeaver/dbeaver) ★46118 [`ai`] [`copilot`] [`database`] [`db2`] [`dbeaver`] [`erd`] [`gui`] [`java`] [`jdbc`] [`mysql`] [`nosql`] [`openai`] [`oracle`] [`postgresql`] [`redshift`] [`sql`] [`sqlite`] [`sqlserver`]  
...
- [skylot/jadx](https://github.com/skylot/jadx) ★46039 [`android`] [`decompiler`] [`dex`] [`java`]  
...
- [halo-dev/halo](https://github.com/halo-dev/halo) ★37234 [`blog`] [`blog-engine`] [`cms`] [`content-management-system`] [`halo`] [`halocms`] [`website-builder`]  
...
- [zxing/zxing](https://github.com/zxing/zxing) ★33683 [`android`] [`barcode`] [`barcode-scanner`] [`datamatrix`] [`java`] [`qr-code`] [`upc`] [`zxing`]  
...
- [DrKLO/Telegram](https://github.com/DrKLO/Telegram) ★27886 [`telegram`]  
...
- [dataease/dataease](https://github.com/dataease/dataease) ★22266 [`apache-doris`] [`business-intelligence`] [`data-analysis`] [`data-visualization`] [`echarts`] [`kettle`] [`superset`] [`tableau`]  
...
- [lionsoul2014/ip2region](https://github.com/lionsoul2014/ip2region) ★18332 [`ip-address`] [`ip-address-database`] [`ip-address-location`] [`ip-location`] [`ip-lookup`] [`ipv4-address`] [`ipv4-lookup`] [`ipv4-support`] [`ipv6-address`] [`ipv6-lookup`] [`ipv6-support`] [`xdb-engine`] [`xdb-ipv4`] [`xdb-ipv6`]  
...
- [microg/GmsCore](https://github.com/microg/GmsCore) ★11323 [`android`] [`auth`] [`cloud-messaging`] [`firebase`] [`geolocation`] [`google`] [`google-cloud-messaging`] [`java`] [`kotlin`] [`kotlin-android`] [`maps`] [`microg`] [`mobile`] [`push-notifications`]  
...
- [jeecgboot/jimureport](https://github.com/jeecgboot/jimureport) ★7697 [`bi`] [`bigscreen`] [`birt`] [`data-analysis`] [`data-visualization`] [`dataease`] [`datav`] [`echart`] [`echarts`] [`finereport`] [`highcharts`] [`ireport`] [`jasperreport`] [`jfreechart`] [`metabase`] [`print`] [`redash`] [`report`] [`superset`] [`tableau`]  
...
- [648540858/wvp-GB28181-pro](https://github.com/648540858/wvp-GB28181-pro) ★6395 [`1078`] [`28181`] [`28181web`] [`808`] [`gb28181`] [`gb28181server`] [`wvp`]  
...
- [meefik/linuxdeploy](https://github.com/meefik/linuxdeploy) ★5649 [`android`] [`chroot`] [`containers`] [`deployment`] [`linux`]  
...
- [201206030/novel](https://github.com/201206030/novel) ★5510 [`book`] [`cms`] [`mybatis`] [`novel`] [`read`] [`springboot`]  
...
- [SuperMonster003/AutoJs6](https://github.com/SuperMonster003/AutoJs6) ★4853 [`android`] [`autojs`] [`autojs6`] [`automated-tool`] [`automation`] [`javascript`]  
...
- [rememberber/WePush](https://github.com/rememberber/WePush) ★4607 [`gui`] [`java`] [`mail`] [`message`] [`push`] [`send`] [`sender`] [`sms`] [`swing`] [`wechat`] [`weixin`]  
...
- [pqpo/SmartCropper](https://github.com/pqpo/SmartCropper) ★4099 [`detection`] [`hed-net`] [`image`] [`image-cropper`] [`opencv`] [`pytorch`] [`smartcropper`] [`tensorflow`]  
  Smart
- [syncthing/syncthing-android](https://github.com/syncthing/syncthing-android) ★4012 [`android`] [`java`] [`p2p`] [`peer-to-peer`] [`synchronization`]  
...
- [qaiu/netdisk-fast-download](https://github.com/qaiu/netdisk-fast-download) ★2371 [`api`] [`download`] [`drive`] [`file-server`] [`ilanzou`] [`java`] [`netdisk-fast-download`] [`onedrive`] [`parser`] [`share`] [`vertx`] [`webserver`] [`yunpan`]  
...
- [Kong/kong](https://github.com/Kong/kong) ★42130 [`ai`] [`ai-gateway`] [`api-gateway`] [`api-management`] [`apis`] [`artificial-intelligence`] [`cloud-native`] [`devops`] [`kubernetes`] [`kubernetes-ingress`] [`kubernetes-ingress-controller`] [`llm-gateway`] [`llm-ops`] [`mcp`] [`mcp-gateway`] [`microservice`] [`microservices`] [`openai-proxy`] [`reverse-proxy`] [`serverless`]  
...
- [iDvel/rime-ice](https://github.com/iDvel/rime-ice) ★13653 [`rime`] [`rime-config`] [`rime-custom`] [`rime-schema`] [`rime-squirrel`] [`rime-weasel`]  
...
- [twbs/bootstrap](https://github.com/twbs/bootstrap) ★173676 [`bootstrap`] [`css`] [`css-framework`] [`html`] [`javascript`] [`sass`] [`scss`]  
...
- [996icu/996.ICU](https://github.com/996icu/996.ICU) ★274746  
  该项目是一个关于中国程序员工作强度和压力的匿名吐槽平台。用户可以通过匿名发表帖子，分享工作经历和感受。平台使用简单的文本格式，并支持搜索和过滤功能。该项目主要使用PHP语言开发，并使用数据库存储用户数据和帖子信息。
- [awesome-selfhosted/awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ★256745 [`awesome`] [`awesome-list`] [`cloud`] [`free-software`] [`hosting`] [`privacy`] [`self-hosted`] [`selfhosted`]  
...
- [ruanyf/weekly](https://github.com/ruanyf/weekly) ★78425  
...
- [PlexPt/awesome-chatgpt-prompts-zh](https://github.com/PlexPt/awesome-chatgpt-prompts-zh) ★56715 [`chat-gpt`] [`chatgpt`] [`chatgpt3`] [`chatgpt4`] [`gpt`]  
...
- [justjavac/awesome-wechat-weapp](https://github.com/justjavac/awesome-wechat-weapp) ★49472 [`demo`] [`minapp`] [`miniprogram`] [`weapp-demo`] [`wechat`] [`wechat-weapp`] [`wepy`] [`wxapp`] [`wxml`]  
...
- [imDazui/Tvlist-awesome-m3u-m3u8](https://github.com/imDazui/Tvlist-awesome-m3u-m3u8) ★27694 [`awesome`] [`iptv`] [`iptv-channels`] [`iptv-free`] [`iptv-m3u8`] [`iptv-playlist`] [`kodi`] [`kodi-addons`] [`kodi-plugin`] [`m3u`] [`m3u8`]  
...
- [leiurayer/downkyi](https://github.com/leiurayer/downkyi) ★23791  
...
- [AZeC4/TelegramGroup](https://github.com/AZeC4/TelegramGroup) ★19077 [`telegram`] [`telegram-api`] [`telegram-bot`] [`telegram-bot-api`] [`telegram-bots`] [`telegram-channel`] [`telegramgroups`]  
...
- [Johnshall/Shadowrocket-ADBlock-Rules-Forever](https://github.com/Johnshall/Shadowrocket-ADBlock-Rules-Forever) ★18209 [`adblock`] [`gfw`] [`proxy`] [`shadowrocket`] [`v2ray`]  
...
- [dongyubin/DockerHub](https://github.com/dongyubin/DockerHub) ★6338 [`cloudflare`] [`docker`] [`docker-image`] [`docker-registry`] [`dockerhub`] [`proxy`]  
...
- [reqable/reqable-app](https://github.com/reqable/reqable-app) ★5475 [`android-app`] [`capture`] [`debugging-tool`] [`desktop-app`] [`flutter`] [`http`] [`http2`] [`http3`] [`https`] [`ios-app`] [`quic`] [`rest-api`]  
...
- [ACL4SSR/ACL4SSR](https://github.com/ACL4SSR/ACL4SSR) ★5308 [`acl`] [`acl4ssr`] [`clash`] [`gfwlist`]  
...
- [yinggaozhen/awesome-go-cn](https://github.com/yinggaozhen/awesome-go-cn) ★5181 [`awesome`] [`awesome-list`] [`cn-doc`] [`go`] [`golang`] [`golang-library`]  
...
- [suxuang/myIPTV](https://github.com/suxuang/myIPTV) ★4242  
...
- [dweinstein/awesome-frida](https://github.com/dweinstein/awesome-frida) ★3348 [`android`] [`awesome`] [`dynamic-analysis`] [`frida`] [`hooking`] [`ios`] [`r2frida`]  
...
- [swyefun/BBLLV5](https://github.com/swyefun/BBLLV5) ★995  
...
- [cheat-engine/cheat-engine](https://github.com/cheat-engine/cheat-engine) ★17219  
...
- [stascorp/rdpwrap](https://github.com/stascorp/rdpwrap) ★16005  
...
- [easychen/howto-make-more-money](https://github.com/easychen/howto-make-more-money) ★18035  
...
- [librespeed/speedtest](https://github.com/librespeed/speedtest) ★13788 [`hacktoberfest`] [`html5-speedtest`] [`internet-speed`] [`internet-speed-checker`] [`librespeed`] [`php`] [`speedtest`] [`web-worker`] [`xhr`]  
...
- [FreshRSS/FreshRSS](https://github.com/FreshRSS/FreshRSS) ★12994 [`feed`] [`freshrss`] [`news-aggregator`] [`php`] [`rss`] [`rss-aggregator`] [`rss-reader`] [`self-hosted`] [`websub`]  
...
- [assimon/dujiaoka](https://github.com/assimon/dujiaoka) ★11412 [`dujiaofaka`] [`dujiaoka`] [`faka`]  
...
- [vrana/adminer](https://github.com/vrana/adminer) ★7118 [`database`] [`mssql`] [`mysql`] [`php`] [`postgresql`] [`sqlite`]  
...
- [icret/EasyImages2.0](https://github.com/icret/EasyImages2.0) ★3546 [`api`] [`class-upload-php`] [`easyimage`] [`image-store`] [`images`] [`markdown`] [`php`] [`picture`] [`upload-images`] [`upload-pictures`] [`zui`]  
...
- [Bubka/2FAuth](https://github.com/Bubka/2FAuth) ★3504 [`2fa`] [`2factor`] [`hotp`] [`otp`] [`qrcode`] [`self-hosted`] [`totp`] [`two-factor`] [`two-factor-authentication`] [`webapp`]  
...
- [kalcaddle/kodbox](https://github.com/kalcaddle/kodbox) ★2746 [`docx`] [`file-explorer`] [`file-manager`] [`file-sharing`] [`file-upload`] [`file-viewer`] [`filemanager`] [`filesystem`] [`free-software`] [`javascript`] [`markdown-editor`] [`php`] [`text-editor`] [`webdav`] [`xlsx`]  
...
- [chrome-php/chrome](https://github.com/chrome-php/chrome) ★2523 [`hacktoberfest`]  
...
- [ScoopInstaller/Scoop](https://github.com/ScoopInstaller/Scoop) ★23111 [`installer`] [`powershell`] [`scoop`] [`windows`]  
...
- [TapXWorld/ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook) ★54474  
...
- [pyenv/pyenv](https://github.com/pyenv/pyenv) ★43579 [`python`] [`shell`]  
...
- [discourse/discourse](https://github.com/discourse/discourse) ★45507 [`discourse`] [`ember`] [`forum`] [`javascript`] [`postgresql`] [`rails`] [`ruby`]  
...
- [rustdesk/rustdesk](https://github.com/rustdesk/rustdesk) ★102017 [`android`] [`anydesk`] [`dart`] [`flatpak`] [`flutter`] [`flutter-apps`] [`ios`] [`linux`] [`macos`] [`p2p`] [`rdp`] [`remote-control`] [`remote-desktop`] [`rust`] [`rust-lang`] [`teamviewer`] [`vnc`] [`wayland`] [`windows`]  
...
- [zed-industries/zed](https://github.com/zed-industries/zed) ★69263 [`gpui`] [`rust-lang`] [`text-editor`] [`zed`]  
...
- [topjohnwu/Magisk](https://github.com/topjohnwu/Magisk) ★56792  
...
- [starship/starship](https://github.com/starship/starship) ★52060 [`bash`] [`fish`] [`fish-prompt`] [`fish-theme`] [`oh-my-zsh`] [`powershell`] [`rust`] [`shell-prompt`] [`starship`] [`zsh`] [`zsh-prompt`] [`zsh-theme`]  
...
- [dani-garcia/vaultwarden](https://github.com/dani-garcia/vaultwarden) ★50601 [`bitwarden`] [`bitwarden-rs`] [`docker`] [`rocket`] [`rust`] [`vaultwarden`]  
...
- [tw93/Pake](https://github.com/tw93/Pake) ★43267 [`chatgpt`] [`claude`] [`desktop`] [`gemini`] [`hight-performance`] [`linux`] [`macos`] [`no-electron`] [`package`] [`rust`] [`tauri`] [`windows`] [`youtube`]  
...
- [fish-shell/fish-shell](https://github.com/fish-shell/fish-shell) ★31421 [`fish`] [`rust`] [`shell`] [`terminal`]  
...
- [rustdesk/rustdesk-server](https://github.com/rustdesk/rustdesk-server) ★8798 [`remote-access`] [`remote-control`] [`remote-desktop`] [`tauri`]  
...
- [EasyTier/EasyTier](https://github.com/EasyTier/EasyTier) ★7943 [`nat-traversal`] [`p2p`] [`rust`] [`tailscale`] [`vpn`] [`zerotier`]  
...
- [rtyley/bfg-repo-cleaner](https://github.com/rtyley/bfg-repo-cleaner) ★11816 [`git`]  
...
- [imputnet/cobalt](https://github.com/imputnet/cobalt) ★37142 [`collaboration`] [`downloader`] [`instagram`] [`javascript`] [`music`] [`reddit`] [`social-media`] [`soundcloud`] [`svelte`] [`tiktok`] [`twitter`] [`typescript`] [`video`] [`vimeo`] [`vk`] [`webapp`] [`youtube`] [`youtube-downloader`]  
...
- [Finb/Bark](https://github.com/Finb/Bark) ★6994 [`ios`] [`ios-app`] [`ios-swift`] [`mvvm`] [`mvvm-architecture`] [`push-notifications`] [`rxcocoa`] [`rxdatasources`] [`rxswift`]  
...
- [X1a0He/Adobe-Downloader](https://github.com/X1a0He/Adobe-Downloader) ★2477  
...
- [iptv-org/iptv](https://github.com/iptv-org/iptv) ★98342 [`iptv`] [`m3u`] [`playlist`] [`streams`] [`tv`]  
...
- [ant-design/ant-design](https://github.com/ant-design/ant-design) ★96556 [`ant-design`] [`antd`] [`design-systems`] [`react`] [`typescript`] [`ui-kit`] [`ui-library`]  
...
- [mermaid-js/mermaid](https://github.com/mermaid-js/mermaid) ★83942 [`diagrams`] [`diagrams-as-code`] [`documentation`] [`flowchart`] [`javascript`] [`mindmap`] [`typescript`] [`uml-diagrams`]  
...
- [immich-app/immich](https://github.com/immich-app/immich) ★83624 [`backup-tool`] [`flutter`] [`google-photos`] [`google-photos-alternative`] [`javascript`] [`mobile-app`] [`nestjs`] [`nodejs`] [`photo-gallery`] [`photos`] [`photos-management`] [`self-hosted`] [`svelte`] [`sveltekit`] [`typescript`] [`videos`]  
...
- [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) ★81706 [`gemini`] [`gemini-api`]  
...
- [clash-verge-rev/clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev) ★80738 [`clash`] [`clash-meta`] [`clash-verge`] [`linux`] [`mac`] [`mihomo`] [`tauri-app`] [`windows`]  
...
- [hoppscotch/hoppscotch](https://github.com/hoppscotch/hoppscotch) ★76831 [`api`] [`api-client`] [`api-rest`] [`api-testing`] [`developer-tools`] [`graphql`] [`http`] [`http-client`] [`pwa`] [`rest`] [`rest-api`] [`spa`] [`testing`] [`testing-tools`] [`tools`] [`vue`] [`vuejs`] [`websocket`]  
...
- [lobehub/lobe-chat](https://github.com/lobehub/lobe-chat) ★67499 [`agent`] [`ai`] [`artifacts`] [`chat`] [`chatgpt`] [`claude`] [`deepseek`] [`deepseek-r1`] [`function-calling`] [`gemini`] [`gpt`] [`knowledge-base`] [`mcp`] [`nextjs`] [`ollama`] [`openai`] [`rag`]  
...
- [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) ★66632 [`ai`] [`ai-agents`] [`ai-crawler`] [`ai-scraping`] [`ai-search`] [`crawler`] [`data-extraction`] [`html-to-markdown`] [`llm`] [`markdown`] [`scraper`] [`scraping`] [`web-crawler`] [`web-data`] [`web-data-extraction`] [`web-scraper`] [`web-scraping`] [`web-search`] [`webscraping`]  
...
- [nocodb/nocodb](https://github.com/nocodb/nocodb) ★58614 [`airtable`] [`airtable-alternative`] [`automatic-api`] [`hacktoberfest`] [`low-code`] [`no-code`] [`no-code-database`] [`no-code-platform`] [`postgresql`] [`rest-api`] [`restful-api`] [`spreadsheet`] [`sqlite`] [`swagger`]  
...
- [lyswhut/lx-music-desktop](https://github.com/lyswhut/lx-music-desktop) ★47004 [`electron`] [`javascript`] [`music-player`] [`vue`]  
...
- [RocketChat/Rocket.Chat](https://github.com/RocketChat/Rocket.Chat) ★43800 [`chat`] [`collaboration`] [`foss`] [`free`] [`hacktoberfest`] [`javascript`] [`meteor`] [`mit`] [`real-time`] [`slack`] [`webrtc`]  
...
- [DIYgod/RSSHub](https://github.com/DIYgod/RSSHub) ★39695 [`bilibili`] [`douban`] [`dribbble`] [`instagram`] [`lofter`] [`pixiv`] [`rss`] [`rsshub`] [`spotify`] [`telegram`] [`tiktok`] [`twitter`] [`v2ex`] [`wechat`] [`weibo`] [`ximalaya`] [`youtube`] [`zhihu`]  
...
- [RSSNext/Folo](https://github.com/RSSNext/Folo) ★35669 [`ai`] [`reader`] [`rss`] [`rss-reader`] [`rsshub`]  
...
- [umami-software/umami](https://github.com/umami-software/umami) ★31432 [`analytics`] [`charts`] [`google-analytics`] [`statistics`] [`web-analytics`]  
...
- [NginxProxyManager/nginx-proxy-manager](https://github.com/NginxProxyManager/nginx-proxy-manager) ★29241 [`nginx`] [`nginx-proxy`]  
...
- [blakeblackshear/frigate](https://github.com/blakeblackshear/frigate) ★26767 [`ai`] [`camera`] [`google-coral`] [`home-assistant`] [`home-automation`] [`homeautomation`] [`mqtt`] [`nvr`] [`object-detection`] [`realtime`] [`rtsp`] [`tensorflow`]  
...
- [oldj/SwitchHosts](https://github.com/oldj/SwitchHosts) ★25846 [`electron`] [`hosts`] [`hostseditor`] [`hostsfile`] [`switch-hosts`] [`switchhosts`]  
...
- [fingerprintjs/fingerprintjs](https://github.com/fingerprintjs/fingerprintjs) ★25820 [`audio-fingerprinting`] [`browser`] [`browser-fingerprint`] [`browser-fingerprinting`] [`detection`] [`fingerprint`] [`fingerprinting`] [`fingerprintjs`] [`fraud`] [`fraud-detection`] [`identification`] [`javascript`] [`visitor-identifier`]  
...
- [maotoumao/MusicFree](https://github.com/maotoumao/MusicFree) ★21281 [`free`] [`music-player`] [`musicfree`] [`plugin`] [`react`] [`react-native`] [`typescript`]  
...
- [musistudio/claude-code-router](https://github.com/musistudio/claude-code-router) ★21027  
...
- [louislam/dockge](https://github.com/louislam/dockge) ★20153 [`docker`] [`docker-compose`] [`docker-deployment`] [`docker-stack`] [`docker-stack-deploy`] [`docker-ui`] [`responsive`] [`self-hosted`] [`selfhosted`] [`single-page-app`] [`socket-io`] [`webapp`] [`websocket`]  
...
- [whyour/qinglong](https://github.com/whyour/qinglong) ★18634 [`crontab`] [`docker`] [`javascript`] [`python`] [`shell`] [`task-manager`] [`typescript`]  
...
- [winfunc/opcode](https://github.com/winfunc/opcode) ★18605 [`anthropic`] [`anthropic-claude`] [`claude`] [`claude-4`] [`claude-4-opus`] [`claude-4-sonnet`] [`claude-ai`] [`claude-code`] [`claude-code-sdk`] [`cursor`] [`ide`] [`llm`] [`llm-code`] [`rust`] [`tauri`]  
...
- [wangeditor-team/wangEditor](https://github.com/wangeditor-team/wangEditor) ★18179 [`rich-text`] [`rich-text-html-editor`] [`typescript`] [`wangeditor`] [`wysiwyg`] [`wysiwyg-editor`]  
...
- [apitable/apitable](https://github.com/apitable/apitable) ★14994 [`admin-dashboard`] [`airtable`] [`airtable-alternative`] [`api`] [`automatic-api`] [`embed`] [`hacktoberfest`] [`internal-tool`] [`javascript`] [`low-code`] [`nestjs`] [`nextjs`] [`no-code`] [`nocodb`] [`notion`] [`react`] [`spreadsheet`] [`spring`] [`typescript`]  
...
- [ourongxing/newsnow](https://github.com/ourongxing/newsnow) ★13636 [`elegant`] [`news`]  
...
- [ikatyang/emoji-cheat-sheet](https://github.com/ikatyang/emoji-cheat-sheet) ★13455 [`cheat-sheet`] [`emoji`] [`github`] [`markdown`]  
...
- [ayangweb/BongoCat](https://github.com/ayangweb/BongoCat) ★12555 [`bongo-cat`] [`bongocat`] [`cross-platform`] [`desktop-app`] [`desktop-pet`] [`linux`] [`macos`] [`pet`] [`pet-project`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [plait-board/drawnix](https://github.com/plait-board/drawnix) ★12232 [`collaboration`] [`drawing`] [`flowchart`] [`localfirst`] [`mindmap`] [`productivity`] [`whiteboard`]  
...
- [dream-num/univer](https://github.com/dream-num/univer) ★11477 [`ai-excel`] [`ai-sheet`] [`ai-spreadsheet`] [`appscript`] [`collaboration`] [`data-table`] [`doc`] [`excel`] [`excel-mcp`] [`grid`] [`live-share`] [`ppt`] [`sdk`] [`sheet`] [`sheet-mcp`] [`spreadsheet`] [`spreadsheet-mcp`] [`univer-mcp`] [`word`] [`xlsx`]  
...
- [giscus/giscus](https://github.com/giscus/giscus) ★10758 [`blog`] [`comment-system`] [`comments`] [`comments-widget`] [`giscus`] [`github`] [`github-discussions`] [`hacktoberfest`] [`javascript`] [`nextjs`] [`react`] [`reactjs`] [`utterances`] [`widget`]  
...
- [jackyzha0/quartz](https://github.com/jackyzha0/quartz) ★10469 [`digital-garden`] [`networked-thought`] [`obsidian`] [`obsidian-md`] [`quartz-ssg`] [`static-site-generator`]  
...
- [AIsouler/GKD_subscription](https://github.com/AIsouler/GKD_subscription) ★8846 [`gkd`] [`gkd-subscription`] [`typescript`]  
...
- [humanlayer/humanlayer](https://github.com/humanlayer/humanlayer) ★6668 [`agents`] [`ai`] [`amp`] [`claude-code`] [`codex`] [`human-in-the-loop`] [`humanlayer`] [`llm`] [`llms`] [`opencode`]  
...
- [EcoPasteHub/EcoPaste](https://github.com/EcoPasteHub/EcoPaste) ★6350 [`application`] [`clipboard`] [`clipboard-manager`] [`cross-platform`] [`desktop-app`] [`desktop-application`] [`linux`] [`macos`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [Termix-SSH/Termix](https://github.com/Termix-SSH/Termix) ★6317 [`docker`] [`file-management`] [`self-hosted`] [`ssh`] [`ssh-tunnel`] [`termix`]  
...
- [remotely-save/remotely-save](https://github.com/remotely-save/remotely-save) ★6268  
...
- [wechat-article/wechat-article-exporter](https://github.com/wechat-article/wechat-article-exporter) ★4669 [`download`] [`wechat`] [`wechat-article`] [`wechat-download`]  
...
- [galaxy-s10/billd-desk](https://github.com/galaxy-s10/billd-desk) ★4565 [`coturn`] [`electron`] [`flutter`] [`nodejs`] [`parsec`] [`remote-desktop`] [`rustdesk`] [`socket-io`] [`todesk`] [`typescript`] [`vue3`] [`webrtc`]  
...
- [zh-lx/pinyin-pro](https://github.com/zh-lx/pinyin-pro) ★4437 [`hanzi`] [`hanzi-pinyin`] [`hanzi2pinyin`] [`js-pinyin`] [`pinyin`] [`pinyin-match`] [`pinyin-pro`]  
...
- [salarcode/SmartProxy](https://github.com/salarcode/SmartProxy) ★2520 [`browser-extension`] [`chrome`] [`chrome-extension`] [`edge-extension`] [`firefox`] [`firefox-addon`] [`firefox-extension`] [`proxy`] [`proxy-list`] [`proxy-switcher`] [`webextension`] [`webextensions`]  
...
- [Cloxl/CursorPool_Client](https://github.com/Cloxl/CursorPool_Client) ★595  
...
- [abbodi1406/vcredist](https://github.com/abbodi1406/vcredist) ★7113  
...
- [vbenjs/vue-vben-admin](https://github.com/vbenjs/vue-vben-admin) ★30505 [`admin-template`] [`ant-design`] [`element-plus`] [`monorepo`] [`naive-ui`] [`shadcn-ui`] [`tsx`] [`typescript`] [`vben`] [`vite`] [`vite-template`] [`vue-router`] [`vue3`] [`vuex`]  
...
- [Lissy93/dashy](https://github.com/Lissy93/dashy) ★22994 [`awesome`] [`dashboard`] [`docker`] [`hacktoberfest`] [`homelab`] [`homepage`] [`mit`] [`nodejs`] [`organization`] [`productivity`] [`pwa`] [`self-hosted`] [`startpage`] [`vue`]  
...
- [pure-admin/vue-pure-admin](https://github.com/pure-admin/vue-pure-admin) ★19141 [`admin`] [`element-plus`] [`esm`] [`pinia`] [`tailwindcss`] [`typescript`] [`vite`] [`vue3`]  
...
- [chaitin/xray](https://github.com/chaitin/xray) ★11289 [`passive-vulnerability-scanner`] [`poc`] [`security`] [`sqlinjection`] [`vulnerability`] [`vulnerability-scanner`] [`xss`]  
...
- [doocs/md](https://github.com/doocs/md) ★10946 [`ai-bot`] [`doocs`] [`editor`] [`llm`] [`markdown`] [`markdown-editor`] [`tailwindcss`] [`vite`] [`vue`] [`vue3`] [`wechat`] [`weixin`]  
...
- [Akryum/vue-virtual-scroller](https://github.com/Akryum/vue-virtual-scroller) ★10480 [`scroller`] [`virtual-scroller`] [`vuejs`] [`vuejs-components`] [`vuejs2`]  
...
- [jason5ng32/MyIP](https://github.com/jason5ng32/MyIP) ★9249 [`awesome`] [`censorship`] [`chatgpt`] [`dns`] [`ip`] [`ipinfo`] [`leaks`] [`myip`] [`network`] [`pingchecker`] [`proxy`] [`security`] [`security-tools`] [`speedtest`] [`vercel`] [`webrtc`] [`whatismyip`] [`whatismyipaddress`] [`whois`] [`whois-lookup`]  
...
- [hslr-s/sun-panel](https://github.com/hslr-s/sun-panel) ★4602 [`docker`] [`gin`] [`golang`] [`homelab`] [`homepage`] [`nas`] [`navigationpage`] [`raspberry-pi`] [`self-hosted`] [`startpage`] [`synology`] [`vue3`]  
...
- [HuLaSpark/HuLa](https://github.com/HuLaSpark/HuLa) ★4518 [`chatbot`] [`cross-platform`] [`cross-platform-app`] [`macos`] [`mobile`] [`rust`] [`tauri`] [`tsx`] [`vue3`] [`webview`] [`windows`] [`windows-10`] [`windows-11`]  
