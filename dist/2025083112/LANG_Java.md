...
- [Stirling-Tools/Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF) ★64811 [`docker`] [`java`] [`pdf`] [`pdf-converter`] [`pdf-editor`] [`pdf-manipulation`] [`pdf-merger`] [`pdf-ocr`] [`pdf-tools`] [`pdf-web-apps`] [`pdfmerger`]  
...
- [skylot/jadx](https://github.com/skylot/jadx) ★45299 [`android`] [`decompiler`] [`dex`] [`java`]  
...
- [termux/termux-app](https://github.com/termux/termux-app) ★44600 [`android`] [`hacktoberfest`] [`linux`] [`terminal`] [`termux`]  
...
- [halo-dev/halo](https://github.com/halo-dev/halo) ★36761 [`blog`] [`blog-engine`] [`cms`] [`content-management-system`] [`halo`] [`halocms`]  
...
- [justauth/JustAuth](https://github.com/justauth/JustAuth) ★17158 [`googlelogin`] [`justauth`] [`oauth2`] [`qqlogin`] [`weixinlogin`]  
...
- [microg/GmsCore](https://github.com/microg/GmsCore) ★10774 [`android`] [`auth`] [`cloud-messaging`] [`firebase`] [`geolocation`] [`google`] [`google-cloud-messaging`] [`java`] [`kotlin`] [`kotlin-android`] [`maps`] [`microg`] [`mobile`] [`push-notifications`]  
...
- [jeecgboot/jimureport](https://github.com/jeecgboot/jimureport) ★7430 [`bi`] [`bigscreen`] [`birt`] [`data-analysis`] [`data-visualization`] [`dataease`] [`datav`] [`echart`] [`echarts`] [`finereport`] [`highcharts`] [`ireport`] [`jasperreport`] [`jfreechart`] [`metabase`] [`print`] [`redash`] [`report`] [`superset`] [`tableau`]  
...
- [FongMi/TV](https://github.com/FongMi/TV) ★6428 [`catvod`] [`danmaku`] [`leanback`] [`media3`] [`p2p`] [`thunder`] [`tvbus`]  
...
- [SuperMonster003/AutoJs6](https://github.com/SuperMonster003/AutoJs6) ★4520 [`android`] [`autojs`] [`autojs6`] [`automated-tool`] [`automation`] [`javascript`]  
...
- [niumoo/bing-wallpaper](https://github.com/niumoo/bing-wallpaper) ★2997 [`bing`] [`bing-image`] [`bing-wallpaper`] [`wallpaper`]  
