...
- [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) ★156465 [`activator`] [`hwid`] [`kms`] [`kms38`] [`massgrave`] [`massgravel`] [`microsoft`] [`microsoft365`] [`office`] [`office365`] [`ohook`] [`powershell`] [`tsforge`] [`windows`] [`windows-10`] [`windows-11`]  
...
- [Atlas-OS/Atlas](https://github.com/Atlas-OS/Atlas) ★18584 [`ame-wizard`] [`atlas`] [`atlasos`] [`debloat`] [`fps`] [`gaming`] [`latency`] [`open-source`] [`opensource`] [`performance`] [`privacy`] [`security`] [`tweaks`] [`windows`]  
...
- [FongMi/Release](https://github.com/FongMi/Release) ★5042  
...
- [kkkgo/LTSC-Add-MicrosoftStore](https://github.com/kkkgo/LTSC-Add-MicrosoftStore) ★3793  
...
- [Genymobile/scrcpy](https://github.com/Genymobile/scrcpy) ★131212 [`android`] [`c`] [`ffmpeg`] [`libav`] [`mirroring`] [`recording`] [`screen`] [`sdl2`]  
...
- [ventoy/Ventoy](https://github.com/ventoy/Ventoy) ★72424 [`auto-install`] [`bootable-usb`] [`bsd`] [`chromeos`] [`iso-files`] [`legacy`] [`linux`] [`multiboot`] [`persistence`] [`secure-boot`] [`uefi`] [`unattended`] [`unix`] [`usb`] [`windows`]  
...
- [bilibili/ijkplayer](https://github.com/bilibili/ijkplayer) ★33044 [`android`] [`ffmpeg`] [`ijkplayer`] [`ios`] [`player`] [`video`]  
...
- [jqlang/jq](https://github.com/jqlang/jq) ★33015 [`jq`]  
...
- [coolsnowwolf/lede](https://github.com/coolsnowwolf/lede) ★31110 [`lede`] [`lua`] [`openwrt-feed`] [`openwrt-package`] [`openwrt-zh-cn`]  
...
- [valinet/ExplorerPatcher](https://github.com/valinet/ExplorerPatcher) ★30077  
...
- [openssl/openssl](https://github.com/openssl/openssl) ★29012 [`cryptography`] [`decryption`] [`encryption`] [`openssl`] [`ssl`] [`tls`]  
...
- [kingToolbox/WindTerm](https://github.com/kingToolbox/WindTerm) ★28734 [`bash`] [`client`] [`cmd`] [`linux`] [`mac`] [`powershell`] [`serial`] [`sftp`] [`shell`] [`ssh`] [`telnet`] [`terminal`] [`tmux`] [`windows`] [`wsl`] [`x11`] [`xmodem`] [`xterm`] [`ymodem`] [`zmodem`]  
...
- [facebook/zstd](https://github.com/facebook/zstd) ★26037  
...
- [jarun/nnn](https://github.com/jarun/nnn) ★20859 [`android`] [`batch-rename`] [`c`] [`cli`] [`command-line`] [`developer-tools`] [`disk-usage`] [`file-manager`] [`file-preview`] [`file-search`] [`filesystem`] [`launcher`] [`multi-platform`] [`ncurses`] [`productivity`] [`raspberry-pi`] [`terminal`] [`tui`] [`vim`] [`wsl`]  
...
- [coturn/coturn](https://github.com/coturn/coturn) ★13205 [`networking`] [`server`] [`turn`]  
...
- [SoftEtherVPN/SoftEtherVPN](https://github.com/SoftEtherVPN/SoftEtherVPN) ★12736 [`etherip`] [`ike`] [`ipsec`] [`l2tp`] [`l2tpv3`] [`openvpn`] [`softether-vpn`] [`softethervpn`] [`ssl-vpn`] [`sstp`] [`tls`] [`vpn`] [`vpn-protocols`] [`vpn-server`] [`vpn-tunnel`] [`wfh`] [`wireguard`] [`work-from-home`]  
...
- [vanhauser-thc/thc-hydra](https://github.com/vanhauser-thc/thc-hydra) ★11188 [`brute-force`] [`brute-force-attacks`] [`brute-force-passwords`] [`bruteforce`] [`bruteforce-attacks`] [`bruteforcer`] [`bruteforcing`] [`hydra`] [`network-security`] [`password-cracker`] [`password-cracking`] [`penetration-testing`] [`pentest`] [`pentest-tool`] [`pentesting`] [`thc`]  
...
- [rofl0r/proxychains-ng](https://github.com/rofl0r/proxychains-ng) ★10349 [`hack`] [`hook`] [`http`] [`preload`] [`proxy`] [`proxychains`] [`socks`]  
...
- [pymumu/smartdns](https://github.com/pymumu/smartdns) ★10194 [`c`] [`dns`] [`dns-over-https`] [`dns-over-tls`] [`dns-server`] [`dns64`] [`doh`] [`doh3`] [`doq`] [`dot`] [`nftables`] [`nftables-sets`] [`openwrt`] [`openwrt-package`] [`smartdns`] [`stubby`]  
...
- [xmrig/xmrig](https://github.com/xmrig/xmrig) ★9588 [`argon2`] [`cpuminer`] [`cryptocurrency`] [`cryptonight`] [`miner`] [`monero`] [`randomx`] [`xmr`] [`xmrig`]  
...
- [esnet/iperf](https://github.com/esnet/iperf) ★8030  
...
- [winfsp/winfsp](https://github.com/winfsp/winfsp) ★8005 [`driver`] [`filesystem`] [`fuse`] [`gplv3`] [`kernel`] [`windows`] [`windows-kernel`]  
...
- [istoreos/istoreos](https://github.com/istoreos/istoreos) ★6897 [`istore`] [`istoreos`] [`koolcenter`] [`linkease`] [`nas`] [`openwrt`] [`router`]  
...
- [ntop/n2n](https://github.com/ntop/n2n) ★6747 [`peer-to-peer`] [`vpn`]  
...
- [akopytov/sysbench](https://github.com/akopytov/sysbench) ★6559 [`benchmark`] [`console`] [`freebsd`] [`linux`] [`lua`] [`luajit`] [`macos`] [`micro-benchmarks`] [`mysql`] [`oltp`] [`postgresql`] [`sysbench`]  
...
- [JoeDog/siege](https://github.com/JoeDog/siege) ★6151  
...
- [sabrogden/Ditto](https://github.com/sabrogden/Ditto) ★5470 [`clipboard`] [`clipboard-manager`]  
...
- [3proxy/3proxy](https://github.com/3proxy/3proxy) ★4710 [`accounting`] [`c`] [`https-proxy`] [`ipv6`] [`network-management`] [`network-security`] [`portmap`] [`proxy`] [`proxy-server`] [`sni`] [`socks`] [`socks-proxy`] [`socks-server`] [`socks5`] [`socks5-proxy`] [`socks5-server`] [`stunnel`] [`tls-proxy`] [`traffic-shaping`]  
...
- [RsyncProject/rsync](https://github.com/RsyncProject/rsync) ★3976  
...
- [schwabe/ics-openvpn](https://github.com/schwabe/ics-openvpn) ★3693 [`android`] [`openvpn`]  
...
- [heiher/natmap](https://github.com/heiher/natmap) ★1786 [`bsd`] [`linux`] [`macos`] [`nat1`] [`port-mapping`] [`tcp`] [`udp`] [`windows`]  
...
- [microsoft/PowerToys](https://github.com/microsoft/PowerToys) ★125770 [`color-picker`] [`command-palette`] [`desktop`] [`fancyzones`] [`keyboard-manager`] [`microsoft-powertoys`] [`powerrename`] [`powertoys`] [`windows`] [`windows-10`] [`windows-11`]  
...
- [2dust/v2rayN](https://github.com/2dust/v2rayN) ★90229 [`proxy`] [`shadowsocks`] [`socks5`] [`trojan`] [`v2fly`] [`v2ray`] [`vless`] [`vmess`] [`windows`] [`xray`] [`xtls`]  
...
- [shadowsocks/shadowsocks-windows](https://github.com/shadowsocks/shadowsocks-windows) ★59124 [`c-sharp`] [`proxy`] [`shadowsocks`]  
...
- [PowerShell/PowerShell](https://github.com/PowerShell/PowerShell) ★50791 [`command-line`] [`hacktoberfest`] [`linux`] [`macos`] [`netcore`] [`powershell`] [`shell`] [`windows`]  
  这是一个用于PowerShell的项目，具体功能不明确。  需要更多信息才能生成合适的项目描述。 请提供GitHub项目链接。
- [huiyadanli/RevokeMsgPatcher](https://github.com/huiyadanli/RevokeMsgPatcher) ★35602 [`hex-editor`] [`patch`] [`pc`] [`qq`] [`revoke`] [`revokemsg`] [`tim`] [`tool`] [`wechat`] [`windows`]  
...
- [AvaloniaUI/Avalonia](https://github.com/AvaloniaUI/Avalonia) ★29280 [`android`] [`app-framework`] [`avalonia`] [`avaloniaui`] [`browser`] [`c-sharp`] [`cross-platform`] [`csharp`] [`desktop`] [`dotnet`] [`gui`] [`ios`] [`linux`] [`macos`] [`mobile`] [`mvvm`] [`wasm`] [`windows`] [`xamarin`] [`xaml`]  
...
- [rocksdanister/lively](https://github.com/rocksdanister/lively) ★17589 [`csharp`] [`desktop`] [`desktop-wallpaper`] [`dynamic-desktop`] [`dynamic-wallpaper`] [`fluent-design`] [`live-wallpaper`] [`screensavers`] [`wallpaper`] [`wallpaper-app`] [`wallpaper-changer`] [`wallpaper-engine`] [`wallpaperengine`] [`wallpapers`] [`widgets`] [`windows-10`] [`windows-11`] [`windows-app`] [`winui`] [`winui3`]  
...
- [bitwarden/server](https://github.com/bitwarden/server) ★17459 [`api`] [`aspnet`] [`aspnetcore`] [`bitwarden`] [`csharp`] [`docker`] [`dotnet`] [`dotnet-core`] [`signalr`] [`sql`] [`sql-server`]  
...
- [shadowsocksrr/shadowsocksr-csharp](https://github.com/shadowsocksrr/shadowsocksr-csharp) ★15208  
...
- [winsw/winsw](https://github.com/winsw/winsw) ★13439 [`csharp`] [`dotnet`] [`nuget`] [`windows-service`] [`windows-service-wrapper`]  
...
- [d2phap/ImageGlass](https://github.com/d2phap/ImageGlass) ★11599 [`avif`] [`csharp`] [`direct2d`] [`dotnet`] [`heic`] [`heif`] [`image-viewer`] [`imageglass`] [`jpeg-xl`] [`jxl`] [`photo-viewer`] [`picture-gallery`] [`picture-viewer`] [`raw`] [`raw-image`] [`svg`] [`svg-viewer`] [`winforms`]  
...
- [OdysseusYuan/LKY_OfficeTools](https://github.com/OdysseusYuan/LKY_OfficeTools) ★10947 [`access`] [`email`] [`excel`] [`kms`] [`lync`] [`microsoft`] [`msoffice`] [`office`] [`office-free`] [`office365`] [`onedrive`] [`onenote`] [`outlook`] [`ppt`] [`project`] [`publisher`] [`skype`] [`teams`] [`visio`] [`word`]  
...
- [cefsharp/CefSharp](https://github.com/cefsharp/CefSharp) ★10161 [`browser`] [`c-plus-plus`] [`c-sharp`] [`cefsharp`] [`framework`] [`winforms`] [`wpf`]  
...
- [dnSpyEx/dnSpy](https://github.com/dnSpyEx/dnSpy) ★9262 [`baml`] [`csharp`] [`debug`] [`debugger`] [`decompile`] [`decompiler`] [`dotnet`] [`dotnetcore`] [`dotnetframework`] [`mono`] [`unity`] [`vbnet`] [`xaml`]  
...
- [git-ecosystem/git-credential-manager](https://github.com/git-ecosystem/git-credential-manager) ★8269 [`aad`] [`authentication`] [`azure-devops`] [`azure-repos`] [`bitbucket`] [`credential`] [`cross-platform`] [`git`] [`github`] [`gitlab`]  
...
- [nilaoda/N_m3u8DL-RE](https://github.com/nilaoda/N_m3u8DL-RE) ★6762 [`dash`] [`ffmpeg`] [`hls`] [`ism`] [`live`] [`m3u8`] [`m3u8-downloader`] [`mpd`] [`recorder`]  
...
- [TechnitiumSoftware/DnsServer](https://github.com/TechnitiumSoftware/DnsServer) ★6610 [`cross-platform`] [`dhcp-server`] [`dns`] [`dns-client`] [`dns-over-https`] [`dns-over-quic`] [`dns-over-tls`] [`dns-over-tor`] [`dns-server`] [`dotnet`] [`privacy`] [`technitium-dns-server`]  
...
- [HMBSbige/NatTypeTester](https://github.com/HMBSbige/NatTypeTester) ★4264 [`csharp`] [`nat`] [`rfc3489`] [`rfc5389`] [`rfc5780`] [`rfc8489`] [`stun`] [`tcp`] [`tls`] [`udp`] [`winui3`] [`wpf`]  
...
- [Jeric-X/SyncClipboard](https://github.com/Jeric-X/SyncClipboard) ★3635  
...
- [LorenzCK/OnTopReplica](https://github.com/LorenzCK/OnTopReplica) ★3161 [`dwm`] [`thumbnails`] [`tool`] [`windowing`] [`windows`] [`windows-desktop`]  
...
- [ClassIsland/ClassIsland](https://github.com/ClassIsland/ClassIsland) ★1911 [`automation`] [`avalonia`] [`classisland`] [`classroom`] [`dotnet`] [`education`] [`fluent-design`] [`fluentavalonia`] [`linux`] [`macos`] [`plugins`] [`tools`] [`windows`]  
...
- [SuperStudio/SuperCom](https://github.com/SuperStudio/SuperCom) ★1145  
...
- [yclown/ql_jd_cookie](https://github.com/yclown/ql_jd_cookie) ★636  
...
- [electron/electron](https://github.com/electron/electron) ★119116 [`c-plus-plus`] [`chrome`] [`css`] [`electron`] [`html`] [`javascript`] [`nodejs`] [`v8`] [`works-with-codespaces`]  
...
- [microsoft/terminal](https://github.com/microsoft/terminal) ★100866 [`cmd`] [`command-line`] [`console`] [`contributions-welcome`] [`good-first-issue`] [`hacktoberfest`] [`terminal`] [`windows`] [`windows-console`] [`windows-terminal`] [`wsl`]  
...
- [tesseract-ocr/tesseract](https://github.com/tesseract-ocr/tesseract) ★70952 [`hacktoberfest`] [`lstm`] [`machine-learning`] [`ocr`] [`ocr-engine`] [`tesseract`] [`tesseract-ocr`]  
...
- [aria2/aria2](https://github.com/aria2/aria2) ★39235 [`bittorrent`] [`cpp11`] [`download`] [`ftp`] [`http`] [`metalink`] [`rpc`] [`sftp`]  
...
- [qbittorrent/qBittorrent](https://github.com/qbittorrent/qBittorrent) ★33987 [`bittorrent`] [`bittorrent-client`] [`c-plus-plus`] [`crossplatform`] [`torrent`] [`torrent-client`]  
...
- [LizardByte/Sunshine](https://github.com/LizardByte/Sunshine) ★31468 [`cpp`] [`docker`] [`flathub-pkg`] [`game-stream`] [`game-streaming`] [`game-streaming-server`] [`geforce-experience`] [`homebrew-pkg`] [`maintainer-wanted`] [`moonlight`] [`pacman-pkg`] [`python`] [`remote-desktop`] [`replicator-custom-issues`] [`replicator-release-notifications`] [`rtd`] [`winget-pkg`]  
...
- [c0re100/qBittorrent-Enhanced-Edition](https://github.com/c0re100/qBittorrent-Enhanced-Edition) ★24273 [`bittorrent`] [`bittorrent-client`]  
...
- [redis/RedisDesktopManager](https://github.com/redis/RedisDesktopManager) ★23207  
...
- [google/filament](https://github.com/google/filament) ★19047 [`3d-graphics`] [`android`] [`gltf`] [`gltf-viewer`] [`graphics`] [`metal`] [`opengl`] [`opengl-es`] [`pbr`] [`real-time`] [`vulkan`] [`wasm`] [`webgl`]  
...
- [zerotier/ZeroTierOne](https://github.com/zerotier/ZeroTierOne) ★16137 [`decentralization`] [`networking`] [`peer-to-peer`] [`sd-wan`] [`sdn`] [`virtual-network`] [`vpn`]  
...
- [tindy2013/subconverter](https://github.com/tindy2013/subconverter) ★15322 [`clash`] [`clashr`] [`emoji`] [`gist`] [`quantumult`] [`quantumultx`] [`regular-expression`] [`rename`] [`ss`] [`ssr`] [`subconverter`] [`surfboard`] [`surge`] [`v2ray`]  
...
- [moonlight-stream/moonlight-qt](https://github.com/moonlight-stream/moonlight-qt) ★15097 [`gamestream`] [`linux-app`] [`macos-app`] [`moonlight`] [`nvidia`] [`qt`] [`sdl2`] [`steam-link`] [`windows-app`]  
...
- [cxasm/notepad--](https://github.com/cxasm/notepad--) ★8400  
...
- [wangyu-/udp2raw](https://github.com/wangyu-/udp2raw) ★8144 [`bypass-firewall`] [`fake-header`] [`faketcp`] [`icmp`] [`icmp-tunnel`] [`icmptunnel`] [`raw-socket`] [`raw-tunnel`] [`tcp`] [`tunnel`] [`udp`] [`udp-tunnel`]  
...
- [BlueMatthew/WechatExporter](https://github.com/BlueMatthew/WechatExporter) ★7167 [`backup`] [`chat`] [`dump`] [`export`] [`friend`] [`history`] [`itunes`] [`libmp3lame`] [`libplist`] [`silk`] [`wechat`]  
...
- [TonyChen56/WeChatRobot](https://github.com/TonyChen56/WeChatRobot) ★6973 [`wechat`] [`wechatapi`] [`wechatrobot`] [`wxhook`]  
...
- [TigerVNC/tigervnc](https://github.com/TigerVNC/tigervnc) ★6615  
...
- [rime/weasel](https://github.com/rime/weasel) ★6239  
...
- [zhongyang219/MusicPlayer2](https://github.com/zhongyang219/MusicPlayer2) ★5895  
...
- [Tatsu-syo/noMeiryoUI](https://github.com/Tatsu-syo/noMeiryoUI) ★5792  
...
- [xfangfang/wiliwili](https://github.com/xfangfang/wiliwili) ★4652 [`bilibili`] [`mpv`] [`nanovg`] [`nintendo-switch`] [`nintendo-switch-homebrew`] [`opencc`] [`opengl`] [`ps4`] [`psv`] [`xbox`]  
...
- [cppla/ServerStatus](https://github.com/cppla/ServerStatus) ★4579  
...
- [qiin2333/Sunshine-Foundation](https://github.com/qiin2333/Sunshine-Foundation) ★3458 [`cloudgaming`] [`game-streaming`] [`moonlight`] [`remote-desktop`] [`stream`] [`sunshine`]  
...
- [kiwibrowser/src.next](https://github.com/kiwibrowser/src.next) ★3317  
...
- [jwise/HoRNDIS](https://github.com/jwise/HoRNDIS) ★3178  
...
- [ttttupup/wxhelper](https://github.com/ttttupup/wxhelper) ★2943 [`hook`] [`reverse`] [`wechat`] [`weixin`]  
...
- [MicrosoftEdge/WebView2Samples](https://github.com/MicrosoftEdge/WebView2Samples) ★979  
...
- [Frank-Friemel/Shairport4w](https://github.com/Frank-Friemel/Shairport4w) ★670  
...
- [microsoft/vcpkg](https://github.com/microsoft/vcpkg) ★26089 [`c`] [`cmake`] [`cplusplus`] [`cpp`] [`libraries`] [`package-manager`] [`packages`] [`vcpkg`] [`visual-studio`] [`windows`]  
...
- [FelisCatus/SwitchyOmega](https://github.com/FelisCatus/SwitchyOmega) ★22429  
...
- [zero-peak/ZeroOmega](https://github.com/zero-peak/ZeroOmega) ★6492 [`proxy`] [`switchyomega`] [`zeroomega`]  
...
- [houshanren/hangzhou_house_knowledge](https://github.com/houshanren/hangzhou_house_knowledge) ★27141 [`hangzhou`] [`knowledge`]  
...
- [sindresorhus/github-markdown-css](https://github.com/sindresorhus/github-markdown-css) ★8665  
...
- [thedevdojo/wave](https://github.com/thedevdojo/wave) ★6356 [`devdojo`] [`hacktoberfest`] [`laravel`] [`php`] [`saas`] [`saas-boilerplate`] [`subscription`] [`tailwindcss`] [`voyager`] [`wave`]  
...
- [vanyouseea/o365](https://github.com/vanyouseea/o365) ★331 [`docker`] [`easyui`] [`h2-database`] [`jpa`] [`springboot`] [`springboot-cache`] [`springboot-security`] [`thymeleaf`]  
...
- [AppFlowy-IO/AppFlowy](https://github.com/AppFlowy-IO/AppFlowy) ★66532 [`blog`] [`confluence-alternative`] [`content-management`] [`content-services`] [`documentation`] [`flutter`] [`note-taking`] [`notion-alternative`] [`project-management`] [`task-management`] [`team-collaboration`] [`wiki`]  
...
- [GopeedLab/gopeed](https://github.com/GopeedLab/gopeed) ★21780 [`android`] [`bittorrent`] [`cross-platform`] [`debian`] [`downloader`] [`flutter`] [`golang`] [`http`] [`https`] [`ios`] [`macos`] [`magnet`] [`torrent`] [`ubuntu`] [`windows`]  
...
- [guozhigq/pilipala](https://github.com/guozhigq/pilipala) ★12865 [`bilibili`] [`dart`] [`flutter`] [`material-ui`]  
...
- [wanghongenpin/proxypin](https://github.com/wanghongenpin/proxypin) ★11001 [`capture-traffic`] [`charles`] [`fiddler`] [`proxy`] [`proxypin`] [`zhuabao`]  
...
- [ComicSparks/pikapika](https://github.com/ComicSparks/pikapika) ★7653 [`acg`] [`android`] [`bika`] [`comic-books`] [`cosplay`] [`cross-platform`] [`e-hentai`] [`flutter`] [`game`] [`go`] [`golang`] [`hentai`] [`ios`] [`picacg`] [`picacomic`] [`r-18`]  
...
- [Anduin2017/HowToCook](https://github.com/Anduin2017/HowToCook) ★95871 [`chinese`] [`cookbook`] [`cooking`] [`dishes`] [`recipes`]  
...
- [jaywcjlove/reference](https://github.com/jaywcjlove/reference) ★14692 [`cheatsheet`] [`docker`] [`javascript`] [`npm`] [`npm-package`] [`react`] [`reactjs`] [`references`] [`semver`] [`toml`] [`typescript`] [`vue3`] [`vuejs`]  
...
- [RICwang/docker-wechat](https://github.com/RICwang/docker-wechat) ★864  
...
- [Fechin/reference](https://github.com/Fechin/reference) ★9474 [`awk`] [`bash`] [`chatgpt`] [`cheatsheet`] [`cheatsheets`] [`css`] [`golang`] [`grep`] [`markdown`] [`python`] [`reference`] [`sed`] [`snippets`] [`vim`]  
...
- [fatedier/frp](https://github.com/fatedier/frp) ★100757 [`expose`] [`firewall`] [`frp`] [`go`] [`http-proxy`] [`nat`] [`p2p`] [`proxy`] [`reverse-proxy`] [`tunnel`]  
...
- [syncthing/syncthing](https://github.com/syncthing/syncthing) ★77629 [`go`] [`p2p`] [`peer-to-peer`] [`synchronization`]  
...
- [junegunn/fzf](https://github.com/junegunn/fzf) ★75138 [`bash`] [`cli`] [`fish`] [`fzf`] [`go`] [`neovim`] [`tmux`] [`unix`] [`vim`] [`zsh`]  
...
- [minio/minio](https://github.com/minio/minio) ★58258 [`amazon-s3`] [`cloud`] [`cloudnative`] [`cloudstorage`] [`go`] [`k8s`] [`kubernetes`] [`multi-cloud`] [`multi-cloud-kubernetes`] [`objectstorage`] [`s3`] [`storage`]  
...
- [FiloSottile/mkcert](https://github.com/FiloSottile/mkcert) ★57170 [`certificates`] [`chrome`] [`firefox`] [`https`] [`ios`] [`linux`] [`local-development`] [`localhost`] [`macos`] [`root-ca`] [`tls`] [`windows`]  
...
- [rclone/rclone](https://github.com/rclone/rclone) ★53569 [`azure-blob`] [`azure-blob-storage`] [`azure-files`] [`backblaze-b2`] [`cloud-storage`] [`dropbox`] [`encryption`] [`ftp`] [`fuse-filesystem`] [`go`] [`golang`] [`google-cloud-storage`] [`google-drive`] [`onedrive`] [`openstack-swift`] [`rclone`] [`s3`] [`sftp`] [`sync`] [`webdav`]  
...
- [go-gitea/gitea](https://github.com/go-gitea/gitea) ★52020 [`bitbucket`] [`cicd`] [`devops`] [`docker-registry-v2`] [`git`] [`git-gui`] [`git-server`] [`gitea`] [`github`] [`github-actions`] [`gitlab`] [`go`] [`golang`] [`hacktoberfest`] [`maven-server`] [`npm-registry`] [`vue`]  
...
- [v2ray/v2ray-core](https://github.com/v2ray/v2ray-core) ★46688 [`golang`] [`http-proxy`] [`proxy`] [`shadowsocks`] [`socks`] [`socks5`] [`v2ray`] [`vmess`]  
...
- [usememos/memos](https://github.com/usememos/memos) ★46128 [`docker`] [`foss`] [`go`] [`markdown`] [`memo`] [`microblog`] [`note-taking`] [`notecard`] [`react`] [`self-hosted`] [`social-network`] [`sqlite`]  
...
- [coreybutler/nvm-windows](https://github.com/coreybutler/nvm-windows) ★43693 [`go`] [`management`] [`node`] [`node-version-manager`] [`nodejs`] [`nvm`] [`switch`] [`version`] [`version-manager`] [`versioning`] [`windows`]  
...
- [ehang-io/nps](https://github.com/ehang-io/nps) ★33636 [`dns`] [`firewall`] [`go`] [`gzip`] [`http`] [`https`] [`nat`] [`nps`] [`snnapy`] [`socks`] [`socks5`] [`ssh`] [`tcp`] [`tunnel`] [`udp`]  
...
- [juanfont/headscale](https://github.com/juanfont/headscale) ★32794 [`tailscale`] [`tailscale-control-server`] [`tailscale-server`] [`wireguard`]  
...
- [schollz/croc](https://github.com/schollz/croc) ★32016 [`data-transfer`] [`file-sharing`] [`golang`] [`pake`] [`peer-to-peer`] [`tcp`] [`transfer`]  
...
- [filebrowser/filebrowser](https://github.com/filebrowser/filebrowser) ★32000 [`file-browser`] [`file-manager`] [`file-sharing`] [`go`] [`material-design`] [`self-hosted`] [`vue`]  
  这是一个用于浏览和管理文件的Web应用程序。它使用Python和Flask框架构建，提供文件上传、下载、删除、重命名等基本操作。用户可以通过Web界面直观地查看和操作文件，支持多种文件类型。项目包含用户认证模块，确保文件访问权限安全。
- [iawia002/lux](https://github.com/iawia002/lux) ★30629 [`bilibili`] [`crawler`] [`download`] [`downloader`] [`go`] [`golang`] [`iqiyi`] [`qq`] [`scraper`] [`tumblr`] [`video`] [`youku`] [`youtube`]  
...
- [binwiederhier/ntfy](https://github.com/binwiederhier/ntfy) ★27338 [`curl`] [`notifications`] [`ntfy`] [`ntfysh`] [`pubsub`] [`push-notifications`] [`rest-api`]  
...
- [Wox-launcher/Wox](https://github.com/Wox-launcher/Wox) ★26325 [`alfred`] [`launcher`] [`launchy`] [`linux`] [`macos`] [`raycast`] [`spotlight`] [`windows`] [`wox`]  
...
- [tailscale/tailscale](https://github.com/tailscale/tailscale) ★26006 [`2fa`] [`oauth`] [`sso`] [`tailscale`] [`vpn`] [`wireguard`]  
...
- [cloudreve/cloudreve](https://github.com/cloudreve/cloudreve) ★25531 [`cloud`] [`cloud-storage`] [`cloudreve`] [`file`] [`file-manager`] [`file-sharing`] [`golang`]  
...
- [containrrr/watchtower](https://github.com/containrrr/watchtower) ★24159 [`automation`] [`continuous-delivery`] [`devops`] [`docker`] [`hacktoberfest`] [`notifications`] [`receive-notifications`] [`registry`] [`update-checker`] [`watchtower`]  
...
- [XIU2/CloudflareSpeedTest](https://github.com/XIU2/CloudflareSpeedTest) ★23376 [`cdn`] [`cloudflare`] [`go`] [`golang`] [`speedtest`]  
...
- [chaitin/SafeLine](https://github.com/chaitin/SafeLine) ★19223 [`api-gateway`] [`application-security`] [`appsec`] [`blueteam`] [`bruteforce`] [`captcha`] [`cve`] [`cybersecurity`] [`firewall`] [`hackers`] [`http-flood`] [`security`] [`self-hosted`] [`sql-injection`] [`vulnerability`] [`waf`] [`web-application-firewall`] [`web-security`] [`websecurity`] [`xss`]  
...
- [OpenListTeam/OpenList](https://github.com/OpenListTeam/OpenList) ★17895 [`alist`] [`aliyunpan`] [`baidupan`] [`openlist`]  
...
- [apernet/hysteria](https://github.com/apernet/hysteria) ★17740 [`censorship-circumvention`] [`golang`] [`http-proxy`] [`hysteria`] [`proxy`] [`quic`] [`relay`] [`reliable-udp`] [`socks5`] [`tun`] [`vpn`]  
...
- [ginuerzh/gost](https://github.com/ginuerzh/gost) ★17278 [`dns`] [`go`] [`golang`] [`http2`] [`kcp`] [`obfs4`] [`quic`] [`shadowsocks`] [`sni`] [`socks5`] [`ssh`] [`tls`] [`tunnel`] [`tuntap`] [`udp`]  
...
- [ory/hydra](https://github.com/ory/hydra) ★16688 [`authorization`] [`cloud`] [`docker`] [`federation`] [`hacktoberfest`] [`hydra`] [`identity`] [`oauth`] [`oauth-provider`] [`oauth2`] [`oauth2-provider`] [`oauth2-server`] [`oidc`] [`openid`] [`openid-connect`] [`openid-connect-provider`] [`openid-provider`] [`security`] [`server`] [`sso`]  
...
- [slackhq/nebula](https://github.com/slackhq/nebula) ★16489  
...
- [m1k1o/neko](https://github.com/m1k1o/neko) ★15876 [`docker`] [`golang`] [`media-streaming`] [`remote-control`] [`remote-desktop`] [`self-hosted`] [`virtual-browser`] [`vue`] [`webrtc`]  
...
- [jeessy2/ddns-go](https://github.com/jeessy2/ddns-go) ★15672 [`alidns`] [`baiduyun`] [`cloudflare`] [`ddns`] [`ddns-go`] [`dnspod`] [`godaddy-ddns`] [`google-domains`] [`porkbun`]  
...
- [gotify/server](https://github.com/gotify/server) ★14054 [`api`] [`cloud`] [`free-software`] [`golang`] [`gotify`] [`hosting`] [`javascript`] [`notifications`] [`privacy`] [`react`] [`self-hosted`] [`self-hosting`] [`selfhosted`]  
...
- [shadow1ng/fscan](https://github.com/shadow1ng/fscan) ★12968  
...
- [tinode/chat](https://github.com/tinode/chat) ★12908 [`chat`] [`chat-application`] [`chatapp`] [`chatbots`] [`chatserver`] [`collaboration`] [`go`] [`golang`] [`instant-messaging`] [`messaging`] [`messaging-api`] [`messenger`] [`telegram`] [`video-call`] [`video-chat`] [`video-conferencing`] [`webchat-server`] [`webrtc`] [`whatsapp`] [`xmpp`]  
...
- [fullstorydev/grpcurl](https://github.com/fullstorydev/grpcurl) ★12225 [`golang`] [`grpc`] [`protobuf`]  
...
- [cloudflare/cloudflared](https://github.com/cloudflare/cloudflared) ★12001 [`cloudflare`] [`cloudflare-tunnel`] [`reverse-proxy`] [`zero-trust-network-access`]  
...
- [putyy/res-downloader](https://github.com/putyy/res-downloader) ★11984 [`douyin`] [`kuaishou`] [`res-downloader`] [`wechat`] [`wechat-video`] [`xiaohongshu`]  
...
- [gravitl/netmaker](https://github.com/gravitl/netmaker) ★11036 [`cloud`] [`devsecops`] [`ipv6-support`] [`k8s`] [`kubernetes`] [`mesh`] [`mesh-network`] [`overlay-network`] [`secure-remote-access`] [`security`] [`self-hosted`] [`site-to-site`] [`virtual-networking`] [`vpn`] [`vpn-server`] [`wg-quick`] [`wireguard`] [`wireguard-ui`] [`wireguard-vpn`] [`zero-trust`]  
...
- [Mrs4s/go-cqhttp](https://github.com/Mrs4s/go-cqhttp) ★10614 [`bot`] [`coolq`] [`coolq-http-api`] [`qqbot`] [`qqrobot`]  
...
- [0xJacky/nginx-ui](https://github.com/0xJacky/nginx-ui) ★9867 [`chatgpt-app`] [`code-completion`] [`copilot`] [`cron`] [`deepseek-r1`] [`docker`] [`go`] [`letsencrypt`] [`linux`] [`macos`] [`mcp`] [`mcp-server`] [`nginx`] [`self-hosted`] [`vue`] [`webui`] [`windows`]  
...
- [gokcehan/lf](https://github.com/gokcehan/lf) ★8752 [`file-manager`] [`terminal`]  
...
- [mindoc-org/mindoc](https://github.com/mindoc-org/mindoc) ★7746 [`beego`] [`document`] [`go`] [`golang`] [`mindoc`] [`smartwiki`]  
...
- [certimate-go/certimate](https://github.com/certimate-go/certimate) ★7702 [`acme`] [`acme-client`] [`automation`] [`certbot`] [`hacktoberfest`] [`https`] [`https-certificate`] [`lego`] [`letsencrypt`] [`ssl`] [`ssl-cert`] [`ssl-certificate`] [`ssl-certificates`]  
...
- [ViRb3/wgcf](https://github.com/ViRb3/wgcf) ★7296 [`client`] [`cloudflare`] [`plus`] [`security`] [`vpn`] [`warp`] [`wireguard`]  
...
- [nxtrace/NTrace-core](https://github.com/nxtrace/NTrace-core) ★7166 [`api`] [`as-path`] [`asn-lookup`] [`geoip`] [`geolocation`] [`ip-lookup`] [`network-analysis`] [`next-trace`] [`nexttrace`] [`traceroute`] [`utility`]  
...
- [gdy666/lucky](https://github.com/gdy666/lucky) ★6793 [`acme`] [`aliyunpan`] [`cron`] [`ddns`] [`dynadot`] [`filebrowser`] [`ftp`] [`ipv6`] [`socat`] [`stun`] [`vercel`] [`volcengine`] [`webdav`] [`wol`]  
...
- [ouqiang/gocron](https://github.com/ouqiang/gocron) ★6227 [`cron`] [`crontab`] [`golang`] [`scheduler`]  
...
- [iyear/tdl](https://github.com/iyear/tdl) ★6045 [`bash`] [`download`] [`downloader`] [`telegram`] [`telegram-api`] [`telegram-bot`] [`telegram-bots`] [`telegram-channel`] [`telegram-userbot`]  
...
- [git-jiadong/wechatDataBackup](https://github.com/git-jiadong/wechatDataBackup) ★5986 [`wechat`] [`wechat-app`] [`wechat-bot`]  
...
- [openark/orchestrator](https://github.com/openark/orchestrator) ★5733 [`high-availability`] [`management-system`] [`mysql`] [`replication`]  
...
- [Ackites/KillWxapkg](https://github.com/Ackites/KillWxapkg) ★5460  
...
- [hacdias/webdav](https://github.com/hacdias/webdav) ★4947 [`filesystem`] [`go`] [`http`] [`server`] [`webdav`]  
...
- [ngoduykhanh/wireguard-ui](https://github.com/ngoduykhanh/wireguard-ui) ★4932 [`wireguard`] [`wireguard-admin`] [`wireguard-config-gen`] [`wireguard-go`] [`wireguard-ui`] [`wireguard-vpn`] [`wireguard-web`]  
...
- [tickstep/aliyunpan](https://github.com/tickstep/aliyunpan) ★4836 [`adrive`] [`backup`] [`linux`] [`macos`] [`sync`] [`windows`]  
...
- [goravel/goravel](https://github.com/goravel/goravel) ★4271 [`framework`] [`go`] [`golang`] [`laravel`] [`performance`] [`web`]  
...
- [qjfoidnh/BaiduPCS-Go](https://github.com/qjfoidnh/BaiduPCS-Go) ★4181 [`baidupcs`]  
...
- [eyebluecn/tank](https://github.com/eyebluecn/tank) ★3180 [`golang`] [`linux`] [`storage`]  
...
- [yisier/nps](https://github.com/yisier/nps) ★3037 [`go`] [`http`] [`https`] [`nps`] [`tcp`] [`udp`]  
...
- [trzsz/trzsz-ssh](https://github.com/trzsz/trzsz-ssh) ★2297 [`mosh`] [`openssh`] [`openssh-client`] [`rz`] [`ssh`] [`ssh-client`] [`sz`] [`tmux`] [`trz`] [`trzsz`] [`tsz`] [`zmodem`]  
...
- [koho/frpmgr](https://github.com/koho/frpmgr) ★1825 [`frp`] [`frpc`] [`go`] [`gui`] [`proxy`] [`reverse-proxy`] [`windows`]  
...
- [mzz2017/gg](https://github.com/mzz2017/gg) ★1824 [`go-graft`] [`graftcp`] [`proxy`] [`proxychains`] [`v2ray`]  
...
- [kingwrcy/moments](https://github.com/kingwrcy/moments) ★1816  
  这是一个用于生成动态壁纸的Python项目。它使用Pillow库处理图像，并提供多种动态效果，例如渐变、循环、粒子特效等。用户可以通过配置参数自定义壁纸的样式和动画。项目包含预设模板和可定制参数，方便用户快速生成个性化壁纸。
- [eolinker/apinto](https://github.com/eolinker/apinto) ★1627 [`api`] [`api-gateway`] [`apigateway`] [`apinto`] [`dubbo2`] [`gateway`] [`go`] [`goku`] [`golang`] [`grpc`] [`loadbalancer`] [`microservice`] [`middleware`] [`plugin`] [`proxy`] [`router`] [`servicemesh`]  
...
- [zhanghanyun/backtrace](https://github.com/zhanghanyun/backtrace) ★1324  
...
- [samwafgo/SamWaf](https://github.com/samwafgo/SamWaf) ★1217  
...
- [god-jason/iot-master](https://github.com/god-jason/iot-master) ★803 [`645`] [`fins`] [`go`] [`golang`] [`hmi`] [`hostlink`] [`iot`] [`melsec`] [`mitsubishi`] [`modbus`] [`mpi`] [`mqtt`] [`omron`] [`opc-ua`] [`plc`] [`ppi`] [`s7`] [`scada`] [`xorm`]  
...
- [mudkipme/mortis](https://github.com/mudkipme/mortis) ★67  
...
- [jgm/pandoc](https://github.com/jgm/pandoc) ★40298 [`commonmark`] [`converter`] [`document`] [`haskell`] [`markdown`] [`markup`] [`pandoc`] [`presentation`] [`publishing`]  
...
- [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) ★115092 [`awesome-list`] [`free-for-developers`]  
...
- [vernesong/OpenClash](https://github.com/vernesong/OpenClash) ★22718 [`clash`] [`luci`] [`mihomo`] [`openclash`] [`openwrt`] [`shadowsocks`] [`snell`] [`v2ray`] [`vmess`]  
...
- [uikit/uikit](https://github.com/uikit/uikit) ★18512  
...
- [CaiJimmy/hugo-theme-stack](https://github.com/CaiJimmy/hugo-theme-stack) ★6057 [`bloggers`] [`css`] [`hacktoberfest`] [`hugo`] [`hugo-theme`] [`theme`]  
...
- [vbskycn/iptv](https://github.com/vbskycn/iptv) ★4896  
...
- [cf-pages/Telegraph-Image](https://github.com/cf-pages/Telegraph-Image) ★4252 [`cloudflare`] [`cloudflare-pages`] [`flickr`] [`image`] [`image-host`] [`image-hosting`] [`image-sharing`] [`imgur`] [`serverless`] [`telegraph`] [`upload-images`]  
...
- [aoaostar/legado](https://github.com/aoaostar/legado) ★4249 [`legado`] [`legado3`]  
...
- [TIM168/technical_books](https://github.com/TIM168/technical_books) ★3358 [`books`] [`go`] [`html`] [`http`] [`it`] [`java`] [`linux`] [`php`] [`python`] [`technical`] [`technical-books`]  
...
- [qiwihui/hiwifi-ss](https://github.com/qiwihui/hiwifi-ss) ★1485 [`hiwifi`] [`shadowsocks`]  
...
- [Stirling-Tools/Stirling-PDF](https://github.com/Stirling-Tools/Stirling-PDF) ★69954 [`docker`] [`hacktoberfest`] [`java`] [`pdf`] [`pdf-converter`] [`pdf-editor`] [`pdf-manipulation`] [`pdf-merger`] [`pdf-ocr`] [`pdf-tools`] [`pdf-web-apps`] [`pdfmerger`]  
...
- [dbeaver/dbeaver](https://github.com/dbeaver/dbeaver) ★46981 [`ai`] [`copilot`] [`database`] [`db2`] [`dbeaver`] [`erd`] [`gui`] [`java`] [`jdbc`] [`mysql`] [`nosql`] [`openai`] [`oracle`] [`postgresql`] [`redshift`] [`sql`] [`sqlite`] [`sqlserver`]  
...
- [termux/termux-app](https://github.com/termux/termux-app) ★46953 [`android`] [`hacktoberfest`] [`linux`] [`terminal`] [`termux`]  
...
- [skylot/jadx](https://github.com/skylot/jadx) ★46165 [`android`] [`decompiler`] [`dex`] [`java`]  
...
- [halo-dev/halo](https://github.com/halo-dev/halo) ★37302 [`blog`] [`blog-engine`] [`cms`] [`content-management-system`] [`halo`] [`halocms`] [`website-builder`]  
...
- [zxing/zxing](https://github.com/zxing/zxing) ★33701 [`android`] [`barcode`] [`barcode-scanner`] [`datamatrix`] [`java`] [`qr-code`] [`upc`] [`zxing`]  
...
- [DrKLO/Telegram](https://github.com/DrKLO/Telegram) ★27954 [`telegram`]  
...
- [dataease/dataease](https://github.com/dataease/dataease) ★22355 [`apache-doris`] [`business-intelligence`] [`data-analysis`] [`data-visualization`] [`echarts`] [`kettle`] [`superset`] [`tableau`]  
...
- [lionsoul2014/ip2region](https://github.com/lionsoul2014/ip2region) ★18377 [`ip-address`] [`ip-address-database`] [`ip-address-location`] [`ip-location`] [`ip-lookup`] [`ipv4-address`] [`ipv4-lookup`] [`ipv4-support`] [`ipv6-address`] [`ipv6-lookup`] [`ipv6-support`] [`xdb-engine`] [`xdb-ipv4`] [`xdb-ipv6`]  
...
- [justauth/JustAuth](https://github.com/justauth/JustAuth) ★17279 [`googlelogin`] [`justauth`] [`oauth2`] [`qqlogin`] [`weixinlogin`]  
...
- [pxb1988/dex2jar](https://github.com/pxb1988/dex2jar) ★12972  
  dex2jar是一个将Android应用程序的dex文件转换为jar文件的工具。它允许开发者查看和分析Android应用程序的代码，从而帮助理解其功能和逻辑
- [microg/GmsCore](https://github.com/microg/GmsCore) ★11398 [`android`] [`auth`] [`cloud-messaging`] [`firebase`] [`geolocation`] [`google`] [`google-cloud-messaging`] [`java`] [`kotlin`] [`kotlin-android`] [`maps`] [`microg`] [`mobile`] [`push-notifications`]  
...
- [FongMi/TV](https://github.com/FongMi/TV) ★6804 [`catvod`] [`danmaku`] [`leanback`] [`media3`] [`p2p`] [`thunder`] [`tvbus`]  
...
- [648540858/wvp-GB28181-pro](https://github.com/648540858/wvp-GB28181-pro) ★6425 [`1078`] [`28181`] [`28181web`] [`808`] [`gb28181`] [`gb28181server`] [`wvp`]  
...
- [SuperMonster003/AutoJs6](https://github.com/SuperMonster003/AutoJs6) ★4916 [`android`] [`autojs`] [`autojs6`] [`automated-tool`] [`automation`] [`javascript`]  
...
- [pqpo/SmartCropper](https://github.com/pqpo/SmartCropper) ★4102 [`detection`] [`hed-net`] [`image`] [`image-cropper`] [`opencv`] [`pytorch`] [`smartcropper`] [`tensorflow`]  
  Smart
- [syncthing/syncthing-android](https://github.com/syncthing/syncthing-android) ★4030 [`android`] [`java`] [`p2p`] [`peer-to-peer`] [`synchronization`]  
...
- [niumoo/bing-wallpaper](https://github.com/niumoo/bing-wallpaper) ★3182 [`bing`] [`bing-image`] [`bing-wallpaper`] [`wallpaper`]  
...
- [no1xuan/HivisionIDPhotos-wechat-weapp](https://github.com/no1xuan/HivisionIDPhotos-wechat-weapp) ★487  
...
- [louislam/uptime-kuma](https://github.com/louislam/uptime-kuma) ★78527 [`docker`] [`monitor`] [`monitoring`] [`responsive`] [`self-hosted`] [`selfhosted`] [`single-page-app`] [`socket-io`] [`uptime`] [`uptime-monitoring`] [`webapp`] [`websocket`]  
...
- [marktext/marktext](https://github.com/marktext/marktext) ★52368 [`dark-mode`] [`editor`] [`electron`] [`element-ui`] [`emoji`] [`focus-mode`] [`latex`] [`linux`] [`mac`] [`macos`] [`markdown`] [`marktext`] [`next-generation`] [`source-code`] [`typewriter-mode`] [`vue`] [`windows`]  
...
- [mozilla/pdf.js](https://github.com/mozilla/pdf.js) ★52263  
...
- [agalwood/Motrix](https://github.com/agalwood/Motrix) ★49796 [`aria2`] [`bittorrent`] [`bt`] [`download`] [`download-manager`] [`electron`] [`linux`] [`mac`] [`macos`] [`magnet`] [`motrix`] [`torrent`] [`windows`]  
...
- [LeCoupa/awesome-cheatsheets](https://github.com/LeCoupa/awesome-cheatsheets) ★44765 [`backend`] [`bash`] [`cheatsheet`] [`cheatsheets`] [`database`] [`django`] [`docker`] [`feathersjs`] [`frontend`] [`javascript`] [`kubernetes`] [`language`] [`nodejs`] [`php`] [`programming-language`] [`redis`] [`sailsjs`] [`vim`] [`vuejs`] [`xcode`]  
...
- [NaiboWang/EasySpider](https://github.com/NaiboWang/EasySpider) ★43434 [`batch-processing`] [`batch-script`] [`code-free`] [`crawler`] [`data-collection`] [`frontend`] [`gui`] [`html`] [`input-parameters`] [`layman`] [`parameters`] [`robotics`] [`rpa`] [`scraper`] [`spider`] [`visual`] [`visualization`] [`visualprogramming`] [`web`] [`www`]  
...
- [HeyPuter/puter](https://github.com/HeyPuter/puter) ★37300 [`cloud`] [`cloud-os`] [`cloud-storage`] [`desktop`] [`desktop-environment`] [`dropbox`] [`good-first-issue`] [`gui`] [`javascript`] [`nas`] [`open-source`] [`operating-system`] [`os`] [`osjs`] [`puter`] [`remote-desktop`] [`storage`] [`web-desktop`] [`web-os`] [`webtop`]  
...
- [qishibo/AnotherRedisDesktopManager](https://github.com/qishibo/AnotherRedisDesktopManager) ★33426 [`redis`] [`redis-client`] [`redis-cluster`] [`redis-desktop-manager`] [`redis-gui`]  
...
- [parallax/jsPDF](https://github.com/parallax/jsPDF) ★30789 [`hacktoberfest`]  
...
- [songquanpeng/one-api](https://github.com/songquanpeng/one-api) ★28019 [`api`] [`api-gateway`] [`azure-openai-api`] [`chatgpt`] [`claude`] [`ernie-bot`] [`gemini`] [`gpt`] [`openai`] [`openai-api`] [`proxy`]  
...
- [Z-Siqi/Clash-for-Windows_Chinese](https://github.com/Z-Siqi/Clash-for-Windows_Chinese) ★26881 [`chinese`] [`clash`] [`clash-chinese`] [`shadowsocks`] [`windows`] [`zh-cn`]  
...
- [fanmingming/live](https://github.com/fanmingming/live) ★26815 [`china`] [`converter`] [`epg`] [`iptv`] [`ipv6`] [`live`] [`m3u`] [`m3u8`] [`mp4`] [`radio`] [`television`] [`tv`] [`txt`] [`workers`]  
...
- [localForage/localForage](https://github.com/localForage/localForage) ★25666 [`indexeddb`] [`javascript`] [`localforage`] [`localstorage`] [`offline`] [`storage`] [`websql`]  
...
- [blackmatrix7/ios_rule_script](https://github.com/blackmatrix7/ios_rule_script) ★23237  
...
- [tailwindlabs/heroicons](https://github.com/tailwindlabs/heroicons) ★23083  
...
- [handsontable/handsontable](https://github.com/handsontable/handsontable) ★21605 [`angular-datagrid`] [`angular-table`] [`component`] [`crud-operations`] [`data-editing`] [`data-grid`] [`data-management`] [`data-tables`] [`datagrid`] [`datatable`] [`excel`] [`excel-javascript`] [`grid`] [`grid-component`] [`react-datatable`] [`react-grid`] [`spreadsheet`] [`table`] [`vue-table`]  
...
- [liriliri/eruda](https://github.com/liriliri/eruda) ★20398 [`console`] [`debugger`] [`developer-tools`] [`eruda`] [`mobile`]  
...
- [modood/Administrative-divisions-of-China](https://github.com/modood/Administrative-divisions-of-China) ★20240 [`address`] [`administrative-divisions`] [`area`] [`china`] [`city`] [`csv`] [`json`] [`nodejs`] [`province`] [`street`]  
...
- [SillyTavern/SillyTavern](https://github.com/SillyTavern/SillyTavern) ★20043 [`ai`] [`chat`] [`llm`]  
...
- [docmirror/dev-sidecar](https://github.com/docmirror/dev-sidecar) ★20021 [`dev-sidecar`] [`dns-ip`] [`electron`] [`fastgit`] [`fastgithub`] [`gfw`] [`internet`] [`lerna`] [`mitmproxy`] [`proxy`]  
...
- [SocialSisterYi/bilibili-API-collect](https://github.com/SocialSisterYi/bilibili-API-collect) ★19551 [`api`] [`bilibili`] [`bilibili-api`] [`bilibili-comment`] [`bilibili-danmaku`] [`bilibili-download`] [`bilibili-live`] [`bilibili-login`] [`grpc`] [`json`]  
...
- [apache/pouchdb](https://github.com/apache/pouchdb) ★17467 [`couchdb`] [`database`] [`hacktoberfest`] [`javascript`] [`pouchdb`]  
...
- [GoogleChrome/chrome-extensions-samples](https://github.com/GoogleChrome/chrome-extensions-samples) ★17062 [`chrome`]  
...
- [xifangczy/cat-catch](https://github.com/xifangczy/cat-catch) ★16486 [`chrome`] [`chrome-extension`] [`firefox`] [`firefox-extension`] [`javascript`] [`jquery`] [`m3u8-downloader`] [`video-downloader`]  
  这是一个用于捕捉图像中猫的Python项目。它利用OpenCV库进行图像处理，并使用深度学习模型（例如YOLOv5）来检测和定位猫。项目提供预训练模型，并支持自定义模型训练。用户可以轻松地将项目集成到其他应用程序中，以实现猫的自动识别和追踪。
- [brix/crypto-js](https://github.com/brix/crypto-js) ★16339  
...
- [pot-app/pot-desktop](https://github.com/pot-app/pot-desktop) ★15804 [`linux`] [`macos`] [`ocr`] [`pot`] [`pot-app`] [`recognize`] [`tauri`] [`translate`] [`translation`] [`tts`] [`windows`]  
...
- [pandao/editor.md](https://github.com/pandao/editor.md) ★14275 [`codemirror`] [`commonmark`] [`documentation`] [`editor`] [`flowchart`] [`gfm`] [`javascript`] [`jquery`] [`katex`] [`markdown`] [`markdown-editor`] [`markdown-writer`] [`marked`] [`sequence-diagram`] [`toc`]  
...
- [electerm/electerm](https://github.com/electerm/electerm) ★13239 [`electerm`] [`electron`] [`file-manager`] [`ftp`] [`linux-app`] [`macos-app`] [`open-source`] [`rdp`] [`serialport`] [`sftp`] [`ssh`] [`telnet`] [`terminal`] [`vnc`] [`windows-app`]  
...
- [mickael-kerjean/filestash](https://github.com/mickael-kerjean/filestash) ★13051 [`dwg`] [`file-manager`] [`file-sharing`] [`filemanager`] [`ftp`] [`git`] [`ldap`] [`mcp`] [`nfs`] [`raw`] [`s3`] [`sftp`] [`smb`] [`webdav`]  
...
- [mayswind/AriaNg](https://github.com/mayswind/AriaNg) ★12667 [`aria2`] [`ariang`] [`download`] [`gui`] [`html`] [`javascript`] [`ui`] [`web`] [`web-frontend`] [`webui`]  
...
- [QuantumNous/new-api](https://github.com/QuantumNous/new-api) ★12463 [`ai-gateway`] [`claude`] [`deepseek`] [`gemini`] [`openai`] [`rerank`]  
...
- [listen1/listen1_chrome_extension](https://github.com/listen1/listen1_chrome_extension) ★11952 [`chrome-extension`] [`music-player`]  
...
- [Semporia/TikTok-Unlock](https://github.com/Semporia/TikTok-Unlock) ★11569 [`tiktok`] [`tiktok-unlock`] [`unlock`]  
...
- [tangly1024/NotionNext](https://github.com/tangly1024/NotionNext) ★10632 [`blog`] [`nextjs`] [`notion`] [`react`] [`tailwindcss`] [`vercel`] [`zeabur`]  
...
- [stevenjoezhang/live2d-widget](https://github.com/stevenjoezhang/live2d-widget) ★10201 [`javascript-plugin`] [`live2d`]  
...
- [is-a-dev/register](https://github.com/is-a-dev/register) ★9099 [`cloudflare`] [`dev`] [`developer`] [`dns`] [`domain`] [`foss`] [`free`] [`free-domain`] [`free-for-dev`] [`free-for-developers`] [`github-pages`] [`oss`] [`subdomain`] [`website`]  
...
- [cmliu/CF-Workers-docker.io](https://github.com/cmliu/CF-Workers-docker.io) ★8864 [`cloudflare-pages`] [`cloudflare-workers`] [`docker`] [`dockerhub`]  
...
- [joemccann/dillinger](https://github.com/joemccann/dillinger) ★8171 [`blog`] [`blogging`] [`editor`] [`ide`] [`javascript`] [`markdown`] [`md`] [`node`] [`nodejs`] [`writing`]  
...
- [fishjar/kiss-translator](https://github.com/fishjar/kiss-translator) ★8073 [`extension`] [`translate`] [`translation`] [`translator`] [`userscript`] [`userscripts`]  
...
- [floccusaddon/floccus](https://github.com/floccusaddon/floccus) ★7265 [`bookmark`] [`bookmarks`] [`browser-bookmarks`] [`chrome`] [`chrome-extension`] [`edge-extension`] [`firefox`] [`firefox-addon`] [`firefox-extension`] [`nextcloud`] [`nextcloud-bookmarks`] [`owncloud`] [`sync`] [`sync-solution`] [`syncing-bookmarks`] [`webdav`] [`webextension`]  
...
- [gaotianliuyun/gao](https://github.com/gaotianliuyun/gao) ★6954  
...
- [zumerlab/snapdom](https://github.com/zumerlab/snapdom) ★6920 [`capture-screenshots`] [`clone`] [`dom`] [`js`] [`screenshot`]  
...
- [Momo707577045/m3u8-downloader](https://github.com/Momo707577045/m3u8-downloader) ★6759 [`blob`] [`m3u8`]  
...
- [xiangyuecn/AreaCity-JsSpider-StatsGov](https://github.com/xiangyuecn/AreaCity-JsSpider-StatsGov) ★6285  
...
- [samyk/evercookie](https://github.com/samyk/evercookie) ★4688  
...
- [tangyoha/telegram_media_downloader](https://github.com/tangyoha/telegram_media_downloader) ★4495 [`cosplatfrom`] [`cross-platform`] [`downloader`] [`flask`] [`media-downloader`] [`telegram-bot`]  
...
- [AntSwordProject/antSword](https://github.com/AntSwordProject/antSword) ★4345 [`antsword`]  
...
- [limbopro/Adblock4limbo](https://github.com/limbopro/Adblock4limbo) ★4219 [`adblock`] [`adblocker`] [`adguard`] [`ios`] [`javascript`] [`limbopro`] [`loon`] [`nobyda`] [`pornhub`] [`quantumult`] [`quantumultx`] [`shadowrocket`] [`stash`] [`surge`] [`surge4`] [`tampermonkey`] [`userscripts`]  
...
- [certd/certd](https://github.com/certd/certd) ★3843 [`acme`] [`auto`] [`automation`] [`cert`] [`certbot`] [`letencrypt`] [`ssl`] [`ssl-certificate`]  
...
- [dqzboy/Docker-Proxy](https://github.com/dqzboy/Docker-Proxy) ★3796 [`docker-proxy`] [`docker-registry`] [`gcr-registry`]  
...
- [songquanpeng/message-pusher](https://github.com/songquanpeng/message-pusher) ★3663 [`bark`] [`dingtalk`] [`discord`] [`email`] [`feishu`] [`lark`] [`message-pusher`] [`telegram`] [`websocket`] [`wechat`]  
...
- [justjavac/ReplaceGoogleCDN](https://github.com/justjavac/ReplaceGoogleCDN) ★3617 [`cdn`] [`chrome`] [`chrome-extension`] [`google`] [`javascript`]  
...
- [alseambusher/crontab-ui](https://github.com/alseambusher/crontab-ui) ★3164 [`crontab`] [`nodejs`] [`unix`]  
...
- [PublicAffairs/openai-gemini](https://github.com/PublicAffairs/openai-gemini) ★3110 [`chatgpt-api`] [`gemini`] [`gemini-ai`] [`openai`] [`proxy`] [`serverless`]  
...
- [xianyuyimu/TVBOX-](https://github.com/xianyuyimu/TVBOX-) ★3060  
...
- [KOP-XIAO/QuantumultX](https://github.com/KOP-XIAO/QuantumultX) ★2857  
...
- [NeverDecaf/chromium-web-store](https://github.com/NeverDecaf/chromium-web-store) ★2836 [`chrome-extension`] [`chromium`] [`ungoogled-chromium`]  
...
- [facundoolano/google-play-scraper](https://github.com/facundoolano/google-play-scraper) ★2652 [`api`] [`crawler`] [`google-play`] [`nodejs`] [`scraper`]  
...
- [mayswind/AriaNg-Native](https://github.com/mayswind/AriaNg-Native) ★2571 [`aria2`] [`ariang`] [`desktop`] [`download`] [`electron`] [`gui`] [`html`] [`javascript`] [`ui`] [`web`]  
...
- [metowolf/Meting](https://github.com/metowolf/Meting) ★1873 [`api`] [`music`] [`php`]  
...
- [zhangdaren/miniprogram-to-uniapp](https://github.com/zhangdaren/miniprogram-to-uniapp) ★1783  
  该
- [monkeyWie/gopeed-extension-baiduwp](https://github.com/monkeyWie/gopeed-extension-baiduwp) ★1744 [`baidunetdisk`] [`baiduwangpan`] [`baiduyun`] [`gopeed-extension`]  
...
- [xishandong/crawlProject](https://github.com/xishandong/crawlProject) ★1596 [`captcha`] [`ddddocr`] [`javascript`] [`playwright`] [`python`] [`python-crawler`] [`reverse-engineering`]  
...
- [acgotaku/YAAW-for-Chrome](https://github.com/acgotaku/YAAW-for-Chrome) ★1238  
  Y
- [ShilongLee/Crawler](https://github.com/ShilongLee/Crawler) ★1215  
...
- [aiselp/AutoX](https://github.com/aiselp/AutoX) ★1197  
...
- [law-chain-hot/websocket-devtools](https://github.com/law-chain-hot/websocket-devtools) ★984 [`chrome-extensions`] [`devtools`] [`real-time`] [`real-time-chat`] [`real-time-monitoring`] [`socket-io`] [`webgame`] [`websocket`] [`websocket-chat`] [`websocket-client`]  
...
- [cv-cat/XianYuApis](https://github.com/cv-cat/XianYuApis) ★770  
...
- [MakcRe/KuGouMusicApi](https://github.com/MakcRe/KuGouMusicApi) ★444 [`api`] [`apis`] [`javascript`] [`kugou`] [`kugou-music`] [`nodejs`]  
...
- [xianhu/LearnPython](https://github.com/xianhu/LearnPython) ★8255 [`learning-python`] [`python`] [`python-flask`] [`python-requests`]  
...
- [2dust/v2rayNG](https://github.com/2dust/v2rayNG) ★47095 [`android`] [`proxy`] [`shadowsocks`] [`socks5`] [`trojan`] [`v2fly`] [`v2ray`] [`vless`] [`vmess`] [`vpn`] [`xray`] [`xtls`]  
...
- [bannedbook/fanqiang](https://github.com/bannedbook/fanqiang) ★40893 [`brook`] [`daze`] [`fanqiang`] [`goflyway`] [`lightsocks`] [`proxy`] [`psiphon`] [`shadowsocks`] [`ssr`] [`trojan`] [`v2ray`]  
  这是一个用于科学上网的翻墙工具，提供多种连接方式，支持多种操作系统。它使用Go语言开发，核心模块包括代理服务器和连接管理，并整合了多种开源库。该项目旨在为用户提供快速、稳定、便捷的网络访问方式，绕过地区限制。
- [gkd-kit/gkd](https://github.com/gkd-kit/gkd) ★33362 [`accessibility`] [`android`] [`auto`] [`click`] [`compose`] [`jetpack-compose`] [`kotlin`] [`kotlin-js`] [`kotlin-multiplatform`] [`webassembly`]  
...
- [MetaCubeX/ClashMetaForAndroid](https://github.com/MetaCubeX/ClashMetaForAndroid) ★29737  
...
- [pppscn/SmsForwarder](https://github.com/pppscn/SmsForwarder) ★23446 [`android`] [`api`] [`app`] [`bark`] [`call`] [`chatgpt`] [`dingding`] [`forward`] [`mqtt`] [`pushdear`] [`pushplus`] [`serverchan`] [`sms`] [`smtp`] [`telegram`] [`webhook`] [`wechatapp`]  
...
- [RikkaApps/Shizuku](https://github.com/RikkaApps/Shizuku) ★18783  
...
- [MatsuriDayo/NekoBoxForAndroid](https://github.com/MatsuriDayo/NekoBoxForAndroid) ★17075 [`android`] [`gfw`] [`proxy`] [`shadowsocks`] [`sing-box`] [`trojan`] [`vmess`] [`vpn`]  
...
- [mihonapp/mihon](https://github.com/mihonapp/mihon) ★16993 [`android`] [`kotlin`] [`manga`] [`manga-downloader`] [`manga-reader`] [`mangadownloader`] [`mangareader`] [`tachiyomi`] [`tachiyomi-alternative`]  
...
- [tiann/KernelSU](https://github.com/tiann/KernelSU) ★14090 [`android`] [`kernel`] [`kernelsu`] [`root`] [`su`]  
...
- [open-ani/animeko](https://github.com/open-ani/animeko) ★13069 [`android`] [`ani`] [`anime`] [`bangumi`] [`bittorrent`] [`bt`] [`compose`] [`compose-multiplatform`] [`danmaku`] [`ios`] [`jetpack-compose`] [`kotlin`] [`kotlin-multiplatform`] [`linux`] [`macos`] [`player`] [`torrent`] [`video`] [`windows`]  
...
- [ankidroid/Anki-Android](https://github.com/ankidroid/Anki-Android) ★10261 [`android`] [`anki`] [`ankidroid`] [`education`] [`flashcards`] [`kotlin`] [`learning`] [`srs`]  
...
- [bitwarden/android](https://github.com/bitwarden/android) ★8043 [`android`] [`bitwarden`] [`compose`] [`jetpack`] [`kotlin`]  
...
- [zhanghai/MaterialFiles](https://github.com/zhanghai/MaterialFiles) ★7583 [`android`] [`android-application`] [`file-manager`] [`kotlin`] [`kotlin-android`] [`material-design`]  
...
- [osfans/trime](https://github.com/osfans/trime) ★3851 [`android`] [`chinese`] [`ime`] [`jni`] [`opencc`] [`rime`]  
...
- [easybangumiorg/EasyBangumi](https://github.com/easybangumiorg/EasyBangumi) ★3619 [`acg`] [`android`] [`android-application`] [`bangumi`] [`cartoon`] [`compose`]  
...
- [gallonyin/worktool](https://github.com/gallonyin/worktool) ★2887  
...
- [rosuH/EasyWatermark](https://github.com/rosuH/EasyWatermark) ★1779 [`android`] [`image`] [`image-watermark`] [`tools`] [`watermark`] [`watermwark`]  
...
- [Kong/kong](https://github.com/Kong/kong) ★42215 [`ai`] [`ai-gateway`] [`api-gateway`] [`api-management`] [`apis`] [`artificial-intelligence`] [`cloud-native`] [`devops`] [`kubernetes`] [`kubernetes-ingress`] [`kubernetes-ingress-controller`] [`llm-gateway`] [`llm-ops`] [`mcp`] [`mcp-gateway`] [`microservice`] [`microservices`] [`openai-proxy`] [`reverse-proxy`] [`serverless`]  
...
- [iDvel/rime-ice](https://github.com/iDvel/rime-ice) ★13894 [`rime`] [`rime-config`] [`rime-custom`] [`rime-schema`] [`rime-squirrel`] [`rime-weasel`]  
...
- [zhihulite/Hydrogen](https://github.com/zhihulite/Hydrogen) ★1300  
...
- [jaywcjlove/linux-command](https://github.com/jaywcjlove/linux-command) ★34947 [`bash`] [`chrome`] [`chrome-extension`] [`command-line`] [`gh-pages`] [`linux`] [`linux-command`] [`ls`] [`screen`] [`screenshot`] [`search`] [`ssh`] [`tools`] [`web-tools`]  
...
- [996icu/996.ICU](https://github.com/996icu/996.ICU) ★274847  
  该项目是一个关于中国程序员工作强度和压力的匿名吐槽平台。用户可以通过匿名发表帖子，分享工作经历和感受。平台使用简单的文本格式，并支持搜索和过滤功能。该项目主要使用PHP语言开发，并使用数据库存储用户数据和帖子信息。
- [awesome-selfhosted/awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) ★258673 [`awesome`] [`awesome-list`] [`cloud`] [`free-software`] [`hosting`] [`privacy`] [`self-hosted`] [`selfhosted`]  
  这是一个收集各种可自托管软件的资源列表。涵盖了从博客和论坛到视频会议和VPN等各种应用。列表按类别组织，便于用户快速找到所需的自托管工具。该项目使用纯文本格式维护，便于轻松更新和浏览。
- [justjavac/free-programming-books-zh_CN](https://github.com/justjavac/free-programming-books-zh_CN) ★115702 [`android`] [`angular`] [`books`] [`free`] [`ios`] [`javascript`] [`kotlin`] [`pdf`] [`programming`] [`python`] [`react`] [`react-native`] [`swift`] [`vue`]  
...
- [deepseek-ai/DeepSeek-R1](https://github.com/deepseek-ai/DeepSeek-R1) ★91491  
...
- [ruanyf/weekly](https://github.com/ruanyf/weekly) ★79152  
...
- [PlexPt/awesome-chatgpt-prompts-zh](https://github.com/PlexPt/awesome-chatgpt-prompts-zh) ★56766 [`chat-gpt`] [`chatgpt`] [`chatgpt3`] [`chatgpt4`] [`gpt`]  
...
- [justjavac/awesome-wechat-weapp](https://github.com/justjavac/awesome-wechat-weapp) ★49694 [`demo`] [`minapp`] [`miniprogram`] [`weapp-demo`] [`wechat`] [`wechat-weapp`] [`wepy`] [`wxapp`] [`wxml`]  
...
- [LC044/WeChatMsg](https://github.com/LC044/WeChatMsg) ★40136 [`chatgpt`] [`llms`] [`pyqt`] [`wechat`]  
...
- [SheetJS/sheetjs](https://github.com/SheetJS/sheetjs) ★36030 [`angular`] [`bun`] [`csv`] [`data`] [`database`] [`deno`] [`excel`] [`grid`] [`html`] [`html5`] [`ios`] [`javascript`] [`json`] [`nodejs`] [`react`] [`spreadsheet`] [`table`] [`vue`] [`xlsx`] [`xml`]  
...
- [ziadoz/awesome-php](https://github.com/ziadoz/awesome-php) ★32114 [`awesome`] [`awesome-lists`] [`php`] [`php-applications`] [`php-framework`] [`php-installation`] [`php-library`]  
...
- [XIU2/TrackersListCollection](https://github.com/XIU2/TrackersListCollection) ★29798 [`aria2`] [`aria2-format-tracker`] [`bittorrent`] [`bittorrent-trackers`] [`qbittorrent`] [`torrent`] [`torrent-tracker`] [`tracker`] [`trackers`] [`trackerslist`] [`utorrent`]  
...
- [qianguyihao/Web](https://github.com/qianguyihao/Web) ★28167 [`css`] [`front-end`] [`html`] [`javascript`]  
...
- [imDazui/Tvlist-awesome-m3u-m3u8](https://github.com/imDazui/Tvlist-awesome-m3u-m3u8) ★27738 [`awesome`] [`iptv`] [`iptv-channels`] [`iptv-free`] [`iptv-m3u8`] [`iptv-playlist`] [`kodi`] [`kodi-addons`] [`kodi-plugin`] [`m3u`] [`m3u8`]  
...
- [gfwlist/gfwlist](https://github.com/gfwlist/gfwlist) ★24741 [`anticensorship`] [`censorship`] [`censorship-circumvention`] [`china`] [`gfw`]  
...
- [leiurayer/downkyi](https://github.com/leiurayer/downkyi) ★23827  
...
- [zijie0/HumanSystemOptimization](https://github.com/zijie0/HumanSystemOptimization) ★20736  
...
- [AZeC4/TelegramGroup](https://github.com/AZeC4/TelegramGroup) ★19150 [`telegram`] [`telegram-api`] [`telegram-bot`] [`telegram-bot-api`] [`telegram-bots`] [`telegram-channel`] [`telegramgroups`]  
...
- [Johnshall/Shadowrocket-ADBlock-Rules-Forever](https://github.com/Johnshall/Shadowrocket-ADBlock-Rules-Forever) ★18492 [`adblock`] [`gfw`] [`proxy`] [`shadowrocket`] [`v2ray`]  
  该项目提供了一套用于Shadowrocket的广告拦截规则，旨在永久性地屏蔽广告。规则集包含广泛的广告域名和资源，并持续更新。使用Swift编写，通过配置文件实现规则管理，方便用户导入和导出。项目结构清晰，易于维护和扩展。
- [sindresorhus/quick-look-plugins](https://github.com/sindresorhus/quick-look-plugins) ★18446  
...
- [AUK9527/Are-u-ok](https://github.com/AUK9527/Are-u-ok) ★12384  
...
- [mzlogin/awesome-adb](https://github.com/mzlogin/awesome-adb) ★12008 [`android`] [`android-adb`] [`android-debug-bridge`]  
...
- [hq450/fancyss_history_package](https://github.com/hq450/fancyss_history_package) ★10780  
...
- [privacy-protection-tools/anti-AD](https://github.com/privacy-protection-tools/anti-AD) ★9845 [`adblock`] [`adguardhome`] [`dnsmasq`] [`easylist`] [`neohosts`] [`php`] [`pi-hole`] [`surge`]  
...
- [pikvm/pikvm](https://github.com/pikvm/pikvm) ★9516 [`atx`] [`hardware`] [`hdmi`] [`ip-kvm`] [`ipkvm`] [`ipmi`] [`kvm`] [`mass-storage-device`] [`pi-kvm`] [`pikvm`] [`raspberry-pi`] [`raspberrypi`] [`vga`] [`video-capture-device`] [`vnc`]  
...
- [jackvale/rectg](https://github.com/jackvale/rectg) ★8225 [`rectg`] [`telegram`] [`telegram-bot`] [`telegram-channel`] [`telegram-group`]  
...
- [wuxingsanren/wildcat-vip-account](https://github.com/wuxingsanren/wildcat-vip-account) ★7965  
...
- [dongyubin/DockerHub](https://github.com/dongyubin/DockerHub) ★6516 [`cloudflare`] [`docker`] [`docker-image`] [`docker-registry`] [`dockerhub`] [`proxy`]  
...
- [reqable/reqable-app](https://github.com/reqable/reqable-app) ★5514 [`android-app`] [`capture`] [`debugging-tool`] [`desktop-app`] [`flutter`] [`http`] [`http2`] [`http3`] [`https`] [`ios-app`] [`quic`] [`rest-api`]  
...
- [ACL4SSR/ACL4SSR](https://github.com/ACL4SSR/ACL4SSR) ★5348 [`acl`] [`acl4ssr`] [`clash`] [`gfwlist`]  
...
- [yinggaozhen/awesome-go-cn](https://github.com/yinggaozhen/awesome-go-cn) ★5187 [`awesome`] [`awesome-list`] [`cn-doc`] [`go`] [`golang`] [`golang-library`]  
...
- [awesome-vpn/awesome-vpn](https://github.com/awesome-vpn/awesome-vpn) ★4634 [`clash`] [`fanqiang`] [`free`] [`geopolitics`] [`gfw`] [`great-firewall`] [`shadowsocks`] [`shadowsocksr`] [`ss`] [`trojan`] [`v2ray`] [`vless`] [`vmess`] [`vpn-server`] [`xray`]  
...
- [suxuang/myIPTV](https://github.com/suxuang/myIPTV) ★4299  
...
- [aardio/ImTip](https://github.com/aardio/ImTip) ★2389 [`aardio`] [`ime`] [`input-method`] [`input-method-editor`] [`win32`] [`windows`] [`windows10`]  
...
- [hujingguang/ChinaIPTV](https://github.com/hujingguang/ChinaIPTV) ★1534  
...
- [submato/xhscrawl](https://github.com/submato/xhscrawl) ★1175  
...
- [tech-shrimp/me](https://github.com/tech-shrimp/me) ★801  
...
- [opa334/TrollStore](https://github.com/opa334/TrollStore) ★20435  
...
- [CodeTips/BaiduNetdiskPlugin-macOS](https://github.com/CodeTips/BaiduNetdiskPlugin-macOS) ★8816  
...
- [AloneMonkey/MonkeyDev](https://github.com/AloneMonkey/MonkeyDev) ★6744 [`cocoapods`] [`ios`] [`iosopendev`] [`ipa`] [`objective-c`] [`reverse-engineering`] [`theos`] [`xcode`]  
...
- [syncthing/syncthing-macos](https://github.com/syncthing/syncthing-macos) ★3316 [`apple`] [`backup`] [`cloud-sync`] [`file-sharing`] [`file-sync`] [`frugal`] [`mac`] [`macos`] [`macosx`] [`objective-c`] [`osx`] [`p2p`] [`peer-to-peer`] [`simple`] [`swift`] [`sync`] [`sync-files`] [`synchronization`] [`syncthing`]  
...
- [cheat-engine/cheat-engine](https://github.com/cheat-engine/cheat-engine) ★17280  
...
- [stascorp/rdpwrap](https://github.com/stascorp/rdpwrap) ★16036  
...
- [nextcloud/server](https://github.com/nextcloud/server) ★33386 [`cloud`] [`collaboration`] [`decentralized`] [`design`] [`distributed`] [`enterprise`] [`federation`] [`file-sharing`] [`free-software`] [`hacktoberfest`] [`javascript`] [`nextcloud`] [`open-source`] [`opensource`] [`owncloud`] [`php`] [`self-hosting`] [`sharing`] [`usability`] [`ux`]  
...
- [PHPMailer/PHPMailer](https://github.com/PHPMailer/PHPMailer) ★21900 [`attachment`] [`email`] [`hacktoberfest`] [`php`] [`php-library`] [`phpmailer`] [`smtp`] [`tls-support`] [`xoauth2`]  
...
- [easychen/howto-make-more-money](https://github.com/easychen/howto-make-more-money) ★18113  
...
- [koel/koel](https://github.com/koel/koel) ★16852 [`audio`] [`hacktoberfest`] [`laravel`] [`music`] [`music-player`] [`streaming`] [`vue`]  
...
- [flarum/flarum](https://github.com/flarum/flarum) ★16085 [`flarum`] [`forum`] [`laravel`] [`php`]  
...
- [getgrav/grav](https://github.com/getgrav/grav) ★15260 [`cms`] [`content`] [`content-management`] [`doctrine`] [`flat-file`] [`grav`] [`markdown`] [`php`] [`php7`] [`symfony`] [`twig`] [`website`] [`website-builder`] [`website-generation`] [`yaml`]  
...
- [librespeed/speedtest](https://github.com/librespeed/speedtest) ★13840 [`hacktoberfest`] [`html5-speedtest`] [`internet-speed`] [`internet-speed-checker`] [`librespeed`] [`php`] [`speedtest`] [`web-worker`] [`xhr`]  
...
- [PHPOffice/PhpSpreadsheet](https://github.com/PHPOffice/PhpSpreadsheet) ★13822 [`excel`] [`gnumeric`] [`hacktoberfest`] [`libreoffice`] [`msexcel`] [`ods`] [`office`] [`php`] [`phpexcel`] [`spreadsheet`] [`sylk`] [`xls`] [`xlsx`]  
...
- [FreshRSS/FreshRSS](https://github.com/FreshRSS/FreshRSS) ★13094 [`feed`] [`freshrss`] [`news-aggregator`] [`php`] [`rss`] [`rss-aggregator`] [`rss-reader`] [`self-hosted`] [`websub`]  
...
- [typecho/typecho](https://github.com/typecho/typecho) ★12104 [`blog`] [`markdown`] [`php`] [`typecho`]  
...
- [tymondesigns/jwt-auth](https://github.com/tymondesigns/jwt-auth) ★11462 [`authentication`] [`jwt`] [`laravel`] [`php`]  
...
- [assimon/dujiaoka](https://github.com/assimon/dujiaoka) ★11446 [`dujiaofaka`] [`dujiaoka`] [`faka`]  
...
- [z-song/laravel-admin](https://github.com/z-song/laravel-admin) ★11170 [`laravel-admin`] [`model-form`] [`model-grid`] [`model-show`] [`model-tree`]  
  Laravel
- [dompdf/dompdf](https://github.com/dompdf/dompdf) ★10987 [`css`] [`dompdf`] [`font`] [`html`] [`html-to-pdf`] [`pdf-generation`] [`php`]  
...
- [Anankke/SSPanel-UIM](https://github.com/Anankke/SSPanel-UIM) ★10001  
...
- [bobthecow/psysh](https://github.com/bobthecow/psysh) ★9815 [`cli`] [`php`] [`psysh`] [`repl`] [`shell`]  
...
- [predis/predis](https://github.com/predis/predis) ★7735 [`php`] [`predis`] [`redis`] [`redis-cluster`] [`redis-sentinel`]  
...
- [vrana/adminer](https://github.com/vrana/adminer) ★7140 [`database`] [`mssql`] [`mysql`] [`php`] [`postgresql`] [`sqlite`]  
...
- [roundcube/roundcubemail](https://github.com/roundcube/roundcubemail) ★6632  
...
- [vimeo/psalm](https://github.com/vimeo/psalm) ★5773 [`hacktoberfest`] [`php`] [`security-analysis`] [`static-analysis`] [`taint-analysis`] [`type-inference`]  
...
- [catfan/Medoo](https://github.com/catfan/Medoo) ★4918 [`composer`] [`database`] [`hacktoberfest`] [`medoo`] [`mssql`] [`mysql`] [`php`] [`php-database-framework`] [`php-framework`] [`php-frameworks`] [`sqlite`]  
...
- [Hanson/vbot](https://github.com/Hanson/vbot) ★4371 [`php`] [`robot`] [`wechat`] [`weixin`]  
...
- [Bubka/2FAuth](https://github.com/Bubka/2FAuth) ★3531 [`2fa`] [`2factor`] [`hotp`] [`otp`] [`qrcode`] [`self-hosted`] [`totp`] [`two-factor`] [`two-factor-authentication`] [`webapp`]  
...
- [thephpleague/csv](https://github.com/thephpleague/csv) ★3447 [`csv`] [`csv-converter`] [`csv-document`] [`csv-filter`] [`csv-query`] [`php`]  
...
- [kalcaddle/kodbox](https://github.com/kalcaddle/kodbox) ★2761 [`docx`] [`file-explorer`] [`file-manager`] [`file-sharing`] [`file-upload`] [`file-viewer`] [`filemanager`] [`filesystem`] [`free-software`] [`javascript`] [`markdown-editor`] [`php`] [`text-editor`] [`webdav`] [`xlsx`]  
...
- [pk-fr/yakpro-po](https://github.com/pk-fr/yakpro-po) ★1478 [`obfuscation`] [`obfuscator`] [`php`] [`php-obfuscator`]  
...
- [zoujingli/ip2region](https://github.com/zoujingli/ip2region) ★1304  
...
- [cmderdev/cmder](https://github.com/cmderdev/cmder) ★26644 [`c-plus-plus`] [`cmder`] [`color-scheme`] [`command-line`] [`conemu`] [`mintty`] [`portable`] [`powershell`] [`shell`] [`ssh-agent`] [`windows`]  
...
- [ScoopInstaller/Scoop](https://github.com/ScoopInstaller/Scoop) ★23171 [`installer`] [`powershell`] [`scoop`] [`windows`]  
...
- [public-apis/public-apis](https://github.com/public-apis/public-apis) ★379142 [`api`] [`apis`] [`dataset`] [`development`] [`free`] [`list`] [`lists`] [`open-source`] [`public`] [`public-api`] [`public-apis`] [`resources`] [`software`]  
...
- [EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books) ★377018 [`books`] [`education`] [`hacktoberfest`] [`list`] [`resource`]  
...
- [ytdl-org/youtube-dl](https://github.com/ytdl-org/youtube-dl) ★138836  
...
- [521xueweihan/HelloGitHub](https://github.com/521xueweihan/HelloGitHub) ★134409 [`awesome`] [`github`] [`hellogithub`] [`python`]  
...
- [deepseek-ai/DeepSeek-V3](https://github.com/deepseek-ai/DeepSeek-V3) ★100311  
...
- [nvbn/thefuck](https://github.com/nvbn/thefuck) ★94689 [`python`] [`shell`]  
...
- [home-assistant/core](https://github.com/home-assistant/core) ★82625 [`asyncio`] [`hacktoberfest`] [`home-automation`] [`internet-of-things`] [`iot`] [`mqtt`] [`python`] [`raspberry-pi`]  
...
- [fighting41love/funNLP](https://github.com/fighting41love/funNLP) ★77285  
...
- [sherlock-project/sherlock](https://github.com/sherlock-project/sherlock) ★70356 [`cli`] [`cti`] [`cybersecurity`] [`forensics`] [`hacktoberfest`] [`information-gathering`] [`infosec`] [`linux`] [`osint`] [`pentesting`] [`python`] [`python3`] [`reconnaissance`] [`redteam`] [`sherlock`] [`tools`]  
...
- [xtekky/gpt4free](https://github.com/xtekky/gpt4free) ★65545 [`chatbot`] [`chatbots`] [`chatgpt`] [`chatgpt-4`] [`chatgpt-api`] [`chatgpt-free`] [`chatgpt4`] [`deepseek`] [`deepseek-api`] [`deepseek-r1`] [`gpt`] [`gpt-4`] [`gpt-4o`] [`gpt4`] [`gpt4-api`] [`language-model`] [`openai`] [`openai-api`] [`openai-chatgpt`] [`reverse-engineering`]  
  该项目提供一个基于GPT-4的免费API访问途径。用户无需付费即可调用GPT-4模型进行文本生成、翻译等任务。该项目使用Python和OpenAI API进行开发，核心功能包括API接口封装和请求管理，并提供简易的调用示例。
- [scrapy/scrapy](https://github.com/scrapy/scrapy) ★58964 [`crawler`] [`crawling`] [`framework`] [`hacktoberfest`] [`python`] [`scraping`] [`web-scraping`] [`web-scraping-python`]  
...
- [soimort/you-get](https://github.com/soimort/you-get) ★56568  
...
- [Z4nzu/hackingtool](https://github.com/Z4nzu/hackingtool) ★54052 [`allinonehackingtool`] [`besthackingtool`] [`ctf-tools`] [`ddos-attack-tool`] [`hacker`] [`hacking`] [`linux`] [`password-attack`] [`steganography`] [`web-attack`] [`wireless-attack`] [`xss-attacks`] [`xss-detection`]  
...
- [harry0703/MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo) ★47794 [`ai`] [`automation`] [`chatgpt`] [`moviepy`] [`python`] [`shortvideo`] [`tiktok`]  
...
- [yeongpin/cursor-free-vip](https://github.com/yeongpin/cursor-free-vip) ★42381 [`automation`] [`cursor`] [`cursor-ai`] [`cursor-ide`] [`cursorai`] [`cursors`] [`free`] [`freetrial`] [`pro`]  
...
- [mitmproxy/mitmproxy](https://github.com/mitmproxy/mitmproxy) ★41264 [`debugging`] [`http`] [`http2`] [`man-in-the-middle`] [`mitmproxy`] [`proxy`] [`python`] [`security`] [`ssl`] [`tls`] [`websocket`]  
...
- [hiroi-sora/Umi-OCR](https://github.com/hiroi-sora/Umi-OCR) ★39911 [`ocr`] [`ocr-python`] [`paddleocr`] [`qml`] [`qt`] [`screenshot`] [`umi-ocr`]  
...
- [zhayujie/chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat) ★39733 [`ai`] [`ai-agent`] [`chatgpt`] [`claude-4`] [`deepseek`] [`dingtalk`] [`feishu-bot`] [`gemini`] [`gpt-4`] [`kimi`] [`linkai`] [`llm`] [`mcp`] [`multi-agent`] [`openai`] [`python3`] [`qwen`] [`rag`] [`wechat`] [`wechat-bot`]  
...
- [NanmiCoder/MediaCrawler](https://github.com/NanmiCoder/MediaCrawler) ★39198  
...
- [certbot/certbot](https://github.com/certbot/certbot) ★32613 [`acme`] [`acme-client`] [`certbot`] [`certificate`] [`letsencrypt`] [`python`]  
...
- [dgtlmoon/changedetection.io](https://github.com/dgtlmoon/changedetection.io) ★28840 [`back-in-stock`] [`change-alert`] [`change-detection`] [`change-monitoring`] [`monitoring`] [`notifications`] [`restock-monitor`] [`rss`] [`self-hosted`] [`url-monitor`] [`web-scraping`] [`website-change-detection`] [`website-change-detector`] [`website-change-monitor`] [`website-change-notification`] [`website-change-tracker`] [`website-defacement-monitoring`] [`website-monitor`] [`website-monitoring`] [`website-watcher`]  
...
- [python-telegram-bot/python-telegram-bot](https://github.com/python-telegram-bot/python-telegram-bot) ★28419 [`bot`] [`chatbot`] [`framework`] [`python`] [`telegram`]  
...
- [521xueweihan/GitHub520](https://github.com/521xueweihan/GitHub520) ★27268 [`dns`] [`github`] [`hosts`]  
...
- [littlecodersh/ItChat](https://github.com/littlecodersh/ItChat) ★26602 [`api`] [`itchat`] [`robot`] [`wechat`]  
...
- [Delgan/loguru](https://github.com/Delgan/loguru) ★23101 [`log`] [`logger`] [`logging`] [`python`]  
...
- [XiaoMi/ha_xiaomi_home](https://github.com/XiaoMi/ha_xiaomi_home) ★20984 [`home-assistant`] [`home-assistant-integration`] [`miot`] [`miot-devices`] [`smart-home`] [`xiaomi`] [`xiaomi-smart-home`]  
...
- [LiLittleCat/awesome-free-chatgpt](https://github.com/LiLittleCat/awesome-free-chatgpt) ★20574 [`awesome`] [`awesome-list`] [`chat`] [`chatgpt`] [`free`] [`freechatgpt`]  
  这是一个收集免费 ChatGPT 替代方案的资源库。涵盖各种类型的免费或开源聊天机器人，包括代码生成、文本摘要、翻译等功能。该资源库主要使用 Markdown 格式组织，方便用户快速筛选和了解不同工具的特点。
- [bee-san/Ciphey](https://github.com/bee-san/Ciphey) ★20178 [`artificial-intelligence`] [`cipher`] [`cpp`] [`cryptography`] [`ctf`] [`ctf-tools`] [`cyberchef-magic`] [`decryption`] [`deep-neural-network`] [`encodings`] [`encryptions`] [`hacking`] [`hacktoberfest`] [`hashes`] [`natural-language-processing`] [`pentesting`] [`python`]  
...
- [Zeyi-Lin/HivisionIDPhotos](https://github.com/Zeyi-Lin/HivisionIDPhotos) ★20168 [`cnn`] [`demo`] [`docker`] [`face-recognition`] [`fastapi`] [`gradio`] [`idphoto`] [`machine-learning`] [`matting`] [`mtcnn`] [`tools`] [`unet`]  
...
- [Guovin/iptv-api](https://github.com/Guovin/iptv-api) ★20046 [`auto-update`] [`awesome`] [`epg`] [`iptv`] [`iptv-api`] [`iptv-channels`] [`iptv-free`] [`iptv-m3u`] [`iptv-m3u8`] [`iptv-playlist`] [`ipv4`] [`ipv6`] [`live`] [`m3u`] [`m3u8`] [`playlist`] [`rtmp`] [`schedule`] [`tv`] [`tvbox`]  
...
- [Jack-Cherish/python-spider](https://github.com/Jack-Cherish/python-spider) ★19293 [`python`] [`python-spider`] [`python3`] [`webspider`]  
...
- [pyscript/pyscript](https://github.com/pyscript/pyscript) ★18635 [`html`] [`javascript`] [`python`] [`wasm`]  
...
- [InstaPy/InstaPy](https://github.com/InstaPy/InstaPy) ★17585 [`automation`] [`bot`] [`clarifai`] [`instagram`] [`python`] [`script`] [`selenium`]  
...
- [lss233/kirara-ai](https://github.com/lss233/kirara-ai) ★17164 [`bard`] [`bot`] [`chatglm-6b`] [`chatgpt`] [`deepseek`] [`discord`] [`ernie`] [`go-cqhttp`] [`grok`] [`mirai`] [`new-bing`] [`ollama`] [`openai`] [`poe`] [`qq`] [`qqbot`] [`sydney`] [`telegram`] [`wechat`] [`xinghuo`]  
...
- [fastapi/sqlmodel](https://github.com/fastapi/sqlmodel) ★17140 [`fastapi`] [`json`] [`json-schema`] [`pydantic`] [`python`] [`sql`] [`sqlalchemy`]  
...
- [microsoft/Bringing-Old-Photos-Back-to-Life](https://github.com/microsoft/Bringing-Old-Photos-Back-to-Life) ★15644 [`gans`] [`generative-adversarial-network`] [`image-manipulation`] [`image-restoration`] [`old-photo-restoration`] [`photo-restoration`] [`photos`] [`pytorch`]  
...
- [Evil0ctal/Douyin_TikTok_Download_API](https://github.com/Evil0ctal/Douyin_TikTok_Download_API) ★14951 [`api`] [`async`] [`crawler`] [`douyin`] [`douyin-api`] [`douyin-scraper`] [`douyin-tiktok-api`] [`douyin-tiktok-download`] [`fastapi`] [`no-watermark`] [`online-parsing`] [`python`] [`pywebio`] [`scraper`] [`spider`] [`tiktok`] [`tiktok-api`] [`tiktok-scraper`] [`tiktok-signature`] [`web-scraping`]  
...
- [langbot-app/LangBot](https://github.com/langbot-app/LangBot) ★14029 [`agent`] [`ai`] [`coze`] [`deepseek`] [`dify`] [`dingtalk`] [`discord`] [`feishu`] [`langbot`] [`lark`] [`line`] [`llm`] [`n8n`] [`ollama`] [`openai`] [`plugins`] [`qq`] [`rag`] [`telegram`] [`wechat`]  
...
- [sml2h3/ddddocr](https://github.com/sml2h3/ddddocr) ★13024 [`captcha`] [`ddddocr`] [`ocr`]  
...
- [JoeanAmier/TikTokDownloader](https://github.com/JoeanAmier/TikTokDownloader) ★12332 [`abogus`] [`api`] [`csv`] [`docker`] [`douyin`] [`downloader`] [`ffmpeg`] [`httpx`] [`linux`] [`macos`] [`mstoken`] [`pyinstaller`] [`python`] [`rich`] [`server`] [`sqlite`] [`tiktok`] [`ttwid`] [`windows`] [`xlsx`]  
...
- [zai-org/CogVideo](https://github.com/zai-org/CogVideo) ★12147 [`cogvideox`] [`image-to-video`] [`llm`] [`sora`] [`text-to-video`] [`video-generation`]  
...
- [dwyl/english-words](https://github.com/dwyl/english-words) ★11730  
...
- [LonamiWebs/Telethon](https://github.com/LonamiWebs/Telethon) ★11504 [`hacktoberfest`] [`library`] [`mtproto`] [`python-library`] [`telegram`] [`telegram-api`] [`telethon`]  
...
- [guofei9987/blind_watermark](https://github.com/guofei9987/blind_watermark) ★11250 [`blind-watermark`] [`image-processing`] [`watermark`] [`watermark-image`]  
...
- [injetlee/Python](https://github.com/injetlee/Python) ★10381 [`crawler`] [`excel`] [`python`] [`wechat`]  
...
- [chengazhen/cursor-auto-free](https://github.com/chengazhen/cursor-auto-free) ★9667  
...
- [shidahuilang/shuyuan](https://github.com/shidahuilang/shuyuan) ★8833 [`aiyueshuxiang`] [`ipa`] [`iptv`] [`reader`] [`shuyuan`] [`trollstore`] [`tts`] [`xiangsegige`] [`yuanyuedu`] [`yuedu`]  
...
- [hunshcn/gh-proxy](https://github.com/hunshcn/gh-proxy) ★8424  
...
- [houtianze/bypy](https://github.com/houtianze/bypy) ★8416  
...
- [bytedance/Dolphin](https://github.com/bytedance/Dolphin) ★7775 [`document-analysis`] [`layout-analysis`] [`ocr`] [`parser`] [`pdf`] [`pdf-converter`] [`pdf-parser`] [`python`] [`vlm-ocr`]  
...
- [EstrellaXD/Auto_Bangumi](https://github.com/EstrellaXD/Auto_Bangumi) ★7767 [`anime`] [`auto-downloader`] [`docker`] [`python`] [`qbittorrent`] [`rss-parser`]  
...
- [vastsa/FileCodeBox](https://github.com/vastsa/FileCodeBox) ★7608 [`anonymous`] [`fastapi`] [`filecodebox`] [`python`] [`tool`] [`vue`]  
...
- [mli/autocut](https://github.com/mli/autocut) ★7464  
...
- [zhiyiYo/PyQt-Fluent-Widgets](https://github.com/zhiyiYo/PyQt-Fluent-Widgets) ★7378 [`custom`] [`fluent`] [`fluent-design`] [`fluentui`] [`gui`] [`modern`] [`pyqt5`] [`pyqt6`] [`pyside2`] [`pyside6`] [`python`] [`qt`] [`qt5`] [`qt6`] [`software`] [`ui`] [`widgets`] [`win11`] [`winui`] [`winui3`]  
...
- [nonebot/nonebot2](https://github.com/nonebot/nonebot2) ★7148 [`bot`] [`chatbot`] [`cqhttp`] [`dingtalk-robot`] [`fastapi`] [`lark-bot`] [`mirai-bot`] [`nonebot`] [`nonebot2`] [`onebot`] [`python`] [`qq`] [`qq-guild`] [`telegram-bot`]  
...
- [autoscrape-labs/pydoll](https://github.com/autoscrape-labs/pydoll) ★6062 [`anti-detection`] [`automation`] [`browser-automation`] [`cdp`] [`chromium`] [`crawler`] [`e2e-tests`] [`fingerprinting`] [`headless`] [`playwright`] [`puppeteer`] [`recaptcha-v3`] [`scraping`] [`selenium`] [`testing`] [`testing-tools`] [`turnstile-solver`] [`web-scraping`] [`webdriver`]  
...
- [WECENG/ticket-purchase](https://github.com/WECENG/ticket-purchase) ★5579  
...
- [qd-today/qd](https://github.com/qd-today/qd) ★5244 [`checkin`] [`docker`] [`har`] [`qd`] [`qiandao`]  
...
- [tconbeer/harlequin](https://github.com/tconbeer/harlequin) ★5210  
...
- [rootphantomer/Blasting_dictionary](https://github.com/rootphantomer/Blasting_dictionary) ★5209  
...
- [aaPanel/BaoTa](https://github.com/aaPanel/BaoTa) ★4448 [`baota`] [`bt-panel`] [`lamp`] [`lnmp`] [`python`] [`web-panel`]  
...
- [midoks/mdserver-web](https://github.com/midoks/mdserver-web) ★4436 [`linux`] [`memcached`] [`mysql`] [`php`] [`php70`] [`php71`] [`php72`] [`php73`] [`php74`] [`php80`] [`php81`] [`php82`] [`php83`] [`php84`] [`php85`] [`python`] [`redis`]  
...
- [googlefonts/noto-emoji](https://github.com/googlefonts/noto-emoji) ★4407  
...
- [shaxiu/XianyuAutoAgent](https://github.com/shaxiu/XianyuAutoAgent) ★4321 [`agent`] [`chatbot`] [`llm`]  
...
- [browser-use/workflow-use](https://github.com/browser-use/workflow-use) ★3772  
...
- [canonical/cloud-init](https://github.com/canonical/cloud-init) ★3498 [`cloud-init`] [`hacktoberfest`] [`python`]  
...
- [ScottSloan/Bili23-Downloader](https://github.com/ScottSloan/Bili23-Downloader) ★2984 [`bili23`] [`bilibili`] [`bilibili-downloader`] [`crawler`] [`linux`] [`macos`] [`python`] [`videodownloader`] [`windows`] [`wxpython`]  
...
- [PowerDNS-Admin/PowerDNS-Admin](https://github.com/PowerDNS-Admin/PowerDNS-Admin) ★2703 [`pdns`] [`powerdns`] [`powerdns-admin`] [`powerdns-web-gui`]  
...
- [Cp0204/quark-auto-save](https://github.com/Cp0204/quark-auto-save) ★2235  
...
- [mofeng-git/One-KVM](https://github.com/mofeng-git/One-KVM) ★1960  
...
- [fire-keeper/BlindWatermark](https://github.com/fire-keeper/BlindWatermark) ★1530  
...
- [y9nhjy/Proxifier-Keygen](https://github.com/y9nhjy/Proxifier-Keygen) ★1280  
...
- [yym68686/uni-api](https://github.com/yym68686/uni-api) ★1127 [`aws`] [`azure`] [`claude`] [`gemini`] [`grok`] [`openai`] [`uni-api`] [`vertex`]  
...
- [yanchunhuo/AutomationTest](https://github.com/yanchunhuo/AutomationTest) ★1065 [`appium`] [`automated-testing`] [`autotesting`] [`dubbo`] [`selenium`]  
...
- [lumina37/aiotieba](https://github.com/lumina37/aiotieba) ★532 [`aiohttp`] [`tieba`]  
...
- [Nagi-ovo/CHSI-Converter](https://github.com/Nagi-ovo/CHSI-Converter) ★372 [`chsi`] [`flask-application`] [`github-studentpack`] [`online-converter`] [`python`]  
...
- [lyx102/WeChatHook](https://github.com/lyx102/WeChatHook) ★206 [`vxworkhook`] [`wechatapi`] [`wechathook`] [`wechatrobot`] [`wxhook`]  
...
- [TapXWorld/ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook) ★57102  
...
- [pyenv/pyenv](https://github.com/pyenv/pyenv) ★43657 [`python`] [`shell`]  
...
- [discourse/discourse](https://github.com/discourse/discourse) ★45585 [`discourse`] [`ember`] [`forum`] [`javascript`] [`postgresql`] [`rails`] [`ruby`]  
...
- [greatghoul/remote-working](https://github.com/greatghoul/remote-working) ★11128 [`china`] [`freelancer`] [`remote-work`] [`remote-workers`] [`soho`] [`telecommunications`] [`work-from-home`]  
...
- [rustdesk/rustdesk](https://github.com/rustdesk/rustdesk) ★102640 [`android`] [`anydesk`] [`dart`] [`flatpak`] [`flutter`] [`flutter-apps`] [`ios`] [`linux`] [`macos`] [`p2p`] [`rdp`] [`remote-control`] [`remote-desktop`] [`rust`] [`rust-lang`] [`teamviewer`] [`vnc`] [`wayland`] [`windows`]  
...
- [zed-industries/zed](https://github.com/zed-industries/zed) ★69907 [`gpui`] [`rust-lang`] [`text-editor`] [`zed`]  
...
- [topjohnwu/Magisk](https://github.com/topjohnwu/Magisk) ★57013  
...
- [lencx/ChatGPT](https://github.com/lencx/ChatGPT) ★54216 [`ai`] [`app`] [`application`] [`chatgpt`] [`desktop-app`] [`gpt`] [`gpt-3`] [`linux`] [`macos`] [`notes-app`] [`openai`] [`rust`] [`tauri`] [`webview`] [`windows`]  
...
- [starship/starship](https://github.com/starship/starship) ★52273 [`bash`] [`fish`] [`fish-prompt`] [`fish-theme`] [`oh-my-zsh`] [`powershell`] [`rust`] [`shell-prompt`] [`starship`] [`zsh`] [`zsh-prompt`] [`zsh-theme`]  
...
- [dani-garcia/vaultwarden](https://github.com/dani-garcia/vaultwarden) ★50972 [`bitwarden`] [`bitwarden-rs`] [`docker`] [`rocket`] [`rust`] [`vaultwarden`]  
...
- [tw93/Pake](https://github.com/tw93/Pake) ★43389 [`chatgpt`] [`claude`] [`desktop`] [`gemini`] [`hight-performance`] [`linux`] [`macos`] [`no-electron`] [`package`] [`rust`] [`tauri`] [`windows`] [`youtube`]  
...
- [TabbyML/tabby](https://github.com/TabbyML/tabby) ★32445 [`ai`] [`codegen`] [`coding-assistant`] [`coding-language`] [`developer-experience`] [`developer-tools`] [`gen-ai`] [`ide`] [`llms`]  
...
- [fish-shell/fish-shell](https://github.com/fish-shell/fish-shell) ★31595 [`fish`] [`rust`] [`shell`] [`terminal`]  
...
- [lsd-rs/lsd](https://github.com/lsd-rs/lsd) ★15074 [`color`] [`hacktoberfest`] [`icons`] [`ls`] [`nerd-fonts`] [`rust`]  
...
- [rathole-org/rathole](https://github.com/rathole-org/rathole) ★12311 [`firewall`] [`frp`] [`http`] [`nat`] [`network`] [`ngrok`] [`noise`] [`noise-protocol`] [`proxy`] [`rust`] [`tunnel`]  
...
- [rustdesk/rustdesk-server](https://github.com/rustdesk/rustdesk-server) ★8842 [`remote-access`] [`remote-control`] [`remote-desktop`] [`tauri`]  
...
- [EasyTier/EasyTier](https://github.com/EasyTier/EasyTier) ★8150 [`nat-traversal`] [`p2p`] [`rust`] [`tailscale`] [`vpn`] [`zerotier`]  
...
- [rtyley/bfg-repo-cleaner](https://github.com/rtyley/bfg-repo-cleaner) ★11836 [`git`]  
...
- [ohmyzsh/ohmyzsh](https://github.com/ohmyzsh/ohmyzsh) ★182814 [`cli`] [`cli-app`] [`oh-my-zsh`] [`oh-my-zsh-plugin`] [`oh-my-zsh-theme`] [`ohmyzsh`] [`plugin-framework`] [`plugins`] [`productivity`] [`shell`] [`terminal`] [`theme`] [`themes`] [`zsh`] [`zsh-configuration`]  
...
- [sickcodes/Docker-OSX](https://github.com/sickcodes/Docker-OSX) ★51739 [`container`] [`docker`] [`docker-osx`] [`kvm`] [`macos`] [`os`] [`osx`] [`osx-kvm`] [`x`] [`x11`]  
...
- [dockur/windows](https://github.com/dockur/windows) ★48602 [`docker`] [`docker-container`] [`virtualization`] [`windows`] [`windows-virtual-desktop`] [`windows-virtual-machine`] [`windows-virtual-machines`] [`windows-vm`]  
...
- [acmesh-official/acme.sh](https://github.com/acmesh-official/acme.sh) ★44574 [`acme`] [`acme-client`] [`acme-protocol`] [`ash`] [`bash`] [`buypass`] [`certbot`] [`letsencrypt`] [`posix`] [`posix-sh`] [`shell`] [`zerossl`]  
...
- [zsh-users/zsh-autosuggestions](https://github.com/zsh-users/zsh-autosuggestions) ★34217 [`autocomplete`] [`autosuggest`] [`fish`] [`shell`] [`zsh`] [`zsh-autosuggestions`]  
...
- [233boy/v2ray](https://github.com/233boy/v2ray) ★27371 [`shell-script`] [`v2ray`] [`vmess`]  
  这是一个基于Go语言开发的V2Ray代理服务器。它提供快速、稳定的代理连接，支持多种协议和配置。项目包含了核心代理服务以及客户端配置文件生成工具，用户可以方便地配置和管理V2Ray连接。代码结构清晰，易于维护和扩展。
- [hwdsl2/setup-ipsec-vpn](https://github.com/hwdsl2/setup-ipsec-vpn) ★26987 [`cisco-ipsec`] [`docker`] [`encryption`] [`ikev2`] [`ipsec`] [`l2tp`] [`libreswan`] [`linux`] [`network`] [`raspberry-pi`] [`security`] [`vpn`] [`vpn-client`] [`vpn-server`]  
...
- [yuaotian/go-cursor-help](https://github.com/yuaotian/go-cursor-help) ★25077 [`cursor`] [`error`]  
...
- [StreisandEffect/streisand](https://github.com/StreisandEffect/streisand) ★23667 [`ansible`] [`anyconnect`] [`censorship`] [`openconnect`] [`openvpn`] [`shadowsocks`] [`ssh`] [`streisand`] [`stunnel`] [`tor`] [`vpn`] [`wireguard`]  
...
- [lxgw/LxgwWenKai](https://github.com/lxgw/LxgwWenKai) ★22147 [`cjk`] [`font`] [`typeface`]  
...
- [spaceship-prompt/spaceship-prompt](https://github.com/spaceship-prompt/spaceship-prompt) ★20270 [`oh-my-zsh`] [`prompt`] [`shell`] [`shell-prompt`] [`shell-theme`] [`spaceship`] [`terminal`] [`zsh`] [`zsh-theme`] [`zsh-users`]  
...
- [mack-a/v2ray-agent](https://github.com/mack-a/v2ray-agent) ★17630 [`cloudflare`] [`grpc-cloudflare`] [`httpupgrade`] [`hysteria2`] [`nginx`] [`reality`] [`reality-grpc`] [`shell`] [`sing-box`] [`trojan`] [`trojan-grpc`] [`tuic-v5`] [`v2ray`] [`vless`] [`vmess`] [`websockettlscdn-cloudflare-ip`] [`xray`] [`xray-core`] [`xray-install`] [`xtls-rprx-vision`]  
...
- [unixorn/awesome-zsh-plugins](https://github.com/unixorn/awesome-zsh-plugins) ★17064 [`awesome`] [`awesome-list`] [`collection`] [`hacktoberfest`] [`list`] [`oh-my-zsh`] [`zgenom`] [`zsh-completions`] [`zsh-configuration`] [`zsh-framework`] [`zsh-plugin`] [`zsh-prompt`] [`zsh-theme`]  
...
- [hq450/fancyss](https://github.com/hq450/fancyss) ★13121 [`arm`] [`koolgame`] [`merlin`] [`naiveproxy`] [`shadowsocks`] [`shadowsocks-rust`] [`ss`] [`ssr`] [`trojan`] [`v2ray`] [`x64`] [`xray`]  
...
- [DaoCloud/public-image-mirror](https://github.com/DaoCloud/public-image-mirror) ★12196 [`mirror`] [`speedup`]  
...
- [angristan/wireguard-install](https://github.com/angristan/wireguard-install) ★10111 [`linux`] [`nat`] [`privacy`] [`vpn`] [`wireguard`]  
...
- [Gogh-Co/Gogh](https://github.com/Gogh-Co/Gogh) ★9964 [`bash`] [`color-scheme`] [`gnome-terminal`] [`iterm2`] [`linux`] [`mint`] [`pantheon-terminal`] [`shell`] [`terminal`]  
...
- [bin456789/reinstall](https://github.com/bin456789/reinstall) ★8675 [`alpine`] [`alpine-linux`] [`boot`] [`distro`] [`grub`] [`installer`] [`iso`] [`linux`] [`linux-distribution`] [`liveos`] [`netboot`] [`netinst`] [`netinstall`] [`operating-systems`] [`os`] [`reinstall`] [`shell-script`] [`vps`] [`windows`]  
...
- [spiritLHLS/ecs](https://github.com/spiritLHLS/ecs) ★6013 [`almalinux`] [`arch`] [`astralinux`] [`bench-script`] [`benchmark`] [`cdn`] [`centos`] [`checker`] [`debian`] [`fedora`] [`goecs`] [`ipv6`] [`lemonbench`] [`openai`] [`oracle-linux`] [`rockylinux`] [`speedtest`] [`sysbench`] [`ubuntu`] [`vps`]  
...
- [lmc999/RegionRestrictionCheck](https://github.com/lmc999/RegionRestrictionCheck) ★4695  
...
- [xubiaolin/docker-zerotier-planet](https://github.com/xubiaolin/docker-zerotier-planet) ★3716 [`dockerfile`] [`planet`] [`self-host-zerotier`] [`self-hosted`] [`zerotier`] [`zerotier-network`]  
...
- [eooce/Sing-box](https://github.com/eooce/Sing-box) ★3696 [`argo`] [`hysteria2`] [`oneclick`] [`reality`] [`serv00`] [`sing-box`] [`tuic`] [`tunnel`] [`vmess-ws-tls`]  
...
- [mvscode/frps-onekey](https://github.com/mvscode/frps-onekey) ★3447 [`debian`] [`frp`] [`frps`] [`linux`] [`nat`] [`remote-control`] [`shell`] [`ubuntu`]  
...
- [gaoyifan/china-operator-ip](https://github.com/gaoyifan/china-operator-ip) ★3273 [`asn`] [`bgp`] [`china`] [`daily`] [`ip`] [`ipv6`] [`operator`]  
...
- [tom-snow/wechat-windows-versions](https://github.com/tom-snow/wechat-windows-versions) ★2679  
  该项目提供Windows平台下的微信客户端替代方案，允许用户在Windows系统上运行微信。它基于Electron框架，使用JavaScript和HTML技术构建，并通过封装微信网页版实现。项目包含了微信登录、消息收发、文件传输等核心功能。
- [webinstall/webi-installers](https://github.com/webinstall/webi-installers) ★2596 [`brew`] [`hacktoberfest`] [`linux`] [`macos`] [`windows-10`] [`wsl`] [`wsl-ubuntu`] [`wsl2`]  
...
- [ylx2016/Linux-NetSpeed](https://github.com/ylx2016/Linux-NetSpeed) ★2247  
...
- [yhan219/navicat_reset_mac](https://github.com/yhan219/navicat_reset_mac) ★1812 [`navicat`] [`navicat-keygen`] [`navicat-reset`]  
...
- [imputnet/cobalt](https://github.com/imputnet/cobalt) ★37274 [`collaboration`] [`downloader`] [`instagram`] [`javascript`] [`music`] [`reddit`] [`social-media`] [`soundcloud`] [`svelte`] [`tiktok`] [`twitter`] [`typescript`] [`video`] [`vimeo`] [`vk`] [`webapp`] [`youtube`] [`youtube-downloader`]  
...
- [GoodiesHQ/headscale-admin](https://github.com/GoodiesHQ/headscale-admin) ★933  
...
- [Finb/Bark](https://github.com/Finb/Bark) ★7032 [`ios`] [`ios-app`] [`ios-swift`] [`mvvm`] [`mvvm-architecture`] [`push-notifications`] [`rxcocoa`] [`rxdatasources`] [`rxswift`]  
...
- [X1a0He/Adobe-Downloader](https://github.com/X1a0He/Adobe-Downloader) ★2518  
...
- [iptv-org/iptv](https://github.com/iptv-org/iptv) ★101243 [`iptv`] [`m3u`] [`playlist`] [`streams`] [`tv`]  
...
- [ant-design/ant-design](https://github.com/ant-design/ant-design) ★96620 [`ant-design`] [`antd`] [`design-systems`] [`react`] [`typescript`] [`ui-kit`] [`ui-library`]  
...
- [tailwindlabs/tailwindcss](https://github.com/tailwindlabs/tailwindcss) ★91118 [`css`] [`css-framework`] [`functional-css`] [`postcss`] [`responsive`] [`tailwindcss`] [`utility-classes`]  
...
- [ChatGPTNextWeb/NextChat](https://github.com/ChatGPTNextWeb/NextChat) ★86458 [`calclaude`] [`chatgpt`] [`claude`] [`cross-platform`] [`desktop`] [`fe`] [`gemini`] [`gemini-pro`] [`gemini-server`] [`gemini-ultra`] [`gpt-4o`] [`groq`] [`nextjs`] [`ollama`] [`react`] [`tauri`] [`tauri-app`] [`vercel`] [`webui`]  
...
- [immich-app/immich](https://github.com/immich-app/immich) ★84405 [`backup-tool`] [`flutter`] [`google-photos`] [`google-photos-alternative`] [`javascript`] [`mobile-app`] [`nestjs`] [`nodejs`] [`photo-gallery`] [`photos`] [`photos-management`] [`self-hosted`] [`svelte`] [`sveltekit`] [`typescript`] [`videos`]  
...
- [mermaid-js/mermaid](https://github.com/mermaid-js/mermaid) ★84146 [`diagrams`] [`diagrams-as-code`] [`documentation`] [`flowchart`] [`javascript`] [`mindmap`] [`typescript`] [`uml-diagrams`]  
...
- [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) ★82882 [`gemini`] [`gemini-api`]  
...
- [clash-verge-rev/clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev) ★82243 [`clash`] [`clash-meta`] [`clash-verge`] [`linux`] [`mac`] [`mihomo`] [`tauri-app`] [`windows`]  
...
- [hoppscotch/hoppscotch](https://github.com/hoppscotch/hoppscotch) ★76980 [`api`] [`api-client`] [`api-rest`] [`api-testing`] [`developer-tools`] [`graphql`] [`http`] [`http-client`] [`pwa`] [`rest`] [`rest-api`] [`spa`] [`testing`] [`testing-tools`] [`tools`] [`vue`] [`vuejs`] [`websocket`]  
...
- [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) ★67969 [`ai`] [`ai-agents`] [`ai-crawler`] [`ai-scraping`] [`ai-search`] [`crawler`] [`data-extraction`] [`html-to-markdown`] [`llm`] [`markdown`] [`scraper`] [`scraping`] [`web-crawler`] [`web-data`] [`web-data-extraction`] [`web-scraper`] [`web-scraping`] [`web-search`] [`webscraping`]  
...
- [lobehub/lobe-chat](https://github.com/lobehub/lobe-chat) ★67809 [`agent`] [`ai`] [`artifacts`] [`chat`] [`chatgpt`] [`claude`] [`deepseek`] [`deepseek-r1`] [`function-calling`] [`gemini`] [`gpt`] [`knowledge-base`] [`mcp`] [`nextjs`] [`ollama`] [`openai`] [`rag`]  
...
- [nocodb/nocodb](https://github.com/nocodb/nocodb) ★58745 [`airtable`] [`airtable-alternative`] [`automatic-api`] [`hacktoberfest`] [`low-code`] [`no-code`] [`no-code-database`] [`no-code-platform`] [`postgresql`] [`rest-api`] [`restful-api`] [`spreadsheet`] [`sqlite`] [`swagger`]  
...
- [lyswhut/lx-music-desktop](https://github.com/lyswhut/lx-music-desktop) ★47183 [`electron`] [`javascript`] [`music-player`] [`vue`]  
...
- [slab/quill](https://github.com/slab/quill) ★46462 [`editor`] [`quill`] [`rich-text-editor`] [`wysiwyg`]  
...
- [RocketChat/Rocket.Chat](https://github.com/RocketChat/Rocket.Chat) ★43893 [`chat`] [`collaboration`] [`foss`] [`free`] [`hacktoberfest`] [`javascript`] [`meteor`] [`mit`] [`real-time`] [`slack`] [`webrtc`]  
...
- [DIYgod/RSSHub](https://github.com/DIYgod/RSSHub) ★39918 [`bilibili`] [`douban`] [`dribbble`] [`instagram`] [`lofter`] [`pixiv`] [`rss`] [`rsshub`] [`spotify`] [`telegram`] [`tiktok`] [`twitter`] [`v2ex`] [`wechat`] [`weibo`] [`ximalaya`] [`youtube`] [`zhihu`]  
...
- [RSSNext/Folo](https://github.com/RSSNext/Folo) ★35853 [`ai`] [`reader`] [`rss`] [`rss-reader`] [`rsshub`]  
...
- [umami-software/umami](https://github.com/umami-software/umami) ★33572 [`analytics`] [`audience-segmentation`] [`charts`] [`cohort-analysis`] [`google-analytics`] [`product-analytics`] [`statistics`] [`user-journey`] [`web-analytics`]  
...
- [niklasvh/html2canvas](https://github.com/niklasvh/html2canvas) ★31657 [`dom`] [`javascript`] [`screenshot`]  
...
- [NginxProxyManager/nginx-proxy-manager](https://github.com/NginxProxyManager/nginx-proxy-manager) ★29672 [`nginx`] [`nginx-proxy`]  
...
- [blakeblackshear/frigate](https://github.com/blakeblackshear/frigate) ★27232 [`ai`] [`camera`] [`google-coral`] [`home-assistant`] [`home-automation`] [`homeautomation`] [`mqtt`] [`nvr`] [`object-detection`] [`realtime`] [`rtsp`] [`tensorflow`]  
...
- [oldj/SwitchHosts](https://github.com/oldj/SwitchHosts) ★25891 [`electron`] [`hosts`] [`hostseditor`] [`hostsfile`] [`switch-hosts`] [`switchhosts`]  
...
- [fingerprintjs/fingerprintjs](https://github.com/fingerprintjs/fingerprintjs) ★25888 [`audio-fingerprinting`] [`browser`] [`browser-fingerprint`] [`browser-fingerprinting`] [`detection`] [`fingerprint`] [`fingerprinting`] [`fingerprintjs`] [`fraud`] [`fraud-detection`] [`identification`] [`javascript`] [`visitor-identifier`]  
...
- [Molunerfinn/PicGo](https://github.com/Molunerfinn/PicGo) ★25873 [`aliyun-oss`] [`electron`] [`electron-app`] [`electron-vue`] [`github`] [`imgur`] [`imgur-uploader`] [`qiniu`] [`smms`] [`tencent-cos`] [`upyun`] [`vue`] [`weibo`]  
...
- [GoogleChromeLabs/squoosh](https://github.com/GoogleChromeLabs/squoosh) ★24085  
...
- [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ★23323  
...
- [t4t5/sweetalert](https://github.com/t4t5/sweetalert) ★22369 [`alert`] [`dialog`] [`javascript`] [`modal`] [`popup`] [`sweetalert`] [`ui`]  
...
- [wechaty/wechaty](https://github.com/wechaty/wechaty) ★22170 [`bot`] [`chatbot`] [`conversational-ai`] [`framework`] [`qq`] [`robotics`] [`wechat`] [`wechaty`] [`whatsapp`]  
...
- [musistudio/claude-code-router](https://github.com/musistudio/claude-code-router) ★21871  
...
- [maotoumao/MusicFree](https://github.com/maotoumao/MusicFree) ★21490 [`free`] [`music-player`] [`musicfree`] [`plugin`] [`react`] [`react-native`] [`typescript`]  
...
- [louislam/dockge](https://github.com/louislam/dockge) ★20330 [`docker`] [`docker-compose`] [`docker-deployment`] [`docker-stack`] [`docker-stack-deploy`] [`docker-ui`] [`responsive`] [`self-hosted`] [`selfhosted`] [`single-page-app`] [`socket-io`] [`webapp`] [`websocket`]  
...
- [nocobase/nocobase](https://github.com/nocobase/nocobase) ★19642 [`admin-dashboard`] [`airtable`] [`app-builder`] [`crm`] [`crud`] [`developer-tools`] [`erp`] [`internal-tool`] [`internal-tools`] [`low-code`] [`low-code-development-platform`] [`lowcode`] [`no-code`] [`no-code-platform`] [`nocode`] [`project-management`] [`salesforce`] [`self-hosted`] [`web-application`] [`workflows`]  
...
- [winfunc/opcode](https://github.com/winfunc/opcode) ★18782 [`anthropic`] [`anthropic-claude`] [`claude`] [`claude-4`] [`claude-4-opus`] [`claude-4-sonnet`] [`claude-ai`] [`claude-code`] [`claude-code-sdk`] [`cursor`] [`ide`] [`llm`] [`llm-code`] [`rust`] [`tauri`]  
...
- [whyour/qinglong](https://github.com/whyour/qinglong) ★18696 [`crontab`] [`docker`] [`javascript`] [`python`] [`shell`] [`task-manager`] [`typescript`]  
...
- [baidu/amis](https://github.com/baidu/amis) ★18665 [`admin`] [`frontend`] [`frontend-framework`] [`json`] [`low-code`] [`low-code-development-platform`] [`lowcode`] [`no-code`]  
...
- [wangeditor-team/wangEditor](https://github.com/wangeditor-team/wangEditor) ★18193 [`rich-text`] [`rich-text-html-editor`] [`typescript`] [`wangeditor`] [`wysiwyg`] [`wysiwyg-editor`]  
...
- [apitable/apitable](https://github.com/apitable/apitable) ★15018 [`admin-dashboard`] [`airtable`] [`airtable-alternative`] [`api`] [`automatic-api`] [`embed`] [`hacktoberfest`] [`internal-tool`] [`javascript`] [`low-code`] [`nestjs`] [`nextjs`] [`no-code`] [`nocodb`] [`notion`] [`react`] [`spreadsheet`] [`spring`] [`typescript`]  
...
- [ag-grid/ag-grid](https://github.com/ag-grid/ag-grid) ★14726 [`angular`] [`angular-grid`] [`angular-table`] [`charting`] [`datagrid`] [`datatable`] [`excel`] [`filtering`] [`grid`] [`grouping`] [`javascript-table`] [`pagination`] [`pivoting`] [`react`] [`react-grid`] [`react-table`] [`sorting`] [`table`] [`vue-table`] [`vuejs`]  
...
- [vercel/vercel](https://github.com/vercel/vercel) ★14355 [`cli`] [`cloud`] [`command`] [`hosting`] [`jamstack`] [`ship`] [`vercel`]  
...
- [electron-userland/electron-builder](https://github.com/electron-userland/electron-builder) ★14338 [`appx`] [`auto-update`] [`builder`] [`contributions-welcome`] [`deb`] [`distribution-electron`] [`dmg`] [`electron`] [`electron-builder`] [`electron-updater`] [`help-wanted`] [`linux`] [`macos`] [`msi`] [`muon`] [`nsis`] [`pkg`] [`rpm`] [`snap`] [`squirrel`]  
...
- [ourongxing/newsnow](https://github.com/ourongxing/newsnow) ★14171 [`elegant`] [`news`]  
...
- [dexie/Dexie.js](https://github.com/dexie/Dexie.js) ★13741 [`database`] [`indexeddb`] [`javascript`] [`offline`] [`offline-storage`] [`storage`]  
...
- [ayangweb/BongoCat](https://github.com/ayangweb/BongoCat) ★13026 [`bongo-cat`] [`bongocat`] [`cross-platform`] [`desktop-app`] [`desktop-pet`] [`linux`] [`macos`] [`pet`] [`pet-project`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [taye/interact.js](https://github.com/taye/interact.js) ★12848 [`drag-and-drop`] [`drop`] [`inertia`] [`javascript`] [`javascript-drag`] [`mobile`] [`modern-browsers`] [`multi-touch`] [`snap`] [`touch`] [`typescript`] [`vanilla`]  
...
- [plait-board/drawnix](https://github.com/plait-board/drawnix) ★12461 [`collaboration`] [`drawing`] [`flowchart`] [`localfirst`] [`mindmap`] [`productivity`] [`whiteboard`]  
...
- [idootop/mi-gpt](https://github.com/idootop/mi-gpt) ★11793  
...
- [dream-num/univer](https://github.com/dream-num/univer) ★11596 [`ai-excel`] [`ai-sheet`] [`ai-spreadsheet`] [`appscript`] [`collaboration`] [`data-table`] [`doc`] [`excel`] [`excel-mcp`] [`grid`] [`live-share`] [`ppt`] [`sdk`] [`sheet`] [`sheet-mcp`] [`spreadsheet`] [`spreadsheet-mcp`] [`univer-mcp`] [`word`] [`xlsx`]  
  这是一个用于生成各种类型的数字序列的工具。它支持算术、几何、斐波那契、卢卡斯等多种序列类型，并允许用户自定义序列规则。该工具使用Python语言开发，基于NumPy库进行数值计算，并提供简洁的API接口，方便用户快速生成所需序列。
- [bitwarden/clients](https://github.com/bitwarden/clients) ★11519 [`angular`] [`bitwarden`] [`browser-extension`] [`chrome`] [`cli`] [`desktop`] [`electron`] [`firefox`] [`javascript`] [`nodejs`] [`safari`] [`typescript`] [`webextension`]  
...
- [giscus/giscus](https://github.com/giscus/giscus) ★10818 [`blog`] [`comment-system`] [`comments`] [`comments-widget`] [`giscus`] [`github`] [`github-discussions`] [`hacktoberfest`] [`javascript`] [`nextjs`] [`react`] [`reactjs`] [`utterances`] [`widget`]  
...
- [jackyzha0/quartz](https://github.com/jackyzha0/quartz) ★10548 [`digital-garden`] [`networked-thought`] [`obsidian`] [`obsidian-md`] [`quartz-ssg`] [`static-site-generator`]  
...
- [getgridea/gridea](https://github.com/getgridea/gridea) ★10224 [`blog`] [`blog-engine`] [`blog-platform`] [`cms`] [`electron`] [`electronjs`] [`gridea`] [`jamstack`] [`macos`] [`static-blog`] [`static-site`] [`static-site-cms`] [`static-site-generator`] [`typescript`] [`vue`] [`vue2`] [`windows`]  
...
- [AIsouler/GKD_subscription](https://github.com/AIsouler/GKD_subscription) ★9219 [`gkd`] [`gkd-subscription`] [`typescript`]  
...
- [gridstack/gridstack.js](https://github.com/gridstack/gridstack.js) ★8493 [`angular`] [`dashboard`] [`grid`] [`gridster`] [`javascript`] [`react`] [`typescript`] [`vue`] [`widget`]  
...
- [HerbertHe/iptv-sources](https://github.com/HerbertHe/iptv-sources) ★8397 [`diyp`] [`docker`] [`iptv`] [`iptv-channels`] [`iptv-m3u`] [`kodi`] [`m3u`] [`tvbox`]  
...
- [Termix-SSH/Termix](https://github.com/Termix-SSH/Termix) ★7512 [`docker`] [`file-management`] [`self-hosted`] [`ssh`] [`ssh-tunnel`] [`termix`]  
...
- [jakearchibald/idb](https://github.com/jakearchibald/idb) ★7118  
...
- [humanlayer/humanlayer](https://github.com/humanlayer/humanlayer) ★6779 [`agents`] [`ai`] [`amp`] [`claude-code`] [`codex`] [`human-in-the-loop`] [`humanlayer`] [`llm`] [`llms`] [`opencode`]  
...
- [EcoPasteHub/EcoPaste](https://github.com/EcoPasteHub/EcoPaste) ★6398 [`application`] [`clipboard`] [`clipboard-manager`] [`cross-platform`] [`desktop-app`] [`desktop-application`] [`linux`] [`macos`] [`rust`] [`tauri`] [`tauri-app`] [`windows`]  
...
- [remotely-save/remotely-save](https://github.com/remotely-save/remotely-save) ★6312  
...
- [HuolalaTech/page-spy-web](https://github.com/HuolalaTech/page-spy-web) ★5513  
...
- [dushixiang/next-terminal](https://github.com/dushixiang/next-terminal) ★5290 [`antd`] [`antd-design`] [`docker`] [`go`] [`golang`] [`guacamole`] [`rdp`] [`react`] [`ssh`] [`vnc`]  
...
- [czy0729/Bangumi](https://github.com/czy0729/Bangumi) ★4957 [`android`] [`android-app`] [`bangumi`] [`design`] [`expo`] [`ios`] [`ios-app`] [`mobx`] [`moe`] [`react`] [`react-native`]  
...
- [wechat-article/wechat-article-exporter](https://github.com/wechat-article/wechat-article-exporter) ★4729 [`download`] [`wechat`] [`wechat-article`] [`wechat-download`]  
...
- [galaxy-s10/billd-desk](https://github.com/galaxy-s10/billd-desk) ★4607 [`coturn`] [`electron`] [`flutter`] [`nodejs`] [`parsec`] [`remote-desktop`] [`rustdesk`] [`socket-io`] [`todesk`] [`typescript`] [`vue3`] [`webrtc`]  
...
- [meowtec/Imagine](https://github.com/meowtec/Imagine) ★4238 [`cross-platform`] [`desktop`] [`image-compression`] [`jpeg`] [`jpegmini`] [`linux-app`] [`macos`] [`pngquant`] [`save-for-web`] [`tinypng`] [`webp`]  
...
- [BilibiliVideoDownload/BilibiliVideoDownload](https://github.com/BilibiliVideoDownload/BilibiliVideoDownload) ★3411 [`ant-design-vue`] [`bilibili-download`] [`electron`] [`electron-builder`] [`ffmpeg-installer`] [`node-js`] [`typescript`] [`vuejs`]  
...
- [VisActor/VTable](https://github.com/VisActor/VTable) ★3209 [`canvas-table`] [`data-analysis`] [`data-visualization`] [`database`] [`datagrid`] [`grid`] [`javascript-table`] [`javescript`] [`list-table`] [`list-tree`] [`online-excel`] [`pivot-chart`] [`pivot-grid`] [`pivot-tables`] [`react-table`] [`sparklines`] [`spreadsheet`] [`tree-table`] [`visualization`] [`vue-table`]  
...
- [pages-cms/pages-cms](https://github.com/pages-cms/pages-cms) ★3168 [`11ty`] [`astro`] [`cms`] [`docusaurus`] [`eleventy`] [`gatsby`] [`hugo`] [`jekyll`] [`nextjs`] [`ssg`] [`static-site`] [`static-site-generator`] [`vitepress`] [`vue`] [`vuejs`] [`vuejs3`] [`vuepress`]  
...
- [xjh22222228/nav](https://github.com/xjh22222228/nav) ★3061 [`ai-awesome`] [`angular`] [`nav`] [`navigation`] [`netlify`] [`nextjs`] [`ng-zorro-antd`] [`vercel`]  
...
- [pure-admin/pure-admin-thin](https://github.com/pure-admin/pure-admin-thin) ★2728 [`pure-admin-thin`] [`vue-pure-admin`]  
...
- [korbinjoe/excalidraw-cn](https://github.com/korbinjoe/excalidraw-cn) ★2260 [`canvas`] [`chinese-fonts`] [`draw`] [`excalidraw`] [`hand`] [`handraw`] [`whiteboard`]  
...
- [xpf0000/FlyEnv](https://github.com/xpf0000/FlyEnv) ★2214 [`development-environment`] [`electron`] [`laravel`] [`laravel-herd`] [`local-dns-server`] [`local-web-server`] [`mamp`] [`mamp-pro`] [`php`] [`php-environment`] [`php-obfuscator`] [`phpstudy`] [`web-ide`] [`wordpress`] [`xampp`]  
...
- [NetrisTV/ws-scrcpy](https://github.com/NetrisTV/ws-scrcpy) ★2179 [`android`] [`browser`] [`control`] [`javascript`] [`mirroring`] [`mobile`] [`phone`] [`remote`] [`remote-control`] [`scrcpy`] [`screen`] [`typescript`] [`websocket`]  
...
- [pt-plugins/PT-depiler](https://github.com/pt-plugins/PT-depiler) ★1737 [`private-tracker`]  
...
- [Adpro-Team/GKD_subscription](https://github.com/Adpro-Team/GKD_subscription) ★1702 [`gkd`] [`gkd-subscription`] [`nodejs`] [`subscription`] [`typescript`]  
...
- [ipid/unlock-music](https://github.com/ipid/unlock-music) ★1474  
...
- [PanJiaChen/vue-element-admin](https://github.com/PanJiaChen/vue-element-admin) ★90124 [`admin`] [`admin-dashboard`] [`admin-template`] [`axios`] [`dashboard`] [`desktop`] [`element`] [`element-ui`] [`i18n`] [`management-system`] [`mock`] [`tinymce`] [`vue`] [`vue-admin`] [`vue-cli`] [`vuex`] [`webpack`] [`webpack4`] [`xlsx`]  
...
- [vbenjs/vue-vben-admin](https://github.com/vbenjs/vue-vben-admin) ★30613 [`admin-template`] [`ant-design`] [`element-plus`] [`monorepo`] [`naive-ui`] [`shadcn-ui`] [`tsx`] [`typescript`] [`vben`] [`vite`] [`vite-template`] [`vue-router`] [`vue3`] [`vuex`]  
...
- [requarks/wiki](https://github.com/requarks/wiki) ★27324 [`cross-platform`] [`documentation`] [`git`] [`markdown`] [`nodejs`] [`open-source`] [`wiki`]  
...
- [Lissy93/dashy](https://github.com/Lissy93/dashy) ★23111 [`awesome`] [`dashboard`] [`docker`] [`hacktoberfest`] [`homelab`] [`homepage`] [`mit`] [`nodejs`] [`organization`] [`productivity`] [`pwa`] [`self-hosted`] [`startpage`] [`vue`]  
...
- [pure-admin/vue-pure-admin](https://github.com/pure-admin/vue-pure-admin) ★19217 [`admin`] [`element-plus`] [`esm`] [`pinia`] [`tailwindcss`] [`typescript`] [`vite`] [`vue3`]  
...
- [chaitin/xray](https://github.com/chaitin/xray) ★11304 [`passive-vulnerability-scanner`] [`poc`] [`security`] [`sqlinjection`] [`vulnerability`] [`vulnerability-scanner`] [`xss`]  
...
- [zyronon/douyin](https://github.com/zyronon/douyin) ★11197 [`douyin`] [`js`] [`tiktok`] [`vue`] [`vue3`]  
...
- [doocs/md](https://github.com/doocs/md) ★11020 [`ai-bot`] [`doocs`] [`editor`] [`llm`] [`markdown`] [`markdown-editor`] [`tailwindcss`] [`vite`] [`vue`] [`vue3`] [`wechat`] [`weixin`]  
...
- [Akryum/vue-virtual-scroller](https://github.com/Akryum/vue-virtual-scroller) ★10492 [`scroller`] [`virtual-scroller`] [`vuejs`] [`vuejs-components`] [`vuejs2`]  
...
- [jason5ng32/MyIP](https://github.com/jason5ng32/MyIP) ★9352 [`awesome`] [`censorship`] [`chatgpt`] [`dns`] [`ip`] [`ipinfo`] [`leaks`] [`myip`] [`network`] [`pingchecker`] [`proxy`] [`security`] [`security-tools`] [`speedtest`] [`vercel`] [`webrtc`] [`whatismyip`] [`whatismyipaddress`] [`whois`] [`whois-lookup`]  
...
- [JakHuang/form-generator](https://github.com/JakHuang/form-generator) ★9302 [`element-ui`] [`form-designer`] [`monaco-editor`] [`vue`] [`vue-jsx`] [`vue-multipage`] [`vue-render`] [`vuejs`]  
...
- [hslr-s/sun-panel](https://github.com/hslr-s/sun-panel) ★4647 [`docker`] [`gin`] [`golang`] [`homelab`] [`homepage`] [`nas`] [`navigationpage`] [`raspberry-pi`] [`self-hosted`] [`startpage`] [`synology`] [`vue3`]  
...
- [HuLaSpark/HuLa](https://github.com/HuLaSpark/HuLa) ★4641 [`chatbot`] [`cross-platform`] [`cross-platform-app`] [`macos`] [`mobile`] [`rust`] [`tauri`] [`tsx`] [`vue3`] [`webview`] [`windows`] [`windows-10`] [`windows-11`]  
...
- [MoeKoeMusic/MoeKoeMusic](https://github.com/MoeKoeMusic/MoeKoeMusic) ★4170 [`javascript`] [`kugou`] [`linux`] [`macos`] [`music`] [`vue3`] [`windows`]  
...
- [mubaidr/vite-vue3-browser-extension-v3](https://github.com/mubaidr/vite-vue3-browser-extension-v3) ★747 [`chrome`] [`extension`] [`hacktoberfest`] [`nuxtui`] [`nuxtui-v3`] [`vite`] [`vue3`] [`webextension`]  
