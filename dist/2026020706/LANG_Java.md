...
- [NationalSecurityAgency/ghidra](https://github.com/NationalSecurityAgency/ghidra) ★64141 [`disassembler`] [`reverse-engineering`] [`software-analysis`]  
...
- [termux/termux-app](https://github.com/termux/termux-app) ★50253 [`android`] [`hacktoberfest`] [`linux`] [`terminal`] [`termux`]  
...
- [dbeaver/dbeaver](https://github.com/dbeaver/dbeaver) ★48576 [`ai`] [`copilot`] [`database`] [`db2`] [`dbeaver`] [`erd`] [`gui`] [`java`] [`jdbc`] [`mysql`] [`nosql`] [`openai`] [`oracle`] [`postgresql`] [`redshift`] [`sql`] [`sqlite`] [`sqlserver`]  
...
- [skylot/jadx](https://github.com/skylot/jadx) ★47209 [`android`] [`decompiler`] [`dex`] [`java`]  
...
- [DrKLO/Telegram](https://github.com/DrKLO/Telegram) ★28435 [`telegram`]  
...
- [FongMi/TV](https://github.com/FongMi/TV) ★7269 [`catvod`] [`leanback`] [`media3`]  
